...
/**
 * {@link AbstractMSLiveSubscribeService}
 *
...
public abstract class AbstractMSLiveSubscribeService extends AbstractSubscribeService {
    ...
    protected final OAuthServiceMetaData metadata;

    /** The service look-up */
    protected final ServiceLookup services;

    private static final String DISPLAY_NAME = "MS Live";

    /**
     * Initializes a new {@link AbstractMSLiveSubscribeService}.
     * 
     * @param oAuthServiceMetaData
     * @param services
     */
    protected AbstractMSLiveSubscribeService(OAuthServiceMetaData oAuthServiceMetaData, ServiceLookup services) {
        super();
        metadata = oAuthServiceMetaData;
    ...
    public void modifyOutgoing(final Subscription subscription) throws OXException {
        ...
        if (null != accountId) {
            ...
            if (null != displayName && !"".equals(displayName)) {
                ...
                subscription.setDisplayName(DISPLAY_NAME);
            }
