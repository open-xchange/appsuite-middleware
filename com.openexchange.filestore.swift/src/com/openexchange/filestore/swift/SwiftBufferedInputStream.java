...
/**
 * {@link SwiftBufferedInputStream} - The Swift buffered input stream.
 * <p>
...
public class SwiftBufferedInputStream extends InputStream {
    ...
    /**
     * Initializes a new {@link SwiftBufferedInputStream}.
     *
     * @param documentChunks The document's chunks
     * @param client The client to use
     */
    public SwiftBufferedInputStream(List<Chunk> documentChunks, SwiftClient client) {
     ...
     */
    public SwiftBufferedInputStream(List<Chunk> documentChunks, SwiftClient client, long start, long end) {
        super();
    ...
    private InputStream initNext() throws OXException {
        ...
        while (true) {
            ...
            if (null != relativeRange) {
                InputStream in = (0 == relativeRange.length) ? client.get(chunk.getSwiftId()) : client.get(chunk.getSwiftId(), relativeRange[0], relativeRange[1]);
