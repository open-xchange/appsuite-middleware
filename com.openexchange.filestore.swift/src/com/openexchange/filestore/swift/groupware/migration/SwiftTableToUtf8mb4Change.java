...
package com.openexchange.filestore.swift.groupware.migration;
 ...
 * @since v7.10.0
 */
public class SwiftTableToUtf8mb4Change extends AbstractLiquibaseUtf8mb4Adapter {

    @Override
    public String getConfirmationMessage() {
        return "Swift table successfully converted to utf8mb4";
    }

    @Override
    protected List<String> tablesToConvert() {
        return ImmutableList.of("swift_token");
    }
