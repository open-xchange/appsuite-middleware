...
/**
 * {@link SproxydCreateTableService} - The {@link CreateTableService} for Swoft object store.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class SproxydCreateTableService extends AbstractCreateTableImpl {

    private static final String TABLE_SWIFT_FILESTORE = "swift_filestore";

    private static final String CREATE_SWIFT_FILESTORE = "CREATE TABLE "+TABLE_SWIFT_FILESTORE+" (" +
    ...
    public static String[] getTablesToCreate() {
        return new String[] { TABLE_SWIFT_FILESTORE };
    }
    ...
    public static String[] getCreateStmts() {
        return new String[] { CREATE_SWIFT_FILESTORE };
    }
