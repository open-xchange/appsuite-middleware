...
public enum SwiftExceptionCode implements DisplayableOXExceptionCode {
     ...
     */
    NO_SUCH_DOCUMENT("No such document: %1$s", CATEGORY_ERROR, 4, SwiftExceptionMessages.NO_SUCH_DOCUMENT_MSG),
    /**
     * No such chunk: %1$s
     */
    NO_SUCH_CHUNK("No such chunk: %1$s", CATEGORY_ERROR, 5, SwiftExceptionMessages.NO_SUCH_CHUNK_MSG),
    /**
    ...
    private SwiftExceptionCode(String message, Category category, int detailNumber, String displayMessage) {
    ...
    private SwiftExceptionCode(String message, Category category, int detailNumber) {
        this.message = message;
        this.detailNumber = detailNumber;
        this.category = category;
