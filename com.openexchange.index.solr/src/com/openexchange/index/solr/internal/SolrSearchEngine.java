...
/**
 * {@link SolrSearchEngine}
 *
 * @author <a href="mailto:steffen.templin@open-xchange.com">Steffen Templin</a>
 */
public class SolrSearchEngine implements IndexSearchEngine {

    @Override
    public Map<Integer, IndexResult<?>> search(Session session, String searchTerm) throws OXException {
        ...
        try {
            latch.await();
            if (!mailFuture.isCancelled()) {
                result.put(Types.EMAIL, mailFuture.get());
            }
            if (!infostoreFuture.isCancelled()) {
