...
public class ImportedEvent extends EventComponent implements ImportedComponent {
    ...
    public List<OXException> getWarnings() {
        List<OXException> allWarnings = new ArrayList<OXException>();
        if (null != this.warnings) {
            allWarnings.addAll(this.warnings);
        }
        List<OXException> alarmWarnings = ComponentUtils.collectWarnings(getAlarms());
        if (null != alarmWarnings) {
            allWarnings.addAll(alarmWarnings);
        }
        return allWarnings;
    }
