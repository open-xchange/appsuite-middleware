...
/**
 *
 * {@link GoogleExceptionCodes}
 *
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 * @since v7.10.0
 */
public enum GoogleExceptionCodes implements DisplayableOXExceptionCode {
    /**
    ...
    /**
     * Initializes a new {@link GoogleExceptionCodes}.
     *
     ...
     */
    private GoogleExceptionCodes(String message, Category category, int number) {
     ...
     * @param number The error number
     */
    private GoogleExceptionCodes(String message, String displayMessage, Category category, int number) {
