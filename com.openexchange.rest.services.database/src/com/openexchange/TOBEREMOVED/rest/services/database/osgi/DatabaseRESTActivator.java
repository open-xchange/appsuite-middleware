package com.openexchange.TOBEREMOVED.rest.services.database.osgi;

import java.util.Arrays;
import java.util.Collection;
import java.util.concurrent.TimeUnit;
import com.openexchange.TOBEREMOVED.rest.services.database.DBRESTService;
import com.openexchange.TOBEREMOVED.rest.services.database.migrations.DBVersionChecker;
...
import com.openexchange.TOBEREMOVED.rest.services.database.sql.CreateServiceSchemaLockTableTask;
import com.openexchange.TOBEREMOVED.rest.services.database.sql.CreateServiceSchemaVersionTable;
import com.openexchange.TOBEREMOVED.rest.services.database.sql.CreateServiceSchemaVersionTableTask;
import com.openexchange.TOBEREMOVED.rest.services.database.transactions.InMemoryTransactionKeeper;
