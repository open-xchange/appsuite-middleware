...
public interface DataProvider<T> {
    ...
    /**
     * An id to register this type of data provider under.
     */
    public String getId();

    /**
     * Start a session for this data provider and return all session specific data. This is useful for initiating connections to a backend, for example.
