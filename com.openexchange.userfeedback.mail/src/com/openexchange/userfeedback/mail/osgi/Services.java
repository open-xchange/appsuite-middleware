...
public static AtomicReference<ServiceLookup> services = new AtomicReference<>();
    ...
    public static <T> T getService(Class<T> klass) {
        ...
        if (serviceLookup == null) {
            throw new IllegalStateException("Missing ServiceLookup instance. Bundle \"com.openexchange.userfeedback.mail\" not started?");
        }
