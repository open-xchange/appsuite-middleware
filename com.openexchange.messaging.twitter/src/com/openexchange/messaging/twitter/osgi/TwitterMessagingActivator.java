...
public final class TwitterMessagingActivator extends HousekeepingActivator {
    ...
    protected void handleAvailability(final Class<?> clazz) {
        final org.apache.commons.logging.Log logger = com.openexchange.log.Log.loggerFor(TwitterMessagingActivator.class);
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            com.openexchange.log.Log.loggerFor(TwitterMessagingActivator.class).error(
                e.getMessage(),
                e);
            throw e;
        }
