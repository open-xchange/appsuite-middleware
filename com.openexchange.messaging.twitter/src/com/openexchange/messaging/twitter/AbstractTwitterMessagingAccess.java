...
public abstract class AbstractTwitterMessagingAccess {
    ...
    private boolean testOAuthTwitterAccess(final TwitterAccess newTwitterAccess) {
        try {
            ...
            final org.apache.commons.logging.Log logger = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(AbstractTwitterMessagingAccess.class)));
