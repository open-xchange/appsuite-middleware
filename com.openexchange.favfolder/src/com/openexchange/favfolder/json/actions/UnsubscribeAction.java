 ...
 */
public final class UnsubscribeAction extends AbstractFavFolderAction {

    private final UnsubscribeFavFolderPerformer unsubscribePerformer;
    ...
    public UnsubscribeAction(final ServiceLookup services) {
        super(services);
        unsubscribePerformer = new UnsubscribeFavFolderPerformer(services);
    }
    ...
    protected AJAXRequestResult perform(final FavFolderAJAXRequest request) throws OXException, JSONException {
         ...
         * Perform subscribe
         */
        unsubscribePerformer.unsubscribeFolders(treeId, folderIds, request.getSession());
