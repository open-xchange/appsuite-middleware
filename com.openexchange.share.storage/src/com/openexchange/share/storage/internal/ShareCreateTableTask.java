...
/**
 * {@link ShareCreateTableTask}
 *
 * @author <a href="mailto:tobias.friedrich@open-xchange.com">Tobias Friedrich</a>
 */
public class ShareCreateTableTask extends UpdateTaskAdapter {

    /**
     * Initializes a new {@link ShareCreateTableTask}.
     */
    public ShareCreateTableTask() {
        super();
    }

    @Override
    public void perform(final PerformParameters params) throws OXException {
        final DatabaseService dbService = ShareStorageServiceLookup.getService(DatabaseService.class);
        if (dbService == null) {
        ...
        try {
            ...
            transactional = true;
            final String[] tableNames = ShareCreateTableService.getTablesToCreate();
            final String[] createStmts = ShareCreateTableService.getCreateStmts();
