...
package com.openexchange.admin.soap.usercopy.osgi;
...
/**
 * {@link SoapUserCopyActivator}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class SoapUserCopyActivator extends HousekeepingActivator {

    /**
     * Initializes a new {@link SoapUserCopyActivator}.
     */
    public SoapUserCopyActivator() {
        super();
    }
    ...
    protected void startBundle() throws Exception {
        ...
        final ServiceTrackerCustomizer<Remote, Remote> trackerCustomizer = new ServiceTrackerCustomizer<Remote, Remote>() {
            ...
            public void removedService(final ServiceReference<Remote> reference, final Remote service) {
                if (null != service) {
                    OXUserCopyServicePortTypeImpl.RMI_REFERENCE.set(null);
            ...
            public Remote addingService(final ServiceReference<Remote> reference) {
                ...
                if (service instanceof OXUserCopyInterface) {
                    OXUserCopyServicePortTypeImpl.RMI_REFERENCE.set((OXUserCopyInterface) service);
                    return service;
                }
                context.ungetService(reference);
                return null;
        ...
        final OXUserCopyServicePortTypeImpl soapService = new OXUserCopyServicePortTypeImpl();
        registerService(OXUserCopyServicePortType.class, soapService);
    }
