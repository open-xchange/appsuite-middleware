...
public abstract class ListCore extends ResourceAbstraction {
    ...
    protected final void setOptions(final AdminParser parser) {
        ...
        this.searchOption = setShortLongOpt(parser, OPT_NAME_SEARCHPATTERN, OPT_NAME_SEARCHPATTERN_LONG, "The search pattern which is used for listing. This applies to name.", false, NeededQuadState.notneeded);
    }
