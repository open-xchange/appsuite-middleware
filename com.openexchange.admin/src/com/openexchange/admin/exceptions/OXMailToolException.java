...
public class OXMailToolException extends Exception {
     ...
     * @param message
     */
    public OXMailToolException(final String message) {
        super(message);
     ...
     * @param cause
     */
    public OXMailToolException(final Throwable cause) {
        super(cause);
     ...
     * @param cause
     */
    public OXMailToolException(final String message, final Throwable cause) {
        super(message, cause);
    }
