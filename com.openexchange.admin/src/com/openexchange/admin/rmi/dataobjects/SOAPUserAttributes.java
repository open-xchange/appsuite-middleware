...
public class SOAPUserAttributes {
    ...
    private UserAttributesNamespace[] namespaces;
    ...
    public SOAPUserAttributes(Map<String, Map<String, String>> userAttributes) {
        ...
        for(Map.Entry<String, Map<String, String>> namespace : userAttributes.entrySet()) {
            arr[index++] = new UserAttributesNamespace(namespace.getKey(), namespace.getValue());
        }
        this.namespaces = arr;
    }
    ...
    public Map<String, Map<String, String>> toMap() {
        ...
        for (UserAttributesNamespace namespace : namespaces) {
            map.put(namespace.getName(), namespace.getValuesAsMap());
        }
        return map;
    }
