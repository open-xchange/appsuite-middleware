...
public enum UserSettingMailAttribute {
    ...
    SEND_ADDR("send_addr"),
    STD_DRAFTS("std_drafts"),
    STD_SENT("std_sent"),
    STD_SPAM("std_spam"),
    STD_TRASH("std_trash"),
    CONFIRMED_SPAM("confirmed_spam"),
    CONFIRMED_HAM("confirmed_ham"),
    UPLOAD_QUOTA("upload_quota"),
    UPLOAD_QUOTA_PER_FILE("upload_quota_per_file"),
    ;
    ...
    /**
     * 
     * Initialises a new {@link UserSettingMailAttribute}.
     * 
     * @param sqlFieldName the name of the attribute
     */
    private UserSettingMailAttribute(String sqlFieldName) {
