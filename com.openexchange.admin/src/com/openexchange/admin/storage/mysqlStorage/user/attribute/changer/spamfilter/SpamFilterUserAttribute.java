...
/**
 * {@link SpamFilterUserAttribute}
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public enum SpamFilterUserAttribute implements Attribute {
    // Mark attribute, no real value
    SPAM_FILTER_ATTRIBUTE;

    private static final String SPAM_FILTER_ATTRIBUTE_NAME = "user_setting_mail";
    ...
    public String getSQLFieldName() {
        return SPAM_FILTER_ATTRIBUTE_NAME;
    }
