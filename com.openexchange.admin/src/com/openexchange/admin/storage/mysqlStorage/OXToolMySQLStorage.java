            ...
            if (viewFactory != null) {
                try {
                    ...
                    if (userAttribute != null) {
                        final ComposedConfigProperty<String> property = view.property("com.openexchange.admin.user.defaultLanguage", String.class).precedence("server, reseller, contextSets");
