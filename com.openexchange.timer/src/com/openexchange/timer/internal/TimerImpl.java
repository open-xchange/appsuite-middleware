...
public final class TimerImpl implements Timer {
    ...
    private static final class WrappingScheduledTimerTask implements ScheduledTimerTask {

        private final ScheduledFuture<?> scheduledFuture;

        public WrappingScheduledTimerTask(final ScheduledFuture<?> scheduledFuture) {
            super();
