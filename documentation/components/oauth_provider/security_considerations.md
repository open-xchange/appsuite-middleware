...
# Permissions / Limits
  ...
  * It is possible to deny OAuth access at all for certain users via a config-cascade enabled property [com.openexchange.oauth.provider.enabled](https://documentation.open-xchange.com/components/middleware/config/{{version}}/index.html#com.openexchange.oauth.provider.enabled).
