...
![Code flow login](openid/APIgw_Relationship Oauth2.png "Code flow login")
...
## Direct Logout from Appsuite
![Logout direct](openid/Logout direct.png "Logout direct")
