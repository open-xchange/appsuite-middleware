...
---
| __Key__ | USER_STORAGE |
|:----------------|:--------|
| __Description__ | A OXUserStorageInterface implementation which should be used by the admin module.<br> |
| __Default__ | com.openexchange.admin.storage.mysqlStorage.OXUserMySQLStorage |
| __Version__ | 7.8.3 |
| __Reloadable__ | false |
| __Configcascade Aware__ | false |
| __Tags__ | <a href="https://documentation.open-xchange.com/latest/middleware/configuration/tags/Admin.html">Admin</a> |
| __File__ | AdminDaemon.properties |

---
| __Key__ | GROUP_STORAGE |
|:----------------|:--------|
| __Description__ | A OXGroupStorageInterface implementation which should be used by the admin module.<br> |
| __Default__ | com.openexchange.admin.storage.mysqlStorage.OXGroupMySQLStorage |
| __Version__ | 7.8.3 |
| __Reloadable__ | false |
| __Configcascade Aware__ | false |
| __Tags__ | <a href="https://documentation.open-xchange.com/latest/middleware/configuration/tags/Admin.html">Admin</a> |
...
---
| __Key__ | RESOURCE_STORAGE |
|:----------------|:--------|
| __Description__ | A OXResourceStorageInterface implementation which should be used by the admin module.<br> |
| __Default__ | com.openexchange.admin.storage.mysqlStorage.OXResourceMySQLStorage |
| __Version__ | 7.8.3 |
| __Reloadable__ | false |
| __Configcascade Aware__ | false |
| __Tags__ | <a href="https://documentation.open-xchange.com/latest/middleware/configuration/tags/Admin.html">Admin</a> |
...
---
| __Key__ | CONCURRENT_JOBS |
|:----------------|:--------|
| __Description__ | How many jobs should be executed concurrently.<br> |
| __Default__ | 2 |
| __Version__ | 7.8.3 |
| __Reloadable__ | false |
| __Configcascade Aware__ | false |
...
---
| __Key__ | MASTER_ACCOUNT_OVERRIDE |
|:----------------|:--------|
| __Description__ | Set this to true if you want to be able to do all operations on any context using the<br>login and password of the oxadminmaster account<br> |
| __Default__ | false |
| __Version__ | 7.8.3 |
| __Reloadable__ | false |
| __Configcascade Aware__ | false |
...
---
| __Key__ | UID_NUMBER_START |
|:----------------|:--------|
| __Description__ | Set to > 0 to use the uidnumber feature.<br> |
| __Default__ | -1 |
| __Version__ | 7.8.3 |
| __Reloadable__ | false |
| __Configcascade Aware__ | false |
