...
import com.openexchange.soap.cxf.staxutils.Utility;
...
public class XMLFaultOutInterceptor extends AbstractOutDatabindingInterceptor {
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        message.put(org.apache.cxf.message.Message.RESPONSE_CODE, Integer.valueOf(f.getStatusCode()));
        ...
        try {
            ...
            writer.writeCharacters(Utility.sanitizeXmlContent(t == null ? xmlFault.getMessage() : t.toString()));
            // fault string
