...
public class MailNotifyPushUdpSocketListener implements Runnable {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(MailNotifyPushUdpSocketListener.class)));
