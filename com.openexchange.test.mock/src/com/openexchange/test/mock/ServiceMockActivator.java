...
public class ServiceMockActivator {
    ...
    public static ConcurrentMap<Class<?>, ServiceProvider<?>> activateServiceMocks(Object activator, Class... clazz) {
        ...
        try {
            ...
            MockUtils.injectValueIntoPrivateField(activator, "context", context);
        ...
        MockUtils.injectValueIntoPrivateField(activator, "services", services);

        return services;
    }

    /**
     * Returns the service which was created with com.openexchange.test.mock.ServiceMockActivator.activateServicesForBundleActivator(Object,
     * Class...)
     * 
