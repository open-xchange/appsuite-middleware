 ...
 * com.openexchange.test.mock.MockFactory.getMock(Class<T>)
 * 
...
public class MockFactory {
    ...
    private static String getFullyQualifiedMockName(Class type) {
        ...
        if (mockName.startsWith("com.openexchange.")) {
            ...
            int lastDotOccurrence = mockName.lastIndexOf('.');
            mockName = mockName.substring(0, lastDotOccurrence) + ".test.mock.objects." + mockName.subSequence(
                lastDotOccurrence + 1,
                mockName.length()) + "Mock";
