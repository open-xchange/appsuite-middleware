...
package com.openexchange.test.mock.objects.session;
...
/**
 * Mock for {@link Session}
 * 
 * @author <a href="mailto:martin.schneider@open-xchange.com">Martin Schneider</a>
 * @since 7.4
 */
public class SessionMock<T extends Session> extends AbstractMock {

    /**
     * The mocked {@link Session}
     */
    private T session;

    /**
     * Initializes a new {@link SessionMock}.
     */
    public SessionMock() {
        super();
    }
    ...
    protected void createMocks() {
        this.session = (T) PowerMockito.mock(Session.class);
    }
