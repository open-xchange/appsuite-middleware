        ...
        public Void call() {
            try {
                ...
                if (otherMembersInCluster.isEmpty()) {
                    ...
                    LOG.info("{} now runs permanent listeners for {} users", localMember, startedOnes.size());
                    return null;
                }
                ...
                if (false == remotePlan) { // <-- Called from remote node to perform a new reschedule; see PortablePlanRescheduleCallable
                    ...
                    LOG.info("{} now runs permanent listeners for {} users", localMember, numberOfStartedOnes);
