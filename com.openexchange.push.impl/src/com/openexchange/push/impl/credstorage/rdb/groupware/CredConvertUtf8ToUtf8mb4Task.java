 ...
 * @since v7.10.0
 */
public class CredConvertUtf8ToUtf8mb4Task extends SimpleConvertUtf8ToUtf8mb4UpdateTask {

    /**
     * Initializes a new {@link CredConvertUtf8ToUtf8mb4Task}.
     */
    public CredConvertUtf8ToUtf8mb4Task() {
        super(ImmutableList.of("credentials"), CredStorageCreateTableTask.class.getName());
    }
}
