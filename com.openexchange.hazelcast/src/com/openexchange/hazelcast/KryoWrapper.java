...
public final class KryoWrapper implements Serializable {
     ...
     * @param classLoader The class loader to use to resolve/load associated class
     */
    public KryoWrapper(final Object target, final ClassLoader classLoader) {
        super();
        this.classLoader = classLoader;
        bytes = KryoSerializer.write(target, classLoader);
    }
    ...
    private Object readResolve() throws ObjectStreamException {
        return KryoSerializer.read(bytes, classLoader);
    }
