...
public class Database {
    ...
    public Database(final com.openexchange.admin.rmi.dataobjects.Database db) {
        super();
        if( null != db ) {
            this.id = db.getId();
            this.read_id = db.getRead_id();
            this.clusterWeight = db.getClusterWeight();
            this.url = db.getUrl();
            this.login = db.getLogin();
            this.password = db.getPassword();
            this.name = db.getName();
            this.driver = db.getDriver();
            this.scheme = db.getScheme();
            this.maxUnits = db.getMaxUnits();
            this.poolHardLimit = db.getPoolHardLimit();
            this.poolInitial = db.getPoolInitial();
            this.poolMax = db.getPoolMax();
            this.masterId = db.getMasterId();
            this.master = db.getMaster();
            this.currentUnits = db.getCurrentUnits();
        } else {
            init();
        }
    }
