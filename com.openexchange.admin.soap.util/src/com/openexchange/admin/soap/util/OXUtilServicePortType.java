...
public interface OXUtilServicePortType {
    ...
    @RequestWrapper(localName = "registerServer", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.RegisterServer")
    @WebMethod(action = "urn:registerServer")
    @ResponseWrapper(localName = "registerServerResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.RegisterServerResponse")
    public com.openexchange.admin.soap.dataobjects.xsd.Server registerServer(
        @WebParam(name = "srv", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.soap.dataobjects.xsd.Server srv,
    ...
    @RequestWrapper(localName = "listAllDatabase", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllDatabase")
    @WebMethod(action = "urn:listAllDatabase")
    @ResponseWrapper(localName = "listAllDatabaseResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllDatabaseResponse")
    public java.util.List<com.openexchange.admin.soap.dataobjects.xsd.Database> listAllDatabase(
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, RemoteException_Exception;
    ...
    @RequestWrapper(localName = "listAllServer", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllServer")
    @WebMethod(action = "urn:listAllServer")
    @ResponseWrapper(localName = "listAllServerResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllServerResponse")
    public java.util.List<com.openexchange.admin.soap.dataobjects.xsd.Server> listAllServer(
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, RemoteException_Exception;
    ...
    @RequestWrapper(localName = "listMaintenanceReason", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListMaintenanceReason")
    @WebMethod(action = "urn:listMaintenanceReason")
    @ResponseWrapper(localName = "listMaintenanceReasonResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListMaintenanceReasonResponse")
    public java.util.List<com.openexchange.admin.rmi.dataobjects.xsd.MaintenanceReason> listMaintenanceReason(
    ...
    @RequestWrapper(localName = "listServer", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListServer")
    @WebMethod(action = "urn:listServer")
    @ResponseWrapper(localName = "listServerResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListServerResponse")
    public java.util.List<com.openexchange.admin.soap.dataobjects.xsd.Server> listServer(
        @WebParam(name = "search_pattern", targetNamespace = "http://soap.admin.openexchange.com")
        java.lang.String searchPattern,
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ...
    @RequestWrapper(localName = "listDatabase", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListDatabase")
    @WebMethod(action = "urn:listDatabase")
    @ResponseWrapper(localName = "listDatabaseResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListDatabaseResponse")
    public java.util.List<com.openexchange.admin.soap.dataobjects.xsd.Database> listDatabase(
        @WebParam(name = "search_pattern", targetNamespace = "http://soap.admin.openexchange.com")
        java.lang.String searchPattern,
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ...
    @RequestWrapper(localName = "createMaintenanceReason", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.CreateMaintenanceReason")
    @WebMethod(action = "urn:createMaintenanceReason")
    @ResponseWrapper(localName = "createMaintenanceReasonResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.CreateMaintenanceReasonResponse")
    public com.openexchange.admin.rmi.dataobjects.xsd.MaintenanceReason createMaintenanceReason(
        @WebParam(name = "reason", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.MaintenanceReason reason,
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, RemoteException_Exception;
    ...
    @RequestWrapper(localName = "registerDatabase", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.RegisterDatabase")
    @WebMethod(action = "urn:registerDatabase")
    @ResponseWrapper(localName = "registerDatabaseResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.RegisterDatabaseResponse")
    public com.openexchange.admin.soap.dataobjects.xsd.Database registerDatabase(
    ...
    @RequestWrapper(localName = "listAllMaintenanceReason", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllMaintenanceReason")
    @WebMethod(action = "urn:listAllMaintenanceReason")
    @ResponseWrapper(localName = "listAllMaintenanceReasonResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllMaintenanceReasonResponse")
    public java.util.List<com.openexchange.admin.rmi.dataobjects.xsd.MaintenanceReason> listAllMaintenanceReason(
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, RemoteException_Exception;
    ...
    @RequestWrapper(localName = "registerFilestore", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.RegisterFilestore")
    @WebMethod(action = "urn:registerFilestore")
    @ResponseWrapper(localName = "registerFilestoreResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.RegisterFilestoreResponse")
    public com.openexchange.admin.soap.dataobjects.xsd.Filestore registerFilestore(
        @WebParam(name = "fstore", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.soap.dataobjects.xsd.Filestore fstore,
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, RemoteException_Exception;
    ...
    @RequestWrapper(localName = "listFilestore", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListFilestore")
    @WebMethod(action = "urn:listFilestore")
    @ResponseWrapper(localName = "listFilestoreResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListFilestoreResponse")
    public java.util.List<com.openexchange.admin.soap.dataobjects.xsd.Filestore> listFilestore(
        @WebParam(name = "search_pattern", targetNamespace = "http://soap.admin.openexchange.com")
        java.lang.String searchPattern,
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ...
    @RequestWrapper(localName = "listAllFilestore", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllFilestore")
    @WebMethod(action = "urn:listAllFilestore")
    @ResponseWrapper(localName = "listAllFilestoreResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.util.ListAllFilestoreResponse")
    public java.util.List<com.openexchange.admin.soap.dataobjects.xsd.Filestore> listAllFilestore(
        @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com")
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials auth
    ) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, RemoteException_Exception;
