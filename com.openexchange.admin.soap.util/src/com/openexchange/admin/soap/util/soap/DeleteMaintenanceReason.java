 ...
 *       &lt;sequence>
 *         &lt;element name="reasons" type="{http://dataobjects.rmi.admin.openexchange.com/xsd}MaintenanceReason" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "deleteMaintenanceReason")
public class DeleteMaintenanceReason {

    @XmlElement(nillable = true)
    protected List<MaintenanceReason> reasons;
    @XmlElement(nillable = true)
    ...
    public List<MaintenanceReason> getReasons() {
        if (reasons == null) {
            reasons = new ArrayList<MaintenanceReason>();
        }
        return this.reasons;
    }
