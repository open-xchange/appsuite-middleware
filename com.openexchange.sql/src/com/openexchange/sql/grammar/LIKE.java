...
public class LIKE extends TernaryPredicate {

	public LIKE(Expression left, Expression middle, Expression right) {
		super(left, middle, right);
	}

	public LIKE(String column, Expression middle, Expression right) {
		super(column, middle, right);
	}

	public LIKE(String column, String value, String escape) {
