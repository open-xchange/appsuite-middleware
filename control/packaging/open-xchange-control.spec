...
BuildRequires:  ant open-xchange-common >= @OXVERSION@ open-xchange-global >= @OXVERSION@ open-xchange-management >= @OXVERSION@ open-xchange-server >= @OXVERSION@
...
Requires:       open-xchange-common >= @OXVERSION@ open-xchange-global >= @OXVERSION@ open-xchange-management >= @OXVERSION@ open-xchange-server >= @OXVERSION@
#
