...
/**
 * {@link MailCategoriesJSONExceptionCodes}
 *
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 * @since v7.8.2
 */
public enum MailCategoriesJSONExceptionCodes implements DisplayableOXExceptionCode {
     ...
     * @param number number.
     */
    private MailCategoriesJSONExceptionCodes(final String message, final Category category, final int number) {
     ...
     */
    private MailCategoriesJSONExceptionCodes(final String message, final Category category, final int number, final String displayMessage) {
