...
public class Mapper {
    ...
    public static ContactObject getContact(final LdapGetter getter) {
        final PropertyHandler instance = PropertyHandler.getInstance();
        final ContactObject retval = new ContactObject();
        retval.setObjectID(getter.getAttribute(instance.getUniqueid()).hashCode());
        retval.setSurName(getter.getAttribute(instance.getSurname()));
        retval.setDisplayName(getter.getAttribute(instance.getDisplayname()));
        retval.setGivenName(getter.getAttribute(instance.getGivenname()));
        return retval;
    }
}
