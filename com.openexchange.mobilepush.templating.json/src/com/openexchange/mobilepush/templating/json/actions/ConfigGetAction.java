...
import com.openexchange.mobilepush.templating.json.convert.NotifyTemplateWriter;
...
public class ConfigGetAction extends AbstractMobilePushAction {
    ...
    protected AJAXRequestResult perform(MobilePushRequest req) throws OXException, JSONException {
        ...
        if (providers == null) {
            // Get all Services
            List<MobilePushService> notifierServices = mobileNotifierRegistry.getAllServices(uid, cid);
            for (MobilePushService notifierService : notifierServices) {
