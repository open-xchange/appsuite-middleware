...
import com.openexchange.mobilepush.templating.json.convert.NotifyTemplateParser;
import com.openexchange.mobilepush.templating.json.convert.ParsedNotifyTemplate;
...
public class ConfigPutAction extends AbstractMobilePushAction {
    /**
    ...
    protected AJAXRequestResult perform(MobilePushRequest req) throws OXException, JSONException {
        ...
        for (ParsedNotifyTemplate parsedTemplate : parsedTemplates) {
            MobilePushService notifierService = mobileNotifierRegistry.getService(parsedTemplate.getFrontendName(), uid, cid);
