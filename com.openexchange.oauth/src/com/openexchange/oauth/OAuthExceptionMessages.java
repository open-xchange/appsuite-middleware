...
/**
 * {@link OAuthExceptionMessages} - Exception messages for {@link OAuthException} that needs to be translated.
 * 
...
public final class OAuthExceptionMessages implements LocalizableStrings {
    ...
    public static final String TOKEN_EXPIRED_MSG = "OAuth Token has expired. Please authorize the '%1$s' account in configuration->my social ox->accounts and try again.";
