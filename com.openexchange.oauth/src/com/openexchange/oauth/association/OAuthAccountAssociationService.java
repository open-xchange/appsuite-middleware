 ...
 */
@SingletonService
public interface OAuthAccountAssociationService {

    /**
     * Gets all known associations that are linked with specified OAuth account.
     *
     ...
     */
    Collection<OAuthAccountAssociation> getAssociationsFor(int accountId, Session session) throws OXException;
