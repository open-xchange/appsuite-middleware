...
package com.openexchange.mobilepush.templating.reminder;
...
import com.openexchange.mobilepush.templating.utility.DateUtility;
...
/**
 * {@link MobilePushReminderImpl}
 *
 * @author <a href="mailto:lars.hoogestraat@open-xchange.com">Lars Hoogestraat</a>
 */
public class MobilePushReminderImpl extends AbstractMobilePushService {

    private final ServiceLookup services;

    public MobilePushReminderImpl(ServiceLookup services) {
        this.services = services;
    }

    @Override
    public String getProviderName() {
        return MobilePushProviders.REMINDER.getProviderName();
    }

    @Override
    public String getFrontendName() {
        return MobilePushProviders.REMINDER.getFrontendName();
    }
        ...
        while (reminderObjects.hasNext()) {
            ...
            if (module == Types.APPOINTMENT) {
                ...
                try {
                    ...
                    throw MobilePushExceptionCodes.SQL_ERROR.create(e.getMessage(), e);
                }
            }
        }
        return items;
    ...
    public NotifyTemplate getTemplate() throws OXException {
        final String template = MobileNotifierFileUtility.getTemplateFileContent(MobilePushProviders.REMINDER.getTemplateFileName());
        final String title = MobilePushProviders.REMINDER.getTitle();
        return new NotifyTemplate(title, template, false, MobilePushProviders.REMINDER.getIndex());
    }

    @Override
    public void putTemplate(String changedTemplate) throws OXException {
        MobileNotifierFileUtility.writeTemplateFileContent(MobilePushProviders.REMINDER.getTemplateFileName(), changedTemplate);
    }
}
