...
package com.openexchange.user.copy.internal.subscription.osgi;
...
/**
 * {@link SubscriptionTaskRegisterer}
 *
 * @author <a href="mailto:steffen.templin@open-xchange.com">Steffen Templin</a>
 */
public class SubscriptionTaskRegisterer implements ServiceTrackerCustomizer<IDGeneratorService, IDGeneratorService> {
    ...
    public SubscriptionTaskRegisterer(final BundleContext context) {
        super();
    ...
    public IDGeneratorService addingService(final ServiceReference<IDGeneratorService> reference) {
        ...
        final SubscriptionCopyTask task = new SubscriptionCopyTask(service);
