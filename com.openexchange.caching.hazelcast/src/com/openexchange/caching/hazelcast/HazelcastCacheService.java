...
public final class HazelcastCacheService implements CacheService {
    ...
    /* (non-Javadoc)
     * @see com.openexchange.caching.CacheService#freeCache(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.openexchange.caching.CacheService#loadConfiguration(java.io.InputStream)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.openexchange.caching.CacheService#loadDefaultConfiguration()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.openexchange.caching.CacheService#newCacheKey(int, java.io.Serializable)
     */
    @Override
