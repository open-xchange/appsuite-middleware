...
public class OXNoSQLSessionStorageExceptionMessages implements LocalizableStrings {
    ...
    public final static String NOSQL_SESSIONSTORAGE_ALTID_NOT_FOUND_MSG = "Lookup for session with altId %1$s failed";

    public final static String NOSQL_SESSIONSTORAGE_NO_USERSESSIONS_MSG = "No sessions found for user %1$s in context %2$s";

    public final static String NOSQL_SESSIONSTORAGE_NO_CONTEXTSESSIONS_MSG = "No sessions found for context %1$s";
