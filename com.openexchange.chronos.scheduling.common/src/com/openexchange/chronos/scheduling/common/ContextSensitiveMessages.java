...
public class ContextSensitiveMessages {
    ...
    private static final ContextSensitiveMessages INSTANCE = new ContextSensitiveMessages();
    private I18nServiceRegistry i18nServiceRegistry;

    private ContextSensitiveMessages() {}

    public void initialize(ServiceLookup serviceLookup) throws OXException {
        this.i18nServiceRegistry = serviceLookup.getServiceSafe(I18nServiceRegistry.class);
    }

    public static ContextSensitiveMessages getInstance() {
        return INSTANCE;
    }
    ...
    public String getDescription(ParticipationStatus status, Locale locale, Context ctxt) {
    ...
    public String accepted(Locale locale, Context ctxt) {
    ...
    public String declined(Locale locale, Context ctxt) {
        I18nService i18nService = i18nServiceRegistry.getI18nService(locale);
        if (i18nService == null) {
            LOG.debug("No service for {}  found. Using default for bundle ", locale);
            return "declined";
    ...
    public String tentative(Locale locale, Context ctxt) {
        I18nService i18nService = i18nServiceRegistry.getI18nService(locale);
        if (i18nService == null) {
            LOG.debug("No service for {}  found. Using default for bundle ", locale);
