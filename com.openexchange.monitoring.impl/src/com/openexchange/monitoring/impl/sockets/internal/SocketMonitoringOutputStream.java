...
/**
 * {@link SocketMonitoringOutputStream}
 *
...
public class SocketMonitoringOutputStream extends OutputStream {
    ...
    /**
     * Initializes a new {@link SocketMonitoringOutputStream}.
     *
     * @param socket The associated socket
     * @param out The socket output stream to delegate to
     */
    public SocketMonitoringOutputStream(Socket socket, OutputStream out) {
        this.out = out;
        this.socket = socket;
    }
