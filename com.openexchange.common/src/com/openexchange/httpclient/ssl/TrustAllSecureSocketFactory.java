...
package com.openexchange.httpclient.ssl;
...
public class TrustAllSecureSocketFactory implements SecureProtocolSocketFactory {
    ...
    /**
     * Initializes a new {@link TrustAllSecureSocketFactory}.
     */
    public TrustAllSecureSocketFactory() {
        super();
        delegate = TrustAllSSLSocketFactory.getDefault();
    }
