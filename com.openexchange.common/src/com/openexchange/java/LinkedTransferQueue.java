...
public class LinkedTransferQueue<E> extends AbstractQueue<E>
    ...
    static final class Node {
        ...
        Node(final Object item, final boolean isData) {
            itemUpdater.set(this, item); // relaxed write
            this.isData = isData;
        }
        ...
        final void forgetContents() {
            itemUpdater.set(this, this);
            waiterUpdater.set(this, null);
        }
    ...
    private boolean casSweepVotes(final int cmp, final int val) {
        return sweepVotesUpdater.compareAndSet(this, Integer.valueOf(cmp), Integer.valueOf(val));
    }
    ...
    private E xfer(final E e, final boolean haveData, final int how, final long nanos) {
        ...
        for (;;) {                            // restart on append race
            ...
            for (Node h = head, p = h; p != null;) { // find & match first node
                ...
                if (item != p && (item != null) == isData) { // unmatched
                    ...
                    if (p.casItem(item, e)) { // match
                        for (Node q = p; q != h;) {
                            final Node n = q.next;  // update by 2 unless singleton
            ...
            if (how != NOW) {                 // No matches available
                ...
                final Node pred = tryAppend(s, haveData);
                if (pred == null)
                 {
    ...
    public E take() throws InterruptedException {
        final E e = xfer(null, false, SYNC, 0);
        if (e != null) {
            return e;
        }
        Thread.interrupted();
    ...
    public E poll(final long timeout, final TimeUnit unit) throws InterruptedException {
        final E e = xfer(null, false, TIMED, unit.toNanos(timeout));
    ...
    private static final AtomicReferenceFieldUpdater<LinkedTransferQueue, Integer> sweepVotesUpdater = AtomicReferenceFieldUpdater.newUpdater(LinkedTransferQueue.class, int.class, "sweepVotes");
