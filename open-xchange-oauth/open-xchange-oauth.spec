...
if [ ${1:-0} -eq 2 ]; then
    ...
    PROTECT="facebookoauth.properties googleoauth.properties msliveconnectoauth.properties twitteroauth.properties xingoauth.properties yahoooauth.properties settings/flickroauth.properties settings/tumblroauth.properties"
...
%changelog
* Tue Jun 01 2021 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2021-06-18 (6001)
* Thu Mar 18 2021 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2021-03-26 (5974)
* Tue Jan 12 2021 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2021-01-15 (5932)
* Mon Nov 23 2020 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2020-11-23 (5916)
* Thu Sep 17 2020 Steffen Templin <marcus.klein@open-xchange.com>
...
* Thu Apr 02 2020 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2020-04-07 (5685)
* Tue Mar 03 2020 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2020-03-06 (5637)
* Wed Jan 08 2020 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2020-01-13 (5537)
* Tue Jul 09 2019 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2019-07-12 (5315)
* Tue Jun 18 2019 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2019-07-01 (5288)
* Fri May 03 2019 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2019-05-13 (5231)
* Wed Mar 13 2019 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2019-03-12 (5165)
* Fri Feb 01 2019 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2019-02-11 (5104)
* Mon Nov 12 2018 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2018-11-19 (4895)
* Wed Aug 29 2018 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2018-08-30 (4876)
* Tue Aug 14 2018 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2018-08-20 (4860)
* Thu Aug 02 2018 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2018-08-08 (4856)
* Thu Jun 21 2018 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2018-06-25 (4789)
* Fri May 11 2018 Steffen Templin <marcus.klein@open-xchange.com>
...
* Tue Jan 30 2018 Steffen Templin <marcus.klein@open-xchange.com>
...
* Fri Oct 13 2017 Steffen Templin <marcus.klein@open-xchange.com>
Build for Patch 2017-10-16 (4391)
* Mon Aug 14 2017 Steffen Templin <marcus.klein@open-xchange.com>
2017-08-21 (4315)
* Wed Aug 02 2017 Steffen Templin <marcus.klein@open-xchange.com>
...
* Mon May 08 2017 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2017-05-15 (4133)
* Tue Apr 18 2017 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2017-04-21 (4079)
* Fri Mar 31 2017 Steffen Templin <marcus.klein@open-xchange.com>
...
* Wed Feb 08 2017 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2017-02-20 (3949)
* Thu Jan 26 2017 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2017-01-26 (3922)
* Thu Jan 19 2017 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2017-01-23 (3875)
* Tue Jan 03 2017 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2017-01-06 (3833)
* Fri Nov 11 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-11-21 (3728)
* Fri Nov 04 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-11-10 (3712)
* Thu Oct 13 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-10-24 (3627)
* Tue Sep 20 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-09-26 (3569)
* Thu Sep 01 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-09-07 (3527)
* Fri Aug 19 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-08-29 (3519)
* Thu Jul 21 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-08-01 (3464)
* Thu Jun 30 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-07-04 (3358)
* Wed Jun 01 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-06-06 (3315)
* Tue May 03 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-05-09 (3270)
* Tue Apr 19 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-04-25 (3237)
* Mon Mar 21 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-03-29 (3187)
* Tue Mar 08 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-03-14 (3147)
* Mon Feb 22 2016 Steffen Templin <marcus.klein@open-xchange.com>
...
* Tue Jan 19 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-01-25 (3030)
* Fri Jan 15 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-01-14 (3023)
* Thu Jan 07 2016 Steffen Templin <marcus.klein@open-xchange.com>
Build for patch 2016-01-13 (2972)
* Tue Dec 01 2015 Steffen Templin <marcus.klein@open-xchange.com>
Second candidate for 7.6.3 release
* Mon Oct 26 2015 Steffen Templin <marcus.klein@open-xchange.com>
...
* Wed Mar 25 2015 Steffen Templin <marcus.klein@open-xchange.com>
prepare for 7.6.3
