 ...
 * @since v7.6.0
 */
public class StockFolderNamingFactory {
    ...
    public static Facet getStockFolderNamingFacet() {
        ...
        final Facet stockFolderNamingFacet = new Facet(StockFolderNamingFacetType.FOLDER_TYPE, folderTypeValues);
        return stockFolderNamingFacet;
    }
}
