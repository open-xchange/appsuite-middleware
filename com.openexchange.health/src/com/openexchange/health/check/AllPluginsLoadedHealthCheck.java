...
/**
 * {@link AllPluginsLoadedHealthCheck}
 *
 * @author <a href="mailto:jan.bauerdick@open-xchange.com">Jan Bauerdick</a>
 * @since v7.10.1
 */
public class AllPluginsLoadedHealthCheck extends DefaultHealthCheck {

    private static final String NAME = "allPluginsLoaded";

    private final ServiceLookup services;

    public AllPluginsLoadedHealthCheck(ServiceLookup services) {
        super(NAME);
    ...
    public DefaultHealthCheckResponse execute() {
        ...
        try {
            builder.name(name).state(service.allPluginsloaded());
        } catch (OXException e) {
