...
/**
 * {@link GroupAJAXRequest}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class GroupAJAXRequest {
    ...
    /**
     * Initializes a new {@link GroupAJAXRequest}.
     *
     * @param session The session
     * @param request The request
     */
    public GroupAJAXRequest(final AJAXRequestData request, final ServerSession session) {
        super();
