...
public final class FreeBusyConverters {
    ...
    public static final List<AttributeConverter<VFreeBusy, FreeBusyInformation>> REQUEST;
    public static final List<AttributeConverter<VFreeBusy, FreeBusyInformation>> REPLY;

    private static AttributeConverter<VFreeBusy, FreeBusyInformation> uid = new Uid<VFreeBusy, FreeBusyInformation>();
    ...
    private static List<AttributeConverter<VFreeBusy, FreeBusyInformation>> getRequest() {
    ...
    private static List<AttributeConverter<VFreeBusy, FreeBusyInformation>> getReply() {
        List<AttributeConverter<VFreeBusy, FreeBusyInformation>> tmp = new ArrayList<AttributeConverter<VFreeBusy, FreeBusyInformation>>();
        tmp.add(start);
        tmp.add(end);
        tmp.add(xMicrosoftCdoAlldayEvent);
        ...
        tmp.add(createdBy);
        tmp.add(createdAndDTStamp);
        tmp.add(freeBusyAttendee);
        tmp.add(freeBusySlots);
        return tmp;
    }
