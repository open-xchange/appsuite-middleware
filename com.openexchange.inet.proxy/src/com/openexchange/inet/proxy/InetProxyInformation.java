 ...
 */
public interface InetProxyInformation {

    /**
     * Whether to establish a secure connection.
     * 
     * @return <code>true</code> to establish a secure connection; otherwise <code>false</code>
     */
    boolean isSecure();
