...
public final class TwitterOAuthActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(TwitterOAuthActivator.class))).error(e.getMessage(), e);
            throw e;
        }
    }
