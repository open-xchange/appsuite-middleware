...
public class PushTransport {
    ...
    /**
     * Initializes a new {@link PushTransport}.
     *
     ...
     */
    public PushTransport(String transportUri, int refreshInterval, String transportData) {
        super();
    ...
    public String toString() {
        return "PushTransport [refreshInterval=" + refreshInterval + ", transportUri=" + transportUri + ", transportData=" + transportData + "]";
    }
