...
public class ConfigurableHostnameServiceActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        final ConfigViewFactory configViews = getService(ConfigViewFactory.class);

        final ConfigurableHostnameService hostnameService = new ConfigurableHostnameService(configViews);
