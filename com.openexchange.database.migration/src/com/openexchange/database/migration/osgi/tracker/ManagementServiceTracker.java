...
public class ManagementServiceTracker implements ServiceTrackerCustomizer<ManagementService, ManagementService> {
     ...
     */
    public ManagementServiceTracker(final BundleContext context, DatabaseService databaseService) {
        super();
    ...
    private void registerMBean(final ManagementService management) {
        if (objectName == null) {
            try {
                ...
                management.registerMBean(objectName, new DBMigrationMBeanImpl(DBMigrationMBean.class, databaseService));
