...
Summary:        The Open-Xchange folder JSON interface bundle
...
%description
The Open-Xchange folder JSON interface bundle
...
%config(noreplace) /opt/open-xchange/etc/groupware/folderjson.properties