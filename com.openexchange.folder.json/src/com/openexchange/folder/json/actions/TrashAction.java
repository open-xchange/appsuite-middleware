...
/**
 * {@link TrashAction} - Maps the action to a TRASH action.
 *
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 * @since v7.8.4
 */
@OAuthAction(OAuthAction.CUSTOM)
public final class TrashAction extends AbstractFolderAction {
    ...
    protected AJAXRequestResult doPerform(final AJAXRequestData request, final ServerSession session) throws OXException, JSONException {
        ...
        if (failOnError) {
            final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TrashAction.class);
    ...
    private static String getFolderNameSafe(FolderService folderService, String folderId, String treeId, ServerSession session) {
        try {
            ...
            org.slf4j.LoggerFactory.getLogger(TrashAction.class).debug("Error getting folder name for {}", folderId, e);
        }
        return folderId;
    }
