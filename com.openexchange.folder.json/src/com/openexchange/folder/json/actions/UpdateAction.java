...
public final class UpdateAction extends AbstractFolderAction {
    ...
    public AJAXRequestResult perform(final AJAXRequestData request, final ServerSession session) throws OXException {
        ...
        folderService.updateFolder(folder, timestamp, session, new FolderServiceDecorator().put("permissions", request.getParameter("permissions")).put("altNames", request.getParameter("altNames")));
        /*
