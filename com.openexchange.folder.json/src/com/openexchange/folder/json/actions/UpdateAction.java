...
/**
 * {@link UpdateAction} - Maps the action to a UPDATE action.
 * 
...
public final class UpdateAction extends AbstractFolderAction {
    ...
    public AJAXRequestResult perform(final AJAXRequestData request, final ServerSession session) throws AbstractOXException {
         ...
         */
        return new AJAXRequestResult(folder.getID(), folderService.getFolder(treeId, id, session, null).getLastModifiedUTC());
    }
