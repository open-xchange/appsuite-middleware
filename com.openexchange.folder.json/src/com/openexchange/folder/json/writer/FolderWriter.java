...
public final class FolderWriter {
	 ...
	 * The logger constant.
	 */
	static final org.apache.commons.logging.Log LOG = com.openexchange.log.Log
	 ...
	 *         Betten</a>
	 */
	private static final class AdditionalFolderFieldWriter implements
			FolderFieldWriter {
		...
		protected AdditionalFolderFieldWriter(
				final ServerSession serverSession,
				final AdditionalFolderField additionalFolderField) {
			this.serverSession = serverSession;
			this.additionalFolderField = additionalFolderField;
		}

		@Override
		public void writeField(final JSONValuePutter jsonPutter,
				final UserizedFolder folder) throws JSONException {
			...
			jsonPutter.put(additionalFolderField.getColumnName(),
					additionalFolderField.getValue(fo, serverSession));
		}
	}
	...
	private static interface FolderFieldWriter {
		...
		void writeField(JSONValuePutter jsonValue, UserizedFolder folder)
				throws JSONException;
	}
	...
	private static final FolderFieldWriter UNKNOWN_FIELD_FFW = new FolderFieldWriter() {
		...
		@Override
		public void writeField(final JSONValuePutter jsonValue,
				final UserizedFolder folder) throws JSONException {
	...
	static {
		final TIntObjectMap<FolderFieldWriter> m = new TIntObjectHashMap<FolderFieldWriter>(
				32);
		...
		m.put(FolderField.CREATED_BY.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(
						FolderField.CREATED_BY.getName(),
						-1 == createdBy ? JSONObject.NULL : Integer
								.valueOf(createdBy));
			}
		});
		m.put(FolderField.MODIFIED_BY.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(
						FolderField.MODIFIED_BY.getName(),
						-1 == modifiedBy ? JSONObject.NULL : Integer
								.valueOf(modifiedBy));
			}
		});
		m.put(FolderField.CREATION_DATE.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.CREATION_DATE.getName(),
						null == d ? JSONObject.NULL : Long.valueOf(d.getTime()));
			}
		});
		m.put(FolderField.LAST_MODIFIED.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.LAST_MODIFIED.getName(),
						null == d ? JSONObject.NULL : Long.valueOf(d.getTime()));
			}
		});
		m.put(FolderField.LAST_MODIFIED_UTC.getColumn(),
				new FolderFieldWriter() {
					...
					public void writeField(final JSONValuePutter jsonPutter,
						...
						jsonPutter.put(
								FolderField.LAST_MODIFIED_UTC.getName(),
								null == d ? JSONObject.NULL : Long.valueOf(d
										.getTime()));
					}
				});
		...
		m.put(FolderField.MODULE.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.MODULE.getName(),
						null == obj ? JSONObject.NULL : obj.toString());
			}
		});
		m.put(FolderField.TYPE.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(
						FolderField.TYPE.getName(),
						null == obj ? JSONObject.NULL : Integer.valueOf(obj
								.getType()));
			}
		});
		m.put(FolderField.SUBFOLDERS.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				if (null == obj) {
					LOG.warn("Got null as subfolders for folder "
							+ folder.getID()
							+ ". Marking this folder to hold subfolders...");
					jsonPutter.put(FolderField.SUBFOLDERS.getName(),
							Boolean.TRUE);
				} else {
					jsonPutter.put(FolderField.SUBFOLDERS.getName(),
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				if (bits < 0) {
					...
					jsonPutter.put(
							...
							null == obj ? JSONObject.NULL : Integer
									.valueOf(createPermissionBits(
					...
					jsonPutter.put(FolderField.OWN_RIGHTS.getName(),
							Integer.valueOf(bits));
				}
			}
		});
		m.put(FolderField.PERMISSIONS_BITS.getColumn(),
				new FolderFieldWriter() {
						...
						final JSONArray ja;
						{
							...
							if (null == obj) {
								...
								for (final Permission permission : obj) {
									...
									jo.put(FolderField.BITS.getName(),
											createPermissionBits(permission));
									jo.put(FolderField.ENTITY.getName(),
											permission.getEntity());
									jo.put(FolderField.GROUP.getName(),
											permission.isGroup());
									ja.put(jo);
								}
							}
						}
						jsonPutter.put(FolderField.PERMISSIONS_BITS.getName(),
								null == ja ? JSONObject.NULL : ja);
					}
				});
		m.put(FolderField.SUMMARY.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.SUMMARY.getName(),
						null == obj ? JSONObject.NULL : obj);
			}
		});
		m.put(FolderField.STANDARD_FOLDER.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
					final UserizedFolder folder) throws JSONException {
				jsonPutter.put(FolderField.STANDARD_FOLDER.getName(),
						Boolean.valueOf(folder.isDefault()));
			}
		});
		m.put(FolderField.STANDARD_FOLDER_TYPE.getColumn(),
				new FolderFieldWriter() {
					...
					public void writeField(final JSONValuePutter jsonPutter,
							final UserizedFolder folder) throws JSONException {
						jsonPutter.put(
								FolderField.STANDARD_FOLDER_TYPE.getName(),
								Integer.valueOf(folder.getDefaultType()));
					}
				});
		m.put(FolderField.TOTAL.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.TOTAL.getName(),
						-1 == obj ? JSONObject.NULL : Integer.valueOf(obj));
			}
		});
		m.put(FolderField.NEW.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.NEW.getName(),
						-1 == obj ? JSONObject.NULL : Integer.valueOf(obj));
			}
		});
		m.put(FolderField.UNREAD.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.UNREAD.getName(),
						-1 == obj ? JSONObject.NULL : Integer.valueOf(obj));
			}
		});
		m.put(FolderField.DELETED.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.DELETED.getName(),
						-1 == obj ? JSONObject.NULL : Integer.valueOf(obj));
			}
		});
		m.put(FolderField.SUBSCRIBED.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
					final UserizedFolder folder) throws JSONException {
				jsonPutter.put(FolderField.SUBSCRIBED.getName(),
						Boolean.valueOf(folder.isSubscribed()));
			}
		});
		m.put(FolderField.SUBSCR_SUBFLDS.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				 ...
				 */
				jsonPutter.put(FolderField.SUBSCR_SUBFLDS.getName(),
						Boolean.valueOf(folder.hasSubscribedSubfolders()));
			}
		});
		m.put(FolderField.CAPABILITIES.getColumn(), new FolderFieldWriter() {
			...
			public void writeField(final JSONValuePutter jsonPutter,
				...
				jsonPutter.put(FolderField.CAPABILITIES.getName(),
						-1 == caps ? JSONObject.NULL : Integer.valueOf(caps));
			}
		});
	 ...
	 * 
	 * @param fields
	 *            The fields to write or <code>null</code> to write all
	 * @param folder
	 *            The folder
	 * @return The JSON array carrying requested fields of given folder
	 * @throws OXException
	 *             If writing JSON array fails
	 */
	public static JSONArray writeSingle2Array(final int[] fields,
			final UserizedFolder folder) throws OXException {
		...
		try {
			...
			throw FolderExceptionErrorMessage.JSON_ERROR.create(e,
					e.getMessage());
		}
	}

	/**
	 * Writes requested fields of given folders into a JSON array consisting of
	 * JSON arrays.
	 * 
	 * @param fields
	 *            The fields to write to each JSON array or <code>null</code> to
	 *            write all
	 * @param folders
	 *            The folders
	 ...
	 *             If writing JSON array fails
	 */
	public static JSONArray writeMultiple2Array(final int[] fields,
			final UserizedFolder[] folders, final ServerSession serverSession,
			final AdditionalFolderFieldList additionalFolderFieldList)
			throws OXException {
		final int[] cols = null == fields ? ALL_FIELDS : fields;
		final FolderFieldWriter[] ffws = new FolderFieldWriter[cols.length];
		for (int i = 0; i < ffws.length; i++) {
			...
			if (null == ffw) {
				if (additionalFolderFieldList.knows(curCol)) {
					final AdditionalFolderField additionalFolderField = new BulkFolderField(
							additionalFolderFieldList.get(curCol));
					additionalFolderField.getValues(
					...
					ffw = new FolderFieldWriter() {
                        ...
                        public void writeField(
								...
								throws JSONException {
							final FolderObject fo = new FolderObject();
							final int numFolderId = getUnsignedInteger(folder
									.getID());
							if (numFolderId < 0) {
								fo.setFullName(folder.getID());
							} else {
							...
							fo.setType(folder.getType().getType());
							fo.setCreatedBy(folder.getCreatedBy());
							jsonPutter.put(additionalFolderField
									.getColumnName(), additionalFolderField
									.getValue(fo, serverSession));
						}
					};
				} else {
					if (LOG.isWarnEnabled()) {
	 ...
	 */
	public static JSONArray writeMultiple2Array(final int[] fields,
			final Collection<UserizedFolder> folders) throws OXException {
		final int[] cols = null == fields ? ALL_FIELDS : fields;
		final FolderFieldWriter[] ffws = new FolderFieldWriter[cols.length];
		for (int i = 0; i < ffws.length; i++) {
			FolderFieldWriter ffw = STATIC_WRITERS_MAP.get(cols[i]);
	 ...
	 * @throws OXException
	 *             If writing JSON object fails
	 */
	public static JSONObject writeSingle2Object(final int[] fields,
			final UserizedFolder folder, final ServerSession serverSession,
			final AdditionalFolderFieldList additionalFolderFieldList)
			throws OXException {
		final int[] cols = null == fields ? getAllFields(additionalFolderFieldList)
				: fields;
		final FolderFieldWriter[] ffws = new FolderFieldWriter[cols.length];
		for (int i = 0; i < ffws.length; i++) {
			final int curCol = cols[i];
			...
			if (null == ffw) {
				if (additionalFolderFieldList.knows(curCol)) {
					final AdditionalFolderField additionalFolderField = additionalFolderFieldList
							.get(curCol);
					ffw = new AdditionalFolderFieldWriter(serverSession,
	...
	private static int[] getAllFields(
			final AdditionalFolderFieldList additionalFolderFieldList) {
	 ...
	 * 
	 * @param fields
	 *            The fields to write to each JSON object or <code>null</code>
	 *            to write all
	 * @param folders
	 *            The folders
	 ...
	 *             If writing JSON array fails
	 */
	public static JSONArray writeMultiple2Object(final int[] fields,
			final UserizedFolder[] folders) throws OXException {
		final int[] cols = null == fields ? ALL_FIELDS : fields;
		final FolderFieldWriter[] ffws = new FolderFieldWriter[cols.length];
		for (int i = 0; i < ffws.length; i++) {
			FolderFieldWriter ffw = STATIC_WRITERS_MAP.get(cols[i]);
	...
	static int createPermissionBits(final Permission perm) {
		return createPermissionBits(perm.getFolderPermission(),
	...
	/**
	 * Parses a positive <code>int</code> value from passed {@link String}
	 * instance.
	 * 
	 * @param s
	 *            The string to parse
	 * @return The parsed positive <code>int</code> value or <code>-1</code> if
	 *         parsing failed
	 */
