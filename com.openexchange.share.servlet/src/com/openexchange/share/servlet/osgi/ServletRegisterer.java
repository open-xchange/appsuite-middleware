...
public final class ServletRegisterer implements ServiceTrackerCustomizer<Object, Object> {
     ...
     */
    public ServletRegisterer(RankingAwareNearRegistryServiceTracker<ShareHandler> shareHandlerRegistry, BundleContext context) {
        super();
    ...
    private boolean registerServlet(String alias, HttpService httpService) {
        try {
            httpService.registerServlet(alias, new ShareServlet(shareHandlerRegistry), null, null);
