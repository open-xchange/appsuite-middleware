...
public class ShareServletStrings implements LocalizableStrings {
    ...
    public static final String ASK_PASSWORD_WITH_TARGET = "You can access %1$s %2$s more times without password. You can set a password now.";

    public static final String ASK_PASSWORD_WITHOUT_TARGET = "You can access these shares %1$s more times without password. You can set a password now.";
