...
public class TestMailAuthenticityStatusMatrixD2 extends AbstractTestMailAuthenticity {
    ...
    public void testSPFNeutralDKIMMissingDMARCFailRejectPolicy() throws Exception {
        ...
        perform("ox.io; spf=neutral smtp.mailfrom=example.net; dmarc=fail (p=reject sp=NONE dis=NONE) header.from=example.net");
    ...
    public void testSPFMissingDKIMMissingDMARCFailRejectPolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; dmarc=fail (p=reject sp=NONE dis=NONE) header.from=example.net");
    ...
    public void testSPFNeutralDKIMMissingDMARCFailQuarantinePolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; spf=neutral smtp.mailfrom=example.net; dmarc=fail (p=quarantine sp=NONE dis=NONE) header.from=example.net");
    ...
    public void testSPFMissingDKIMMissingDMARCFailQuarantinePolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; dmarc=fail (p=quarantine sp=NONE dis=NONE) header.from=example.net");
    ...
    public void testSPFNeutralDKIMMissingDMARCFailNonePolicyWithDomainMatch() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; spf=neutral smtp.mailfrom=example.net; dmarc=fail (p=none sp=NONE dis=NONE) header.from=example.net");
    ...
    public void testSPFNeutralDKIMNeutralDMARCFailNonePolicyWithDomainMatch() throws AddressException {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; spf=neutral smtp.mailfrom=example.net; dkim=neutral header.d=example.net; dmarc=fail (p=none sp=NONE dis=NONE) header.from=example.net");
    ...
    public void testSPFMissingDKIMMissingDMARCFailNonePolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; dmarc=fail (p=none sp=NONE dis=NONE) header.from=example.net");
    ...
    public void testSPFMissingDKIMNeutralDMARCFailNonePolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; dkim=neutral header.d=example.net; dmarc=fail (p=none sp=NONE dis=NONE) header.from=example.net");
