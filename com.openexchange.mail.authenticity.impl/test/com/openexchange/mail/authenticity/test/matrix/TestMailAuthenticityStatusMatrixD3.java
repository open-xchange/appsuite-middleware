...
public class TestMailAuthenticityStatusMatrixD3 extends AbstractTestMailAuthenticity {
    ...
    public void testSPFNeutralDKIMFailDMARCFailRejectPolicy() throws Exception {
        ...
        perform("ox.io; spf=neutral smtp.mailfrom=example.net; dkim=fail (bad signature) header.d=example.net; dmarc=fail (p=reject sp=NEUTRAL dis=NEUTRAL) header.from=example.net");
    ...
    public void testSPFMissingDKIMFailDMARCFailRejectPolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; dkim=fail (bad signature) header.d=example.net; dmarc=fail (p=reject sp=NEUTRAL dis=NEUTRAL) header.from=example.net");
    ...
    public void testSPFNeutralDKIMFailDMARCFailQuarantinePolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; spf=neutral smtp.mailfrom=example.net; dkim=fail (bad signature) header.d=example.net; dmarc=fail (p=quarantine sp=NEUTRAL dis=NEUTRAL) header.from=example.net");
    ...
    public void testSPFMissingDKIMFailDMARCFailQuarantinePolicy() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; dkim=fail (bad signature) header.d=example.net; dmarc=fail (p=quarantine sp=NEUTRAL dis=NEUTRAL) header.from=example.net");
    ...
    public void testSPFNeutralDKIMFailDMARCFailNonePolicyWithDomainMatch() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; spf=neutral smtp.mailfrom=example.net; dkim=fail (bad signature) header.d=example.net; dmarc=fail (p=none sp=NEUTRAL dis=NEUTRAL) header.from=example.net");
    ...
    public void testSPFMissingDKIMFailDMARCFailNonePolicyWithDomainMatch() throws Exception {
        fromAddresses[0] = new InternetAddress("Jane Doe <jane.doe@example.net>");
        perform("ox.io; dkim=fail (bad signature) header.d=example.net; dmarc=fail (p=none sp=NEUTRAL dis=NEUTRAL) header.from=example.net");
