...
PROTECT=( autoconfig.properties configdb.properties hazelcast.properties jolokia.properties mail.properties mail-push.properties management.properties secret.properties secrets sessiond.properties tokenlogin-secrets )
for FILE in "${PROTECT[@]}"
do
