...
# SoftwareChange_Request-3412
oldval=$(ox_read_property com.openexchange.log.audit.slf4j.file.pattern /opt/open-xchange/etc/slf4j-auditlog.properties)
if [[ ${oldval} == '"%message%n"' ]]
then
  ox_set_property com.openexchange.log.audit.slf4j.file.pattern '"%sanitisedMessage%n"' /opt/open-xchange/etc/slf4j-auditlog.properties
fi
