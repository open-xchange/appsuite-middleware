...
/**
 * {@link CreateMultifactorTotpTable}
 *
 * @author <a href="mailto:benjamin.gruedelbach@open-xchange.com">Benjamin Gruedelbach</a>
 * @since v7.10.2
 */
public class CreateMultifactorTotpTable extends AbstractCreateTableImpl {

    private static final String TABLE_MULTIFACTOR_TOTP = "multifactor_totp_device";
    ...
    private static final String CREATE_MULTIFACTOR_TABLE =
        "CREATE TABLE " + TABLE_MULTIFACTOR_TOTP + " (" +
            ...
            "trustedApplication TINYINT(1) default 0, " +
