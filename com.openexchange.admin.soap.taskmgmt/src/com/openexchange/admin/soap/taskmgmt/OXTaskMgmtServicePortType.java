 ...
 * 2012-05-31T16:29:10.107+02:00
 * Generated source version: 2.6.0
 * 
 */
@WebService(targetNamespace = "http://soap.admin.openexchange.com", name = "OXTaskMgmtServicePortType")
@XmlSeeAlso({com.openexchange.admin.rmi.exceptions.xsd.ObjectFactory.class, ObjectFactory.class, java.io.xsd.ObjectFactory.class, com.openexchange.admin.soap.dataobjects.xsd.ObjectFactory.class, java.rmi.xsd.ObjectFactory.class, com.openexchange.admin.rmi.dataobjects.xsd.ObjectFactory.class, java.util.concurrent.xsd.ObjectFactory.class})
public interface OXTaskMgmtServicePortType {
    ...
    @RequestWrapper(localName = "getTaskResults", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.taskmgmt.GetTaskResults")
    @WebMethod(action = "urn:getTaskResults")
    @ResponseWrapper(localName = "getTaskResultsResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.taskmgmt.GetTaskResultsResponse")
    public java.lang.Object getTaskResults(
        ...
        com.openexchange.admin.rmi.dataobjects.xsd.Credentials cred,
    ...
    @RequestWrapper(localName = "getJobList", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.taskmgmt.GetJobList")
    @WebMethod(action = "urn:getJobList")
    @ResponseWrapper(localName = "getJobListResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.taskmgmt.GetJobListResponse")
