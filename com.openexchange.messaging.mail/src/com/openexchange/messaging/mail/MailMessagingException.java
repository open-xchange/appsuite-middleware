...
public class MailMessagingException extends MessagingException {
    ...
    /**
     * Initializes a new {@link MailMessagingException}.
     * 
     * @param cause The cause
     */
    public MailMessagingException(final AbstractOXException cause) {
        super(cause);
    }
     ...
     * @param cause The cause
     */
    public MailMessagingException(final ErrorMessage message, final Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public MailMessagingException(final ErrorMessage message, final Throwable cause, final Object... messageArguments) {
        super(message, cause);
