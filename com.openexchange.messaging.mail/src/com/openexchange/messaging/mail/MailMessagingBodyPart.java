 ...
 */
public class MailMessagingBodyPart extends MailMessagingPart implements MessagingBodyPart {

    /**
     * The multipart parent.
     */
    private MailMultipartContent parent;
     ...
     */
    public MailMessagingBodyPart(final MailPart part, final MailMultipartContent parent) {
        super(part);
        this.parent = parent;
    }
