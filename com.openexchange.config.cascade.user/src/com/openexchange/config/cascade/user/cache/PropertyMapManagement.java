...
public final class PropertyMapManagement {
    ...
    public void dropFor(final int contextId) {
        ...
        LOG.debug("Cleaned user-sensitive property cache for context {}", Integer.valueOf(contextId));
    }
    ...
    public void dropFor(final Session session) {
        final ConcurrentMap<Integer, PropertyMap> contextMap = map.getIfPresent(Integer.valueOf(session.getContextId()));
        if (null != contextMap) {
            contextMap.remove(Integer.valueOf(session.getUserId()));
        }
        LOG.debug("Cleaned user-sensitive property cache for user {} in context {}", Integer.valueOf(session.getUserId()), Integer.valueOf(session.getContextId()));
    }
    ...
    public void dropFor(final int userId, final int contextId) {
        ...
        LOG.debug("Cleaned user-sensitive property cache for user {} in context {}", Integer.valueOf(userId), Integer.valueOf(contextId));
    }
