 ...
 * to this service has to implement a {@link QuotaAndUsageProvider}.
 *
...
public interface QuotaAndUsageService {
    ...
    /**
     * Gets all currently known {@link QuotaAndUsageProvider}s.
     *
     * @return A list of providers. Never <code>null</code> but possibly empty.
     */
    List<QuotaAndUsageProvider> getAllProviders();
     ...
     */
    QuotaAndUsageProvider getProvider(String moduleID);
