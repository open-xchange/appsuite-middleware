...
/**
 * A {@link QuotaAndUsageProvider} must be implemented by every module that wants
 * to contribute to the general {@link QuotaAndUsageService}.
 *
 * @author <a href="mailto:steffen.templin@open-xchange.com">Steffen Templin</a>
 * @since v7.6.1
 */
public interface QuotaAndUsageProvider {
     ...
     */
    QuotaAndUsage getFor(Session session, String accountID) throws OXException;
     ...
     * @throws OXException If an error occurs while calculating quota and usage.
     */
    List<QuotaAndUsage> getFor(Session session) throws OXException;
