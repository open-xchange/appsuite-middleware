...
public class ManagementServiceTracker implements ServiceTrackerCustomizer<ManagementService, ManagementService> {
    ...
    private void registerMBean(final ManagementService management) {
        if (objectName == null) {
            ...
            try {
                objectName = getObjectName(ConfigReloadMBean.class.getName(), ConfigReloadMBean.DOMAIN);
                management.registerMBean(objectName, new ConfigReloadMBeanImpl(ConfigReloadMBean.class, configService));
