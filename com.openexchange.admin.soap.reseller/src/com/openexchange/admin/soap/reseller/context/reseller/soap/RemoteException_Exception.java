...
public class RemoteException_Exception extends java.lang.Exception {
    ...
    public RemoteException_Exception(String message, com.openexchange.admin.soap.reseller.context.reseller.soap.RemoteException remoteException) {
        super(message);
        this.remoteException = remoteException;
    }

    public RemoteException_Exception(String message, com.openexchange.admin.soap.reseller.context.reseller.soap.RemoteException remoteException, Throwable cause) {
        super(message, cause);
        this.remoteException = remoteException;
    }

    public com.openexchange.admin.soap.reseller.context.reseller.soap.RemoteException getFaultInfo() {
