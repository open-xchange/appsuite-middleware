 ...
 * 2012-06-06T09:43:16.696+02:00
 * Generated source version: 2.6.0
 * 
 */
@WebService(targetNamespace = "http://soap.reseller.admin.openexchange.com", name = "OXResellerUserServicePortType")
@XmlSeeAlso({com.openexchange.admin.soap.reseller.user.rmi.ObjectFactory.class, com.openexchange.admin.soap.reseller.user.dataobjects.ObjectFactory.class, ObjectFactory.class, com.openexchange.admin.soap.reseller.user.io.ObjectFactory.class, com.openexchange.admin.soap.reseller.user.exceptions.ObjectFactory.class})
public interface OXResellerUserServicePortType {
    ...
    @RequestWrapper(localName = "getContextAdmin", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetContextAdmin")
    @WebMethod(action = "urn:getContextAdmin")
    @ResponseWrapper(localName = "getContextAdminResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetContextAdminResponse")
    public com.openexchange.admin.soap.reseller.user.dataobjects.User getContextAdmin(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "auth", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.Credentials auth
    ...
    @RequestWrapper(localName = "list", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.List")
    @WebMethod(action = "urn:list")
    @ResponseWrapper(localName = "listResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.ListResponse")
    public java.util.List<com.openexchange.admin.soap.reseller.user.dataobjects.User> list(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
    ...
    @RequestWrapper(localName = "createByModuleAccess", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.CreateByModuleAccess")
    @WebMethod(action = "urn:createByModuleAccess")
    @ResponseWrapper(localName = "createByModuleAccessResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.CreateByModuleAccessResponse")
    public com.openexchange.admin.soap.reseller.user.dataobjects.User createByModuleAccess(
        ...
        com.openexchange.admin.soap.reseller.user.dataobjects.User usrdata,
        @WebParam(name = "access", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.UserModuleAccess access,
        @WebParam(name = "auth", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.Credentials auth
    ) throws DatabaseUpdateException_Exception, InvalidCredentialsException_Exception, DuplicateExtensionException_Exception, NoSuchContextException_Exception, StorageException_Exception, RemoteException_Exception, InvalidDataException_Exception;
    ...
    @RequestWrapper(localName = "getModuleAccess", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetModuleAccess")
    @WebMethod(action = "urn:getModuleAccess")
    @ResponseWrapper(localName = "getModuleAccessResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetModuleAccessResponse")
    public com.openexchange.admin.soap.reseller.user.dataobjects.UserModuleAccess getModuleAccess(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "user", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.User user,
        @WebParam(name = "auth", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.Credentials auth
    ) throws DatabaseUpdateException_Exception, NoSuchUserException_Exception, InvalidCredentialsException_Exception, DuplicateExtensionException_Exception, NoSuchContextException_Exception, StorageException_Exception, RemoteException_Exception, InvalidDataException_Exception;
    ...
    @RequestWrapper(localName = "create", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.Create")
    @WebMethod(action = "urn:create")
    @ResponseWrapper(localName = "createResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.CreateResponse")
    public com.openexchange.admin.soap.reseller.user.dataobjects.User create(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "usrdata", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.User usrdata,
    ...
    @RequestWrapper(localName = "listAll", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.ListAll")
    @WebMethod(action = "urn:listAll")
    @ResponseWrapper(localName = "listAllResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.ListAllResponse")
    public java.util.List<com.openexchange.admin.soap.reseller.user.dataobjects.User> listAll(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "auth", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.Credentials auth
    ...
    @RequestWrapper(localName = "getMultipleData", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetMultipleData")
    @WebMethod(action = "urn:getMultipleData")
    @ResponseWrapper(localName = "getMultipleDataResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetMultipleDataResponse")
    public java.util.List<com.openexchange.admin.soap.reseller.user.dataobjects.User> getMultipleData(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "users", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        java.util.List<com.openexchange.admin.soap.reseller.user.dataobjects.User> users,
        @WebParam(name = "auth", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.Credentials auth
    ) throws DatabaseUpdateException_Exception, NoSuchUserException_Exception, InvalidCredentialsException_Exception, DuplicateExtensionException_Exception, NoSuchContextException_Exception, StorageException_Exception, RemoteException_Exception, InvalidDataException_Exception;
    ...
    @RequestWrapper(localName = "getData", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetData")
    @WebMethod(action = "urn:getData")
    @ResponseWrapper(localName = "getDataResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetDataResponse")
    public com.openexchange.admin.soap.reseller.user.dataobjects.User getData(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "user", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.User user,
    ...
    @RequestWrapper(localName = "exists", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.Exists")
    @WebMethod(action = "urn:exists")
    @ResponseWrapper(localName = "existsResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.ExistsResponse")
    ...
    @RequestWrapper(localName = "listCaseInsensitive", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.ListCaseInsensitive")
    @WebMethod(action = "urn:listCaseInsensitive")
    @ResponseWrapper(localName = "listCaseInsensitiveResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.ListCaseInsensitiveResponse")
    public java.util.List<com.openexchange.admin.soap.reseller.user.dataobjects.User> listCaseInsensitive(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "search_pattern", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        java.lang.String searchPattern,
    ...
    @RequestWrapper(localName = "getAccessCombinationName", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetAccessCombinationName")
    @WebMethod(action = "urn:getAccessCombinationName")
    @ResponseWrapper(localName = "getAccessCombinationNameResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.GetAccessCombinationNameResponse")
    ...
    @RequestWrapper(localName = "createByModuleAccessName", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.CreateByModuleAccessName")
    @WebMethod(action = "urn:createByModuleAccessName")
    @ResponseWrapper(localName = "createByModuleAccessNameResponse", targetNamespace = "http://soap.reseller.admin.openexchange.com", className = "com.openexchange.admin.soap.reseller.user.soap.CreateByModuleAccessNameResponse")
    public com.openexchange.admin.soap.reseller.user.dataobjects.User createByModuleAccessName(
        @WebParam(name = "ctx", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.ResellerContext ctx,
        @WebParam(name = "usrdata", targetNamespace = "http://soap.reseller.admin.openexchange.com")
        com.openexchange.admin.soap.reseller.user.dataobjects.User usrdata,
