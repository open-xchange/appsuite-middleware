...
public class InvalidCredentialsException_Exception extends java.lang.Exception {
    ...
    public InvalidCredentialsException_Exception(String message, com.openexchange.admin.soap.reseller.user.reseller.soap.InvalidCredentialsException invalidCredentialsException) {
        super(message);
        this.invalidCredentialsException = invalidCredentialsException;
    }

    public InvalidCredentialsException_Exception(String message, com.openexchange.admin.soap.reseller.user.reseller.soap.InvalidCredentialsException invalidCredentialsException, Throwable cause) {
        super(message, cause);
        this.invalidCredentialsException = invalidCredentialsException;
    }

    public com.openexchange.admin.soap.reseller.user.reseller.soap.InvalidCredentialsException getFaultInfo() {
