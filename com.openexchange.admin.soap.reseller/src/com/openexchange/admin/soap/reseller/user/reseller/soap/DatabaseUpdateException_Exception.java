...
public class DatabaseUpdateException_Exception extends java.lang.Exception {
    ...
    public DatabaseUpdateException_Exception(String message, com.openexchange.admin.soap.reseller.user.reseller.soap.DatabaseUpdateException databaseUpdateException) {
        super(message);
        this.databaseUpdateException = databaseUpdateException;
    }

    public DatabaseUpdateException_Exception(String message, com.openexchange.admin.soap.reseller.user.reseller.soap.DatabaseUpdateException databaseUpdateException, Throwable cause) {
        super(message, cause);
        this.databaseUpdateException = databaseUpdateException;
    }

    public com.openexchange.admin.soap.reseller.user.reseller.soap.DatabaseUpdateException getFaultInfo() {
