 ...
 * generated in the com.openexchange.admin.soap.reseller.service.reseller.rmi.dataobjects package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResellerAdminMandatoryMembersCreate_QNAME = new QName("http://dataobjects.rmi.reseller.admin.openexchange.com/xsd", "mandatoryMembersCreate");
    private final static QName _ResellerAdminMandatoryMembersRegister_QNAME = new QName("http://dataobjects.rmi.reseller.admin.openexchange.com/xsd", "mandatoryMembersRegister");
    private final static QName _ResellerAdminId_QNAME = new QName("http://dataobjects.rmi.reseller.admin.openexchange.com/xsd", "id");
    ...
    private final static QName _ResellerAdminMandatoryMembersChange_QNAME = new QName("http://dataobjects.rmi.reseller.admin.openexchange.com/xsd", "mandatoryMembersChange");
    private final static QName _ResellerAdminName_QNAME = new QName("http://dataobjects.rmi.reseller.admin.openexchange.com/xsd", "name");
    ...
    private final static QName _ResellerAdminMandatoryMembersDelete_QNAME = new QName("http://dataobjects.rmi.reseller.admin.openexchange.com/xsd", "mandatoryMembersDelete");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.openexchange.admin.soap.reseller.service.reseller.rmi.dataobjects
     * 
     */
    ...
    public JAXBElement<String> createResellerAdminMandatoryMembersCreate(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersCreate_QNAME, String.class, ResellerAdmin.class, value);
    }
    ...
    public JAXBElement<String> createResellerAdminMandatoryMembersRegister(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersRegister_QNAME, String.class, ResellerAdmin.class, value);
    }
    ...
    public JAXBElement<Integer> createResellerAdminId(Integer value) {
        return new JAXBElement<Integer>(_ResellerAdminId_QNAME, Integer.class, ResellerAdmin.class, value);
    }
    ...
    public JAXBElement<String> createResellerAdminMandatoryMembersChange(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersChange_QNAME, String.class, ResellerAdmin.class, value);
    }
    ...
    public JAXBElement<String> createResellerAdminName(String value) {
        return new JAXBElement<String>(_ResellerAdminName_QNAME, String.class, ResellerAdmin.class, value);
    }
    ...
    public JAXBElement<String> createResellerAdminMandatoryMembersDelete(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersDelete_QNAME, String.class, ResellerAdmin.class, value);
    }
    ...
    public JAXBElement<String> createRestrictionMandatoryMembersRegister(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersRegister_QNAME, String.class, Restriction.class, value);
    }
    ...
    public JAXBElement<String> createRestrictionMandatoryMembersCreate(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersCreate_QNAME, String.class, Restriction.class, value);
    }
    ...
    public JAXBElement<Integer> createRestrictionId(Integer value) {
        return new JAXBElement<Integer>(_ResellerAdminId_QNAME, Integer.class, Restriction.class, value);
    }
    ...
    public JAXBElement<String> createRestrictionMandatoryMembersChange(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersChange_QNAME, String.class, Restriction.class, value);
    }
    ...
    public JAXBElement<String> createRestrictionName(String value) {
        return new JAXBElement<String>(_ResellerAdminName_QNAME, String.class, Restriction.class, value);
    }
    ...
    public JAXBElement<String> createRestrictionMandatoryMembersDelete(String value) {
        return new JAXBElement<String>(_ResellerAdminMandatoryMembersDelete_QNAME, String.class, Restriction.class, value);
    }
