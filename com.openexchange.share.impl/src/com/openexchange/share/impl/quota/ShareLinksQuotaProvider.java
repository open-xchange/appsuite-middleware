...
public class ShareLinksQuotaProvider extends ShareQuotaProvider {
    ...
    /**
     * Initializes a new {@link ShareLinksQuotaProvider}.
     *
    ...
    protected long getDefaultLimit() {
        return DEFAULT_SHARE_LINKS_QUOTA_LIMIT;
    }

    @Override
    protected long getUsedQuota(ShareStorage storage, ConnectionHelper connectionHelper, int userID) throws OXException {
        return storage.countLinks(connectionHelper.getContextID(), userID, connectionHelper.getParameters());
    }
