 ...
 * @since v7.6.1
 */
public class SharedFolder implements Folder {

    private static final long serialVersionUID = 8107014580445239682L;
    ...
    public Object clone() {
        try {
            final SharedFolder clone = (SharedFolder) super.clone();
