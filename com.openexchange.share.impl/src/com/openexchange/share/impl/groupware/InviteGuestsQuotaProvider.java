...
/**
 * {@link InviteGuestsQuotaProvider}
 *
 * @author <a href="mailto:jan.bauerdick@open-xchange.com">Jan Bauerdick</a>
 * @since v7.8.0
 */
public class InviteGuestsQuotaProvider implements QuotaProvider {
    ...
    public InviteGuestsQuotaProvider(ServiceLookup services) {
        super();
    ...
    public Quota getAmountQuota(Session session, Connection connection, StorageParameters parameters, ConfigViewFactory viewFactory) throws OXException {
        long limit = AmountQuotas.getLimit(session, MODULE_ID, viewFactory, connection, DEFAULT_INVITE_GUESTS_QUOTA_LIMIT);
    ...
    /**
     * Returns the currently existing number of guest users for the given user.
     *
     * @param contextId - id of the relevant context
     * @param userId - id of the user to get the count for
     * @return int - number of currently existing guests
     * @throws OXException
     */
    private int getUsedQuota(int contextId, int userId, StorageParameters parameters) throws OXException {
        ...
        int usedCount = shareStorage.countGuests(contextId, userId, parameters);
        return usedCount;
    }
