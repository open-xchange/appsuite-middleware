 ...
 * @since v7.10.0
 */
public class RecurrenceRule implements Field<Event> {
    ...
    public void set(ResultSet rs, Event target) throws SQLException {
        target.setRecurrenceRule(Recurrence.getRecurrenceRule(rs.getString(getSqlName()), TimeZone.getTimeZone(target.getStartTimezone()), target.isAllDay()));
    }
