 ...
 * @since v7.10.0
 */
public class StartTimezone implements Field<Event> {
    ...
    public void set(ResultSet rs, Event target) throws SQLException {
        target.setStartTimezone(rs.getString(getSqlName()));
    }

    @Override
    public void set(Event source, PreparedStatement stmt, int index) throws SQLException, OXException {
        MySqlTools.setString(stmt, index, source.getStartTimezone());
    }
