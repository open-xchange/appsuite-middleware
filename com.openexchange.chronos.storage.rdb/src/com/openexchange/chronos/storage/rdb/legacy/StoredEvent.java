...
public class StoredEvent extends DelegatingEvent {
     ...
     */
    StoredEvent(RdbEventStorage eventStorage, Connection connection, Event event) throws OXException {
        super(event);
    ...
    public boolean containsStartDate() {
         ...
         */
        return delegate.containsStartDate() || containsRecurrenceRule();
    }
    ...
    public boolean containsEndDate() {
         ...
         */
        return delegate.containsEndDate() || containsRecurrenceRule();
    }
