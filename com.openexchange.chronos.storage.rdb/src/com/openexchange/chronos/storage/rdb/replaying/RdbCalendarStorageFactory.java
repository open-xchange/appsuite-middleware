 ...
 * @since v7.10.0
 */
public class RdbCalendarStorageFactory implements ReplayingCalendarStorageFactory {

    /**
     * Initializes a new {@link RdbCalendarStorageFactory}.
     */
    public RdbCalendarStorageFactory() {
        super();
    }
    ...
    public CalendarStorage create(Context context, EntityResolver entityResolver, DBProvider dbProvider, DBTransactionPolicy txPolicy) throws OXException {
        ...
        CalendarStorage storage = new com.openexchange.chronos.storage.rdb.RdbCalendarStorage(context, 0, entityResolver, dbProvider, txPolicy);
        return new RdbCalendarStorage(storage, legacyStorage);
    }
