 ...
 */
public class GetCommentsActivityRequestAction extends AbstractXingAction {
    ...
    protected AJAXRequestResult perform(XingRequest req) throws OXException, JSONException, XingException {
        ...
        if (limit != null) {
            try {
                optLimit = Integer.parseInt(limit);
            } catch (NumberFormatException e) {
                throw AjaxExceptionCodes.INVALID_PARAMETER_VALUE.create("limit", limit);
            }
        }
        ...
        if (offset != null) {
            try {
                optOffset = Integer.parseInt(offset);
            } catch (NumberFormatException e) {
                throw AjaxExceptionCodes.INVALID_PARAMETER_VALUE.create("offset", offset);
            }
        }
