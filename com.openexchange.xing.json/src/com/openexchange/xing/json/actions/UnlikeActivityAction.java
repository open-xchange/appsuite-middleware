...
/**
 * {@link UnlikeActivityAction}
 * 
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public class UnlikeActivityAction extends AbstractXingAction {
    /**
     * Initializes a new {@link UnlikeActivityAction}.
     */
    public UnlikeActivityAction(ServiceLookup serviceLookup) {
        super(serviceLookup);
    }
    ...
    protected AJAXRequestResult perform(XingRequest req) throws OXException, JSONException, XingException {
        ...
        getXingAPI(req).unlikeActivity(activityId);
