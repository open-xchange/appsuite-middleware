...
/**
 * {@link GetActivityLikesAction}
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public class GetActivityLikesAction extends AbstractXingAction {


    /**
     * Initializes a new {@link GetActivityLikesAction}.
     * @param services
     */
    public GetActivityLikesAction(ServiceLookup services) {
        super(services);
    }
    ...
    protected AJAXRequestResult perform(XingRequest req) throws OXException, JSONException, XingException {
        ...
        Map<String, Object> response = getXingAPI(req).getLikes(activityId, optLimit, optOffset, optUserFields);
