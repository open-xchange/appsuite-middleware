...
public enum OAuthIntrospectionExceptionCode implements OXExceptionCode {
    ...
    /**
     * Validation failed because of internal errors: '%1$s'
     */
    VALIDATON_FAILED("JWT validation failed because of internal errors: '%1$s'", Category.CATEGORY_ERROR, 1),
     ...
     */
    UNABLE_TO_PARSE_CLAIM("Unable to parse claim: '%1$s'", Category.CATEGORY_ERROR, 4);
