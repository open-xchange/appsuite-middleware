...
/**
 * {@link ClientIconEndpoint}
 *
 * @author <a href="mailto:steffen.templin@open-xchange.com">Steffen Templin</a>
 * @since v7.8.0
 */
public class ClientIconEndpoint extends OAuthEndpoint {

    private static final long serialVersionUID = 5716238700714249548L;

    public ClientIconEndpoint(OAuthProviderService oAuthProvider) {
        super(oAuthProvider);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ByteStreams.copy(icon.getInputStream(), os);
        os.flush();
    }
