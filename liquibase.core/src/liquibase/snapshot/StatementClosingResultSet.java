...
/**
 * Closing this result set also closes backing statement.
 */
public class StatementClosingResultSet implements ResultSet {
    ...
    /**
     * Initializes a new {@link StatementClosingResultSet}.
     */
    public StatementClosingResultSet(ResultSet rs, Statement statement) {
        super();
        this.rs = rs;
