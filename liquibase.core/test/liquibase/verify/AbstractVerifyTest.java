...
public class AbstractVerifyTest {
    ...
    protected static class TestState {
        ...
        private final File savedStateDir;
        private final String testName;
        private final String testGroup;
        private final String stateName;
        private final Type type;

        private final StringBuilder stateContent = new StringBuilder();
        ...
        public TestState(String testName, String testGroup, String stateName, Type type) {
            ...
            this.savedStateDir = new File(liquibaseRootDir.getAbsoluteFile(), "liquibase.core/bin/test/output/liquibase/verify/saved_state/"+testName+"/"+testGroup);
