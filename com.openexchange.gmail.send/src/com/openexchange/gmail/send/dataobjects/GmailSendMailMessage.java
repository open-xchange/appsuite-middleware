 ...
 * @since v7.10.2
 */
public class GmailSendMailMessage extends ComposedMailMessage {

    private static final long serialVersionUID = -9088944857152908659L;
    ...
    /**
     * Initializes a new {@link GmailSendMailMessage}.
     * <p>
     ...
     *
     * @param htmlMailBody The mail body as HTML content
     * @param session The session providing user data
     * @param ctx The context
     */
    public GmailSendMailMessage(final String htmlMailBody, final Session session, final Context ctx) {
        super(session, ctx);
        mailPart = new GmailSendBodyPart(htmlMailBody);
     ...
     * @param ctx The context
     */
    public GmailSendMailMessage(final Session session, final Context ctx) {
        super(session, ctx);
        enclosedParts = new ArrayList<MailPart>();
    }
