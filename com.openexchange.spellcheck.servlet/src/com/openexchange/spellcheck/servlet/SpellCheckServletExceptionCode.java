...
public enum SpellCheckServletExceptionCode implements OXExceptionCode {
    ...
    private SpellCheckServletExceptionCode(final String message, final Category category, final int detailNumber) {
