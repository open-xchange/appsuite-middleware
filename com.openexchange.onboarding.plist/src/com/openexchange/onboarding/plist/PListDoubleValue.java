...
/**
 * {@link PListDoubleValue}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.8.1
 */
public class PListDoubleValue extends AbstractPListKeyValue {

    private final double value;

    /**
     * Initializes a new {@link PListDoubleValue}.
     */
    public PListDoubleValue(String key, double value) {
        super(key);
        this.value = value;
    }
