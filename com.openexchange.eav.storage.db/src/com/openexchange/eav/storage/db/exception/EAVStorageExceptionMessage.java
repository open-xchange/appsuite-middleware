...
public enum EAVStorageExceptionMessage implements OXErrorMessage {
    ...
    private EAVStorageExceptionMessage(int detailNumber, Category category, String message, String help) {
    ...
    public static final EAVStorageExceptionFactory EXCEPTIONS = new EAVStorageExceptionFactory();

    public EAVStorageException create(final Throwable cause, final Object... args) {
        return EXCEPTIONS.create(this, cause, args);
    }

    public EAVStorageException create(final Object... args) {
