...
import com.openexchange.eav.storage.db.sql.TextTable;
import com.openexchange.groupware.tx.DBProvider;


/**
 * {@link TextTableManager}
 *
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 *
 */
public class TextTableManager extends BalancedTableManager {
    ...
    public static final String TABLE_PREFIX = TextTable.tablePrefix;

    private static final String COLUMN_NAME = "textTable";
    
    
    public TextTableManager(DBProvider provider) {
        super();
