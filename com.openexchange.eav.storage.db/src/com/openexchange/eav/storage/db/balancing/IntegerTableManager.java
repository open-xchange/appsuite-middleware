...
import com.openexchange.eav.storage.db.sql.IntegerTable;
import com.openexchange.groupware.tx.DBProvider;


/**
 * {@link IntegerTableManager}
 *
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 *
 */
public class IntegerTableManager extends BalancedTableManager {
    ...
    public static final String TABLE_PREFIX = IntegerTable.tablePrefix;

    private static final String COLUMN_NAME = "intTable";
    
    public IntegerTableManager(DBProvider provider) {
        super();
