...
import com.openexchange.eav.storage.db.sql.BooleanTable;
import com.openexchange.groupware.tx.DBProvider;


/**
 * {@link BooleanTableManager}
 *
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 *
 */
public class BooleanTableManager extends BalancedTableManager {
    ...
    public static final String TABLE_PREFIX = BooleanTable.tablePrefix;

    private static final String COLUMN_NAME = "boolTable";
    
    
    public BooleanTableManager(DBProvider provider) {
        super();
