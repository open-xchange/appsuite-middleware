...
import com.openexchange.eav.storage.db.sql.VarcharTable;
import com.openexchange.groupware.tx.DBProvider;


/**
 * {@link VarcharTableManager}
 *
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 *
 */
public class VarcharTableManager extends BalancedTableManager {
    ...
    public static final String TABLE_PREFIX = VarcharTable.tablePrefix;

    private static final String COLUMN_NAME = "varcharTable";
    
    
    public VarcharTableManager(DBProvider provider) {
        super();
