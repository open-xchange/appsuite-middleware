...
import com.openexchange.eav.storage.db.sql.BlobTable;
import com.openexchange.groupware.tx.DBProvider;


/**
 * {@link BlobTableManager}
 *
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 *
 */
public class BlobTableManager extends BalancedTableManager {
    ...
    public static final String TABLE_PREFIX = BlobTable.tablePrefix;

    private static final String COLUMN_NAME = "blobTable";
    
    
    public BlobTableManager(DBProvider provider) {
        super();
