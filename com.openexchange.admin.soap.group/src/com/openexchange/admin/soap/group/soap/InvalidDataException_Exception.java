...
public class InvalidDataException_Exception extends java.lang.Exception {
    ...
    public InvalidDataException_Exception(String message, com.openexchange.admin.soap.group.soap.InvalidDataException invalidDataException) {
        super(message);
        this.invalidDataException = invalidDataException;
    }

    public InvalidDataException_Exception(String message, com.openexchange.admin.soap.group.soap.InvalidDataException invalidDataException, Throwable cause) {
        super(message, cause);
        this.invalidDataException = invalidDataException;
    }

    public com.openexchange.admin.soap.group.soap.InvalidDataException getFaultInfo() {
