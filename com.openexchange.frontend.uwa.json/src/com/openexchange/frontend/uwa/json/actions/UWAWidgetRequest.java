...
/**
 * {@link UWAWidgetRequest}
 *
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 */
public class UWAWidgetRequest extends RequestPrototype<UWAWidget> {

    public UWAWidgetRequest(AJAXRequestData req, ModelParser<UWAWidget> parser, ServerSession session) {
        super(req, parser, session);
    }
