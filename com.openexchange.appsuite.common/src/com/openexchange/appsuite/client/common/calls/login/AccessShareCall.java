...
import static com.openexchange.appsuite.client.common.AppsuiteClientUtils.getHeaderValue;
import static com.openexchange.appsuite.client.common.AppsuiteClientUtils.getSessionCookie;
import static com.openexchange.appsuite.client.common.AppsuiteClientUtils.parseParameters;
 ...
 * @since v7.10.5
 */
public class AccessShareCall extends AbstractGetAppsuiteCall<ShareLoginInformation> {

    private final URL loginLink;
    ...
    @Override
    public boolean appendPathPrefix() {
        return false;
    }
