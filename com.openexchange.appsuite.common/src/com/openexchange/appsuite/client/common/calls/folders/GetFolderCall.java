 ...
 * @since v7.10.5
 */
public class GetFolderCall extends AbstractGetAppsuiteCall<RemoteFolder> {
    ...
    protected void fillParameters(Map<String, String> parameters) {
        ...
        if (allowedModules != null) {
            parameters.put("allowed_modules", AppsuiteClientUtils.toCommaString(allowedModules));
        }
        if (language != null) {
