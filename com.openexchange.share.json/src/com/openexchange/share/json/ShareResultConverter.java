...
public class ShareResultConverter implements ResultConverter {
    ...
    public void convert(AJAXRequestData requestData, AJAXRequestResult result, ServerSession session, Converter converter) throws OXException {
        ...
        if (Share.class.isInstance(resultObject)) {
            resultObject = convert((Share)resultObject, timeZoneID, session);
        } else {
            resultObject = convert((List<Share>) resultObject, timeZoneID, session);
        }
        result.setResultObject(resultObject, "json");
    }

    private JSONArray convert(List<Share> shares, String timeZoneID, Session session) throws OXException {
    ...
    private JSONObject convert(Share share, String timeZoneID, Session session) throws OXException {
        try {
