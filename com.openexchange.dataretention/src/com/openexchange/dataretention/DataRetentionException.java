...
public final class DataRetentionException extends AbstractOXException {
    ...
    private static final String STR_COMPONENT = "DATARET";
     ...
     */
    public DataRetentionException(final AbstractOXException cause) {
        super(cause);
    }
     ...
     */
    DataRetentionException(final ErrorMessage message, final Throwable cause, final Object... messageArgs) {
        super(message, cause);
