...
/**
 * {@link DoAuthenticationMultifactorAction} - performs multifactor authentication against a given {@link MultifactorDevice}
 *
 * @author <a href="mailto:benjamin.gruedelbach@open-xchange.com">Benjamin Gruedelbach</a>
 * @since v7.10.2
 */
public class DoAuthenticationMultifactorAction extends AbstractMultifactorAction {

    /**
     * Initializes a new {@link DoAuthenticationMultifactorAction}.
     *
     * @param serviceLookup The {@link ServiceLookup}
     * @throws OXException
     */
    public DoAuthenticationMultifactorAction(ServiceLookup serviceLookup) throws OXException {
        super(serviceLookup);
    }
    ...
    protected AJAXRequestResult doPerform(AJAXMultifactorRequest request) throws OXException {
        ...
        final MultifactorAuthenticator authenticator = serviceLookup.getServiceSafe(MultifactorAuthenticatorFactory.class).createSessionModifyingAuthenticator(authProvider, request.getServerSession());
        authenticator.doAuthentication(request.getMultifactorRequest(), deviceId, answer);
