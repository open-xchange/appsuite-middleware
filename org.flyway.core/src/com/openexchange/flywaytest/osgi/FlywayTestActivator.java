...
import com.openexchange.flywaytest.FlywayTest;
import com.openexchange.flywaytest.migrations.V1_1__CreateBlablubberTable;
import com.openexchange.startup.SignalStartedService;


/**
 * {@link FlywayTestActivator}
 *
 * @author <a href="mailto:jan.bauerdick@open-xchange.com">Jan Bauerdick</a>
 * @since v7.6.1
 */
public class FlywayTestActivator implements BundleActivator {
...
//      context.registerService(CommandProvider.class, new Bl(context, tracker), null);
        ...
        trackers.add(new ServiceTracker<SignalStartedService, SignalStartedService>(context, SignalStartedService.class, startupTracker));
