 ...
 * @since v7.6.1
 */
public class StartupTracker implements ServiceTrackerCustomizer<SignalStartedService, SignalStartedService> {
    
    private final BundleContext context;
    private final OXResolver resolver;
    
    public StartupTracker(BundleContext context, OXResolver resolver) {
    ...
    public SignalStartedService addingService(ServiceReference<SignalStartedService> reference) {
        new FlywayTest(context, resolver);
