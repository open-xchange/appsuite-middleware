...
/**
 * 
 * {@link IncomingMailResource}
 *
 * @author <a href="mailto:daniel.becker@open-xchange.com">Daniel Becker</a>
 * @since v8.0.0
 */
public class IncomingMailResource extends IncomingCalendarObjectResource {

    private final IncomingSchedulingMail mail;

    /**
     * Initializes a new {@link IncomingMailResource} for a single event.
     * 
     * @param event The event of the calendar object resource
     * @param mail The mail to load attacments from
     */
    public IncomingMailResource(Event event, IncomingSchedulingMail mail) {
        super(event);
        this.mail = mail;
        loadAttachments();
    }
    ...
    /**
     * Initializes a new {@link IncomingMailResource} from one specific and further events.
     * 
     ...
     */
    public IncomingMailResource(Event event, List<Event> events, IncomingSchedulingMail mail) {
        super(event, events);
        this.mail = mail;
        loadAttachments();
    }
    ...
    /**
     * Initializes a new {@link IncomingMailResource}.
     * 
     * @param events The events of the calendar object resource
     * @param mail The mail to load attacments from
     * @throws IllegalArgumentException If passed events do not represent a valid calendar object resource
     */
    public IncomingMailResource(List<Event> events, IncomingSchedulingMail mail) {
        super(events);
        this.mail = mail;
        loadAttachments();
    }
