    ...
    protected AJAXRequestResult doPerform(AJAXRequestData requestData, ServerSession session) throws OXException, JSONException {
        ...
        for (String providerId : onboardingProviderIds) {
            ...
            if (OnboardingPlistProvider.class.isInstance(provider)) {
                PlistScenario scenario = PlistScenario.newInstance(type, Collections.singletonList(provider));
                dict = ((OnboardingPlistProvider) provider).getPlist(dict, scenario, requestData.getHostData().getHost(), session.getUserId(), session.getContextId());
            }
        }
