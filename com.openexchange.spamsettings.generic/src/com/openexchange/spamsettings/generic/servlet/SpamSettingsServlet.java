...
public final class SpamSettingsServlet extends PermissionServlet {
    ...
    protected void doGet(final HttpServletRequest req, final HttpServletResponse resp) throws IOException {
        ...
        } catch (final SpamSettingException e) {
            LOG.error(e.getLocalizedMessage(), e);
            response.setException(e);
        }
    ...
    private JSONObject getValue(final ServerSession session, final SpamSettingService service) throws JSONException, SpamSettingException {
