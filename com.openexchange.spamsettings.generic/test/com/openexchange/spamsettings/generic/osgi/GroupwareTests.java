...
import com.openexchange.spamsettings.generic.osgi.SpamSettingsServletRegisterer;
...
public class GroupwareTests {
    ...
    @Test
    public void GetTest() throws MalformedURLException, IOException, SAXException, JSONException {
        final WebconversationAndSessionID login = login();
        try {
            String body;
            final WebRequest reqmailfilter = new GetMethodWebRequest(PROTOCOL + getHostname() + SpamSettingsServletRegisterer.SERVLET_PATH);
            reqmailfilter.setParameter("action", "get");
    ...
    private void config(final WebconversationAndSessionID conversation, final String hostname) throws MalformedURLException, IOException, SAXException, JSONException {
        String body;
        final WebRequest reqmailfilter = new GetMethodWebRequest(PROTOCOL + hostname + SpamSettingsServletRegisterer.SERVLET_PATH);
