...
public final class MDNSClusterDiscoveryService implements ClusterDiscoveryService {
     ...
     */
    public MDNSClusterDiscoveryService() {
        super();
    }

    /* (non-Javadoc)
     * @see com.openexchange.cluster.discovery.ClusterDiscoveryService#getNodes()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.openexchange.cluster.discovery.ClusterDiscoveryService#addListener(com.openexchange.cluster.discovery.ClusterListener)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.openexchange.cluster.discovery.ClusterDiscoveryService#removeListener(com.openexchange.cluster.discovery.ClusterListener)
     */
    @Override
