...
public class EnhancedTaskOrAppointment {
	...
	private void initialize(Map<String, Object> taskOrAppointment2) throws OXException {
		...
		List<Object> confirmations = (List<Object>) taskOrAppointment.get("confirmations");
		...
		List<Object> participants = (List<Object>) taskOrAppointment.get("participants");
	...
	public boolean hasParticipants() {
		return hasAccepted() || hasDeclined() || hasTentative()
				|| hasUndecided();
	}
	...
	private SimpleParticipant resolveConfirmation(
