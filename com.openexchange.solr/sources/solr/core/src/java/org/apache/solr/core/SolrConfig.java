 ...
 * "solrconfig.xml".
 *
 * @version $Id: SolrConfig.java 1305693 2012-03-27 00:43:47Z janhoy $
 */
public class SolrConfig extends Config {
  ...
  throws ParserConfigurationException, IOException, SAXException {
    ...
    // Old indexDefaults and mainIndex sections are deprecated. We allow either the old-style or new-style, not both
    ...
    if(hasDeprecatedIndexConfig){
      ...
      log.warn("<indexDefaults> and <mainIndex> configuration sections are deprecated (but still work). Please use <indexConfig> instead.");
