 ...
 * @version $Id: FileFloatSource.java 1229782 2012-01-10 22:50:43Z erick $
 */
...
public class FileFloatSource extends ValueSource {
  ...
  public static class ReloadCacheRequestHandler extends RequestHandlerBase {
    ...
    public String getSource() {
      return "$URL: https://svn.apache.org/repos/asf/lucene/dev/branches/branch_3x/solr/core/src/java/org/apache/solr/search/function/FileFloatSource.java $";
    }

    @Override
    public String getSourceId() {
      return "$Id: FileFloatSource.java 1229782 2012-01-10 22:50:43Z erick $";
    }

    @Override
    public String getVersion() {
      return "$Revision: 1229782 $";
    }    
  }
}
