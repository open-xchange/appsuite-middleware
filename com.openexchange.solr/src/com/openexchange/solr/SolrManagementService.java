...
public interface SolrManagementService {
     ...
     */
    void createAndStartCore(String coreName, String instanceDir, String dataDir, String schemaPath, String configPath) throws OXException;
     ...
     * @param coreName The cores name.
     */
    void shutdownCore(String coreName);
