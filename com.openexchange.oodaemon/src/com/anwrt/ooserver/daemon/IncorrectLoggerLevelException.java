...
/**
 * The string that seems to represent a level is not a valid level (syntax error, try buying glasses or putting 'INFO', 'DEBUG', ...) <br>
 * creation : 28 août 07
 *
...
public class IncorrectLoggerLevelException extends Exception {
    ...
    public IncorrectLoggerLevelException(final String lvl) {
