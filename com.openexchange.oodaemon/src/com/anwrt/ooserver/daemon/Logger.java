...
/**
 * Static class.<br>
 * The logger is used by calling Logger's static methods such as info, debug, etc...<br>
 * <br>
...
public abstract class Logger {
     ...
     */
    public static void newInstance(final Logger instance) {
        _instance = instance;
    }
     ...
     */
    public static void setLevel(final int lvl) throws IncorrectLoggerLevelException {
     ...
     * @throws IncorrectLoggerLevelException level passed as an argument is not valid
     */
    public static void setLevel(final String lvlStr) throws IncorrectLoggerLevelException {
        final String lvl = lvlStr.toUpperCase();
        if (lvl.equals("NONE")) {
            level = NONE;
    ...
    public static void debug(final String msg, final Exception ex) {
        if (getInstance() == null) {
            return;
        }
        if (level >= DEBUG) {
    ...
    public static void detailedDebug(final Exception ex) {
        if (getInstance() == null) {
            return;
        }
    ...
    public static void fatalError(final String msg, final Exception ex) {
        if (getInstance() == null) {
            return;
        }
        if (level >= ERROR) {
     ...
     *
     * @param prefixTabs optional tabs that will be written before displaying a line for indentation
