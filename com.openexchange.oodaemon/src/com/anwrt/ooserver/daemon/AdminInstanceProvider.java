...
/**
 * Used to execute admin actions and to return anything that the asker might want (status for example) <br>
 * creation : 23 août 07
 *
...
public class AdminInstanceProvider extends ComponentBase implements XInstanceProvider {
    ...
    public AdminInstanceProvider(final Daemon daemon, final Timer shutdownTask) {
