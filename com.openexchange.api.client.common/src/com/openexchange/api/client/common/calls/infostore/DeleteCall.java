...
public class DeleteCall extends AbstractPutCall<Void> {
    ...
    private final List<DeleteTuple> filesToDelete;
    private final long timestamp;
    private final Boolean hardDelete;
    private final String pushToken;

    public static class DeleteTuple {

        private final String id;
        private final String folderId;

        public DeleteTuple(String folderId, String id) {
     ...
     */
    public DeleteCall(DeleteTuple fileToDelete, long timestamp) {
     ...
     * @param timestamp The last known timestamp
     */
    public DeleteCall(List<DeleteTuple> filesToDelete, long timestamp) {
     ...
     */
    public DeleteCall(DeleteTuple fileToDelete, long timestamp, boolean hardDelete, String pushToken) {
     ...
     * @param hardDelete True in order to delete the document, false to move it into the trash bin
     */
    public DeleteCall(List<DeleteTuple> filesToDelete, long timestamp, boolean hardDelete) {
     ...
     * @param pushToken The push token
     */
    public DeleteCall(List<DeleteTuple> filesToDelete, long timestamp, Boolean hardDelete, String pushToken) {
    ...
    public HttpEntity getBody() throws OXException {
        try {
            ...
            for (DeleteTuple fileToDelete : filesToDelete) {
                JSONObject json = new JSONObject();
                json.put("id", fileToDelete.id);
                json.put("folder", fileToDelete.folderId);
                array.put(json);
            }
    ...
    protected void fillParameters(Map<String, String> parameters) {
        ...
        if (hardDelete != null) {
            parameters.put("hardDelete", String.valueOf(hardDelete));
        }
