...
public class OAuth {
    ...
    public static void main(String[] args) throws DropboxException, IOException {
        ...
        System.err.println("Token key.....: " + tokenKey);
        System.err.println("Token secret..: " + tokenSecret);

        // Re-authorise with the user specific token pair to gain access
        DropboxAPI<WebAuthSession> newDropboxAPI = getAPI(apiKey, apiSecret, AccessType.APP_FOLDER);
        AccessTokenPair accessTokenPair = new AccessTokenPair(tokenKey, tokenSecret);
     ...
     */
    private static DropboxAPI<WebAuthSession> getAPI(String key, String secret, AccessType accessType) {
