...
public abstract class AbstractCarddavCollection extends AbstractCollection {
    ...
    private static final Log LOG = LogFactory.getLog(AbstractCarddavCollection.class);

    protected GroupwareCarddavFactory factory;

    protected WebdavPath url;

    public AbstractCarddavCollection(GroupwareCarddavFactory factory, WebdavPath url) {
        super();
