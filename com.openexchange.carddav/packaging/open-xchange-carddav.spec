...
Name:           open-xchange-carddav
BuildArch:	noarch
#!BuildIgnore: post-build-checks
BuildRequires:  ant open-xchange-common >= @OXVERSION@ open-xchange-global >= @OXVERSION@ open-xchange-server >= @OXVERSION@ open-xchange-calendar >= @OXVERSION@ open-xchange-config-cascade >= @OXVERSION@ open-xchange-webdav-acl >= @OXVERSION@ open-xchange-webdav-directory >= @OXVERSION@ open-xchange-xml >= @OXVERSION@   
...
%description
The Open-Xchange Carddav interface
