...
/**
 * {@link SMSMessagingExceptionCodes} - Enumeration of all {@link OXException}s.
 *
...
public enum SMSMessagingExceptionCodes implements OXExceptionCode {
     ...
     */
    UNEXPECTED_ERROR(SMSMessagingExceptionMessages.UNEXPECTED_ERROR_MSG, CATEGORY_ERROR, 1),

    ;

    private static final String PREFIX = "SMS-MSG";
