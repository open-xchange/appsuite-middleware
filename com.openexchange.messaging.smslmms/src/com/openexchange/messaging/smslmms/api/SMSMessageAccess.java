...
/**
 * {@link SMSMessageAccess} - The access to SMS/MMS messages.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public interface SMSMessageAccess {
     ...
     */
    public SMSMessage getSMSMessage(String folder, String id, boolean peek) throws OXException;
     ...
     */
    public List<SMSMessage> getSMSMessages(String folder, String[] messageIds, MessagingField[] fields) throws OXException;
     ...
     */
    public List<SMSMessage> searchSMSMessages(String folder, IndexRange indexRange, MessagingField sortField, OrderDirection order, SearchTerm<?> searchTerm, MessagingField[] fields) throws OXException;
     ...
     */
    public void updateSMSMessage(SMSMessage message, MessagingField[] fields) throws OXException;
     ...
     */
    public void appendSMSMessages(String folder, SMSMessage[] messages) throws OXException;
     ...
     */
    public List<SMSMessage> getAllSMSMessages(String folder, IndexRange indexRange, MessagingField sortField, OrderDirection order, MessagingField... fields) throws OXException;
     ...
     */
    public SMSMessage smsPerform(String folder, String id, String action) throws OXException;
     ...
     * @throws OXException If performing specified action fails or action is not applicable for this perform() method
     */
    public SMSMessage smsPerform(String action) throws OXException;
     ...
     * @throws OXException If performing specified action fails or action is not applicable for this perform() method
     */
    public SMSMessage smsPerform(SMSMessage message, String action) throws OXException;
