...
public final class EmptySMSFolderAccess implements MessagingFolderAccess {
    ...
    /**
     * Initializes a new {@link EmptySMSFolderAccess}.
     */
    public EmptySMSFolderAccess(final int accountId, final Session session) {
        super();
     ...
     * Initializes a new {@link EmptySMSFolderAccess}.
     */
    public EmptySMSFolderAccess(final int accountId, final int userId, final int context) {
        super();
        this.accountId = accountId;
        this.userId = userId;
