...
public class GetPictureAction extends AbstractGetPictureAction {
    ...
    <V> V getPictureResource(AJAXRequestData req, ServerSession session, boolean eTagOnly) throws OXException {
        ...
        PictureSearchData data = new PictureSearchData(I(contact.getInternalUserId()), accountId, Integer.toString(contact.getParentFolderID()), Integer.toString(contact.getObjectID()), emails);
        try {
            if (eTagOnly) {
