...
public final class DropboxEventHandler implements EventHandler {
     ...
     * The logger constant.
     */
    private static final org.apache.commons.logging.Log LOG = com.openexchange.log.Log.valueOf(com.openexchange.log.LogFactory.getLog(DropboxEventHandler.class));
    ...
    public void handleEvent(final Event event) {
        ...
        try {
            if (SessiondEventConstants.TOPIC_REMOVE_SESSION.equals(topic)) {
                ...
                if (DropboxOAuthAccessRegistry.getInstance().removeSessionIfLast(session.getContextId(), session.getUserId()) && DEBUG) {
