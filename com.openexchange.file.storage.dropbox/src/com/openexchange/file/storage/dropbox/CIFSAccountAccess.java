...
public final class CIFSAccountAccess implements FileStorageAccountAccess {
    ...
    public CIFSAccountAccess(final FileStorageService service, final FileStorageAccount account, final Session session) {
        ...
        username = (String) configuration.get(DropboxConstants.DROPBOX_LOGIN);
        password = (String) configuration.get(DropboxConstants.DROPBOX_PASSWORD);
        this.service = service;
    }

    /**
     * Gets the name of the Dropbox user.
     *
     * @return The name of the Dropbox user
     */
