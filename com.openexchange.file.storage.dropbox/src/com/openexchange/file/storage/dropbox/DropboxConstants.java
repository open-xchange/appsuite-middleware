...
public final class DropboxConstants implements FileStorageConstants {
     ...
     */
    public static final String DROPBOX_LOGIN = CONF_PROPERTY_LOGIN;

    /**
     * The configuration property name for password.
     */
    public static final String DROPBOX_PASSWORD = CONF_PROPERTY_PASSWORD;

    /**
     * The configuration property name for domain.
     */
    public static final String DROPBOX_DOMAIN = "domain";

    /**
     * The configuration property name for URL to Dropbox server.
     */
    public static final String DROPBOX_URL = "url";

    /**
     * The configuration property name for timeout for Dropbox server.
     */
    public static final String DROPBOX_TIMEOUT = "timeout";

    /**
     * The configuration property name for a user's Dropbox home directory.
     */
    public static final String DROPBOX_HOME_DIR = "homedir";
