...
import com.openexchange.file.storage.dropbox.auth.TrustedWebAuthSession;
    ...
    public void initialize() throws OXException {
        synchronized (this) {
            try {
                ...
                WebAuthSession webAuthSession = new TrustedWebAuthSession(appKeys, AccessType.DROPBOX);
