...
public class AppointmentNotificationPool implements AppointmentNotificationPoolService, Runnable {
    ...
    private static final class Update {
        ...
        public ITipEventUpdate getDiff() throws OXException {
            if (diff == null) {
                diff = new ITipEventUpdate(new EventUpdateImpl(oldAppointment, newAppointment, false, NotificationMailGenerator.DEFAULT_SKIP));
            }
            return diff;
        }
    ...
    private final class QueueItem {
        ...
        public HandlingSuggestion tick(boolean force) throws OXException {
            ...
            ITipEventUpdate overallDiff = new ITipEventUpdate(new EventUpdateImpl(original, mostRecent, false, NotificationMailGenerator.DEFAULT_SKIP));
        ...
        private boolean isAlreadyInformed(NotificationParticipant participant, Event mostRecent, int contextId) throws OXException {
            ...
            if (alreadySent != null) {
                ITipEventUpdate diff = new ITipEventUpdate(new EventUpdateImpl(alreadySent, mostRecent, false, (EventField[]) null));
