...
import com.openexchange.admin.lib.console.user.ExistsCore;
...
public class Exists extends ExistsCore {
    ...
    @Override
    protected boolean maincall(AdminParser parser, OXUserInterface oxusr, Context ctx, User usr, Credentials auth) throws RemoteException, InvalidDataException, InvalidCredentialsException, StorageException, DatabaseUpdateException, NoSuchContextException {
        return oxusr.exists(ctx, usr, auth);
    }
