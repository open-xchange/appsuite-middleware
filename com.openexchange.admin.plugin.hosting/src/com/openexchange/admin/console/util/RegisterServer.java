...
public class RegisterServer extends UtilAbstraction {
    ...
    public RegisterServer(final String[] args2) {
        ...
        AdminParser parser = new AdminParser("registerServer");
        ...
        try {
           ...
           final Credentials auth = new Credentials((String)parser.getOptionValue(adminUserOption),(String)parser.getOptionValue(adminPassOption));
            ...
            srv.setName((String)parser.getOptionValue(serverNameOption));            
    ...
    private void setOptions(AdminParser parser) {
        ...
        serverNameOption = setShortLongOpt(parser, OPT_NAME_HOSTNAME_SHORT,OPT_NAME_HOSTNAME_LONG, "The hostname of the server",true, true);
