...
public class UnregisterServer extends UtilAbstraction {
    ...
    private final static String OPT_NAME_SERVER_ID_SHORT = "i";
    ...
    public UnregisterServer(final String[] args2) {
        ...
        try {
            ...
            final String server_id = cmd.getOptionValue(OPT_NAME_SERVER_ID_SHORT);

            oxutil.unregisterServer(Integer.parseInt(server_id), auth);
    ...
    private Options getOptions() {
        ...
        retval.addOption(addDefaultArgName(getShortLongOpt(OPT_NAME_SERVER_ID_SHORT, OPT_NAME_SERVER_ID_LONG, "the id of the filestore which should be deleted", true, true)));
        return retval;
    }
