...
public interface SchemaCache {
     ...
     * @param maxContexts The configured max. number of contexts per schema
     * @param pool The pool
     * @return The schema name according to cache's state
     * @throws StorageException If next schema cannot be returned
     */
    String getNextSchemaFor(int poolId, Connection configCon, int maxContexts, OXAdminPoolInterface pool) throws StorageException;

    /**
     * Clears the cache for given write pool to force (re-)initialization on next {@link #getNextSchemaFor(int)} invocation.
     *
     * @param poolId The identifier of the database pool
