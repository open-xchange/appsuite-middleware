...
public class StatisticTools  {
    ...
    /**
     * This method is called after a hostname change and input parsing,
     * because the url depends on both steps
     */
    ...
    private void initConnection() throws Exception {
        JMXServiceURL u = new JMXServiceURL(ox_jmx_url);
...
//        c = JMXConnectorFactory.connect(u,h);
    ...
    private void showStats(Set data_set,String class_name)
    throws IOException, InstanceNotFoundException, MBeanException, AttributeNotFoundException, ReflectionException, IntrospectionException {
