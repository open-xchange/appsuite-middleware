...
public class ContactObjectTest extends CommonObjectTest {
    ...
    public void testFindDifferingFields() {
        ...
        Contact otherDataObject = getContact();

        otherDataObject.setURL("Blupp");
        assertDifferences(dataObject, otherDataObject, Contact.URL);

        otherDataObject.setAnniversary(new Date(23));
        assertDifferences(dataObject, otherDataObject, Contact.URL, Contact.ANNIVERSARY);

        otherDataObject.setAssistantName("Blupp");
        assertDifferences(dataObject, otherDataObject, Contact.URL, Contact.ANNIVERSARY, Contact.ASSISTANT_NAME);
