 ...
 */
public class Yearly1UntilTest extends UntilTest {

    public void testWithout() throws Exception {
        withoutTest(Appointment.YEARLY, false);
    }

    public void testWithOccurrences() throws Exception {
        withOccurrencesTest(Appointment.YEARLY, false);
    }

    public void testWithUntil() throws Exception {
        withUntilTest(Appointment.YEARLY, false);
    }

    public void testFTWithout() throws Exception {
        withoutTest(Appointment.YEARLY, true);
    }

    public void testFTWithOccurrences() throws Exception {
        withOccurrencesTest(Appointment.YEARLY, true);
    }

    public void testFTWithUntil() throws Exception {
        withUntilTest(Appointment.YEARLY, true);
    }
}
