 ...
 */
public class Monthly1UntilTest extends UntilTest {

    public void testWithout() throws Exception {
        withoutTest(Appointment.MONTHLY, false);
    }

    public void testWithOccurrences() throws Exception {
        withOccurrencesTest(Appointment.MONTHLY, false);
    }

    public void testWithUntil() throws Exception {
        withUntilTest(Appointment.MONTHLY, false);
    }

    public void testFTWithout() throws Exception {
        withoutTest(Appointment.MONTHLY, true);
    }

    public void testFTWithOccurrences() throws Exception {
        withOccurrencesTest(Appointment.MONTHLY, true);
    }

    public void testFTWithUntil() throws Exception {
        withUntilTest(Appointment.MONTHLY, true);
    }
