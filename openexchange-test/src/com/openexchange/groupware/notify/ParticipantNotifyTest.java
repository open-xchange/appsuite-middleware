...
public class ParticipantNotifyTest extends TestCase{
	...
	public void testNoSend() throws Exception{
		...
		if (Locale.getDefault().getLanguage().equalsIgnoreCase("de")) {
			...
			assertNames(enAddresses, "user2@test.invalid", "user4@test.invalid", "user6@test.invalid", "user8@test.invalid","user9@test.invalid");
			assertNames(deAddresses, "mailadmin@test.invalid", "user1@test.invalid","user7@test.invalid", "user3@test.invalid");	
		}
	}
