...
@RunWith(Suite.class)
@Suite.SuiteClasses({
    com.openexchange.ajax.AJAXFileUploadTest.class,
    com.openexchange.ajax.ConfigJumpTest.class,
    com.openexchange.ajax.MailTest.class,
    com.openexchange.ajax.TestFolder.class,
    com.openexchange.ajax.appointment.ResolveUidTest.class,
    ...
    com.openexchange.test.osgi.BundleTestAuthentication.class,
    com.openexchange.test.osgi.BundleTestCache.class,
    com.openexchange.test.osgi.BundleTestConfigJump.class,
    com.openexchange.test.osgi.BundleTestConfiguration.class,
    com.openexchange.test.osgi.BundleTestEventAdmin.class,
    com.openexchange.test.osgi.BundleTestIMAP.class,
    com.openexchange.test.osgi.BundleTestSMTP.class,
    com.openexchange.test.osgi.BundleTestSessionD.class,
    com.openexchange.webdav.FreeBusyTest.class,
    com.openexchange.webdav.ICalTest.class,
    com.openexchange.webdav.TestUpload2.class,
    com.openexchange.webdav.client.EmptyLockTest.class,
