...
//    public InputStream getDocument(CommonObject co, int mid, String ct, int fid, int aid, int off, int len, boolean foe) throws OXException, IOException, JSONException {
//        com.openexchange.ajax.attach.actions.GetDocumentRequest request = new com.openexchange.ajax.attach.actions.GetDocumentRequest(co, mid, ct, fid, aid, off, len, foe);
