...
import com.openexchange.ajax.kata.appointments.AppointmentMoveStep;
import com.openexchange.fitnesse.AbstractStepFixture;
import com.openexchange.fitnesse.wrappers.FixtureDataWrapper;

/**
 * {@link MoveAppointment}
 * 
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 */
public class MoveAppointment extends AbstractStepFixture {
    ...
    protected Step createStep(FixtureDataWrapper data) throws Exception {
        ...
        return new AppointmentMoveStep(folder, data.getFixtureName(), data.getExpectedError());
    }
