...
import com.openexchange.ajax.kata.tasks.TaskMoveStep;
 ...
 *
 */
public class MoveTask extends AbstractStepFixture {
    ...
    protected Step createStep(FixtureDataWrapper data) throws Exception {
        ...
        return new TaskMoveStep(folder, data.getFixtureName(), data.getExpectedError());
    }
