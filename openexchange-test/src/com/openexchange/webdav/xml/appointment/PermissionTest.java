...
public class PermissionTest extends AppointmentTest {
    ...
    public void testInsertAppointmentInPrivateFolderWithoutPermission() throws Exception {
        ...
        try {
            insertAppointment(getSecondWebConversation(), appointmentObj, getHostURI(), getSecondLogin(), getPassword(), context);
    ...
    public void testUpdateAppointmentInPrivateFolderWithoutPermission() throws Exception {
        ...
        try {
            updateAppointment(getSecondWebConversation(), appointmentObj, appointmentObjectId, parentFolderId, getHostURI(), getSecondLogin(), getPassword(), context);
            fail("permission exception expected!");
        } catch (final OXException exc) {
            assertExceptionMessage(exc.getMessage(), XmlServlet.PERMISSION_STATUS);
        }
    ...
    public void testDeleteAppointmentInPrivateFolderWithoutPermission() throws Exception {
        ...
        try {
            deleteAppointment(getSecondWebConversation(), appointmentObjectId, parentFolderId, getHostURI(), getSecondLogin(), getPassword(), context);
            fail("permission exception expected!");
        } catch (final OXException exc) {
            assertExceptionMessage(exc.getMessage(), XmlServlet.PERMISSION_STATUS);
        }
