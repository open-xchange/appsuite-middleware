...
public class Bug8123Test extends AppointmentTest {
    ...
    public void testBug8123() throws Exception {
        final Resource[] resource = GroupUserTest.searchResource(getWebConversation(), "*", new Date(0), getHostURI(), getLogin(), getPassword(), context);
        ...
        loadAppointment = loadAppointment(getWebConversation(), objectId, appointmentFolderId, modified, getHostURI(), getLogin(), getPassword(), context);
        compareObject(appointmentObj, loadAppointment);
