...
public class ConfirmTest extends AppointmentTest {
    ...
    public void testConfirm() throws Exception {
        ...
        confirmAppointment(getSecondWebConversation(), objectId, Appointment.ACCEPT, null, getHostURI(), getSecondLogin(), getPassword(), context);
        ...
        deleteAppointment(getWebConversation(), new int[][] { { objectId, appointmentFolderId } }, getHostURI(), getLogin(), getPassword(), context);
    }
}
