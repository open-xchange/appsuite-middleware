...
public class NewTest extends AppointmentTest {
    ...
    public void testNewAppointmentWithParticipants() throws Exception {
        ...
        final Group[] groupArray = GroupUserTest.searchGroup(getWebConversation(), groupParticipant, new Date(0), getHostURI(), getLogin(), getPassword(), context);
    ...
    public void testNewAppointmentWithUsers() throws Exception {
        ...
        final int userParticipantId = GroupUserTest.getUserId(getSecondWebConversation(), getHostURI(), getSecondLogin(), getPassword(), context);
    ...
    public void testNewAppointmentWithExternalUserParticipants() throws Exception {
        ...
        final int userParticipantId = GroupUserTest.getUserId(getWebConversation(), getHostURI(), getLogin(), getPassword(), context);
        assertTrue("user participant not found", userParticipantId != -1);
    ...
    public void testDailyRecurrenceWithDeletingFirstOccurrence() throws Exception {
        ...
        deleteAppointment(getWebConversation(), objectId, appointmentFolderId, modified, recurrenceDatePosition, getHostURI(), getLogin(), getPassword(), context);
        appointmentObj.setDeleteExceptions(new Date[] { recurrenceDatePosition });

        // prevent master/slave problem
        Thread.sleep(1000);

        loadAppointment = loadAppointment(getWebConversation(), objectId, appointmentFolderId, getHostURI(), getLogin(), getPassword(), context);
        compareObject(appointmentObj, loadAppointment);
    ...
    public void testAppointmentWithAttachment() throws Exception {
        ...
        AttachmentTest.insertAttachment(webCon, attachmentMeta, byteArrayInputStream, getHostURI(), getLogin(), getPassword(), context);
        ...
        final Appointment[] appointmentArray = listAppointment(getWebConversation(), appointmentFolderId, decrementDate(loadAppointment.getLastModified()), true, false, getHostURI(), getLogin(), getPassword(), context);
