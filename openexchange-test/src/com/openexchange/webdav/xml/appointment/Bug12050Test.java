...
public class Bug12050Test extends AppointmentTest {
    ...
    private void createException() throws Exception {
        ...
        int exceptionId = updateAppointment(getWebConversation(), exception, objectId, appointmentFolderId, getHostURI(), getLogin(), getPassword(), context);
    ...
    private void updateException() throws Exception {
        ...
        try {
            updateAppointment(getWebConversation(), exceptionUpdate, exception.getObjectID(), appointmentFolderId, getHostURI(), getLogin(), getPassword(), context);
        } catch (OXException e) {
            fail(e.getMessage());
        }
    }
