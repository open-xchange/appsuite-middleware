...
public class DeleteTest extends AppointmentTest {
    ...
    public void testDeleteConcurentConflict() throws Exception {
        ...
        try {
            deleteAppointment(webCon, objectId, appointmentFolderId, new Date(0), getHostURI(), login, password, context);
        ...
        deleteAppointment(webCon, objectId, appointmentFolderId, getHostURI(), login, password, context);
    }
    ...
    public void testDeleteNotFound() throws Exception {
        ...
        try {
            deleteAppointment(webCon, (objectId + 1000), appointmentFolderId, getHostURI(), login, password, context);
    ...
    public void testDeleteRecurrenceWithDatePosition() throws Exception {
        ...
        Appointment loadAppointment = loadAppointment(webCon, objectId, appointmentFolderId, getHostURI(), login, password, context);
        compareObject(appointmentObj, loadAppointment);

        final Date modified = loadAppointment.getLastModified();

        deleteAppointment(webCon, objectId, appointmentFolderId, modified, new Date(c.getTimeInMillis() + changeExceptionPosition * dayInMillis), getHostURI(), getLogin(), getPassword(), context);
        ...
        deleteAppointment(webCon, new int[][] { { objectId, appointmentFolderId } }, getHostURI(), login, password, context);
    }
    ...
    public void testDeleteRecurrenceWithDeleteExceptions() throws Exception {
        ...
        loadAppointment = loadAppointment(webCon, objectId, appointmentFolderId, decrementDate(modified), getHostURI(), login, password, context);
        compareObject(appointmentObj, loadAppointment);
