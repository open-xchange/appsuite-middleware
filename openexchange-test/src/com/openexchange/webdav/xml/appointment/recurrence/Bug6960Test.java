...
public class Bug6960Test extends AbstractRecurrenceTest {
    ...
    public void testBug6960() throws Exception {
        ...
        final Appointment loadAppointment = loadAppointment(getWebConversation(), exceptionObjectId, appointmentFolderId, getHostURI(), getLogin(), getPassword(), context);
        final Date modified = loadAppointment.getLastModified();

        deleteAppointment(getWebConversation(), exceptionObjectId, appointmentFolderId, recurrenceDatePosition, getHostURI(), getLogin(), getPassword(), context);

        final Appointment[] appointmentArray = listAppointment(getWebConversation(), appointmentFolderId, modified, true, true, getHostURI(), getLogin(), getPassword(), context);
        boolean found = false;
