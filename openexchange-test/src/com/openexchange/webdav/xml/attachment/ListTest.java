...
public class ListTest extends AttachmentTest {
    ...
    public void testLoadAttachment() throws Exception {
        ...
        final int objectId = ContactTest.insertContact(webCon, contactObj, getHostURI(), login, password, context);
        ...
        final InputStream is = loadAttachment(webCon, attachmentObj, getHostURI(), getLogin(), getPassword(), context);
