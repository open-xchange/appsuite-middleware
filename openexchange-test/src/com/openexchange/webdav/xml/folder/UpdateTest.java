...
public class UpdateTest extends FolderTest {
    ...
    public void testMoveFolder() throws Exception {
        ...
        final int parentFolderId = insertFolder(webCon, folderObj, PROTOCOL + hostName, login, password);
    ...
    public void testChangePermissionsOfPrivateFolder() throws Exception {
        final int userParticipantId = GroupUserTest.searchUser(webCon, userParticipant2, new Date(0), PROTOCOL + hostName, login, password)[0].getInternalUserId();
        final int groupParticipantId = GroupUserTest.searchGroup(webCon, groupParticipant, new Date(0), PROTOCOL + hostName, login, password)[0].getIdentifier();
