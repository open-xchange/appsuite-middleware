...
public class UpdateTest extends FolderTest {
    ...
    public void testRenameFolder() throws Throwable {
        ...
        int objectId = insertFolder(webCon, folderObj, getHostURI(), login, password);
        ...
        updateFolder(webCon, folderObj, getHostURI(), login, password);

        FolderObject loadFolder = loadFolder(webCon, objectId, getHostURI(), login, password);
    ...
    public void testMoveFolder() throws Exception {
        ...
        final int parentFolderId = insertFolder(webCon, folderObj, getHostURI(), login, password);
    ...
    public void testChangePermissionsOfPrivateFolder() throws Exception {
        final int userParticipantId = GroupUserTest.searchUser(webCon, userParticipant2, new Date(0), getHostURI(), login, password)[0].getInternalUserId();
        final int groupParticipantId = GroupUserTest.searchGroup(webCon, groupParticipant, new Date(0), getHostURI(), login, password)[0].getIdentifier();
