...
public class NewTest extends TaskTest {
    ...
    public void testNewTaskWithParticipants() throws Exception {
        ...
        final int userParticipantId2 = GroupUserTest.getUserId(getWebConversation(), getHostURI(), userParticipant2, getPassword(), context);
        assertTrue("user participant not found", userParticipantId2 != -1);
        final int userParticipantId3 = GroupUserTest.getUserId(getWebConversation(), getHostURI(), userParticipant3, getPassword(), context);
    ...
    public void testNewTaskWithAlarm() throws Exception {
        ...
        deleteTask(getWebConversation(), objectIdAndFolderId, getHostURI(), getLogin(), getPassword(), context);
    }
    ...
    public void testNewTaskWithUsers() throws Exception {
        ...
        final int userParticipantId = GroupUserTest.getUserId(getWebConversation(), getHostURI(), userParticipant2, getPassword(), context);
    ...
    public void testTaskWithPrivateFlagInPublicFolder() throws Exception {
        ...
        try {
            ...
            deleteTask(getWebConversation(), objectId, parentFolderId, getHostURI(), getLogin(), getPassword(), context);
    ...
    public void testBulkAdd() throws Exception {
        ...
        try {
            ...
            objectIds = insertTasks(webCon, getHostURI(), login, password, context, tasks);

            int i = 0;

            for (final int objectId : objectIds) {
                final Task task = loadTask(getWebConversation(), objectId, tasks[i].getParentFolderID(), getHostURI(), getLogin(), getPassword(), context);
            ...
            if (null != objectIds) {
                ...
                try {
                    for (final int objectId : objectIds) {
                        deleteTask(getWebConversation(), objectId, tasks[i].getParentFolderID(), getHostURI(), getLogin(), getPassword(), context);
                        i++;
                    }
