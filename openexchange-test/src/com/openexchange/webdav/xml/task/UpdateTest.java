...
public class UpdateTest extends TaskTest {
    ...
    public void testUpdateConcurentConflict() throws Exception {
        ...
        try {
            updateTask(webCon, taskObj, objectId, taskFolderId, new Date(0), getHostURI(), login, password, context);
    ...
    public void testUpdateNotFound() throws Exception {
        ...
        try {
            updateTask(webCon, taskObj, (objectId + 1000), taskFolderId, new Date(0), getHostURI(), login, password, context);
