...
public class DeleteTest extends TaskTest {
    ...
    public void testDelete() throws Exception {
        ...
        final int objectId1 = insertTask(webCon, taskObj, getHostURI(), login, password, context);
        final int objectId2 = insertTask(webCon, taskObj, getHostURI(), login, password, context);

        final int[][] objectIdAndFolderId = { { objectId1, taskFolderId }, { objectId2, taskFolderId } };

        deleteTask(webCon, objectIdAndFolderId, getHostURI(), login, password, context);
    }
    ...
    public void testDeleteConcurentConflict() throws Exception {
        ...
        final int objectId = insertTask(webCon, appointmentObj, getHostURI(), login, password, context);

        try {
            deleteTask(webCon, objectId, taskFolderId, new Date(0), getHostURI(), login, password, context);
        ...
        deleteTask(webCon, objectId, taskFolderId, getHostURI(), login, password, context);
    }
    ...
    public void testDeleteNotFound() throws Exception {
        ...
        try {
            deleteTask(webCon, (objectId + 1000), taskFolderId, getHostURI(), login, password, context);
