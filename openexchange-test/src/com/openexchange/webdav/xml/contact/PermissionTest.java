...
public class PermissionTest extends ContactTest {
    ...
    public void testInsertContactInPrivateFolderWithoutPermission() throws Exception {
        ...
        try {
            insertContact(getSecondWebConversation(), contactObj, getHostURI(), getSecondLogin(), getPassword(), context);
    ...
    public void testUpdateContactInPrivateFolderWithoutPermission() throws Exception {
        ...
        final int contactObjectId = insertContact(getWebConversation(), contactObj, getHostURI(), getLogin(), getPassword(), context);
        contactObj.setObjectID(contactObjectId);

        try {
            updateContact(getSecondWebConversation(), contactObj, contactObjectId, parentFolderId, getHostURI(), getSecondLogin(), getPassword(), context);
            fail("permission exception expected!");
        } catch (final OXException exc) {
            assertExceptionMessage(exc.getMessage(), XmlServlet.PERMISSION_STATUS);
        }
    ...
    public void testDeleteContactInPrivateFolderWithoutPermission() throws Exception {
        ...
        try {
            deleteContact(getSecondWebConversation(), contactObjectId, parentFolderId, getHostURI(), getSecondLogin(), getPassword(), context);
            fail("permission exception expected!");
        } catch (final OXException exc) {
            assertExceptionMessage(exc.getMessage(), XmlServlet.PERMISSION_STATUS);
        }
