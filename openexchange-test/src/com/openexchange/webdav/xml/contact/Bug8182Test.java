...
public class Bug8182Test extends ContactTest {
    ...
    public void testBug8182() throws Throwable {
        ...
        deleteContact(getWebConversation(), objectId, contactFolderId, modified, getHostURI(), getLogin(), getPassword(), context);
        // prevent master/slave problem
        Thread.sleep(1000);
        final Contact[] contactArray = listContact(webCon, contactFolderId, modified, true, false, getHostURI(), login, password, context);
        boolean found = true;
