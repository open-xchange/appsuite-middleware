...
public class DeleteTest extends ContactTest {
    ...
    public void testDelete() throws Exception {
        ...
        final int objectId1 = insertContact(webCon, contactObj, getHostURI(), login, password, context);
        final int objectId2 = insertContact(webCon, contactObj, getHostURI(), login, password, context);
    ...
    public void testDeleteConcurentConflict() throws Exception {
        ...
        try {
            deleteContact(webCon, objectId, contactFolderId, new Date(1), getHostURI(), login, password, context);
        ...
        deleteContact(webCon, objectId, contactFolderId, getHostURI(), login, password, context);
    }
    ...
    public void testDeleteNotFound() throws Exception {
        ...
        try {
            deleteContact(webCon, (objectId + 1000), contactFolderId, getHostURI(), login, password, context);
