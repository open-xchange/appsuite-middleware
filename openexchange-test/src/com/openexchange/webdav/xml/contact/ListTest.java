...
public class ListTest extends ContactTest {
    ...
    public void testPropFindWithModified() throws Exception {
        ...
        final Contact loadContact = loadContact(getWebConversation(), objectId1, contactFolderId, getHostURI(), getLogin(), getPassword(), context);
        final Date modified = loadContact.getLastModified();

        final Contact[] contactArray = listContact(webCon, contactFolderId, decrementDate(modified), true, false, getHostURI(), login, password, context);

        assertTrue("check response", contactArray.length >= 2);
        deleteContact(getWebConversation(), objectId1, contactFolderId, getHostURI(), getLogin(), getPassword(), context);
        deleteContact(getWebConversation(), objectId2, contactFolderId, getHostURI(), getLogin(), getPassword(), context);
    }
    ...
    public void testPropFindWithDelete() throws Exception {
        ...
        final Contact[] appointmentArray = listContact(webCon, contactFolderId, decrementDate(modified), false, true, getHostURI(), login, password, context);
    ...
    public void testPropFindWithObjectId() throws Exception {
        ...
        final Contact loadContact = loadContact(webCon, objectId, contactFolderId, getHostURI(), login, password, context);
    ...
    public void testObjectNotFound() throws Exception {
        ...
        try {
            loadContact(webCon, (objectId + 1000), contactFolderId, getHostURI(), login, password, context);
    ...
    public void testListWithAllFields() throws Exception {
        ...
        Contact loadContact = loadContact(getWebConversation(), objectId, contactFolderId, getHostURI(), getLogin(), getPassword(), context);
        final Date modified = loadContact.getLastModified();

        final Contact[] appointmentArray = listContact(webCon, contactFolderId, decrementDate(modified), true, false, getHostURI(), login, password, context);
    ...
    public void testList() throws Exception {
        ...
        final int[] idArray = listContact(getWebConversation(), contactFolderId, getHostURI(), getLogin(), getPassword(), context);
