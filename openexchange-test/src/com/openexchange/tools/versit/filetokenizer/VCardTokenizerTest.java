...
public class VCardTokenizerTest extends TestCase {
	...
	public void testVCardRecognition(){
		prepareTest(VCARD21,1,1, new VersitDefinition[]{VCard21.definition}, new String[]{VCARD21});
		prepareTest(VCARD30,1,1, new VersitDefinition[]{VCard.definition}, new String[]{VCARD30});
		
		prepareTest(VCARD21+VCARD30,2,2, new VersitDefinition[]{VCard21.definition,VCard.definition}, new String[]{VCARD21, VCARD30});
	}
	public void testVCalendarRecognition(){
		prepareTest(VCALENDAR10,1,1, new VersitDefinition[]{VCalendar10.definition}, new String[]{VCALENDAR10});
		prepareTest(ICALENDAR,1,1, new VersitDefinition[]{ICalendar.definition}, new String[]{ICALENDAR});
	}
	public void testAll(){
	...
	private void prepareTest(String content, int entriesFound, int entriesRecognized, VersitDefinition[] compDefs, String[] expectedContent){
		VCardTokenizer chunky = new VCardTokenizer(content);
		...
		for(int i = 0; i < l.size(); i++){
			...
			assertEquals("Contains expected content for entry #"+i+"?", expectedContent[i], l.get(i).getContent());
		}
	}
}
