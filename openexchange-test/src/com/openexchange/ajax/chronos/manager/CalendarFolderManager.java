...
public class CalendarFolderManager extends AbstractManager {
    ...
    public void cleanUp() {
        try {
            foldersApi.deleteFolders(userApi.getSession(), folderIds, TREE_ID, null, CALENDAR_MODULE, true, false, false, null);
    ...
    public void deleteFolders(List<String> folders) throws ApiException {
        foldersApi.deleteFolders(userApi.getSession(), folders, TREE_ID, null, CALENDAR_MODULE, true, false, false, null);
