...
public class BasicSelfProtectionTest extends AbstractChronosTest {
    ...
    public void testTooManyEvents() throws Exception {
        ...
        ChronosCalendarResultResponse updateResponse = defaultUserApi.getChronosApi().updateEvent(defaultUserApi.getSession(), folderId, eventData.getId(), L(eventManager.getLastTimeStamp()), getUpdateBody(eventData), null, null, FALSE, FALSE, FALSE, null, null, fromStr, untilStr, TRUE, null);
        ...
        ChronosUpdatesResponse updatesResponse = defaultUserApi.getChronosApi().getUpdates(defaultUserApi.getSession(), folderId, L(timestamp), fromStr, untilStr, null, null, null, TRUE, FALSE);
    ...
    public void testTooManyAttendees() throws Exception {
        ...
        ChronosCalendarResultResponse updateResponse = defaultUserApi.getChronosApi().updateEvent(defaultUserApi.getSession(), folderId, actualEventData.getId(), L(eventManager.getLastTimeStamp()), getUpdateBody(actualEventData), null, null, FALSE, FALSE, FALSE, null, null, null, null, FALSE, null);
        Assert.assertNotNull("Response doesn't contain an error", updateResponse.getError());
        Assert.assertEquals(excpectedErrorCode, updateResponse.getCode());
    }
