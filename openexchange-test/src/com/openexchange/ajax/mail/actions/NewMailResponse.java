...
public class NewMailResponse extends AbstractAJAXResponse {
    ...
    /**
     * Initializes a new {@link NewMailResponse}.
     * 
     * @param response The JSON response object
     */
    public NewMailResponse(final Response response) {
        super(response);
    }

    /**
     * Gets the folder of <code>PUT</code>'ed mail
     * 
     * @return The folder of <code>PUT</code>'ed mail
    ...
    /**
     * Gets the ID of <code>PUT</code>'ed mail
     * 
     * @return The ID of <code>PUT</code>'ed mail
     * @throws JSONException If a JSON error occurs
     */
