...
public final class GetRequest extends AbstractMailRequest {
	 ...
	 * @param mailPath
	 */
	public GetRequest(final String mailPath) {
		this(mailPath, true);
	}
	 ...
	 * @param failOnError
	 */
	public GetRequest(final String mailPath, final boolean failOnError) {
		super();
	...
	public Parameter[] getParameters() {
		return new Parameter[] { new Parameter(AJAXServlet.PARAMETER_ACTION, AJAXServlet.ACTION_GET),
				new Parameter(AJAXServlet.PARAMETER_ID, mailPath) };
	}
