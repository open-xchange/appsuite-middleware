 ...
 */
public class ListRequest extends AbstractMailFilterRequest {
     ...
     * Default constructor.
     */
    public ListRequest(final String servletPath,
        final String[] idArray, final int[] columns) {
        this(servletPath, idArray, columns, true);
    }
