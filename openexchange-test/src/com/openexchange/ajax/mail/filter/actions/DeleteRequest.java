...
public class DeleteRequest extends AbstractMailFilterRequest {
	 ...
	 * Default constructor.
	 */
	public DeleteRequest(final String objectId, final Date lastModified) {
		this(objectId, lastModified, true);
	}

	public DeleteRequest(final String objectId, final Date lastModified, final boolean failOnError) {
		super();
