...
public class UpdateRequest extends AbstractMailFilterRequest {
	 ...
	 */
	public UpdateRequest(final Rule rule, final String forUser, final Date lastModified) {
		this(rule, forUser, lastModified, true);
	}
	 ...
	 *            Rule object with updated attributes.
	 */
	public UpdateRequest(final Rule rule, final String forUser, final Date lastModified, boolean failOnError) {
		super();
		this.rule = rule;
	...
	public Parameter[] getParameters() {
		return new Parameter[] {
				...
				new Parameter(AJAXServlet.PARAMETER_TIMESTAMP, String.valueOf(lastModified
						.getTime())) };
	}
