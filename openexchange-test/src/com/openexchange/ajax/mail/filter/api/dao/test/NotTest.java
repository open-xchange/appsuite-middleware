 ...
 */
public class NotTest extends AbstractTest implements Test<NotTestArgument> {

    /**
     * Initialises a new {@link NotTest}.
     * 
     * @param testCommand
     */
    public NotTest() {
        super(TestCommand.NOT);
    }
     ...
     */
    @Override
    public void setTestArgument(NotTestArgument argument, Object value) {
     ...
     */
    @Override
    public Object getTestArgument(NotTestArgument argument) {
