 ...
 */
public class MoveWriterImpl extends AbstractActionWriterImpl<MoveActionArgument> implements ActionWriter {

    /**
     * Initialises a new {@link MoveWriterImpl}.
     */
    public MoveWriterImpl() {
        super();
    }
    ...
    public JSONObject write(Action<ActionArgument> type, JSONObject jsonObject) throws JSONException {
        return write(type, EnumSet.allOf(MoveActionArgument.class), jsonObject);
    }
}
