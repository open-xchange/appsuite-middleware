 ...
 */
public class KeepWriterImpl extends AbstractActionWriterImpl<KeepActionArgument> implements ActionWriter {
    ...
    public JSONObject write(Action<ActionArgument> type, JSONObject jsonObject) throws JSONException {
        return write(type, EnumSet.allOf(KeepActionArgument.class), jsonObject);
    }
}
