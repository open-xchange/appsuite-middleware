...
/**
 * {@link GetScriptParser}
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public class GetScriptParser extends AbstractAJAXParser<GetScriptResponse> {

    /**
     * Initialises a new {@link GetScriptParser}.
     */
    public GetScriptParser(boolean failOnError) {
        super(failOnError);
    }
    ...
    protected GetScriptResponse createResponse(Response response) throws JSONException {
        ...
        String script = (String) response.getData();
        r.setScript(script);
        return r;
    }
}
