...
public class AnyOfParserImpl implements TestParser {
    ...
    /**
     * Initialises a new {@link AnyOfParserImpl}.
     */
    public AnyOfParserImpl() {
        super();
    }
    ...
    public Test<? extends TestArgument> parse(JSONObject jsonObject) throws JSONException {
        ...
        Test<AnyOfTestArgument> test = new AnyOfTest();
        test.setTestArgument(AnyOfTestArgument.tests, tests);
        return test;
    }
}
