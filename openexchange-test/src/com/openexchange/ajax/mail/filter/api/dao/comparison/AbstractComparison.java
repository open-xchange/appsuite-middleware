 ...
 */
abstract class AbstractComparison extends AbstractMailFilterDataObject<ComparisonArgument> {
    ...
    public AbstractComparison(MatchType matchType) {
        super();
        addArgument(CommonComparisonArgument.comparison, matchType.name());
    }
}
