...
public class Bug14234Test extends AbstractMailTest {
    ...
    private static final String EML_WITH_REFERENCES =
        "Date: Mon, 10 Oct 2011 09:54:17 +0200 (CEST)\n" + 
        "From: #ADDR#\n" + 
        "Reply-To: #ADDR#\n" + 
        "To: #ADDR#\n" + 
    ...
    public void testTransportNewRFC822MailWithoutFrom() throws Exception {
        ...
        newMailRequest = new NewMailRequest(null, EML_WITH_REFERENCES.replaceAll("#ADDR#", values.getSendAddress()), -1, true);
        newMailResponse = getClient().execute(newMailRequest);
