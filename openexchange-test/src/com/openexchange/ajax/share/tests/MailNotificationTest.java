...
public class MailNotificationTest extends ShareTest {
    ...
    private final String SIGNATURE_IMAGE = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAL4AAAAoCAYAAABAS0DDAAAABmJLR0QA/wD/AP+gvaeTAAAAC"
...
//    }   
    ...
    private void assertSignatureImage(Document document) {
        assertEquals(SIGNATURE_IMAGE, document.getElementById("signature_image").attr("src"));
    }
