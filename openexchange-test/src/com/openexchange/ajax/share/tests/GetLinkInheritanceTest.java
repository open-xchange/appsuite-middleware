...
public class GetLinkInheritanceTest extends AbstractAPIClientSession {
    ...
    public void setUp() throws Exception {
         ...
         *    - E
         */
        A = folderManager.createFolder(infostoreRoot, "A_" + UUID.randomUUID());
        B = folderManager.createFolder(A, "B_" + UUID.randomUUID());
        C = folderManager.createFolder(B, "C_" + UUID.randomUUID());
        D = folderManager.createFolder(infostoreRoot, "D_" + UUID.randomUUID());
        E = folderManager.createFolder(D, "E_" + UUID.randomUUID());
    ...
    private String findInfostoreRoot() throws ApiException {
        ...
        //        folderManager.createFolder(parent, tree, name);
