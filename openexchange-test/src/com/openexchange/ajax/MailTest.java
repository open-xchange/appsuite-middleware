...
public class MailTest extends AbstractAJAXTest {
    ...
    public static JSONObject sendMail(final WebConversation conversation, final String hostname, final String sessionId, final JSONObject mailObj, final File[] uploadFileAttachments, final boolean setCookie) throws Exception {
        return sendMail(conversation, hostname, sessionId, mailObj.toString(), uploadFileAttachments, setCookie);
    }

    public static JSONObject sendMail(final WebConversation conversation, final String hostname, final String sessionId, final String mailObjStr, final File[] uploadFileAttachments, final boolean setCookie) throws Exception {
    ...
    public static JSONObject forwardMail(final WebConversation conversation, final String hostname, final String sessionId, final JSONObject mailObj, final String msgRef, final File[] uploadFileAttachments) throws Exception {
    ...
    public static JSONObject getForwardMailForDisplay(final WebConversation conversation, final String hostname, final String sessionId, final String mailIdentifier, final boolean addCookie) throws Exception {
    ...
    public static JSONObject deleteMail(final WebConversation conversation, final String hostname, final String sessionId, final String mailIdentifier, final boolean addCookie) throws Exception {
        /*
         * Parameters
         */
        final URLParameter parameter = new URLParameter();
    ...
    public static JSONObject getAllMails(final WebConversation conversation, final String hostname, final String sessionId, final String folder, final int[] cols, final boolean setCookie) throws IOException, SAXException, JSONException {
        return getAllMails(conversation, null, hostname, sessionId, folder, cols, setCookie);
    }

    public static JSONObject getAllMails(final WebConversation conversation, final String protocol, final String hostname, final String sessionId, final String folder, final int[] cols, final boolean setCookie) throws IOException, SAXException, JSONException {
    ...
    public static Response getMail(final WebConversation conversation, final String hostName, final String sessionId, final String mailId) throws IOException, SAXException, JSONException {
        return getMail(conversation, null, hostName, sessionId, mailId);
    }

    public static Response getMail(final WebConversation conversation, final String protocol, final String hostName, final String sessionId, final String mailId) throws IOException, SAXException, JSONException {
        final GetMethodWebRequest getReq = new GetMethodWebRequest(((null == protocol) ? PROTOCOL : (protocol + "://")) + hostName + MAIL_URL);
        getReq.setParameter(Mail.PARAMETER_SESSION, sessionId);
