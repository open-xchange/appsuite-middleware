...
public class ChangeStatusRequest extends AbstractXingRequest<ChangeStatusResponse> {
    ...
    /**
     * Initializes a new {@link ChangeStatusRequest}.
     * 
     * @param foe
     */
     ...
     */
    @Override
    public AbstractAJAXParser<? extends ChangeStatusResponse> getParser() {
        return new ChangeStatusParser(failOnError);
    }
