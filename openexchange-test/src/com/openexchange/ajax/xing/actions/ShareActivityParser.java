...
public class ShareActivityParser extends AbstractAJAXParser<ShareActivityResponse> {
    ...
    /**
     * Initializes a new {@link ShareActivityParser}.
     * 
     * @param failOnError
     */
    protected ShareActivityParser(boolean failOnError) {
        super(failOnError);
    }
     ...
     */
    @Override
    protected ShareActivityResponse createResponse(Response response) throws JSONException {
