...
public class UnlikeActivityRequest extends AbstractXingRequest<UnlikeActivityResponse> {
    ...
    /**
     * Initializes a new {@link UnlikeActivityRequest}.
     * 
     * @param foe
     */
    public UnlikeActivityRequest(final String activityId, boolean foe) {
        super(foe);
     ...
     */
    @Override
    public AbstractAJAXParser<? extends UnlikeActivityResponse> getParser() {
        return new UnlikeActivityParser(failOnError);
    }
