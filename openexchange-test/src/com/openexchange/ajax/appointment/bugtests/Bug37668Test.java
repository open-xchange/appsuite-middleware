...
public class Bug37668Test extends AbstractAJAXSession {
    ...
    public void setUp() throws Exception {
        ...
        fulltime2days.setDayInMonth(27);
    ...
    private void doTest(int month) throws Exception {
        ...
        assertEquals("Wrong start date. (" + loadSimple.getTitle() + ")", D("27." + (month + 1) + ".2015 16:00", timeZone), loadSimple.getStartDate());
        assertEquals("Wrong end date. (" + loadSimple.getTitle() + ")", D("27." + (month + 1) + ".2015 17:00", timeZone), loadSimple.getEndDate());
        ...
        assertEquals("Wrong start date. (" + load23h.getTitle() + ")", D("27." + (month + 1) + ".2015 16:00", timeZone), load23h.getStartDate());
        assertEquals("Wrong end date. (" + load23h.getTitle() + ")", D("28." + (month + 1) + ".2015 15:00", timeZone), load23h.getEndDate());
        ...
        assertEquals("Wrong start date. (" + load25h.getTitle() + ")", D("27." + (month + 1) + ".2015 16:00", timeZone), load25h.getStartDate());
        assertEquals("Wrong end date. (" + load25h.getTitle() + ")", D("28." + (month + 1) + ".2015 17:00", timeZone), load25h.getEndDate());
        ...
        assertEquals("Wrong start date. (" + loadFulltime.getTitle() + ")", D("27." + (month + 1) + ".2015 00:00", utc), loadFulltime.getStartDate());
        assertEquals("Wrong end date. (" + loadFulltime.getTitle() + ")", D("28." + (month + 1) + ".2015 00:00", utc), loadFulltime.getEndDate());
        ...
        assertEquals("Wrong start date. (" + loadFulltime2days.getTitle() + ")", D("27." + (month + 1) + ".2015 00:00", utc), loadFulltime2days.getStartDate());
        assertEquals("Wrong end date. (" + loadFulltime2days.getTitle() + ")", D("29." + (month + 1) + ".2015 00:00", utc), loadFulltime2days.getEndDate());
    ...
    private void _doTest(int month) throws Exception {
        fulltime2days.setMonth(month);
        fulltime2days.setTitle("Bug 37668 Test (" + (month + 1) + ") fulltime 2 days.");
