...
public class DailyRecurrenceTest extends AbstractRecurrenceTest {
	...
	public void _notestDailyRecurrenceFromWinter2SummerTime() throws Exception {
		...
		for (int a = 1; a <= 31; a++) {
			...
			int day = a;
			if (day < 10) {
				assertOccurrence(day, simpleDateFormatUTC.parse("2007-03-0" + day + " 08:00:00"), simpleDateFormatUTC.parse("2007-03-0" + day + " 10:00:00"), occurrence);
			} else {
				assertOccurrence(day, simpleDateFormatUTC.parse("2007-03-" + day + " 08:00:00"), simpleDateFormatUTC.parse("2007-03-" + day + " 10:00:00"), occurrence);
			}
		}

		Occurrence occurrence = getOccurrenceByPosition(occurrenceArray, 32);
		assertOccurrence(32, simpleDateFormatUTC.parse("2007-04-01 08:00:00"), simpleDateFormatUTC.parse("2007-04-01 10:00:00"), occurrence);
		
		deleteAppointment(getWebConversation(), objectId, appointmentFolderId, PROTOCOL + getHostName(), getSessionId());
	}
	
	public void _notestDailyRecurrenceFromSummer2WinterTime() throws Exception {
		...
		for (int a = 1; a <= 31; a++) {
			...
			int day = a;
			if (day < 10) {
				assertOccurrence(day, simpleDateFormatUTC.parse("2007-10-0" + day + " 08:00:00"), simpleDateFormatUTC.parse("2007-10-0" + day + " 10:00:00"), occurrence);
			} else {
				assertOccurrence(day, simpleDateFormatUTC.parse("2007-10-" + day + " 08:00:00"), simpleDateFormatUTC.parse("2007-10-" + day + " 10:00:00"), occurrence);
			}
		}

		Occurrence occurrence = getOccurrenceByPosition(occurrenceArray, 32);
		assertOccurrence(32, simpleDateFormatUTC.parse("2007-11-01 08:00:00"), simpleDateFormatUTC.parse("2007-11-01 10:00:00"), occurrence);
