 ...
 */
public class NegativeAssertionOnCreate extends AbstractNegativeAssertion {

    public NegativeAssertionOnCreate(CalendarTestManager manager, int folderToWorkIn) {
