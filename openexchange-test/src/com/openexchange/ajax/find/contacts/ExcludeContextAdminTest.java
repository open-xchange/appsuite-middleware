...
public class ExcludeContextAdminTest extends AbstractFindTest {
    ...
    public void testAdminIsExcluded() throws Exception {
        ...
        PropDocument adminDoc = findByProperty(documents, "display_name", DisplayItems.convert(adminContact, session).getDisplayName());
    ...
    public void testAdminIsIncluded() throws Exception {
        ...
        FacetValue found = findByDisplayName(facets, DisplayItems.convert(adminContact, session).getDisplayName());
