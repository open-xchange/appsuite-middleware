...
public class ExcludeContextAdminTest extends AbstractFindTest {
    ...
    public void testAdminIsExcluded() throws Exception {
        ...
        PropDocument adminDoc = findByProperty(documents, "display_name", DisplayItems.convert(adminContact, getClient().getValues().getLocale()).getDisplayName());
    ...
    public void testAdminIsIncluded() throws Exception {
        ...
        FacetValue found = findByDisplayName(facets, DisplayItems.convert(adminContact, getClient().getValues().getLocale()).getDisplayName());
