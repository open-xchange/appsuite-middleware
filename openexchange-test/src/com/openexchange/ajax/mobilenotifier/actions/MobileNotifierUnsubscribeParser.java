...
public class MobileNotifierUnsubscribeParser extends AbstractAJAXParser<MobileNotifierUnsubscribeResponse> {
    ...
    @Override
    protected MobileNotifierUnsubscribeResponse createResponse(Response response) throws JSONException {
        return new MobileNotifierUnsubscribeResponse(response);
    }
}
