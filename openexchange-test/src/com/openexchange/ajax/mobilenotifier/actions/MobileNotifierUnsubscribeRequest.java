...
/**
 * {@link MobileNotifierUnsubscribeRequest}
 *
 * @author <a href="mailto:lars.hoogestraat@open-xchange.com">Lars Hoogestraat</a>
 */
public class MobileNotifierUnsubscribeRequest extends AbstractMobileNotifierRequest<AbstractAJAXResponse> {
     ...
     *
     */
    public MobileNotifierUnsubscribeRequest(final String serviceId, final String providerId, final String token, final boolean failOnError) {
        super();
    ...
    public AbstractAJAXParser<? extends AbstractAJAXResponse> getParser() {
        return new MobileNotifierUnsubscribeParser(failOnError);
    }
