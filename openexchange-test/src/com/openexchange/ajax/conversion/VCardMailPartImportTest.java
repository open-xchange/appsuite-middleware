	...
	public void testVCardImport() throws Throwable {
		...
		try {
			...
			final JSONObject mailObject_25kb = new JSONObject();
			{
				...
				bodyObject
						.put(MailJSONField.CONTENT.getKey(), NetsolTestConstants.MAIL_TEXT_BODY + "<br />"
								+ NetsolTestConstants.MAIL_TEXT_BODY + "<br />" + NetsolTestConstants.MAIL_TEXT_BODY
								+ "<br />" + NetsolTestConstants.MAIL_TEXT_BODY + "<br />"
								+ NetsolTestConstants.MAIL_TEXT_BODY + "<br />" + NetsolTestConstants.MAIL_TEXT_BODY
								+ "<br />" + NetsolTestConstants.MAIL_TEXT_BODY + "<br />");
			...
			try {
				...
				final NetsolSendResponse response = (NetsolSendResponse) Executor.execute(getSession(),
						new NetsolSendRequest(mailObject_25kb.toString(), in, "text/x-vcard; charset=US-ASCII", "vcard.vcf"));
