...
public class DownloadResponse extends AbstractAJAXResponse {
     ...
     * @param response
     */
    public DownloadResponse(byte[] downloaderBytes) {
        super(null);
        this.downloaderBytes = downloaderBytes;
    }
    ...
    public byte[] getDownloaderBytes() {
        return downloaderBytes;
    }
