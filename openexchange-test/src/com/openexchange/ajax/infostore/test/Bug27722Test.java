...
public final class Bug27722Test extends AbstractInfostoreTest {
    ...
    public void testHardDeleteManyFiles() throws Exception {
        ...
        assertNull("Error message not null: " + itm.getLastResponse().getException() != null ? itm.getLastResponse().getException().getMessage() : "unknown", itm.getLastResponse().getErrorMessage());
