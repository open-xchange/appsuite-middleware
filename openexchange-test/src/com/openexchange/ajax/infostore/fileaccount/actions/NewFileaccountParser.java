...
public class NewFileaccountParser extends AbstractAJAXParser<NewFileaccountResponse> {
    ...
    @Override
    protected NewFileaccountResponse createResponse(Response response) throws JSONException {
        return new NewFileaccountResponse(response);
    }
