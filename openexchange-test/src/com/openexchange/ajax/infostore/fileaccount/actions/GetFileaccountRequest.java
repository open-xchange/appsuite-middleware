 ...
 */
public class GetFileaccountRequest extends AbstractFileaccountRequest<GetFileaccountResponse> {
    ...
    public Parameter[] getParameters() throws JSONException {
        ...
        tmp.add(new Parameter(AJAXServlet.PARAMETER_ACTION, AJAXServlet.ACTION_GET));
    ...
    @Override
    public AbstractAJAXParser<GetFileaccountResponse> getParser() {
        return new GetFileaccountParser(getFailOnError());
    }
}
