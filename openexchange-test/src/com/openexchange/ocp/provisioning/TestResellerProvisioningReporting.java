...
/**
 * {@link TestResellerProvisioningReporting} - End-to-End tests for the OCP Provisioning Reporter.
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 * @since v7.12.0
 */
public class TestResellerProvisioningReporting extends AbstractTestProvisioningReporting {

    private static final Logger LOG = LoggerFactory.getLogger(TestResellerProvisioningReporting.class);

    private Credentials resellerCredentials;
    private User resellerAdmin;

    /**
     * Initializes a new {@link TestResellerProvisioningReporting}.
     */
    public TestResellerProvisioningReporting() {
        super();
    }
    ...
    protected void postSetup() throws Exception {
        super.postSetup();
        resellerCredentials = new Credentials(OCPConfig.getProperty(OCPConfig.Property.BRAND), OCPConfig.getProperty(OCPConfig.Property.BRAND_ADMIN_PASSWORD));
