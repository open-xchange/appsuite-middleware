...
public abstract class CalDAVTest extends WebDAVTest {
	...
	private Map<Long, CalDAVClient> calDAVClients;
    ...
    protected void setUp() throws Exception {
        ...
        this.calDAVClients = new HashMap<Long, CalDAVClient>();
    }
    ...
    protected CalDAVClient getCalDAVClient() throws OXException {
    	Long threadID = Long.valueOf(Thread.currentThread().getId());
    	if (false == this.calDAVClients.containsKey(threadID)) {
    		this.calDAVClients.put(threadID, new CalDAVClient());	
    	}
    	return this.calDAVClients.get(threadID);
    }
