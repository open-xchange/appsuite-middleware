...
/**
 * {@link ChronosAlarmTestMacCalendar}
 *
 * @author <a href="mailto:tobias.friedrich@open-xchange.com">Tobias Friedrich</a>
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 * @since v7.10.0
 */
public class ChronosAlarmTestMacCalendar extends ChronosCaldavTest {
    ...
    public void testAcknowledgeReminder() throws Exception {
        ...
        assertEquals("", acknowledgedDate.getTime(), event.getAlarms().get(0).getAcknowledged().longValue());
        /*
         * verify appointment on client
         */
    ...
    public void noTestSnoozeRecurringReminder() throws Exception {
         ...
         * verify appointment on server
         */
        EventData event = verifyEvent(uid, true, 1);
        Alarm alarm = event.getAlarms().get(0);
