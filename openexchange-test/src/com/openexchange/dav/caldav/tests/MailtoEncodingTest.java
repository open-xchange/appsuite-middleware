...
public class MailtoEncodingTest extends CalDAVTest {
    ...
    @Test
    public void testCreateOnClient() throws Exception {
        ...
        assertNotNull("ATTENDEE not found", iCalResource.getVEvent().getAttendee("horst@m%C3%BCller.example.com"));
        /*
        ...
        assertEquals("unexpected number of participants", 2, appointment.getParticipants().length);
        ...
        assertNotNull("No external participant found", externalParticipant);
        assertEquals("E-Mail address wrong", "horst@m\u00fcller.example.com", externalParticipant.getEmailAddress());
    }
