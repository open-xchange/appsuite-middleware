...
public class InternetAddressTransformator implements Transformator {
	...
	public Object transform(final String value) throws FixtureException {
		...
		for (int i = 0; i < splitted.length; i++) {
			...
			addresses.addAll(getAddresses(fixtureName, fixtureEntry));
		}
...
//	private InternetAddress getAddress(final ContactObject contact) throws FixtureException {
//		String email = null;
//		if (contact.containsEmail1()) {
...
//		try {
//			return new InternetAddress(email, contact.getDisplayName());
//		} catch (UnsupportedEncodingException e) {
//			throw new FixtureException(e);
//		}
//	}
