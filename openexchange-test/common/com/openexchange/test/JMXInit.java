...
public class JMXInit {
    private static boolean jmxPropertiesLoaded = false;
    private static boolean isJMXDirInitialized = false;
    private static String[] jmxPropFiles;
    public static Properties jmxProps = null;
    ...
    private static void initJMXProperties() {
        ...
        if (dir.isDirectory()) {
            ...
            for (String fileName : dir.list()) {
                myFile = new File(new StringBuilder().append(jmxPropertiesDir)
            ...
            System.arraycopy(fileList.toArray(), 0, jmxPropFiles, 0, fileList
                    .size());
        }
    ...
    public static Properties getJMXProperties() {
        ...
        if (!jmxPropertiesLoaded
                || TestInit.getTestProperties().getProperty("jmxPropertiesDir") != null) {
            loadJMXProperties();
        }
        return jmxProps;
    }
