...
/**
 * {@link PasswordResetConfirmMailNotification}
 *
 * @author <a href="mailto:marc.arens@open-xchange.com">Marc Arens</a>
 * @since v7.8.0
 */
public class PasswordResetConfirmMailNotification extends DefaultPasswordResetConfirmNotification<InternetAddress> implements ShareMailAware {

    private ShareMailDelegate shareMailDelegate;

    /**
     * Initializes a new {@link PasswordResetConfirmMailNotification}.
     * 
     * @param transport
     */
    public PasswordResetConfirmMailNotification(Transport transport) {
        super(Transport.MAIL);
        this.shareMailDelegate = new ShareMailDelegate();
    }
