...
/**
 * {@link <code>CollectionCharsetProvider</code>} - A charset provider which
 * performs the {@link CollectionCharsetProvider#charsetForName(String)} and
 * {@link CollectionCharsetProvider#charsets()} method invocations by iterating
...
public final class CollectionCharsetProvider extends CharsetProvider {
	...
	private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory
			.getLog(CollectionCharsetProvider.class);
	...
	/**
	 * Initializes a new {@link <code>CollectionCharsetProvider</code>} with
	 * specified instance of {@link <code>CharsetProvider</code>}
	 * 
	 * @param provider
	 *            The charset provider to be initially added
	 */
	...
	/**
	 * Initializes a new {@link <code>CollectionCharsetProvider</code>} with
	 * specified collection of {@link <code>CharsetProvider</code>} instances
	 * 
	 * @param providers
	 *            The charset provider collection to be initially added
	 */
	...
	/**
	 * Adds an instance of {@link <code>CharsetProvider</code>} to this
	 * provider's collection
	 * 
	 * @param charsetProvider
	 *            The charset provider to add
	 */
	 ...
	 * 
	 * @param provider
	 *            The provider which shall be removed
	 * @return The removed charset provider or <code>null</code> if none
	 *         present
	 */
	...
	/**
	 * Removes the charset provider denoted by specified class argument from
	 * this charset provider's collection
	 * 
	 * @param clazz
	 *            The class of the charset provider which shall be removed
	 * @return The removed charset provider or <code>null</code> if no
	 *         collected charset provider is denoted by given class argument
	 */
