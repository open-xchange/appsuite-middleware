    ...
    public void openAll() {
        ...
        for (final Iterator<MALPollPushListener> i = map.values().iterator(); i.hasNext();) {
            ...
            try {
                ...
                com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(MALPollPushListenerRegistry.class))).error(
