...
public enum I18NErrorMessages implements OXErrorMessage {
    ...
    I18NErrorMessages(int errorCode, String message, String help, AbstractOXException.Category category) {
    ...
    public void throwException(Throwable cause, Object...args) throws I18NException {
        FACTORY.throwException(this,cause,args);    
    }

    public void throwException(Object...args) throws I18NException {
