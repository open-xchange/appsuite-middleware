...
import static com.openexchange.chronos.provider.caching.basic.exception.BasicCachingCalendarExceptionMessages.ALREADY_UP_TO_DATE_MSG;
...
/**
 *
 * {@link BasicCachingCalendarExceptionCodes}
 *
...
public enum BasicCachingCalendarExceptionCodes implements DisplayableOXExceptionCode {
    ...
    private static final String PREFIX = "CAL-CACHE".intern();
    ...
    private BasicCachingCalendarExceptionCodes(String message, Category category, int number) {
        this(message, null, category, number);
    }

    private BasicCachingCalendarExceptionCodes(String message, String displayMessage, Category category, int number) {
