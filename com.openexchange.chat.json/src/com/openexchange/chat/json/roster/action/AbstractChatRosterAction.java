...
/**
 * {@link AbstractChatRosterAction}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public abstract class AbstractChatRosterAction implements AJAXActionService {
    ...
    /**
     * Initializes a new {@link AbstractChatRosterAction}.
     */
    protected AbstractChatRosterAction(final ServiceLookup services) {
        super();
    ...
    /**
     * Performs specified roster request.
     *
     * @param req The roster request
     * @return The result
     * @throws OXException If an error occurs
     * @throws JSONException If a JSON error occurs
     */
    protected abstract AJAXRequestResult perform(ChatRosterAJAXRequest req) throws OXException, JSONException;
