...
public final class Parser {
     ...
     */
    public static ParsedChat parseJSONChat(final JSONObject jsonChat) throws JSONException {
        final ParsedChat parsedChat = new ParsedChat();
        parsedChat.setChatId(jsonChat.getString("id"));
        parsedChat.setSubject(jsonChat.getString("subject"));
        ...
        for (int i = 0; i < length; i++) {
            ...
            parsedChat.join(jsonChatUser.getString("id"));
        }
        return parsedChat;
    }
