...
/opt/open-xchange/bundles/com.openexchange.hostname.ldap.jar
%config(noreplace) /opt/open-xchange/etc/groupware/ldaphostname.properties
%config(noreplace) /opt/open-xchange/etc/groupware/ldaphostname.ccf

%changelog
* Fri Oct 15 2010 - dennis.sieben@open-xchange.com
 - Initial version
