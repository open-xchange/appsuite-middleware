...
public class MoveAction extends AbstractAction {
	 ...
	 * @param serviceLookup
	 */
	public MoveAction(ServiceLookup serviceLookup) {
		super(serviceLookup);
	}
	...
	public AJAXRequestResult perform(AJAXRequestData requestData, ServerSession session) throws OXException {
		...
		try {
			...
			sourceFolderUUID = UUID.fromString(json.getString("sourceFolderUUID"));
			targetFolderUUID = UUID.fromString(json.getString("targetFolderUUID"));
