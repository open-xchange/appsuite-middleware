...
/**
 * A service tracker which handle the appearance and disappearance of the {@link HostnameService} and adds
 * it to the registry of this bundle
 *
 * @author <a href="mailto:dennis.sieben@open-xchange.com">Dennis Sieben</a>
 *
 */
public class HostnameInstallationServiceListener implements ServiceTrackerCustomizer {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(HostnameInstallationServiceListener.class);

    private final BundleContext context;

    public HostnameInstallationServiceListener(BundleContext context) {
        this.context = context;
    }

    public Object addingService(ServiceReference serviceReference) {
        final Object service = context.getService(serviceReference);
        if (service instanceof HostnameService) {
    ...
    public void removedService(ServiceReference arg0, Object o) {
        if (o instanceof HostnameService) {
            MobileConfigServiceRegistry.getServiceRegistry().removeService(HostnameService.class);
        }
