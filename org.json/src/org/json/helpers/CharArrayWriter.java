...
/**
 * {@link CharArrayWriter} - An unsynchronized {@link java.io.Writer}.
 *
...
public class CharArrayWriter extends Writer {
    ...
    public CharArrayWriter(final int initialSize) {
        ...
        charArray = new DynamicCharArray(initialSize);
        lock = charArray;
    }
    ...
    public void write(final String str, final int off, final int len) {
        charArray.append(str.substring(off, off + len));
    }
    ...
    /**
     * Resets underlying character array.
     */
