...
public class ConversionWSHandler implements WSHandler {
	...
	@Override
	public void incoming(Stanza stanza, ServerSession session)
			throws OXException {
	...
	@Override
	public void outgoing(Stanza stanza, ServerSession session, StanzaSender sender)
			throws OXException {
