 ...
 */
public abstract class AbstractJSONHTTPMethod<M extends HttpMethod> extends AbstractJSONMethod {
    ...
    /**
     * Initializes a new {@link AbstractJSONHTTPMethod}.
     */
    protected AbstractJSONHTTPMethod() {
        super();
    }
     ...
     */
    protected M configure(final JSONServerSetting setting, final String queryString) throws OXException {
        M httpMethod = null;
        try {
