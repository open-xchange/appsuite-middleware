 ...
 * @since v7.10.5
 */
public abstract class DoubleMapping<O> extends DefaultJsonMapping<Double, O> {

    /**
     * Initializes a new {@link DoubleMapping}.
     */
    public DoubleMapping(final String ajaxName, final Integer columnId) {
