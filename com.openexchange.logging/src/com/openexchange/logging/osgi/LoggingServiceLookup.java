 ...
 */
public final class LoggingServiceLookup {

    /**
     * Initializes a new {@link ServiceLookup}.
     */
    private LoggingServiceLookup() {
        super();
    }

    private static final AtomicReference<ServiceLookup> reference = new AtomicReference<ServiceLookup>();
    ...
    public static <S extends Object> S getService(Class<? extends S> c) {
        ServiceLookup serviceLookup = reference.get();
