...
public final class IndexExceptionMessages implements LocalizableStrings {
    ...
    public static final String INDEXING_NOT_ENABLED = "Index search for module %1$d is not enabled for user %1$d in context %2$d.";

    // The index for module %1$d for user %1$d in context %2$d is currently locked.
    public static final String INDEX_LOCKED = "The index for module %1$d for user %1$d in context %2$d is currently locked.";
