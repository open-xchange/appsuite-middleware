...
/**
 * This class provides a pure Java implementation of the <a href="http://svn.apache.org/repos/asf/spamassassin/trunk/spamd/PROTOCOL"
 * target="_" title="Apache SVN">SpamAssassin Network Protocol</a>. It can be used by mail software to query a <a
 * href="http://spamassassin.apache.org/" title="The Apache SpamAssassin Project" target="_">SpamAssassin <a
 * href="http://spamassassin.apache.org/full/3.1.x/doc/spamd.html" title="daemonized version of spamassassin" target="_">spamd</a> server
 * and check whether a particular message is spam. There are also commands for learning and reporting.
 * 
 * @author Nick Radov
 * @see <a href="http://svn.apache.org/viewvc/spamassassin/trunk/spamc/" * title="Apache SVN" target="_">spamc C source code< /a>
 * @see <a *
...
public class Spamc {
    ...
    /**
     * The entire response from spamd, including all headers and the processed message. This allows any of the command methods to return the
    ...
    public class SpamdResponse {
        ...
        /**
         * Response code from the first line of the response. It should equal one of the fields defined in {@link ExitCodes}.
         */
        ...
        /**
         * Construct a response object by parsing the response received from the spamd server.
         * 
         * @param response the raw response received from Spamd
         * @throws IllegalArgumentException if <code>response</code> is <code>null</code>, or it doesn't match the expected format
         */
        ...
        /**
         * Extract the protocol version, response code, and response message from the first line of the spamd response.
         * 
         * @param firstLine first line of the response
         */
         ...
         * 
         * @param lines the spamd response split out into individual lines
         * @return line index after all of the headers (should be the start of the message body)
         */
         ...
         * 
         * @return protocol version, which should be &quot;1.3&quot; as of SpamAssassin 3.1.8.
         */
        ...
        /**
         * Get the raw, unparsed spamd response including all headers and body content.
         * 
        ...
        /**
         * Get the response code from the first line of the response. It should equal one of the fields defined in {@link ExitCodes}.
         * 
        ...
        /**
         * Get the message after processing by SpamAssassin. Depending on the options set or command issued, it may include a complete
         * report or just the names of the tests that hit. This value may be empty if an error occurred.
         * 
         ...
         * 
         * @see Headers
         * @return collection of headers; for each map entry the key will be the header name and the value will be the header value
         */
         ...
         * 
         * @return <code>true</code> if the Spam header value starts with the word &quot;True&quot;, otherwise <code>False</code>
         */
         ...
         * 
         * @return spam score
         * @throws NumberFormatException if spamd returned a response that couldn't be interpreted as a <code>double</code>
         */
    ...
    /**
     * Flag to indicate whether input is assumed to be a single BSMTP-formatted message
     */
    ...
    /**
     * Flag to indicate whether the order of spamd server IP addresses to try should be randomized for load balancing
     */
    ...
    /**
     * Flag to indicate whether Unix sockets should be used instead of standard TCP sockets (currently not implemented
     */
    ...
    /**
     * Flag to mark whether SSL should be used when communicating with the spamd server
     */
    ...
    /**
     * Number of seconds to wait for the spamd server to respond before timing out
     */
    ...
    /**
     * Number of times to retry connecting to the spamd server before failing
     */
    ...
    /**
     * Number of seconds to sleep before retrying the connection to a spamd server
     */
    ...
    /**
     * Flag to indicate whether the message body should be transmitted using Zlib compression
     */
     ...
     * 
     * @see #setHosts(List)
     * @param hosts collection of {@link java.lang.String} objects containing host names and/or IP addresses
     */
     ...
     * Set the list of spamd hosts.
     * 
     * @param hosts array containing host names and/or IP addresses
     */
     ...
     * 
     * @return collection of {@link java.lang.String} objects containing host names and/or IP addresses
     */
    ...
    /**
     * Set whether the order of spamd destination hosts should be randomized for load balancing.
     * 
     * @see RandomizeOption
     * @param randomize <code>true</code> for load balancing or <code>false</code> to try hosts in the order specified
     */
    ...
    /**
     * Get whether the order of spamd destination hosts should be randomized for load balancing.
     * 
     * @return <code>true</code> for load balancing or <code>false</code> to try hosts in the order specified
     */
    ...
    /**
     * Set the TCP port to use when connecting to the spamd server (defaults to <code>783</code>).
     * 
     * @param port TCP port number
     * @throws IllegalArgumentException if <code>port</code> is less than <code>0</code> or greater than <code>65535</code>
     */
    ...
    /**
     * Get the TCP port to use when connecting to the spamd server (defaults to <code>783</code>).
     */
    public int getPort() {
        return port;
    }
    ...
    /**
     * Set whether to use Unix sockets instead of TCP sockets when connecting to the spamd server.
     * 
     * @param useUnixSockets <code>true</code> to use Unix sockets, <code>false</code> (default) to use TCP sockets
     * @throws IllegalArgumentException if <code>useUnixSockets</code> is <code>true</code> <i>(that feature is not yet implemented)</i>
     */
     ...
     * 
     * @param bsmtp <code>true</code> to assume BSMTP format, <code>false</code> (default) to assume standard <a
     *            href="ftp://ftp.rfc-editor.org/in-notes/rfc822.txt" target="_" title="Standard for the Format of ARPA Internet Text
     *            Messages">RFC 822</a> format
     * @throws IllegalArgumentException if <code>bsmtp</code> is <code>true</code> <i>(that feature is not yet implemented)</i>
     */
     ...
     * 
     * @param useSsl <code>true</code> to use SSL, <code>false</code> (default) to send the network traffic in the clear
     */
    ...
    /**
     * Fields for use with the {@link Spamc#setProtocolVersion(String)} method.
     */
    ...
    /**
     * Check whether the current protocol version is the same or newer as some other protocol version.
     * 
     * @see #getProtocolVersion()
     * @param protocolVersion protocol version to check, which should be a field from {@link ProtocolVersions}
     * @return <code>true</code> if the current protocol version is the same or higher than <code>protocolVersion</code>
     * @throws IllegalArgumentException if <code>protocolVersion</code> is <code>null</code> or not a valid protocol version
     * @throws IllegalStateException if the current protocol version is not valid
     */
    ...
    /**
     * Get the name of the current class, not including the package name. This method should be removed once Java 1.4 compatibility is no
     * longer needed and the {@link Class#getSimpleName()} method can be used instead.
     * 
    ...
    /**
     * Set the current protocol version. As a side effect, compression will be automatically disabled if it is not supported for the new
     * version.
     * 
     * @see #setCompress(boolean)
     * @param protocolVersion protocol version, which should be a field from {@link ProtocolVersions}
     ...
     * 
     * @return protocol version, which should be a field from {@link ProtocolVersions}
     */
    public String getProtocolVersion() {
        return protocolVersion;
    }
    ...
    /**
     * Set whether to compress the message body with Zlib. The default is <code>false</code>.
     * 
     * @param compress
     * @throws IllegalArgumentException if <code>compress</code> is <code>true</code> and the protocol version is less than &quot;1.4&quot;
     */
     ...
     * 
     * @return <code>true</code> if message bodies will be compressed, otherwise <code>false</code>
     */
     ...
     * 
     * @param command command to send, which should be a field from {@link Commands}
    ...
    /**
     * Send a command to the spamd server with a message to be checked, learned, and/or reported.
     * 
     * @param command command to send, which should be a field from {@link Commands}
     * @param message message in RFC 822 or BSMTP format
     * @see #getAssumeBSMTP()
     * @return spamd server response
     * @throws IOException
     * @throws UnknownHostException
     ...
     * 
     * @param command command to send, which should be a field from {@link Commands}
     * @param headers optional headers to send (the mandatory headers will be added automatically)
     * @param message
     * @return the query
     */
    private String constructQuery(final String command, final Map headers, final String message) {
        ...
        newHeaders.put(Headers.CONTENT_LENGTH, Long.toString(contentLength));
    ...
    /**
     * Translate the list of host names into a list of IP addresses. Each host may have multiple addresses. If the randomization option is
     * turned on then the array entries will be rearranged in pseudo-random order.
     * 
     * @see #getRandomize()
     * @return list of {@link java.let.InetAddress} objects
     * @throws IllegalStateException if there is not at least one host set
     */
    ...
    /**
     * Set up a connection to a spamd server. It iterates through the list of available addresses and retries until it either succeeds, or
    ...
    private Socket setupTransport() throws IOException, UnknownHostException {
        ...
        if (getUseSSL()) {
            ...
            try {
                ...
                final Method getDefault = sslSocketFactory.getMethod("getDefault", null);
                final Object defaultSocketFactory = getDefault.invoke(null, null);
                ...
                final Object[] args = new Object[] {
                    socket, socket.getInetAddress().getHostName(), new Integer(socket.getPort()), Boolean.TRUE };
                socket = (Socket) createSocket.invoke(defaultSocketFactory, args);
            } catch (final ClassNotFoundException e) {
                final IllegalStateException ise = new IllegalStateException(
                    "Class " + SSL_PACKAGE_NAME + "." + SSL_SOCKET_FACTORY_CLASS_NAME + " could not be loaded");
                ise.initCause(e);
                throw ise;
     ...
     * 
     * @param query complete query, including all headers and possibly a message
    ...
    /**
     * Ignore this message -- client opened connection then changed its mind. (This method should not generally be used, but is included for
     * completeness.)
     * 
     * @param message
     * @return
    ...
    /**
     * Tell what type of we are to process and what should be done with that message. This includes setting or removing a local or a remote
     * database (learning, reporting, forgetting, revoking).
     * 
     * @param message message contents
     * @param spam if <code>true</code> &quot;<code>Message-class: spam</code>&quot;, <code>false</code> if it is ham
     * @param setLocal if <code>true</code>, set the &quot;Set: local&quot; header to learn the message in the local database
     * @param setRemote if <code>true</code>, set the &quot;Set: remote&quot; header to learn the message in remote databases
     * @param removeLocal
     * @param removeRemote
     * @return
     * @throws IllegalArgumentException if both <code>setLocal</code> and <code>removeLocal</code> are <code>true</code>, or if both
     *             <code>setRemote</code> and <code>removeRemote</code> are <code>true</code>
     */
    ...
    /**
     * Command line utility for checking whether a message is spam. It takes the same arguments as the standard <code>spamc</code> program.
     * However, some arguments are currently not supported.
     * 
     * @param args command-line arguments; for a full description see {@link #printUsage()}
     */
    public static void main(final String[] args) {
        ...
        try {
            ...
            File spamFile = new File(
                File.separator + File.separator + "ax5" + File.separator + "apps" + File.separator + "Apache" + File.separator + "Mail-SpamAssassin-3.1.8" + File.separator + "sample-spam.txt");
            ...
            if ((flags & CheckOption.FLAG) > 0) {
                ...
                final Iterator iterator = response.getHeaders().keySet().iterator();
                String key;
                while (iterator.hasNext()) {
    ...
    /**
     * Combine the arguments passed on the command line with those included in the configuration file (if it exists).
     * 
     * @param userConfig
     * @param args
     * @return
    ...
    /**
     * SSL support may not be included for some JVMs so we will try to load it dynamically
     */
    ...
    private static abstract class AbstractOption {
        ...
        /**
         * Check whether we should continue running after processing this option. For some options, like those that print usage and version
    ...
    /**
     * Values from <code>sysexits.h</code>, plus some additional values defined for SpamAsassin. One of these should be included in the
     * spamd response.
     * 
