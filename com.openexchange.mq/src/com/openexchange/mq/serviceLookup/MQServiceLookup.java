...
public final class MQServiceLookup {
    ...
    /**
     * Initializes a new {@link MQServiceLookup}.
     */
    private MQServiceLookup() {
        super();
    }
    ...
    public static MQService getMQService() {
        final MQService service = SERVICE.get();
        if (null == service) {
            throw new IllegalStateException("Missing MQService instance.");
        }
        return service;
    }
