...
public final class SSOMultipleHandlerFactory implements MultipleHandlerFactoryService {
    ...
    /**
     * Initializes a new {@link SSOMultipleHandlerFactory}.
     */
    public SSOMultipleHandlerFactory() {
        super();
    }

    public MultipleHandler createMultipleHandler() {
        return new MultipleAdapter(SSOActionFactory.getInstance());
    }

    public String getSupportedModule() {
        return SSOConstants.MODULE;
    }
}
