...
/**
 * {@link XctxSessionManager}
 *
 * @author <a href="mailto:tobias.friedrich@open-xchange.org">Tobias Friedrich</a>
 * @since 7.10.5
 */
@SingletonService
public interface XctxSessionManager {

    /**
     * Acquires a session for a guest user in a foreign context, logging in as the guest user automatically if needed.
     * 
     ...
     */
    Session getGuestSession(Session session, String baseToken, String password) throws OXException;
