 ...
 */
public final class CMISServiceRegisterer implements EventHandler {
     ...
     */
    public CMISServiceRegisterer(final BundleContext context) {
        super();
        ...
        if (FileStorageAccountManagerProvider.TOPIC.equals(event.getTopic())) {
            ...
            synchronized (this) {
                ...
                if (null == service) {
                     ...
                     */
                    try {
                        service = CMISFileStorageService.newInstance((FileStorageAccountManagerProvider) event.getProperty(FileStorageAccountManagerProvider.PROPERTY_PROVIDER));
                    ...
                    if (ranking > this.ranking) {
                        ...
                        if (provider.supports(service)) {
                            try {
                                ...
                                registration = null;
                                service = CMISFileStorageService.newInstance(provider);
                                registration = context.registerService(FileStorageService.class, service, null);
                                this.ranking = ranking;
                                this.service = service;
                            } catch (final OXException e) {
