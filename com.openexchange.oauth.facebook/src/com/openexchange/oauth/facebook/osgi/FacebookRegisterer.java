...
public class FacebookRegisterer implements ServiceTrackerCustomizer {
    ...
    private static final Log LOG = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(LogFactory.getLog(FacebookRegisterer.class))));
