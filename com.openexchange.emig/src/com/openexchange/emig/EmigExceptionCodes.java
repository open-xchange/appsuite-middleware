...
/**
 * {@link EmigExceptionCodes} - Error codes for EMiG module.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since 7.4.2
 */
public enum EmigExceptionCodes implements DisplayableOXExceptionCode {
     ...
     * The prefix constant.
     */
    public static final String PREFIX = "EMIG";
    ...
    private EmigExceptionCodes(final String message, final Category category, final int detailNumber) {
        this(message, category, detailNumber, null);
    }

    private EmigExceptionCodes(final String message, final Category category, final int detailNumber, final String displayMessage) {
