...
package com.openexchange.mobilepush.templating.calendar;
...
/**
 * {@link MobilePushCalendarImpl}
 *
 * @author <a href="mailto:lars.hoogestraat@open-xchange.com">Lars Hoogestraat</a>
 */
public class MobilePushCalendarImpl extends AbstractMobilePushService {

    private final ServiceLookup services;

    private static final String EMPTY_STRING = "";

    public MobilePushCalendarImpl(ServiceLookup services) {
        this.services = services;
    }

    @Override
    public String getProviderName() {
        return MobilePushProviders.APPOINTMENT.getProviderName();
    }

    @Override
    public String getFrontendName() {
        return MobilePushProviders.APPOINTMENT.getFrontendName();
    }
    ...
    public NotifyTemplate getTemplate() throws OXException {
        final String template = MobileNotifierFileUtility.getTemplateFileContent(MobilePushProviders.APPOINTMENT.getTemplateFileName());
        final String title = MobilePushProviders.APPOINTMENT.getTitle();
        return new NotifyTemplate(title, template, false, MobilePushProviders.APPOINTMENT.getIndex());
    }

    @Override
    public void putTemplate(String changedTemplate) throws OXException {
        MobileNotifierFileUtility.writeTemplateFileContent(MobilePushProviders.APPOINTMENT.getTemplateFileName(), changedTemplate);
    }
