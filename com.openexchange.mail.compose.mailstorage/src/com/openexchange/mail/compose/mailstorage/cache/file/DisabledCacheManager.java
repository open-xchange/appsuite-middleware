...
/**
 * {@link DisabledCacheManager} - The special cache manager always signaling disabled result.
 *
...
public class DisabledCacheManager implements CacheManager {
    ...
    private static final DisabledCacheManager INSTANCE = new DisabledCacheManager();
     ...
     * @return The instance
     */
    public static DisabledCacheManager getInstance() {
        return INSTANCE;
    }
    ...
    /**
     * Initializes a new {@link DisabledCacheManager}.
     */
