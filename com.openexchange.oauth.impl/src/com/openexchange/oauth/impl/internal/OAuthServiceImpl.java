...
public class OAuthServiceImpl implements OAuthService, SecretEncryptionStrategy<PWUpdate>, EncryptedItemDetectorService, SecretMigrator, EncryptedItemCleanUpService {
    ...
    public OAuthAccount createAccount(final String serviceMetaData, final Map<String, Object> arguments, final int user, final int contextId, Set<OAuthScope> scopes) throws OXException {
        try {
            ...
            account.setUserIdentity((String) arguments.get("identity"));
            /*
    ...
    public OAuthAccount upsertAccount(String serviceMetaData, OAuthInteractionType type, Map<String, Object> arguments, int user, int contextId, Set<OAuthScope> scopes) throws OXException {
        ...
        arguments.put("identity", userIdentity);
        ...
        if (existingAccount == null) {
            ...
            return createAccount(serviceMetaData, arguments, user, contextId, scopes);
        } else {
