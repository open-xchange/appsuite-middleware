 ...
 * @since 7.10.0
 */
public class OAuthAddIdentityColumnTask extends UpdateTaskAdapter {
    ...
    public void perform(PerformParameters params) throws OXException {
        ...
        try {
            startTransaction(writeConnection);
            rollback = true;
            if (Tools.columnExists(writeConnection, "oauthAccounts", "identity")) {
                return;
            }

            Tools.addColumns(writeConnection, "oauthAccounts", new Column("identity", "varchar(767)"));
