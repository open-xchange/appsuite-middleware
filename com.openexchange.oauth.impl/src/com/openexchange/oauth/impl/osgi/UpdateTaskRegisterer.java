    ...
    public synchronized DatabaseService addingService(final ServiceReference<DatabaseService> reference) {
        ...
        registration = context.registerService(UpdateTaskProviderService.class, new UpdateTaskProviderService() {
            ...
            public Collection<UpdateTaskV2> getUpdateTasks() {
                return Arrays.asList(((UpdateTaskV2) new OAuthCreateTableTask()), new OAuthCreateTableTask2(), new OAuthAddScopeColumnTask(), new RenameMigrateLinkedInServiceIdUpdateTask(), new DropForeignKeyFromOAuthAccountTask(), new OAuthAccountsTableUtf8Mb4UpdateTask());
            }
        }, null);
        return dbService;
    }
