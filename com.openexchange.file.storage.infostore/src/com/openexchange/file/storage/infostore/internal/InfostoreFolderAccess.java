 ...
 */
public class InfostoreFolderAccess implements FileStorageFolderAccess, MediaFolderAwareFolderAccess, PermissionAware, FolderStatsAware, FileStorageCaseInsensitiveAccess, FileStorageRestoringFolderAccess {
    ...
    public Map<String, FileStorageFolder[]> restoreFolderFromTrash(List<String> folderIds, String defaultDestFolderId) throws OXException {
        ...
        for (Map.Entry<String, List<UserizedFolder>> entry : map.entrySet()) {
            ...
            for (UserizedFolder userizedFolder : path) {
                folders[i++] = FolderWriter.writeFolder(userizedFolder);
            }
