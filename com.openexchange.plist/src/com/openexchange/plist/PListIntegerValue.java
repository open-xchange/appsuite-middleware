...
/**
 * {@link PListIntegerValue}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.8.1
 */
public class PListIntegerValue extends AbstractPListKeyValue {

    private final int value;

    /**
     * Initializes a new {@link PListIntegerValue}.
     */
    public PListIntegerValue(String key, int value) {
        super(key);
        this.value = value;
    }
