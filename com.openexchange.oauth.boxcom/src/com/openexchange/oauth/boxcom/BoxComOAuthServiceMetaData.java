 ...
 */
public final class BoxComOAuthServiceMetaData extends AbstractOAuthServiceMetaData implements com.openexchange.oauth.ScribeAware, Reloadable {

    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(BoxComOAuthServiceMetaData.class);

    private static final String[] PROPERTIES = new String[] {"com.openexchange.oauth.boxcom.apiKey", "com.openexchange.oauth.boxcom.apiSecret"};
    ...
    public BoxComOAuthServiceMetaData(final ServiceLookup services) {
        ...
        String apiKey = configService.getProperty("com.openexchange.oauth.boxcom.apiKey");
        if (Strings.isEmpty(apiKey)) {
            throw new IllegalStateException("Missing following property in configuration: com.openexchange.oauth.boxcom.apiKey");
        }
        this.apiKey = apiKey;

        String apiSecret = configService.getProperty("com.openexchange.oauth.boxcom.apiSecret");
        if (Strings.isEmpty(apiSecret)) {
            throw new IllegalStateException("Missing following property in configuration: com.openexchange.oauth.boxcom.apiSecret");
        }
        this.apiSecret = apiSecret;

        String redirectUrl = configService.getProperty("com.openexchange.oauth.boxcom.redirectUrl");
        if (Strings.isEmpty(redirectUrl)) {
            throw new IllegalStateException("Missing following property in configuration: com.openexchange.oauth.boxcom.redirectUrl");
        }
        // Basic URL encoding
    ...
    public void reloadConfiguration(ConfigurationService configService) {
        final String apiKey = configService.getProperty("com.openexchange.oauth.boxcom.apiKey");
        if (Strings.isEmpty(apiKey)) {
            throw new IllegalStateException("Missing following property in configuration: com.openexchange.oauth.boxcom.apiKey");
        }
        this.apiKey = apiKey;

        final String apiSecret = configService.getProperty("com.openexchange.oauth.boxcom.apiSecret");
        if (Strings.isEmpty(apiSecret)) {
            throw new IllegalStateException("Missing following property in configuration: com.openexchange.oauth.boxcom.apiSecret");
        }
        this.apiSecret = apiSecret;
    ...
    public Map<String, String[]> getConfigFileNames() {
        ...
        map.put("boxcomoauth.properties", PROPERTIES);
        return map;
    }
