...
/**
 * {@link UnifiedINBOXMessageAppender} - Appends messages.
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class UnifiedINBOXMessageAppender {
    ...
    /**
     * Initializes a new {@link UnifiedINBOXMessageAppender}.
     * 
     * @param session The session
     * @param access The Unified INBOX access
     */
    public UnifiedINBOXMessageAppender(final Session session, final UnifiedINBOXAccess access) {
        super();
     ...
     * @param mailMessages The mails to append
     * @return The corresponding mail IDs of appended messages in destination folder
     * @throws MailException If append operation fails
     */
    public String[] doAppend(final String destFolder, final MailMessage[] mailMessages) throws MailException {
    ...
    private String[] append2KnownFolder(final String sourceFolder, final String destFolder, final String[] mailIds, final boolean fast, final boolean move) throws MailException {
        /*
