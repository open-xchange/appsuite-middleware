...
/**
 * {@link UnifiedINBOXFolder} - The Unified INBOX folder.
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class UnifiedINBOXFolder {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(UnifiedINBOXFolder.class);
    ...
    /**
     * Initializes a new {@link UnifiedINBOXFolder}.
     * 
     * @param session The session
     */
    public UnifiedINBOXFolder(final Session session) {
        super();
        this.session = session;
        this.user = session.getUserId();
        this.cid = session.getContextId();
    }
