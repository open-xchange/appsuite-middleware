...
final class KF2AFEqualCallable implements Task<Object> {
    ...
    KF2AFEqualCallable(final String sourceFolder, final String destFullname, final boolean fast, final boolean move, final String[] toFill, final int accountId, final Session session) {
        super();
