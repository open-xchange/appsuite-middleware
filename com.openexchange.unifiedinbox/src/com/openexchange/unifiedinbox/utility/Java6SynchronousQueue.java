...
public class Java6SynchronousQueue<E> extends AbstractQueue<E>
    ...
    static final class TransferStack extends Transferer {
        ...
        static boolean isFulfilling(final int m) { return (m & FULFILLING) != 0; }
        ...
        static final class SNode {
            ...
            boolean casNext(final SNode cmp, final SNode val) {
                return (cmp == next &&
             ...
             */
            boolean tryMatch(final SNode s) {
                if (match == null &&
        ...
        boolean casHead(final SNode h, final SNode nh) {
         ...
         */
        static SNode snode(SNode s, final Object e, final SNode next, final int mode) {
            if (s == null) {
                s = new SNode(e);
            }
            s.mode = mode;
         ...
         */
        @Override
        Object transfer(final Object e, final boolean timed, final long nanos) {
            /*-
            ...
            final int mode = (e == null)? REQUEST : DATA;
         ...
         */
        SNode awaitFulfill(final SNode s, final boolean timed, long nanos) {
            /*-
         ...
         * fulfiller.
         */
        boolean shouldSpin(final SNode s) {
            final SNode h = head;
    ...
    static final class TransferQueue extends Transferer {
        ...
        static final class QNode {
            ...
            boolean casNext(final QNode cmp, final QNode val) {
                return (next == cmp &&
                        nextUpdater.compareAndSet(this, cmp, val));
            }
            ...
            boolean casItem(final Object cmp, final Object val) {
                return (item == cmp &&
             ...
             */
            void tryCancel(final Object cmp) {
        ...
        TransferQueue() {
            final QNode h = new QNode(null, false); // initialize to dummy node.
            head = h;
            tail = h;
        }
         ...
         */
        void advanceHead(final QNode h, final QNode nh) {
         ...
         */
        void advanceTail(final QNode t, final QNode nt) {
            if (tail == t) {
         ...
         */
        boolean casCleanMe(final QNode cmp, final QNode val) {
            return (cleanMe == cmp &&
        ...
        Object transfer(final Object e, final boolean timed, final long nanos) {
            ...
            for (;;) {
                ...
                if (h == t || t.isData == isData) { // empty or same-mode
                    ...
                    final Object x = awaitFulfill(s, e, timed, nanos);
         ...
         */
        Object awaitFulfill(final QNode s, final Object e, final boolean timed, long nanos) {
         ...
         */
        void clean(final QNode pred, final QNode s) {
            s.waiter = null; // forget thread
            /*-
            ...
            while (pred.next == s) { // Return early if already unlinked
                final QNode h = head;
                final QNode hn = h.next;   // Absorb cancelled first node as head
                if (hn != null && hn.isCancelled()) {
                    advanceHead(h, hn);
                    continue;
                }
		final QNode t = tail;      // Ensure consistent read for tail
                if (t == h) {
                    return;
                }
		final QNode tn = t.next;
		if (t != tail) {
            continue;
                ...
                if (s != t) {        // If not tail, try to unsplice
                    final QNode sn = s.next;
                    if (sn == s || pred.casNext(s, sn)) {
                        return;
                    }
                }
                final QNode dp = cleanMe;
                if (dp != null) {    // Try unlinking previous cancelled node
                    final QNode d = dp.next;
                    QNode dn;
    ...
    private void writeObject(final java.io.ObjectOutputStream s)
        ...
        final boolean fair = transferer instanceof TransferQueue;
        if (fair) {
