...
public final class UnifiedInboxMessageStorage extends MailMessageStorage implements ISimplifiedThreadStructure {
    ...
    public List<List<MailMessage>> getThreadSortedMessages(final String fullName, final boolean includeSent, final IndexRange indexRange, final MailSortField sortField, final OrderDirection order, final MailField[] mailFields) throws OXException {
                    ...
                    public List<List<MailMessage>> call() {
                        ...
                        try {
                            ...
                            if (messageStorage instanceof ISimplifiedThreadStructure) {
                                final List<List<MailMessage>> list = ((ISimplifiedThreadStructure) messageStorage).getThreadSortedMessages(fn, includeSent, null, sortField, order, checkedFields);
        ...
        try {
            ...
            final IMailMessageStorage messageStorage = mailAccess.getMessageStorage();
            if (messageStorage instanceof ISimplifiedThreadStructure) {
                return ((ISimplifiedThreadStructure) messageStorage).getThreadSortedMessages(fullName, includeSent, indexRange, sortField, order, mailFields);
            }
            /*-
             * 1. Send 'all' request with id, folder_id, level, and received_date - you need all that data.
             * 
