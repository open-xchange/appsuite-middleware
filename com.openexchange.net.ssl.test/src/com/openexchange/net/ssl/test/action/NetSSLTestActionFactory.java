...
/**
 * {@link NetSSLTestActionFactory}
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public class NetSSLTestActionFactory implements AJAXActionServiceFactory {
    ...
    /**
     * Initialises a new {@link NetSSLTestActionFactory}.
     */
    public NetSSLTestActionFactory(ServiceLookup services) {
        super();
        Map<String, AJAXActionService> a = new HashMap<>(1);
        a.put("get", new GetSSLWebSite(services));
