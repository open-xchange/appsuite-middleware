...
/**
 * {@link IDManglingGroupwareContactsFolder}
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 * @since v7.10.5
 */
public class IDManglingGroupwareContactsFolder extends IDManglingContactsFolder implements GroupwareContactsFolder {

    private final String newParentId;
    private final GroupwareContactsFolder delegate;

    /**
     * Initializes a new {@link IDManglingGroupwareContactsFolder}.
     *
     ...
     */
    public IDManglingGroupwareContactsFolder(GroupwareContactsFolder delegate, String newId, String newParentId) {
    ...
    public String toString() {
        return "IDManglingGroupwareContactsFolder [newId=" + newId + ", newParentId=" + newParentId + ", delegate=" + delegate + "]";
    }
