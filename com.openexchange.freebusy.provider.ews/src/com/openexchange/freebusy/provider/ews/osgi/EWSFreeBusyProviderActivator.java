...
/**
 * {@link EWSFreeBusyProviderActivator}
 *
...
public class EWSFreeBusyProviderActivator extends HousekeepingActivator {
     ...
     */
    public EWSFreeBusyProviderActivator() {
        super();
    }
    ...
    protected void startBundle() throws Exception {
        try {
            LOG.info("starting bundle: com.openexchange.freebusy.provider.ews");
            EWSFreeBusyProviderLookup.set(this);
    ...
    protected void stopBundle() throws Exception {
        LOG.info("stopping bundle: com.openexchange.freebusy.provider.ews");
        super.stopBundle();
    }
