 ...
 */
public enum AwsS3ExceptionCode implements DisplayableOXExceptionCode {
     ...
     * Access denied.
     */
    AccessDenied("Access denied.", CATEGORY_USER_INPUT, 3, AwsS3ExceptionMessages.AccessDenied_MSG),
    /**
    ...
    AccountProblem("There is a problem with your AWS account that prevents the operation from completing successfully.",
        CATEGORY_USER_INPUT, 4, AwsS3ExceptionMessages.AccountProblem_MSG),
    /**
    ...
    AmbiguousGrantByEmailAddress("The e-mail address you provided is associated with more than one account", CATEGORY_USER_INPUT, 5,
        AwsS3ExceptionMessages.AmbiguousGrantByEmailAddress_MSG),
    /**
    ...
    BucketAlreadyExists("The requested bucket name is not available. The bucket namespace is shared by all users of the system. Please"
        + " select a different name and try again.", CATEGORY_USER_INPUT, 7, AwsS3ExceptionMessages.BucketAlreadyExists_MSG),
    /**
    ...
    BucketAlreadyOwnedByYou("Your previous request to create the named bucket succeeded and you already own it.", CATEGORY_USER_INPUT, 8,
        AwsS3ExceptionMessages.BucketAlreadyOwnedByYou_MSG),
    /**
     * The bucket you tried to delete is not empty.
     */
    BucketNotEmpty("The bucket you tried to delete is not empty.", CATEGORY_USER_INPUT, 9, AwsS3ExceptionMessages.BucketNotEmpty_MSG),
    /**
     * This request does not support credentials.
     */
    CredentialsNotSupported("This request does not support credentials.", CATEGORY_USER_INPUT, 10,
        AwsS3ExceptionMessages.CredentialsNotSupported_MSG),
    /**
    ...
    CrossLocationLoggingProhibited("Cross location logging not allowed. Buckets in one geographic location cannot log information to a "
        + "bucket in another location.", CATEGORY_USER_INPUT, 11, AwsS3ExceptionMessages.CrossLocationLoggingProhibited_MSG),
    /**
     * Your proposed upload is smaller than the minimum allowed object size.
     */
    EntityTooSmall("Your proposed upload is smaller than the minimum allowed object size.", CATEGORY_USER_INPUT, 12,
        AwsS3ExceptionMessages.EntityTooSmall_MSG),
    /**
     * Your proposed upload exceeds the maximum allowed object size.
     */
    EntityTooLarge("Your proposed upload exceeds the maximum allowed object size.", CATEGORY_USER_INPUT, 13,
        AwsS3ExceptionMessages.EntityTooLarge_MSG),
    /**
     * The provided token has expired.
     */
    ExpiredToken("The provided token has expired.", CATEGORY_USER_INPUT, 14, AwsS3ExceptionMessages.ExpiredToken_MSG),
    /**
    ...
    InvalidAccessKeyId("The AWS Access Key Id you provided does not exist in our records.", CATEGORY_CONFIGURATION, 20,
        AwsS3ExceptionMessages.InvalidAccessKeyId_MSG),
    /**
     ...
     */
    InvalidBucketName("The specified bucket is not valid.", CATEGORY_USER_INPUT, 23, AwsS3ExceptionMessages.InvalidBucketName_MSG),
    /**
     ...
     */
    InvalidPayer("All access to this object has been disabled.", CATEGORY_PERMISSION_DENIED, 30, AwsS3ExceptionMessages.InvalidPayer_MSG),
    /**
     ...
     */
    InvalidSecurity("The provided security credentials are not valid.", CATEGORY_CONFIGURATION, 34, AwsS3ExceptionMessages.InvalidSecurity_MSG),
    /**
     ...
     */
    InvalidToken("The provided token is malformed or otherwise invalid.", CATEGORY_ERROR, 38, AwsS3ExceptionMessages.InvalidToken_MSG),
    /**
     * Couldn't parse the specified URI.
     */
    InvalidURI("Couldn't parse the specified URI.", CATEGORY_USER_INPUT, 39, AwsS3ExceptionMessages.InvalidURI_MSG),
    /**
     * Your key is too long.
     */
    KeyTooLong("Your key is too long.", CATEGORY_USER_INPUT, 40, AwsS3ExceptionMessages.KeyTooLong_MSG),
    /**
     ...
     */
    MaxMessageLengthExceeded("Your request was too big.", CATEGORY_USER_INPUT, 44, AwsS3ExceptionMessages.MaxMessageLengthExceeded_MSG),
    /**
    ...
    MethodNotAllowed("The specified method is not allowed against this resource.", CATEGORY_USER_INPUT, 47,
        AwsS3ExceptionMessages.MethodNotAllowed_MSG),
    /**
     ...
     */
    NoSuchBucket("The specified bucket does not exist.", CATEGORY_USER_INPUT, 54, AwsS3ExceptionMessages.NoSuchBucket_MSG),
    /**
     * The specified key does not exist.
     */
    NoSuchKey("The specified key does not exist.", CATEGORY_USER_INPUT, 55, AwsS3ExceptionMessages.NoSuchKey_MSG),
    /**
     ...
     */
    NotSignedUp("Your account is not signed up for the Amazon S3 service.", CATEGORY_USER_INPUT, 60, AwsS3ExceptionMessages.NotSignedUp_MSG),
    /**
    ...
    OperationAborted("A conflicting conditional operation is currently in progress against this resource. Please try again.",
        CATEGORY_ERROR, 62, AwsS3ExceptionMessages.OperationAborted_MSG),
    /**
    ...
    PreconditionFailed("At least one of the preconditions you specified did not hold.",
        CATEGORY_USER_INPUT, 64, AwsS3ExceptionMessages.PreconditionFailed_MSG),
    /**
     * Temporary redirect.
     */
    Redirect("Temporary redirect.", CATEGORY_ERROR, 65, AwsS3ExceptionMessages.Redirect_MSG),
    /**
     * Object restore is already in progress.
     */
    RestoreAlreadyInProgress("Object restore is already in progress.", CATEGORY_ERROR, 66, AwsS3ExceptionMessages.RestoreAlreadyInProgress_MSG),
    /**
    ...
    TemporaryRedirect("You are being redirected to the bucket while DNS updates.", CATEGORY_WARNING, 74,
        AwsS3ExceptionMessages.TemporaryRedirect_MSG),
    /**
     * The provided token must be refreshed.
     */
    TokenRefreshRequired("The provided token must be refreshed.", CATEGORY_TRY_AGAIN, 75, AwsS3ExceptionMessages.TokenRefreshRequired_MSG),
    /**
    ...
    UnresolvableGrantByEmailAddress("The e-mail address you provided does not match any account on record.", CATEGORY_CONFIGURATION, 78,
        AwsS3ExceptionMessages.UnresolvableGrantByEmailAddress_MSG),
    /**
    ...
    private AwsS3ExceptionCode(final String message, final Category category, final int detailNumber, String displayMessage) {
