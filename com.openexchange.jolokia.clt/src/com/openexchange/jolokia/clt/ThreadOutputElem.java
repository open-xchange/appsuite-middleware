...
public class ThreadOutputElem {
    ...
    public ThreadOutputElem(final long threadId, final String threadName, final long allocatedBytes, final long cpuTime, final long userTime, final JSONArray stackTrace2) {
        this.threadId = threadId;
        this.threadName = threadName;
        this.allocatedBytes = allocatedBytes;
        this.cpuTime = cpuTime;
    ...
    public void setStackTrace(final JSONArray stackTrace) {
