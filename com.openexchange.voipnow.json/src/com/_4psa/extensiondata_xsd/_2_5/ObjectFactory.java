...
public class ObjectFactory {
    ...
    private final static QName _QueueService_QNAME = new QName("http://4psa.com/ExtensionData.xsd/2.5.1", "service");
    private final static QName _QueueWaitFor_QNAME = new QName("http://4psa.com/ExtensionData.xsd/2.5.1", "waitFor");
    private final static QName _QueueCallBetween_QNAME = new QName("http://4psa.com/ExtensionData.xsd/2.5.1", "callBetween");
    private final static QName _ConferenceInfoMohFolder_QNAME = new QName("http://4psa.com/ExtensionData.xsd/2.5.1", "mohFolder");
    private final static QName _CallRuleInfoIntervalID_QNAME = new QName("http://4psa.com/ExtensionData.xsd/2.5.1", "intervalID");
    ...
    public JAXBElement<BigDecimal> createQueueService(BigDecimal value) {
        return new JAXBElement<BigDecimal>(_QueueService_QNAME, BigDecimal.class, Queue.class, value);
    }
    ...
    public JAXBElement<BigInteger> createQueueWaitFor(BigInteger value) {
        return new JAXBElement<BigInteger>(_QueueWaitFor_QNAME, BigInteger.class, Queue.class, value);
    }
    ...
    public JAXBElement<BigInteger> createQueueCallBetween(BigInteger value) {
        return new JAXBElement<BigInteger>(_QueueCallBetween_QNAME, BigInteger.class, Queue.class, value);
    }
    ...
    public JAXBElement<String> createConferenceInfoMohFolder(String value) {
        return new JAXBElement<String>(_ConferenceInfoMohFolder_QNAME, String.class, ConferenceInfo.class, value);
    }
    ...
    public JAXBElement<BigInteger> createCallRuleInfoIntervalID(BigInteger value) {
        return new JAXBElement<BigInteger>(_CallRuleInfoIntervalID_QNAME, BigInteger.class, CallRuleInfo.class, value);
    }
    ...
    public JAXBElement<String> createIVRMohFolder(String value) {
        return new JAXBElement<String>(_ConferenceInfoMohFolder_QNAME, String.class, IVR.class, value);
    }
    ...
    public JAXBElement<String> createPhoneTerminalMohFolder(String value) {
        return new JAXBElement<String>(_ConferenceInfoMohFolder_QNAME, String.class, PhoneTerminal.class, value);
    }
