...
public class GetCustomAlertsResponseType {

    protected List<GetCustomAlertsResponseType.Button> button;
    ...
    public List<GetCustomAlertsResponseType.Button> getButton() {
        if (button == null) {
            button = new ArrayList<GetCustomAlertsResponseType.Button>();
        }
        return this.button;
    }
