...
import com._4psa.extensiondata_xsd._2_5.CardCodeList;
 ...
 *         &lt;element name="code" type="{http://4psa.com/ExtensionData.xsd/2.5.1}CardCodeList" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetCardCodeResponseType {

    protected BigInteger userID;
    protected List<CardCodeList> code;
    ...
    public List<CardCodeList> getCode() {
        if (code == null) {
            code = new ArrayList<CardCodeList>();
        }
        return this.code;
    }
