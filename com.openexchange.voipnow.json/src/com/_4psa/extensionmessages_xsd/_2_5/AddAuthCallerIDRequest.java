...
import com._4psa.extensiondata_xsd._2_5.CallerIDInfo;
 ...
 *       &lt;sequence>
 *         &lt;element name="CallerID" type="{http://4psa.com/ExtensionData.xsd/2.5.1}CallerIDInfo" maxOccurs="10"/>
 *         &lt;choice>
...
@XmlRootElement(name = "AddAuthCallerIDRequest")
public class AddAuthCallerIDRequest {

    @XmlElement(name = "CallerID", required = true)
    protected List<CallerIDInfo> callerID;
     ...
     *
     */
    public List<CallerIDInfo> getCallerID() {
        if (callerID == null) {
            callerID = new ArrayList<CallerIDInfo>();
        }
