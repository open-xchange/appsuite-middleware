...
/**
 * Get reseller response type
 * 
 * <p>Java class for GetResellersResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetResellersResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="reseller" type="{http://4psa.com/ResellerData.xsd/2.5.1}ResellerList" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "GetResellersResponseType", propOrder = {
    "reseller",
    "notice"
})
public class GetResellersResponseType {

    protected List<ResellerList> reseller;
     ...
     * 
     */
    public List<ResellerList> getReseller() {
        if (reseller == null) {
            reseller = new ArrayList<ResellerList>();
        }
