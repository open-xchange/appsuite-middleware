...
import com._4psa.channelmessages_xsd._2_5.EditChannelGroupRequest;
 ...
 *         &lt;element name="channelID" type="{http://4psa.com/Common.xsd/2.5.1}positiveInteger" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    EditChannelGroupRequest.class
})
public class ChannelGroupInfo {

    protected String name;
    protected String notes;
    protected List<BigInteger> channelID;
    ...
    public List<BigInteger> getChannelID() {
        if (channelID == null) {
            channelID = new ArrayList<BigInteger>();
        }
