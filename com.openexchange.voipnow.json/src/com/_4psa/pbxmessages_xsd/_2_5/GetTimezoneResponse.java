...
public class GetTimezoneResponse {
    ...
    protected List<GetTimezoneResponse.Timezone> timezone;
     ...
     * {@link GetTimezoneResponse.Timezone }
     * 
     * 
     */
    public List<GetTimezoneResponse.Timezone> getTimezone() {
        if (timezone == null) {
            timezone = new ArrayList<GetTimezoneResponse.Timezone>();
        }
