...
public final class VoipNowActionFactory implements AJAXActionServiceFactory {
     ...
     */
    private static final VoipNowActionFactory SINGLETON = new VoipNowActionFactory();
    ...
    /**
     * Initializes a new {@link VoipNowActionFactory}.
     */
    ...
    private Map<String, AJAXActionService> initActions() {
        ...
        tmp.put(SetFollowMeAction.ACTION, new SetFollowMeAction());
        tmp.put(FaxAuthAction.ACTION, new FaxAuthAction());
        tmp.put(GetPublicNumbersAction.ACTION, new GetPublicNumbersAction());
        tmp.put(PingAction.ACTION, new PingAction());
