...
public abstract class AbstractVoipNowAction implements AJAXActionService {
    ...
    protected static String[] checkEitherOfStringParameter(final AJAXRequestData request, final String... parameterNames) throws AjaxException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (null != parameter) {
                if (null != foundName) {
                    ...
                    throw new AjaxException(AjaxExceptionCodes.EitherParameterConflict, name, foundName);
                }
                foundName = name;
            }
            retval[i] = parameter;
        ...
        if (null == foundName) {
            throw new AjaxException(AjaxExceptionCodes.MISSING_PARAMETER, parameterNames[0]);
        }
        return retval;
    }
