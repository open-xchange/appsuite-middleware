...
public final class StaticVoipNowServerSetting {
    ...
    private static StaticVoipNowServerSetting instance;
    ...
    public static void initInstance(final ConfigurationService service) {
        synchronized (StaticVoipNowServerSetting.class) {
            if (null == instance) {
                instance = new StaticVoipNowServerSetting();
                instance.setPort(service.getIntProperty("com.4psa.voipnow.port", 443));
                instance.setHost(service.getProperty("com.4psa.voipnow.host", "localhost").trim());
                instance.setSecure(Boolean.parseBoolean(service.getProperty("com.4psa.voipnow.secure", "true").trim()));
                instance.setLogin(service.getProperty("com.4psa.voipnow.adminLogin", "").trim());
                instance.setPassword(service.getProperty("com.4psa.voipnow.adminPassword", "").trim());
                instance.setPasswordHttp(service.getProperty("com.4psa.voipnow.adminPasswordHTTP", "").trim());
            }
        }
    }

    /**
     * Releases the static setting instance.
     */
    ...
    /**
     * Initializes a new {@link StaticVoipNowServerSetting}.
     */
    private StaticVoipNowServerSetting() {
        super();
    }
