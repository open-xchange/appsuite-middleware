...
import com.openexchange.voipnow.json.Constants;
...
public final class VoipNowMultipleHandlerFactory implements MultipleHandlerFactoryService {
    ...
    /**
     * Initializes a new {@link VoipNowMultipleHandlerFactory}.
     */
    public VoipNowMultipleHandlerFactory() {
        super();
    }

    public MultipleHandler createMultipleHandler() {
        return new MultipleAdapter(VoipNowActionFactory.getInstance());
    }
