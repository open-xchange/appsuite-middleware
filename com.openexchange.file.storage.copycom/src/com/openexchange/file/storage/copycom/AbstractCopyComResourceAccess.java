...
/**
 * {@link AbstractCopyComResourceAccess}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public abstract class AbstractCopyComResourceAccess {
    ...
    protected static <T> T parseIntoObject(InputStream inputStream, Class<T> clazz) throws OXException {
        try {
            ...
            throw CopyComExceptionCodes.JSON_ERROR.create(e, e.getMessage());
        } catch (JsonMappingException e) {
            throw CopyComExceptionCodes.JSON_ERROR.create(e, e.getMessage());
        } catch (JsonParseException e) {
            throw CopyComExceptionCodes.JSON_ERROR.create(e, e.getMessage());
        } catch (IOException e) {
            throw CopyComExceptionCodes.IO_ERROR.create(e, e.getMessage());
    ...
    protected final CopyComAccess copyComAccess;
    ...
    protected OXException handleIOError(IOException e) {
        ...
        return CopyComExceptionCodes.IO_ERROR.create(e, e.getMessage());
    }
    ...
    protected OXException handleHttpResponseError(String identifier, HttpResponseException e) {
        if (null != identifier && SC_NOT_FOUND == e.getStatusCode()) {
            return CopyComExceptionCodes.NOT_FOUND.create(e, identifier);
        }
        if (SC_UNAUTHORIZED == e.getStatusCode()) {
            return CopyComExceptionCodes.UNLINKED_ERROR.create();
        }
        return CopyComExceptionCodes.COPY_COM_SERVER_ERROR.create(e, Integer.valueOf(e.getStatusCode()), e.getMessage());
    }

    /**
     * Gets the Copy.com folder identifier from given file storage folder identifier
     *
     * @param folderId The file storage folder identifier
     * @return The appropriate Copy.com folder identifier
     */
    protected String toCopyComFolderId(String folderId) {
