 ...
 */
public final class CopyComFileStorageService implements AccountAware, OAuthUtilizerCreator, OAuthAccountDeleteListener {

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CopyComFileStorageService.class);
    ...
    /**
     * Initializes a new {@link CopyComFileStorageService}.
     */
    private CopyComFileStorageService() {
        super();
    ...
    public void onAfterOAuthAccountDeletion(int oauthAccountId, Map<String, Object> eventProps, int user, int cid, Connection con) {
        try {
            ...
            for (FileStorageAccount deleteMe : toDelete) {
                ...
                LOG.info("Deleted Copy.com account with ID {} as OAuth account {} was deleted for user {} in context {}", deleteMe.getId(), oauthAccountId, user, cid);
            }
    ...
    public String createUtilizer(OAuthAccount oauthAccount, Session session) throws OXException {
        ...
        fileStorageAccount.setDisplayName("Copy.com");
        ...
        LOG.info("Created Copy.com account with ID {} for user {} in context {}", accountId, session.getUserId(), session.getContextId());
        return accountId;
    }
    ...
    public FileStorageAccountAccess getAccountAccess(final String accountId, final Session session) throws OXException {
        ...
        return new CopyComAccountAccess(this, account, session);
    }
