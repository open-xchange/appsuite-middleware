...
/**
 * {@link CopyComEventHandler} - The {@link EventHandler event handler}.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class CopyComEventHandler implements EventHandler {

    /**
     * The logger constant.
     */
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CopyComEventHandler.class);

    /**
     * Initializes a new {@link CopyComEventHandler}.
     */
    public CopyComEventHandler() {
        super();
    }
    ...
    public void handleEvent(final Event event) {
        ...
        try {
            if (SessiondEventConstants.TOPIC_REMOVE_SESSION.equals(topic) || SessiondEventConstants.TOPIC_STORED_SESSION.equals(topic)) {
                ...
                if (!session.isTransient() && CopyComAccessRegistry.getInstance().removeAccessIfLast(session.getContextId(), session.getUserId())) {
