...
import com.openexchange.file.storage.copycom.CopyComConstants;
import com.openexchange.file.storage.copycom.CopyComFileStorageService;
import com.openexchange.oauth.OAuthAccountDeleteListener;
import com.openexchange.oauth.OAuthUtilizerCreator;

/**
 * {@link CopyComServiceRegisterer}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class CopyComServiceRegisterer implements ServiceTrackerCustomizer<FileStorageAccountManagerProvider, FileStorageAccountManagerProvider> {

    private final BundleContext context;
    private volatile FileStorageAccountManagerProvider provider;
    private volatile CopyComFileStorageService service;
    ...
    /**
     * Initializes a new {@link CopyComServiceRegisterer}.
     */
    public CopyComServiceRegisterer(final BundleContext context) {
        super();
        this.context = context;
    }

    /** For testing only */
    public CopyComFileStorageService getService() {
        return service;
    }
    ...
    public FileStorageAccountManagerProvider addingService(final ServiceReference<FileStorageAccountManagerProvider> reference) {
        ...
        if (!provider.supports(CopyComConstants.ID)) {
        ...
        synchronized (this) {
            ...
            if (null == service) {
                ...
                if (null == compositeProvider) {
                    ...
                    service = CopyComFileStorageService.newInstance(compositeProvider);
                    this.serviceRegistration = context.registerService(FileStorageService.class, service, null);
                    this.creatorRegistration = context.registerService(OAuthUtilizerCreator.class, service, null);
                    this.listenerRegistration = context.registerService(OAuthAccountDeleteListener.class, service, null);
                    this.service = service;
