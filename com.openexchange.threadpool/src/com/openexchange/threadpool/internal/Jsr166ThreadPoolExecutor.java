 ...
 * Jsr166RejectedExecutionHandler#rejectedExecution} method of its {@link
 * Jsr166RejectedExecutionHandler}.  Four predefined handler policies are
 * provided:
 *
 * <ol>
 *
 * <li> In the default {@link Jsr166ThreadPoolExecutor.AbortPolicy}, the
 * handler throws a runtime {@link RejectedExecutionException} upon
 * rejection. </li>
 *
 * <li> In {@link Jsr166ThreadPoolExecutor.CallerRunsPolicy}, the thread
 * that invokes {@code execute} itself runs the task. This provides a
 * simple feedback control mechanism that will slow down the rate that
 * new tasks are submitted. </li>
 *
 * <li> In {@link Jsr166ThreadPoolExecutor.DiscardPolicy}, a task that
 * cannot be executed is simply dropped.  </li>
 *
 * <li>In {@link Jsr166ThreadPoolExecutor.DiscardOldestPolicy}, if the
 ...
 * Jsr166RejectedExecutionHandler} classes. Doing so requires some care
 ...
 * @author Doug Lea
 */
public class Jsr166ThreadPoolExecutor extends AbstractExecutorService {
    /**
    ...
    private static int runStateOf(final int c)     { return c & ~CAPACITY; }
    private static int workerCountOf(final int c)  { return c & CAPACITY; }
    private static int ctlOf(final int rs, final int wc) { return rs | wc; }
     ...
     */
    private volatile Jsr166RejectedExecutionHandler handler;
     ...
     */
    private static final Jsr166RejectedExecutionHandler defaultHandler =
        new AbortPolicy();
    ...
    final boolean isRunningOrShutdown(final boolean shutdownOK) {
        final int rs = runStateOf(ctl.get());
     ...
     */
    public Jsr166ThreadPoolExecutor(final int corePoolSize,
    ...
    public Jsr166ThreadPoolExecutor(final int corePoolSize,
                              ...
                              final TimeUnit unit,
                              final BlockingQueue<Runnable> workQueue,
                              final Jsr166RejectedExecutionHandler handler) {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
     ...
     */
    public void setRejectedExecutionHandler(final Jsr166RejectedExecutionHandler handler) {
        if (handler == null) {
            throw new NullPointerException();
        }
        this.handler = handler;
     ...
     */
    public Jsr166RejectedExecutionHandler getRejectedExecutionHandler() {
        return handler;
    }
     ...
     */
    void ensurePrestart() {
        final int wc = workerCountOf(ctl.get());
        if (wc < corePoolSize) {
            addWorker(null, true);
        } else if (wc == 0) {
            addWorker(null, false);
    ...
    public String toString() {
        ...
        final int c = ctl.get();
        final String rs = (runStateLessThan(c, SHUTDOWN) ? "Running" :
     ...
     * is discarded.
     */
    public static class CallerRunsPolicy implements Jsr166RejectedExecutionHandler {
        /**
         ...
         */
        @Override
        public void rejectedExecution(final Runnable r, final Jsr166ThreadPoolExecutor e) {
            if (!e.isShutdown()) {
                r.run();
            }
        }
     ...
     */
    public static class AbortPolicy implements Jsr166RejectedExecutionHandler {
        /**
     ...
     * rejected task.
     */
    public static class DiscardPolicy implements Jsr166RejectedExecutionHandler {
        /**
     ...
     */
    public static class DiscardOldestPolicy implements Jsr166RejectedExecutionHandler {
        /**
