...
public interface RefusedExecutionBehavior {
    ...
    /**
     * Method that may be invoked by a {@link ThreadPoolService} when <tt>submit()</tt> method cannot accept a task. This may occur when no more
     * threads or queue slots are available because their bounds would be exceeded, or upon shutdown of the thread pool. In the absence
     ...
     */
    void refusedExecution(Runnable r, ThreadPoolService threadPool);
