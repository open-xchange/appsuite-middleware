...
public class ManagementRegisterer implements ServiceTrackerCustomizer<ManagementService, ManagementService> {
     ...
     */
    public ManagementRegisterer(CacheEventMonitor monitor, BundleContext context) {
        super();
    ...
    private void registerMBean(ManagementService management) {
        ...
        if (objectName == null) {
            synchronized (this) {
                ...
                if (objectName == null) {
                    try {
                        objectName = getObjectName(CacheEventMBean.NAME, CacheEventMBean.DOMAIN);
                        management.registerMBean(objectName, new CacheEventMBeanImpl(monitor));
