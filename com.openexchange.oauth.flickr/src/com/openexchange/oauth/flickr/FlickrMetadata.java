...
package com.openexchange.oauth.flickr;
...
public class FlickrMetadata extends AbstractOAuthServiceMetaData {
	...
	@Override
	public String getId() {
		return "com.openexchange.oauth.flickr";
	}

	@Override
	public String getAPIKey() {
		final ConfigurationService configurationService = services
				.getService(ConfigurationService.class);
		return configurationService.getProperty(
				"com.openexchange.oauth.flickr.apiKey", "");
	}
	...
	public String getAPISecret() {
		final ConfigurationService configurationService = services
				.getService(ConfigurationService.class);
		return configurationService.getProperty(
				"com.openexchange.oauth.flickr.apiSecret", "");
	}
