 ...
 */
public class OldTaskIterator implements SearchIterator {

    /**
     * Logger.
     */
    private static final Log LOG = LogFactory.getLog(OldTaskIterator.class);
     ...
     */
    OldTaskIterator(final Context ctx, final int userId, final ResultSet result,
