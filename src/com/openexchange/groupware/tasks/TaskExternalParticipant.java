 ...
 */
public class TaskExternalParticipant extends TaskParticipant {

    private final ExternalUserParticipant external;

    TaskExternalParticipant(final ExternalUserParticipant external) {
        super();
    ...
    public boolean equals(final Object obj) {
        if (!(obj instanceof TaskExternalParticipant)) {
            return false;
        }
        final TaskExternalParticipant other = (TaskExternalParticipant) obj;
