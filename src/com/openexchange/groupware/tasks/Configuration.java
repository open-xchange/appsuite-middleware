...
/**
 * This class contains the configuration parameters for the tasks.
 * @author <a href="mailto:marcus@open-xchange.org">Marcus Klein</a>
 */
public final class Configuration {

    /**
     * Name of the property that contains if creator can be added as participant
     * to tasks.
     */
    private static final String CREATOR_AS_PARTICIPANT = "CreatorAsParticipant";
