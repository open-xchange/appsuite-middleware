    ...
    public void deletePerformed(final DeleteEvent event,
        ...
        try {
            ...
            case DeleteEvent.TYPE_USER:
                TaskStorage.getInstance().deleteUser(event.getContext(),
                    readCon, writeCon, event.getId());
                break;
            case DeleteEvent.TYPE_GROUP:
                TaskStorage.getInstance().deleteGroup(event.getContext(),
                    writeCon, event.getId());
                break;
