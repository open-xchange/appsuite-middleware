...
public class OXCalendarException extends OXException {
    ...
    public enum Code {
        ...
        INSERT_WITH_OBJECT_ID("Insert expected but the objectid is already given. Aborting action", 14, AbstractOXException.Category.CODE_ERROR),
        UPDATE_WITHOUT_OBJECT_ID("Update expected but no objectid is given. Aborting action", 15, AbstractOXException.Category.CODE_ERROR),
        ...
        CONTEXT_NOT_SET("CalendarOperation: Context not set.", 35, AbstractOXException.Category.CODE_ERROR),
        ...
        UPDATE_EXCEPTION("Fatal error. An database update exception occurred.", 66, AbstractOXException.Category.INTERNAL_ERROR),
        ;
