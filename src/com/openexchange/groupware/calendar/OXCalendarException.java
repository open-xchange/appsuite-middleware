...
public class OXCalendarException extends OXException {
    ...
    public enum Code {
        CFO_NOT_INITIALIZIED("FATAL: CalendarFolderObject not initialized!", 1, AbstractOXException.Category.PROGRAMMING_ERROR),
        NOT_YET_SUPPORTED("Not yet supported!", 2, AbstractOXException.Category.PROGRAMMING_ERROR),
        NO_SHARED_FOLDER_OWNER("Shared folder owner not given !", 3, AbstractOXException.Category.PROGRAMMING_ERROR),
        FOLDER_TYPE_UNRESOLVEABLE("Folder type unresolvable !", 4, AbstractOXException.Category.PROGRAMMING_ERROR),
        CALENDAR_SQL_ERROR("Unexpected SQL Error!", 5, AbstractOXException.Category.SUBSYSTEM_OR_SERVICE_DOWN),
        LAST_MODIFIED_IS_NULL("clientLastModified IS NULL. Abort action!", 6, AbstractOXException.Category.PROGRAMMING_ERROR),
        ...
        UPDATE_WITHOUT_PARTICIPANTS("FATAL: Would create an object without participants", 9, AbstractOXException.Category.PROGRAMMING_ERROR),
        ...
        ERROR_SESSIONOBJECT_IS_NULL("SessionObject not initialized", 12, AbstractOXException.Category.PROGRAMMING_ERROR),
        NO_PERMISSION("You do not have the necessary permissions", 13, AbstractOXException.Category.PERMISSION),
        INSERT_WITH_OBJECT_ID("Insert expected but the objectid is already given. Aborting action", 14, AbstractOXException.Category.PROGRAMMING_ERROR),
        UPDATE_WITHOUT_OBJECT_ID("Update expected but no objectid is given. Aborting action", 15, AbstractOXException.Category.PROGRAMMING_ERROR),
        FOLDER_DELETE_INVALID_REQUEST("Invalid request. Folder is shared!", 16, AbstractOXException.Category.PROGRAMMING_ERROR),
        FOLDER_FOREIGN_INVALID_REQUEST("Invalid request. Folder is shared!", 17, AbstractOXException.Category.PROGRAMMING_ERROR),
        FOLDER_IS_EMPTY_INVALID_REQUEST("Invalid request. Folder is shared!", 18, AbstractOXException.Category.PROGRAMMING_ERROR),
        FREE_BUSY_UNSUPPOTED_TYPE("Unsupported type detected : %d", 19, AbstractOXException.Category.PROGRAMMING_ERROR),
        ...
        MOVE_NOT_SUPPORTED("Move not supported: Source:Destination %d:%d", 33, AbstractOXException.Category.PROGRAMMING_ERROR),
        SHARED_FOLDER_MOVE_NOT_SUPPORTED("Move not allowed from shared folders", 34, AbstractOXException.Category.PROGRAMMING_ERROR),
        CONTEXT_NOT_SET("CalendarOperation: Context not set.", 35, AbstractOXException.Category.PROGRAMMING_ERROR),
        ...
        RECURRING_MISSING_START_DATE("Missing start date, unable to calculate recurring!", 39, AbstractOXException.Category.PROGRAMMING_ERROR),
        RECURRING_MISSING_DAILY_INTERVAL("Fatal error. (DAILY) Missing or wrong value interval : %d", 40, AbstractOXException.Category.USER_INPUT),
        RECURRING_MISSING_WEEKLY_INTERVAL("Fatal error. (WEEKLY) Missing or wrong value interval : %d", 41, AbstractOXException.Category.USER_INPUT),
        ...
        RECURRING_MISSING_MONTLY_DAY("Fatal error. (MONTHLY2) Missing or wrong value day : %d", 44, AbstractOXException.Category.USER_INPUT),
        RECURRING_MISSING_MONTLY_DAY_2("Fatal error. (MONTHLY2) Missing or wrong DayInMonthvalue day : %d", 45, AbstractOXException.Category.USER_INPUT),
        ...
        RECURRING_MISSING_YEARLY_INTERVAL_2("Fatal error. (YEARLY2) Missing or wrong interval : %d", 49, AbstractOXException.Category.USER_INPUT),
        UNABLE_TO_REMOVE_PARTICIPANT("Unable to remove Participant %d", 50, AbstractOXException.Category.PROGRAMMING_ERROR),
        ...
        UNSUPPORTED_ACTION_TYPE("Action type not supported : %d", 52,  AbstractOXException.Category.PROGRAMMING_ERROR),
        SEARCH_ITERATOR_NULL("SearchIterator NULL", 53, AbstractOXException.Category.PROGRAMMING_ERROR),
        ...
        PRIVATE_MOVE_TO_PUBLIC("Moving a private flag to a public folder is not allowed!", 57, AbstractOXException.Category.USER_INPUT),
        LOAD_PERMISSION_EXCEPTION_1("You do not have the appropriate permissions to modify this object.", 57, AbstractOXException.Category.PERMISSION),
        LOAD_PERMISSION_EXCEPTION_2("Got the wrong folder identification. You do not have the appropriate permissions to modify this object.", 58, AbstractOXException.Category.PERMISSION),
        LOAD_PERMISSION_EXCEPTION_3("Got the wrong shared folder identification. You do not have the appropriate permissions to modify this object.", 59, AbstractOXException.Category.PERMISSION),
        LOAD_PERMISSION_EXCEPTION_4("You do not have the appropriate permissions to move this object.", 60, AbstractOXException.Category.PERMISSION),
