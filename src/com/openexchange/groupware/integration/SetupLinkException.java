 ...
 */
public class SetupLinkException extends AbstractOXException {
     ...
     */
    public SetupLinkException(final Code code, final Object... messageArgs) {
     ...
     * @param messageArgs arguments that will be formatted into the message.
     */
    public SetupLinkException(final Code code, final Throwable cause,
