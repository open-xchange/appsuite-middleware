...
public abstract class SettingStorage {
     ...
     * @param userId Unique identifier of the user that stores a setting.
     * @param setting the setting to store.
     * @throws SettingException if an error occurs while saving the setting.
     */
    public abstract void save(int userId, Setting setting)
     ...
     * @throws SettingException if an error occurs while saving the setting.
     */
    public abstract void readValues(int userId, Setting setting)
        throws SettingException;
