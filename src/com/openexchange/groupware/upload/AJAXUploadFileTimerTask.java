 ...
 * 
 */
public final class AJAXUploadFileTimerTask extends TimerTask {

	private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory
			.getLog(AJAXUploadFileTimerTask.class);
	 ...
	 * Constructor
	 */
	public AJAXUploadFileTimerTask(final AJAXUploadFile file, final long maxIdleTime, final String id,
	...
	public void run() {
		if (file != null && !file.isDeleted() && !file.isBlockedForTimer()
				&& ((System.currentTimeMillis() - file.getLastAccess()) >= maxIdleTime)) {
