 ...
 * instances of <code>com.openexchange.api2.MailInterface</code> are going to
 * be closed before removed from cache
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class IMAPConnectionEventHandler extends ElementEventHandlerWrapper {

	private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory
			.getLog(IMAPConnectionEventHandler.class);

	public IMAPConnectionEventHandler() {
		super();
	}
	...
	/**
	 * Closes given <code>com.openexchange.api2.MailInterface</code> instance
	 */
	private final void close(final DefaultIMAPConnection imapCon) {
		try {
