...
public class JSProcessor implements OXErrorCodeProcessor {
	...
	private void initConfig() {
		...
		if(includeCat != null) {
			this.include = true;
			categories = parseCateogories(includeCat);
		} else if (excludeCat != null) {
			categories = parseCateogories(excludeCat);
			this.include = false;
		} else {
