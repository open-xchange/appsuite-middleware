...
public class OXCollections {
	...
	public static <L,C> L inject(L list, Iterable<C> iterable, Injector<L,C> injector){
	...
	public static <C> List<C> inject(Iterable<C> iterable, Injector<List<C>,C> injector) {
