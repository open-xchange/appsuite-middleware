...
public abstract class User2IMAP {
	...
	public static enum IMAPServer {
		/**
		 * Cyrus: <code>com.openexchange.imap.user2imap.CyrusUser2IMAP</code>
		 */
		CYRUS("Cyrus", "com.openexchange.imap.user2imap.CyrusUser2IMAP"),
		/**
		 * Courier:
		 * <code>com.openexchange.imap.user2imap.CourierUser2IMAP</code>
		 */
		COURIER("Courier", "com.openexchange.imap.user2imap.CourierUser2IMAP");
	...
	private static final Object[] getIMAPServer(final User sessionUser) throws IMAPException {
		...
		} else if (IMAPLoginType.USER.equals(IMAPProperties.getImapLoginType())) {
