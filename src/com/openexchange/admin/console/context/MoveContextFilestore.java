...
public class MoveContextFilestore extends ContextAbtraction {    
 ...
 public MoveContextFilestore(final String[] args2) {
        ...
        try {
            ...
            final Filestore fs = new Filestore(Integer.parseInt((String)parser.getOptionValue(targetFilestoreIDOption)));
    ...
    private void setOptions(AdminParser parser) {
        ...
        targetFilestoreIDOption = setShortLongOpt(parser, OPT_FILESTORE_SHORT,OPT_FILESTORE_LONG,"Target filestore id",true, true);
