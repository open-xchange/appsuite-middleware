...
public class MoveContextDatabase extends BasicCommandlineOptions {    
 ...
 public MoveContextDatabase(String[] args2) {
        ...
        try {
            ...
            Database db = new Database(Integer.parseInt(cmd.getOptionValue(OPT_DATABASE_SHORT)));
    ...
    private Options getOptions() {
        ...
        Option db = getShortLongOpt(OPT_DATABASE_SHORT, OPT_DATABASE_LONG, "Target database id", true, true);
        retval.addOption(db);
