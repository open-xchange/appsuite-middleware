...
//    private final static String OPT_NAME_DATABASE_ID_SHORT = "i";
...
//
//            final String db_id = cmd.getOptionValue(OPT_NAME_DATABASE_ID_SHORT);
//
//            oxutil.unregisterDatabase(Integer.parseInt(db_id), auth);
...
//
//        retval.addOption(addDefaultArgName(getShortLongOpt(OPT_NAME_DATABASE_ID_SHORT, OPT_NAME_DATABASE_ID_LONG, "the id of the filestore which should be deleted", true, true)));
//        return retval;
//    }
//
//}
