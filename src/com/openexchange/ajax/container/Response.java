...
public class Response {
     ...
     */
    private static final String ERROR_CATEGORY = "category";
     ...
     * @throws JSONException if putting the attributes into the json object
     * fails.
     */
    ...
    public static Response parse(final String body) throws JSONException {
        ...
        if (message != null || code != null) {
            ...
            retval.exception = new AbstractOXException(component, category,
                number, message, null);
            if (response.has(ERROR_ID)) {
                retval.exception.overrideExceptionID(
                    response.getString(ERROR_ID));
            }
            parseErrorMessageArgs(response.optJSONArray(ERROR_PARAMS),
                retval.exception);
            parseTruncatedIds(response.optJSONArray(TRUNCATED),
                retval.exception);
        }
        return retval;
    }
     ...
     * @param code error code to parse.
     ...
     * @param jArgs the json array with the error message arguments or
     * <code>null</code>.
     * @param exception the error message arguments will be stored in this
     * exception.
     * @throws JSONException if reading the error message arguments from the
     * JSON array fails.
     */
     ...
     * @param jTrunc the json array with the truncated attribute identifier or
     * <code>null</code>.
     * @param exception the truncated attribute identifier will be stored in
     * this exception.
     * @throws JSONException if reading the truncated attribute identifier from
     * the JSON array fails.
     */
    private static void parseTruncatedIds(final JSONArray jTrunc,
        final AbstractOXException exception) throws JSONException {
        if (null != jTrunc) {
     ...
     */
    public static void write(final Response response,
