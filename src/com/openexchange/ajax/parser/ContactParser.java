...
public class ContactParser extends CommonParser {
	...
	public void parse(ContactObject contactobject, JSONObject jsonobject) throws OXException {
		try {
	...
	protected void parseElementContact(ContactObject contactobject, JSONObject jsonobject) throws Exception {
	...
	protected void parseDistributionList(ContactObject oxobject, JSONObject jsonobject) throws Exception {
		JSONArray jdistributionlist = jsonobject.getJSONArray(ContactFields.DISTRIBUTIONLIST);
	...
	protected void parseLinks(ContactObject oxobject, JSONObject jsonobject) throws Exception {
		JSONArray jlinks = jsonobject.getJSONArray(ContactFields.LINKS);
	...
	private JSONAttributeMapper[] mapping = new JSONAttributeMapper[] {
		new JSONAttributeMapper() {
			...
			public void setObject(ContactObject contactobject,
		...
		new JSONAttributeMapper() {
			...
			public void setObject(ContactObject contactobject,
				JSONObject jsonobject) throws Exception {
				String image = parseString(jsonobject, ContactFields.IMAGE1);
				if (image != null) {					
