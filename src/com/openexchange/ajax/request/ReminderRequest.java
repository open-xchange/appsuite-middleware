...
public class ReminderRequest {
    ...
    private JSONArray actionDelete(final JSONObject jsonObject) throws OXMandatoryFieldException, JSONException, OXException, OXJSONException, AjaxException {
        ...
        try {
            final int uid = sessionObj.getUserObject().getId();
...
//            throw new OXException("SQLException occurred", e);
    ...
    protected boolean hasModulePermission(final SessionObject sessionObj, final ReminderObject reminderObj) {
     ...
     **/
    protected ReminderObject getLatestRecurringReminder(final int objectId, final int inFolder, final SessionObject sessionObj, final Date endRange, final Date oldReminderDate) throws OXException, SQLException {
        ...
        final RecurringResults recurringResults = CalendarRecurringCollection.calculateRecurring(calendarDataObject, startRange.getTime(),  endRange.getTime(), 0, 0, false, uid, cid);
    ...
    protected ReminderObject getNextRecurringReminder(final int objectId, final int recurrencePosition, final int inFolder, final SessionObject sessionObj) throws OXException, SQLException {
        ...
        final RecurringResults recurringResults = CalendarRecurringCollection.calculateRecurring(calendarDataObject, 0, 0, recurrencePosition+1, 0, false, uid, cid);
