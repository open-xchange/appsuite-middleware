 ...
 * del_infostore* database but not in the filestore
 * 
 * @author Dennis Sieben
 *
 */
public class DBDelProblemSolver extends ProblemSolver {
	 ...
	 */
	public DBDelProblemSolver(DatabaseImpl database, FileStorage storage,
			AttachmentBase attachment) {
		super(database, storage, attachment);
	}
