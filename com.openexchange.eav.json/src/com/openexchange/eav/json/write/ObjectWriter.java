 ...
 */
public class ObjectWriter extends AbstractWriter<EAVNode> {

    {
        TYPES = EnumSet.of(EAVType.OBJECT);
    }

    public void write(EAVNode node, JSONObject json) throws JSONException, EAVJsonException {
        JSONObject childJson = new JSONObject();
        for (EAVNode childNode : node.getChildren()) {
            chain.write(childNode, childJson);
        }
