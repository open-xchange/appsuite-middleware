...
public class FileStorageJSONActivator extends AJAXModuleActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class[] { FileStorageServiceRegistry.class, IDBasedFileAccessFactory.class, AttachmentBase.class, FolderService.class, EventAdmin.class };
    }
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            com.openexchange.log.Log.loggerFor(FileStorageJSONActivator.class).error(x.getMessage(), x);
            throw x;
        }
    }
