...
public class FileServlet extends MultipleAdapterServletNew {
    ...
    @Override
    protected boolean handleIndividually(String action, AJAXRequestData data, HttpServletRequest req, HttpServletResponse res) throws IOException, AbstractOXException {
        if (action.equals(DOCUMENT)) {
            AJAXInfostoreRequest request = new AJAXInfostoreRequest(data, getSessionObject(req));
