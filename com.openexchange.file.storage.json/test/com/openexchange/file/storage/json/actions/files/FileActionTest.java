 ...
 */
public abstract class FileActionTest extends TestCase {
    ...
    public TestFriendlyInfostoreRequest request() {
        final FileStorageFileAccess files;
    ...
    public void checkResult(JSONAssertion assertion) {
        JSONAssertion.assertValidates(assertion, result.getResultObject());
    }
    
    public JSONAssertion assertion() {
