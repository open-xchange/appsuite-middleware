...
public class Strings implements LocalizableStrings {
    ...
    public static final String SPOUSE_NAME = "Spouse name";
    ...
    public static final String MANAGER_NAME = "Manager's name";
    public static final String ASSISTANT_NAME = "Assistant's name";
    ...
    public static final String TELEPHONE_CAR = "Telephone car";
    ...
    public static final String TELEPHONE_PAGER = "Telephone pager";
    public static final String TELEPHONE_PRIMARY = "Telephone primary";
    public static final String TELEPHONE_RADIO = "Telephone radio";
    public static final String TELEPHONE_TELEX = "Telephone telex";
    public static final String TELEPHONE_TTYTDD = "Telephone TTY/TDD";
    ...
    public static final String TELEPHONE_IP = "Telephone IP";
