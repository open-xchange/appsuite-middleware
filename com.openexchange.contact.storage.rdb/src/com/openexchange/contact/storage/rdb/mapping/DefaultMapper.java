...
public abstract class DefaultMapper<O, E extends Enum<E>> implements Mapper<O, E> {
	...
	private final EnumMap<E, Mapping<? extends Object, O>> mappings;
	
	public DefaultMapper() {
		this.mappings = createMappings();
	}
	
	protected abstract EnumMap<E, Mapping<? extends Object, O>> createMappings();
	...
	@Override
	public Mapping<? extends Object, O> get(E field) throws OXException {
		final Mapping<? extends Object, O> mapping = this.mappings.get(field);
		if (null == mapping) {
    ...
    public Set<E> filter(final E[] fields, final EnumSet<E> validFields) {
        return filter(fields, validFields, (E[])null);
    }
        
    public Set<E> filter(final E[] fields, final EnumSet<E> validFields, final E... mandatoryFields) {
