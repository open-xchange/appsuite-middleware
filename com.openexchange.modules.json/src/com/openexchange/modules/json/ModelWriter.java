...
public class ModelWriter<T extends Model<T>> {
    ...
    public JSONObject write(T thing) throws JSONException {
        return write(thing, metadata.getAllFields());
    }

    public JSONObject write(T thing, List<Attribute<T>> attributes) throws JSONException {
        JSONObject object = new JSONObject();
        for (Attribute<T> attribute : attributes) {
            Object value = thing.get(attribute);
            Object overridden = overrides.handle(attribute, value, thing);
            object.put(attribute.getName(), (overridden != null) ? overridden : value);
        }
        return object;
    }
