...
public class ChangeByModuleAccess {
    ...
    @XmlElementRef(name = "moduleAccess", namespace = "http://soap.admin.openexchange.com", type = JAXBElement.class)
    protected JAXBElement<UserModuleAccess> moduleAccess;
     ...
     *     
     */
    public JAXBElement<UserModuleAccess> getModuleAccess() {
        return moduleAccess;
    }
     ...
     *     
     */
    public void setModuleAccess(JAXBElement<UserModuleAccess> value) {
