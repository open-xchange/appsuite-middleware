...
public class User {
     ...
     * 
     * @param remoteRemoteContent The {@link Boolean} to set
     */
    public void setRemoteContentAllowed(Boolean remoteRemoteContent) {
        this.remoteContentAllowed = remoteRemoteContent;
    }
