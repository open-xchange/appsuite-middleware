...
public class NoSuchUserException_Exception extends java.lang.Exception {
    ...
    private com.openexchange.admin.soap.user.soap.NoSuchUserException noSuchUserException;
    ...
    public NoSuchUserException_Exception(String message, com.openexchange.admin.soap.user.soap.NoSuchUserException noSuchUserException) {
        super(message);
        this.noSuchUserException = noSuchUserException;
    }

    public NoSuchUserException_Exception(String message, com.openexchange.admin.soap.user.soap.NoSuchUserException noSuchUserException, Throwable cause) {
        super(message, cause);
        this.noSuchUserException = noSuchUserException;
    }

    public com.openexchange.admin.soap.user.soap.NoSuchUserException getFaultInfo() {
