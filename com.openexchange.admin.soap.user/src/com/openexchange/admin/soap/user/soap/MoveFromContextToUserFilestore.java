...
@XmlType(name = "", propOrder = { "ctx", "user", "dstFilestoreId", "maxQuota", "auth"
})
@XmlRootElement(name = "moveFromContextToUserFilestore")
public class MoveFromContextToUserFilestore {
