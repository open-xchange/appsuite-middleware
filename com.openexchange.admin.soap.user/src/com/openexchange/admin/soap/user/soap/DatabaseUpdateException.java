...
public class DatabaseUpdateException {
    ...
    protected com.openexchange.admin.soap.user.exceptions.DatabaseUpdateException databaseUpdateException;
     ...
     * @return
     *     possible object is
     *     {@link com.openexchange.admin.soap.user.exceptions.DatabaseUpdateException }
     *     
     */
    public com.openexchange.admin.soap.user.exceptions.DatabaseUpdateException getDatabaseUpdateException() {
     ...
     *     
     */
    public void setDatabaseUpdateException(com.openexchange.admin.soap.user.exceptions.DatabaseUpdateException value) {
