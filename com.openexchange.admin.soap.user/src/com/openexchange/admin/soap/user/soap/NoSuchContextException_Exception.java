...
public class NoSuchContextException_Exception extends java.lang.Exception {
    ...
    private com.openexchange.admin.soap.user.soap.NoSuchContextException noSuchContextException;
    ...
    public NoSuchContextException_Exception(String message, com.openexchange.admin.soap.user.soap.NoSuchContextException noSuchContextException) {
        super(message);
        this.noSuchContextException = noSuchContextException;
    }

    public NoSuchContextException_Exception(String message, com.openexchange.admin.soap.user.soap.NoSuchContextException noSuchContextException, Throwable cause) {
        super(message, cause);
        this.noSuchContextException = noSuchContextException;
    }

    public com.openexchange.admin.soap.user.soap.NoSuchContextException getFaultInfo() {
