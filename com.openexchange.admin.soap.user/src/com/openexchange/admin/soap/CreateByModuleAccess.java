...
public class CreateByModuleAccess {
    ...
    @XmlElementRef(name = "access", namespace = "http://soap.admin.openexchange.com", type = JAXBElement.class)
    protected JAXBElement<UserModuleAccess> access;
     ...
     *     
     */
    public JAXBElement<UserModuleAccess> getAccess() {
        return access;
    }
     ...
     *     
     */
    public void setAccess(JAXBElement<UserModuleAccess> value) {
        this.access = value;
    }
