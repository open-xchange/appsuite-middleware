...
public class CalendarAdministration implements CalendarAdministrationService {
    ...
    private void deleteUserFromAppointments(final DeleteEvent deleteEvent, final Connection readcon, final Connection writecon) throws SQLException, OXException {
        ...
        try {
            ...
            replace.append(collection.getFieldName(AppointmentObject.CREATED_BY));
            replace.append(" = ");
            replace.append(deleteEvent.getContext().getMailadmin());
            replace.append(", ");
            replace.append(collection.getFieldName(AppointmentObject.LAST_MODIFIED));
            replace.append(" = ");
            ...
            replace_modified_by.append(collection.getFieldName(AppointmentObject.MODIFIED_BY));
            replace_modified_by.append(" = ");
            replace_modified_by.append(deleteEvent.getContext().getMailadmin());
            replace_modified_by.append(", ");
            replace_modified_by.append(collection.getFieldName(AppointmentObject.LAST_MODIFIED));
            replace_modified_by.append(" = ");
    ...
    public final void initializeUpdateString() {
        ...
        u1.append(collection.getFieldName(AppointmentObject.MODIFIED_BY));
        u1.append(" = ? ,");
        u1.append(collection.getFieldName(AppointmentObject.LAST_MODIFIED));
        u1.append(" = ? ");
        u1.append(" WHERE cid = ? AND ");
        u1.append(collection.getFieldName(AppointmentObject.OBJECT_ID));
        u1.append(" = ?");
    }
