 ...
 */
public class Bug56420Test extends AbstractSanitizing {
    ...
    @Test
    public void testIntacHtmlFragment() throws Exception {
        String content = "<div dir=\"ltr\">Nest</div>";
        ...
        assertTrue("Unexpected content: " + sanitized, sanitized.indexOf("&lt;") < 0);
    }
