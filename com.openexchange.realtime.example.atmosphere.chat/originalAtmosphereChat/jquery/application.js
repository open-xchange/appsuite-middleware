...
//        req.url = document.location.toString() + 'chat';
        req.url = "http://"+document.location.toString().split('/')[2]+"/realtime/atmosphere/chat";
    ...
    var request = {url : "http://"+document.location.toString().split('/')[2]+"/realtime/atmosphere/chat",
