...
public final class FacebookDOMParser {
     ...
     * @throws FacebookMessagingException If parsing fails
     */
    public static List<Element> parseXMLResponse(final String xmlReponse) throws FacebookMessagingException {
        try {
            /*
