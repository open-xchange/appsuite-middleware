...
/**
 * {@link FacebookSessionRenewalTask} - Task to renew existing facebook sessions to prevent them from expiration.
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since Open-Xchange v6.16
 */
public final class FacebookSessionRenewalTask implements Runnable {

    private static final org.apache.commons.logging.Log LOG =
        org.apache.commons.logging.LogFactory.getLog(FacebookSessionRenewalTask.class);

    /**
     * Initializes a new {@link FacebookSessionRenewalTask}.
     */
    public FacebookSessionRenewalTask() {
        super();
    }
    ...
    public void run() {
        try {
            ...
            LOG.error(
                new StringBuilder(64).append("Run of facebook session renewal task failed with: ").append(e.getMessage()).toString(),
                e);
        }
    }
