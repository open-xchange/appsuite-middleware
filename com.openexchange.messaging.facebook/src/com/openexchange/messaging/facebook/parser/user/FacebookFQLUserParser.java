 ...
 */
public final class FacebookFQLUserParser {
    ...
    /**
     * Initializes a new {@link FacebookFQLUserParser}.
     */
    private FacebookFQLUserParser() {
        super();
    }
    ...
    public static FacebookUser parseUserDOMElement(final Element userElement) throws MessagingException {
         ...
         * Iterate child nodes
         */
        final NodeList childNodes = userElement.getChildNodes();
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (null != localName) {
                ...
                if (null == itemHandler) {
                    org.apache.commons.logging.LogFactory.getLog(FacebookFQLUserParser.class).warn("Un-handled item: " + localName);
                } else {
