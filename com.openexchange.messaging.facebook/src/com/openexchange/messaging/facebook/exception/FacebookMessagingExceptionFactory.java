...
package com.openexchange.messaging.facebook.exception;
...
public final class FacebookMessagingExceptionFactory extends Exceptions<FacebookOXException> {
     ...
     */
    private FacebookMessagingExceptionFactory() {
        super();
    }
     ...
     */
    public static FacebookMessagingExceptionFactory getInstance() {
        return SINGLETON;
    }
    ...
    protected void knownExceptions() {
        declareAll(FacebookMessagingExceptionCodes.values());
    }
}
