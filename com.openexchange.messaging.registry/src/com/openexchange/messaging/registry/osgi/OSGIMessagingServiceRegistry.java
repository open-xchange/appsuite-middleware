...
import com.openexchange.messaging.MessagingComponent;
...
public class OSGIMessagingServiceRegistry implements MessagingServiceRegistry {
    ...
    public MessagingService getMessagingService(String id) throws MessagingException {
        ...
        throw new MessagingException(MessagingComponent.INSTANCE, Category.SUBSYSTEM_OR_SERVICE_DOWN, 1, "Can not find MessagingService with id: "+id, null);
    }
