...
/**
 * {@link AllocatingStringWriter} - An unsynchronized {@link java.io.Writer}.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class AllocatingStringWriter extends Writer {
     ...
     */
    public AllocatingStringWriter(final int initialSize) {
        if (initialSize < 0) {
     ...
     */
    public AllocatingStringWriter(final StringAllocator buf) {
        if (null == buf) {
     ...
     */
    @Override
    public AllocatingStringWriter append(final CharSequence csq) {
        if (csq == null) {
            write("null");
        } else {
            write(csq.toString());
     ...
     */
    @Override
    public AllocatingStringWriter append(final CharSequence csq, final int start, final int end) {
     ...
     */
    @Override
    public AllocatingStringWriter append(final char c) {
        write(c);
        return this;
    }
