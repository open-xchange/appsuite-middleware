...
public class SessiondException extends AbstractOXException {
	 ...
	 */
	public SessiondException(final Category category, final String message, final int detailNumber,
	...
	public SessiondException(final EnumComponent component, final Category category, final int number,
	...
	public enum Code {
		SESSIOND_EXCEPTION("Sessiond Exception", 1, AbstractOXException.Category.CODE_ERROR), MAX_SESSION_EXCEPTION(
				"Max Session size reached", 2, AbstractOXException.Category.CODE_ERROR), SESSIOND_CONFIG_EXCEPTION(
				"Sessiond Config Exception", 3, AbstractOXException.Category.CODE_ERROR), MISSING_PROPERTY(
				"Missing property '%s'", 4, AbstractOXException.Category.SETUP_ERROR),
		/**
		 ...
		 */
		MAX_SESSION_PER_USER_EXCEPTION("Max. session size for user %1$s in context %2$s exceeded", 7,
