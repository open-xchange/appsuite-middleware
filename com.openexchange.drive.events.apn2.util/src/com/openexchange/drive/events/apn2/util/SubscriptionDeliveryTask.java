...
public abstract class SubscriptionDeliveryTask extends AbstractTask<Void> {
     ...
     */
    protected SubscriptionDeliveryTask(Subscription subscription, DriveEvent event, ApnsHttp2Options options, DriveSubscriptionStore subscriptionStore) {
        super();
    ...
    private void processNotificationResponse(NotificationResponseAndSubscription notificationResponseAndSubscription) throws InterruptedException {
        ...
        try {
            ...
            if (pushNotificationResponse.isAccepted()) {
                ...
                if (pushNotificationResponse.getTokenInvalidationTimestamp() != null) {
                    ...
                    removeSubscription(subscription, subscriptionStore);
                } else {
