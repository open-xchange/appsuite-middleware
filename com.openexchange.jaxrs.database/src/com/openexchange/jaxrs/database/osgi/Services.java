...
public final class Services {
    ...
    public static <S extends Object> S getService(final Class<? extends S> clazz) throws OXException {
        ...
        if (null == serviceLookup) {
            throw new IllegalStateException("Missing ServiceLookup instance. Bundle 'com.openexchange.jaxrs.database' not started?");
        }
        S service = serviceLookup.getService(clazz);
        if (service != null) {
            return service;
        }
        throw ServiceExceptionCode.SERVICE_UNAVAILABLE.create(clazz);
    }
