...
/**
 * {@link ResourceException} - This exception is used if problems occur in the
 * resource component.
 * 
...
public class ResourceException extends AbstractOXException {
	...
	public enum Code {
		 ...
		 * SQL Problem: "%s".
		 */
		SQL_ERROR("SQL Problem: \"%s\"", Category.CODE_ERROR, Detail.ERROR, 2),
		/**
		 * Cannot find resource group with identifier %d.
		 */
		RESOURCEGROUP_NOT_FOUND("Cannot find resource group with identifier %d.", Category.CODE_ERROR, Detail.ERROR, 3),
		/**
		 * Found resource groups with same identifier %d.
		 */
		RESOURCEGROUP_CONFLICT("Found resource groups with same identifier %d.", Category.CODE_ERROR, Detail.ERROR, 4),
		/**
