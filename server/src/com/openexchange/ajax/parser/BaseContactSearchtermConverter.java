 ...
 * 
 * Implementations of this need to implement the abstract method which maps
 * column names to database field names.
 * 
 * @author tobiasprinz
 *
 * @param <T>
 */
public abstract class BaseContactSearchtermConverter {
	 ...
	 * @return
	 */
	abstract protected String translateFromJSONtoDB(String fieldvalue);
