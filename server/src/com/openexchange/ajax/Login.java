...
public class Login extends AJAXServlet {
    ...
    private String parseClient(final HttpServletRequest req, final boolean strict) throws AjaxException {
    ...
    private static String parseAuthId(final HttpServletRequest req, final boolean strict) throws AjaxException {
        final String authId;
