...
public final class AJAXRequestResult {
    ...
    private Collection<AbstractOXException> warnings;
     ...
     */
    public AJAXRequestResult(final Object resultObject, String format) {
     ...
     * @param format The format of the result object
     */
    public AJAXRequestResult(final Object resultObject, final Date timestamp, String format) {
        super();
    ...
    public Collection<AbstractOXException> getWarnings() {
        return null == warnings ? Collections.<AbstractOXException> emptySet() : Collections.unmodifiableCollection(warnings);
    }
