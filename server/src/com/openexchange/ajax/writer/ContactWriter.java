        ...
        */	
        ...
        if (contact.containsImage1()) {
            ...
            if (null == imageService) {
                final org.apache.commons.logging.Log logger = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(ContactWriter.class)));
