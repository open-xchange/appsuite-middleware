...
/**
 * {@link MultiGetCustomizer}
 *
 * @author <a href="mailto:francisco.laguna@open-xchange.com">Francisco Laguna</a>
 *
 */
public class MultiGetCustomizer extends MultiReadCustomizer<FolderGetCustomizer> implements FolderGetCustomizer {

    public void appendData(JSONWriter jsonwriter, FolderObject fo) {
        for(FolderGetCustomizer customizer : customizers) {
    ...
    @Override
    protected MultiReadCustomizer<FolderGetCustomizer> newInstance() {
        return new MultiGetCustomizer();
    }
