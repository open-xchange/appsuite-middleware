...
/**
 * {@link AliasCharset} - An alias charset that delegates unknown charset names
...
public final class AliasCharset extends Charset {
	 ...
	 * 
	 * @param canonicalName
	 *            The canonical name of the alias charset
	 * @param aliases
	 *            An array of this charset's aliases, or <code>null</code> if
	 *            it has no aliases
	 * @param delegate
	 *            The delegate charset
	 */
