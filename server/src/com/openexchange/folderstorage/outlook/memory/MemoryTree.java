...
public final class MemoryTree {
    ...
    /**
     * Initializes a new {@link MemoryTree}.
     */
    public MemoryTree() {
        super();
    ...
    private static final class MemoryCRUDImpl implements MemoryCRUD {
        ...
        public MemoryFolder putIfAbsent(final String folderId, final MemoryFolder folder) {
            ...
            if (null == prev) {
                ...
                if (null == set) {
                    final Set<MemoryFolder> newset = new HashSet<MemoryFolder>();
