...
/**
 * {@link Clear} - Serves the <code>CLEAR</code> request.
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class Clear extends AbstractAction {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(Clear.class);
     ...
     */
    public Clear(final ServerSession session) {
        super(session);
    }
     ...
     */
    public Clear(final User user, final Context context) {
        super(user, context);
    }
