...
/**
 * {@link Path} - Serves the <code>PATH</code> request.
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class Path extends AbstractUserizedFolderAction {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(Path.class);
    ...
    /**
     * Initializes a new {@link Path} from given user-context-pair.
     * 
     * @param user The user
