        ...
        try {
            ...
            if (null != stmt) {
                try {
                    ...
                    com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(VirtualFolderDeleteListener.class))).error(e.getMessage(), e);
                }
            }
        }
