...
/**
 * {@link ImageRegistry} - The image registry which bounds images to a session
 * or a context. A heart-beat to session service/context storage checks if
 * session/context is still valid.
 * 
