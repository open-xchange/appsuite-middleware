...
/**
 * {@link ImageAJAXRequest}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class ImageAJAXRequest {
    ...
    /**
     * Initializes a new {@link ImageAJAXRequest}.
     *
     * @param session The session
     * @param request The request
     */
    public ImageAJAXRequest(final AJAXRequestData request, final ServerSession session) {
        super();
