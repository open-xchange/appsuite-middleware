...
/**
 * {@link AbstractImageAction}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public abstract class AbstractImageAction implements AJAXActionService {
    ...
    /**
     * Initializes a new {@link AbstractImageAction}.
     */
    protected AbstractImageAction(final ServiceLookup services) {
        super();
    ...
    public AJAXRequestResult perform(final AJAXRequestData request, final ServerSession session) throws OXException {
        try {
            final ImageAJAXRequest ir = new ImageAJAXRequest(request, session);
            final String sTimeZone = request.getParameter(AJAXServlet.PARAMETER_TIMEZONE);
            if (null != sTimeZone) {
                ir.setTimeZone(getTimeZone(sTimeZone));
            }
            return perform(ir);
    ...
    /**
     * Performs specified image request.
     *
     ...
     */
    protected abstract AJAXRequestResult perform(ImageAJAXRequest req) throws OXException, JSONException;
