...
/**
 * {@link NonBlockingRWLock} - A non-blocking read-write lock accomplished by a
 * <b>compare-and-set</b> mechanism.
 * <p>
 * The write lock can only be acquired exclusively, but the read lock can be
 * held by multiple threads simultaneously, as long as no write lock is
 * acquired.
 * 
...
public final class NonBlockingRWLock {
	 ...
	 * 
	 * @param prevState
	 *            The previous state when read lock was acquired
	 * @return <code>true</code> if previous state still equals current state
	 *         and thus read lock has been released successfully; otherwise
	 *         <code>false</code>
	 */
