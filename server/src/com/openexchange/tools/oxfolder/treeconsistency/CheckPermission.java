...
abstract class CheckPermission {
    ...
    protected void broadcastEvent(final int folderId, final boolean deleted, final EventAdmin eventAdmin) {
        if (null != eventAdmin) {
            ...
            final org.apache.commons.logging.Log logger = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(CheckPermission.class)));
