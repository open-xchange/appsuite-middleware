...
/**
 * The folder error code enumeration.
 */
public enum OXFolderExceptionCodes {
    /**
     ...
     * </p>
     */
    NO_MODULE_ACCESS("User %1$s has no access to module %2$s in context %3$s due to user configuration", Category.CATEGORY_USER_INPUT, 2),
    /**
     ...
     * </p>
     */
    NO_SHARED_FOLDER_ACCESS("User %1$s has no access on shared folder %2$s in context %3$s due to user configuration", Category.CATEGORY_PERMISSION_DENIED, 4),
    /**
     ...
     * </p>
     */
    NO_PUBLIC_FOLDER_WRITE_ACCESS("User %1$s has no write access on public folder %2$s in context %3$s due to user configuration", Category.CATEGORY_PERMISSION_DENIED, 5),
    /**
     ...
     * </p>
     */
    NO_CREATE_SUBFOLDER_PERMISSION("User %1$s has no create-subfolder permission on folder %2$s in context %3$s", Category.CATEGORY_PERMISSION_DENIED, 6),
    /**
     ...
     * </p>
     */
    ONLY_ONE_PRIVATE_FOLDER_ADMIN("Only one admin permission is allowed on a private folder", Category.CATEGORY_ERROR, 15),
    /**
     ...
     * </p>
     */
    NO_PRIVATE_FOLDER_ADMIN_GROUP("A group must not hold admin permission on a private folder", Category.CATEGORY_ERROR, 16),
    /**
     ...
     * </p>
     */
    ONLY_PRIVATE_FOLDER_OWNER_ADMIN("Only folder owner may hold admin permission on a private folder", Category.CATEGORY_ERROR, 17),
    /**
     ...
     * </p>
     */
    NO_EFFECTIVE_PERMISSION("Effective permission of folder %1$s could not be determined for user %2$s in context %3$s", Category.CATEGORY_ERROR, 37),
    /**
     ...
     */
    NO_WRITE_PERMISSION("User %1$s has no write permission on folder %2$s in context %3$s", Category.CATEGORY_PERMISSION_DENIED, 54),
    /**
     ...
     */
    SHARE_FORBIDDEN("User %1$s is not allowed to share folder %2$s in context %3$s due to user configuration", Category.CATEGORY_PERMISSION_DENIED, 72),
    /**
     ...
     * context %3$s.
     */
    UNAPPLICABLE_FOLDER_PERM("The permissions for the user %1$s are limited. It is not possible to grant this user the wanted permissions for the folder %2$s in context %3$s.", Category.CATEGORY_PERMISSION_DENIED, 73),
    /**
    ...
    private OXFolderExceptionCodes(final String message, final Category category, final int detailNumber) {
    ...
    public OXException create(final Object... arguments) {
        return create((Throwable) null, arguments);
    }
     ...
     * @return The newly created {@link OXException} instance.
     */
    public OXException create(final Category category, final Object... arguments) {
        final OXException ret;
        if (LogLevel.DEBUG.equals(category.getLogLevel())) {
            ret = new OXException(detailNumber, message, null, arguments);
        } else {
            ret = new OXException(detailNumber, OXExceptionStrings.MESSAGE, new Object[0]);
