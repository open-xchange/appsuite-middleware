...
public final class OXFolderUtility {
	 ...
	 * @param userIds
	 *            The user IDs
	 * @param allSharedFolders
	 *            The shared folders
	 * @param folderName
	 *            The folder name of the folder that shall be shared
	 * @param ctx
	 *            The context
	 * @throws OXFolderException
	 *             If a similar named shared folder is already shared to a user
	 */
	 ...
	 * 
	 * @param checkMe
	 *            The folder whose name shall be checked
	 * @throws OXFolderException
	 *             If folder name contains invalid characters
	 */
	 ...
	 *            The context
	 * @throws OXException
	 *             If specified folder's permissions do not pass the checks
	 */
	 ...
	 *            The context
	 * @throws OXException
	 *             If an user tries to share a folder although he is not allowed
	 *             to
	 */
	 ...
	 * 
	 * @param newPerms
	 *            The update-operation permissions
	 * @param storagePerms
	 *            The storage-version permissions
	 ...
	 *            The ID of possible descendant folder
	 * @param readCon
	 ...
	 *            The set of user IDs
	 * @param ctx
	 *            The context (possibly needed to resolve group)
	 */
