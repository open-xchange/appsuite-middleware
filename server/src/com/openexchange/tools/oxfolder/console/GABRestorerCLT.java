    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            try {
                ...
                // Cannot occur
                com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(GABRestorerCLT.class))).error(e.getMessage(), e);
            } finally {
                jmxConnector.close();
            }
