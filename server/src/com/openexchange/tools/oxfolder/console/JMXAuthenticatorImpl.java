...
final class JMXAuthenticatorImpl implements JMXAuthenticator {
    ...
    private static String makeSHAPasswd(final String raw) {
        ...
        try {
            ...
            com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(JMXAuthenticatorImpl.class))).error(e.getMessage(), e);
            return raw;
        }
