...
public final class OXFolderAdminHelper {
    ...
    private static int getContextAdminID(final int cid, final Connection readCon) throws OXException {
        try {
            ...
            if (retval == -1) {
                throw new OXFolderException(OXFolderExceptionCode.NO_ADMIN_USER_FOUND_IN_CONTEXT, Integer.valueOf(cid));
            }
            return retval;
        } catch (final DBPoolingException e) {
            throw new OXFolderException(OXFolderExceptionCode.DBPOOLING_ERROR, e, Integer.valueOf(cid));
        } catch (final SQLException e) {
            throw new OXFolderException(OXFolderExceptionCode.SQL_ERROR, e, e.getMessage());
        }
    }
    ...
    private static void propagateDisplayNameModification(final int userId, final long lastModified, final int contextAdminID, final Connection readCon, final Connection writeCon, final int cid) throws OXException {
        ...
        try {
            ...
            throw new OXFolderException(OXFolderExceptionCode.LDAP_ERROR, e, Integer.valueOf(cid));
        }
    }
