...
//                    if (mapiProp.getType() != MAPIProp.PT_BINARY) {
...
//            }
             ...
             * Sender
             */
            String sSenderSearchKeyEmail = findProp(MAPIProp.PR_SENDER_SEARCH_KEY, mapiProps);
             ...
             */
            s = findProp(MAPIProp.PR_SENDER_EMAIL_ADDRESS, mapiProps);
             ...
             * Start date
             */
            Date d = findProp(MAPIProp.PR_START_DATE, mapiProps);
            // s = remove(s, '-', ':');
             ...
             */
            // s = findProp(MAPIProp.PR_PROVIDER_UID, mapiProps);
            s = findProp(0x1035, mapiProps);
