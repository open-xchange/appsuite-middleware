...
/**
 * This class implements the data container for the attributes of a resource
 * group.
...
public class ResourceGroup {
    ...
    /**
     * The display name of the group. Currently the identifier is used as
     * display name so this attribute will also be filled with the identifier.
     * But the identifier is limited in the characters that can be used and a
     * display name won't be limited.
     */
    ...
    /**
     * Returns if the resource group is available. The resources of the group
     * can only be booked if the group is available.
    ...
    public int[] getMember() {
        int[] retval = new int[member.length];
