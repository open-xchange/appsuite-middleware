    ...
    public void perform(final PerformParameters params) throws AbstractOXException {
        ...
        for (final Iterator<Map.Entry<Integer, List<Integer>>> it = m.entrySet().iterator(); it.hasNext();) {
            ...
            try {
                ...
                final org.apache.commons.logging.Log LOG = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(MailAccountMigrationTask.class)));
