 ...
 */
public class ProgressStatusImpl implements ProgressStatus {
    ...
    private void logState(int current) {
        LOG.info("Update task " + taskName + " finished " + (current * 100 / total) + "% on schema " + schema + '.');
    }
}
