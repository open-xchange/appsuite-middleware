...
public class OXCalendarException extends OXException {
    ...
    public enum Code {
        ...
        UID_ALREDY_EXISTS("Cannot insert appointment (%1$s). An appointment with the unique identifier (%2$s) already exists.", 100, Category.USER_INPUT),
        /** SQL Problem. */
        ...
        INVALID_SEQUENCE("Invalid Sequence value: %1$d", 105, Category.USER_INPUT);
