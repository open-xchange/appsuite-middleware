...
public class Regexp implements PreferencesItemService {
    ...
    public String[] getPath() {
        return new String[] { "modules", "com.openexchange.user.passwordchange", "regexp" };
    }
    ...
    public IValueHandler getSharedValue() {
        return new ReadOnlyValue() {
            ...
            public void getValue(Session session, Context ctx, User user, UserConfiguration userConfig, Setting setting) {
                ...
                String property = service.getProperty("com.openexchange.passwordchange.regexp", "[^a-z0-9]");
