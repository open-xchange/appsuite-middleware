...
public final class UserConfigurationStorageInit implements Initialization {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.exception.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(UserConfigurationStorageInit.class));
    ...
    public void start() throws AbstractOXException {
        ...
        if (null == classNameProp) {
            throw new UserConfigurationException(UserConfigurationCodes.MISSING_SETTING, Property.USER_CONF_STORAGE.getPropertyName());
        }
        try {
            ...
            throw new UserConfigurationException(UserConfigurationCodes.CLASS_NOT_FOUND, e, classNameProp);
