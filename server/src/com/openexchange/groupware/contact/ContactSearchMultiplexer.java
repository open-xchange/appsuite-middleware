...
public class ContactSearchMultiplexer {
    ...
    public SearchIterator<Contact> extendedSearch(ServerSession session, ContactSearchObject search, int orderBy, Order order, int[] cols) throws AbstractOXException {
