...
public class ContactExceptionFactory extends Exceptions<OXException> {
    ...
    private ContactExceptionFactory() {
        super();
    }

    public static final ContactExceptionFactory getInstance() {
        return SINGLETON;
    }

    @Override
    protected void knownExceptions() {
        declareAll(ContactExceptionCodes.values());
    }
