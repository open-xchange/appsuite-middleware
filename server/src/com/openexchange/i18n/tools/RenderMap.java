...
public final class RenderMap implements Cloneable {
	 ...
	 * 
	 * @param replacement
	 *            The replacement to put into this map
	 ...
	 * 
	 * @param token
	 *            The token whose associated value is to be returned
	 ...
	 * 
	 * @param token
	 *            The token whose presence in this map is to be tested
	 ...
	 * 
	 * @param token
	 *            The token whose mapping is to be removed from the map
	 * @return The previous replacement associated with specified token, or
