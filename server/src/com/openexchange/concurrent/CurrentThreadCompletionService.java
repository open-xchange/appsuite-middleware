...
/**
 * {@link CurrentThreadCompletionService} - A {@link CompletionService} that uses submitting thread to perform the task.
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class CurrentThreadCompletionService<V> implements CompletionService<V> {
    ...
    /**
     * Initializes a new {@link CurrentThreadCompletionService} with an unbound {@link BlockingQueue}.
     */
    public CurrentThreadCompletionService() {
        super();
