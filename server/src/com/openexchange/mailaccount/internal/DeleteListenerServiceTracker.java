...
public final class DeleteListenerServiceTracker implements ServiceTrackerCustomizer {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(DeleteListenerServiceTracker.class)));
    ...
    public void removedService(final ServiceReference reference, final Object service) {
        if (null != service) {
            try {
                DeleteListenerRegistry.getInstance().removeDeleteListener((MailAccountDeleteListener) service);
            } finally {
                context.ungetService(reference);
            }
        }
