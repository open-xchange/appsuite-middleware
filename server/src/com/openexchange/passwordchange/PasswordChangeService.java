...
public abstract class PasswordChangeService {
	...
	private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory
			.getLog(PasswordChangeService.class);
	 ...
	 * 
	 * @param event
	 *            The event containing the session of the user whose password
	 ...
	 *            password (needed for verification)
	 * @throws UserException
	 *             If permission is denied to update password
	 */
	...
	/**
	 * Propagates changed password throughout system: invalidate caches,
	 * propagate to sub-systems like mail, etc.
	 * 
	 * @param event
	 *            The event containing the session of the user whose password
	 *            shall be changed, the context, the new password, and the old
	...
	private final void propagate(final PasswordChangeEvent event) throws UserException {
		 ...
		 */
		try {
			MailAccessCache.getInstance().removeMailAccess(event.getSession());
	...
	/**
	 * Utility method to encode given <code>newPassword</code> according to
	 * specified encoding mechanism
	 * 
	 * @param mech
	 *            The encoding mechanism; currently supported values:
	 *            <code>&quot;{CRYPT}&quot;</code> and
	 *            <code>&quot;{SHA}&quot;</code>
	 * @param newPassword
	 *            The new password to encode
	 * @return The encoded password
	 * @throws UserException
	 *             If encoding the new password fails
	 */
