...
public interface MailMessageHandler {
	 ...
	 */
	public boolean handleInlinePlainText(String plainTextContent, ContentType contentType, long size, String fileName,
			String id) throws MailException;

	/**
	 * Handle a UUEncoded plain text inline part
	 */
	public boolean handleInlineUUEncodedPlainText(String decodedTextContent, ContentType contentType, int size,
	 ...
	 */
	public boolean handleInlineHtml(String htmlContent, ContentType contentType, long size, String fileName, String id)
			throws MailException;

	/**
	 * Handle an attachment part (any non-inline parts and file attachments)
	 */
	public boolean handleAttachment(MailPart part, boolean isInline, String baseContentType, String fileName, String id)
			throws MailException;
