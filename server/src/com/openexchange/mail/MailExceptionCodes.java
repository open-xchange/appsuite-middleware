...
/**
 * The mail error code enumeration.
 * <p>
...
public enum MailExceptionCodes {
    ...
    private MailExceptionCodes(final String message, final Category category, final int detailNumber) {
    ...
    private MailExceptionCodes(final MailExceptionCodes source) {
     ...
     * Creates an {@link OXException} instance using this error code.
     * 
     * @param arguments The arguments for log message.
     * @return The newly created {@link OXException} instance.
     */
    ...
    public OXException create(final Throwable cause, final Object... arguments) {
        ...
        if (display) {
            ...
            ret =
                new OXException(
                    detailNumber,
                    EnumType.TRY_AGAIN.equals(category.getType()) ? MailExceptionStrings.MAIL_MESSAGE_RETRY : MailExceptionStrings.MAIL_MESSAGE,
                    cause);
        }
        return ret.setPrefix(PREFIX).addCategory(category).setLogMessage(message, arguments);
    }
}
