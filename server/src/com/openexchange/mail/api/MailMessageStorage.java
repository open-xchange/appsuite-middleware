...
/**
 * {@link MailMessageStorage} - Offers basic access methods to mail message storage.
 * 
...
public abstract class MailMessageStorage {
     ...
     */
    public abstract long[] copyMessages(String sourceFolder, String destFolder, long[] mailIds, boolean fast) throws MailException;
     ...
     */
    public MailPart getImageAttachment(final String folder, final long mailId, final String contentId) throws MailException {
     ...
     * <p>
     * This is a convenience method that invokes {@link #getMessages(String, long[], MailField[])} with specified mail ID and
     ...
     */
    public void updateMessageColorLabel(final String folder, final long[] mailIds, final int colorLabel) throws MailException {
        // Empty body here
    }
     ...
     * the {@link SpamHandler#handleSpam(String, long[], boolean, MailAccess)}/
     * {@link SpamHandler#handleHam(String, long[], boolean, MailAccess)} methods needs to be executed.
     * 
     * @param folder The folder fullname
     * @param mailIds The mail IDs
