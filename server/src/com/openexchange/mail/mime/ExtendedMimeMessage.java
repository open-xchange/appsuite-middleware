 ...
 * attributes to store message informations such as its UID.
 * 
...
public final class ExtendedMimeMessage extends MimeMessage {
	 ...
	 *             If parsing the input stream fails
	 */
	 ...
	 * 
	 * @param hasAttachment
	 *            <code>true</code> to mark this message to hold attachments;
