...
public final class MIMEMultipartMailPart extends MailPart {
	 ...
	 * @throws IOException
	 *             If accessing data source's input stream fails
	 */
	 ...
	 * @param computedFailures
	 *            The computed failures where the pattern matches against
	 *            itself; leave to <code>null</code> to compute from within
