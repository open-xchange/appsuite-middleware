...
public final class SessionMailCache {
    ...
    public static void clearAll(final Session session) {
        try {
            ...
            // SWALLOW
            final org.apache.commons.logging.Log logger = com.openexchange.exception.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(SessionMailCache.class));
