...
public final class EventPool implements Runnable {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(EventPool.class)));
    ...
    public void run() {
        ...
        try {
            ...
            com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(EventPool.class))).error(t.getMessage(), t);
        } finally {
            blocker.unblock();
        }
    }
