...
/**
 * {@link AbortQuotaChecker} - A {@link IQuotaChecker quota checker} that throws a {@link MailException} on exceeded quota (either overall
 * or per-file quota).
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
final class AbortQuotaChecker implements IQuotaChecker {

    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(AbortQuotaChecker.class);
    ...
    /**
     * Initializes a new {@link AbortQuotaChecker}.
     * 
     * @param session The session providing needed user information
     * @throws MailException If initialization fails
     */
    public AbortQuotaChecker(final Session session) throws MailException {
        super();
        try {
