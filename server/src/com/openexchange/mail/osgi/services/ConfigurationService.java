...
package com.openexchange.mail.osgi.services;
...
public final class ConfigurationService extends ServiceHolder<Configuration> {
	 ...
	 */
	public static ServiceHolder<Configuration> getInstance() {
		return com.openexchange.config.services.ConfigurationService.getInstance();
	}
