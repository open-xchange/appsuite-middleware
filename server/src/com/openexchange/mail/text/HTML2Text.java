...
/**
 * {@link HTML2Text} - This class converts HTML content to valid text/plain based on {@link HTMLEditorKit}.
 * 
...
public final class HTML2Text {
    ...
    /**
     * Initializes a new {@link HTML2Text} with default capacity of <code>8192</code>
     * 
     * @param appendHref <code>true</code> to append <i>href</i> and <i>src</i> attributes' content in brackets; otherwise
     *            <code>false</code>.<br>
    ...
    public String html2text(final String html) throws IOException {
        ...
        /*
         * Parse HTML document (true means to ignore character set). Unfortunately the HTMLEditorKit.Parser cannot deal with XHTML conform
         * HTML content, thus simple tags such as "img" or "br" must not end with " />" but with ">"
         */
    ...
    private static final class HTML2TextParserCallback extends HTMLEditorKit.ParserCallback {
        ...
        public void handleEndTag(final HTML.Tag tag, final int pos) {
            if (tag.equals(HTML.Tag.BLOCKQUOTE)) {
                ...
                anchorTag = false;
            } else if (tag.equals(HTML.Tag.H1) || tag.equals(HTML.Tag.H2) || tag.equals(HTML.Tag.H3) || tag.equals(HTML.Tag.H4) || tag.equals(HTML.Tag.H5) || tag.equals(HTML.Tag.H6) || tag.equals(HTML.Tag.ADDRESS) || tag.equals(HTML.Tag.PRE)) {
                textBuilder.append(CRLF);
                quoteText();
                textBuilder.append(CRLF);
                quoteText();
