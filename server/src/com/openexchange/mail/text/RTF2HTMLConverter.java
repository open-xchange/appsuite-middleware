...
public final class RTF2HTMLConverter {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(RTF2HTMLConverter.class)));
    ...
    private static void readString(final String s, final Document document, final RTFEditorKit rtfeditorkit) {
        try {
            final ByteArrayInputStream bytearrayinputstream = new UnsynchronizedByteArrayInputStream(s.getBytes("US-ASCII"));
