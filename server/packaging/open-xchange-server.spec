...
BuildArch:	noarch
BuildRequires:  ant open-xchange-common open-xchange-global open-xchange-conversion open-xchange-conversion-engine open-xchange-configread open-xchange-monitoring open-xchange-cache open-xchange-xml
%if 0%{?suse_version}
...
Requires:       open-xchange-global open-xchange-configread open-xchange-global open-xchange-conversion open-xchange-conversion-engine open-xchange-monitoring open-xchange-management open-xchange-cache open-xchange-xml
%if 0%{?suse_version}
%if %{?suse_version} <= 1010
# SLES10
