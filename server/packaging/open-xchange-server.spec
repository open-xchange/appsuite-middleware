...
BuildArch:	noarch
BuildRequires:  ant open-xchange-common open-xchange-global open-xchange-configread open-xchange-monitoring
...
Requires:       open-xchange-global open-xchange-configread open-xchange-global open-xchange-monitoring open-xchange-management
%if 0%{?suse_version}
%if 0%{?suse_version} <= 1010
# SLES10
...
Requires:	open-xchange-server open-xchange-config open-xchange-authentication open-xchange-control open-xchange-configjump open-xchange-charset open-xchange-sessiond, mysql >= 5.0.0
