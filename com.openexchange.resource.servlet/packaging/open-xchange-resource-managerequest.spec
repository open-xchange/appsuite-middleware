...
Name:           open-xchange-resource-managerequest
BuildArch:	noarch
...
Summary:        The Open-Xchange Server Resource Manage Request Bundle
Requires:       open-xchange-common open-xchange-global open-xchange-server
#

%description
The Open-Xchange Server Resource Manage Request Bundle
