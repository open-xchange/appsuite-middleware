...
/**
 * {@link AbstractIndexAction}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public abstract class AbstractIndexAction implements AJAXActionService {

    private static final AJAXRequestResult RESULT_JSON_NULL = new AJAXRequestResult(JSONObject.NULL, "json");

    protected final ServiceLookup services;

    protected final ResultConverters registry;

    /**
     * Initializes a new {@link AbstractIndexAction}.
     */
    protected AbstractIndexAction(final ServiceLookup services, final ResultConverters registry) {
        super();
    ...
    public AJAXRequestResult perform(final AJAXRequestData requestData, final ServerSession session) throws OXException {
        try {
            return perform(new IndexAJAXRequest(requestData, session));
    ...
    /**
     * Performs specified chat account request.
     *
     * @param req The chat account request
     * @return The result
     * @throws OXException If an error occurs
     * @throws JSONException If a JSON error occurs
     */
    protected abstract AJAXRequestResult perform(IndexAJAXRequest req) throws OXException, JSONException;
