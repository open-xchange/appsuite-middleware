...
Name:           open-xchange-outlook-updater
BuildArch:	noarch
...
%description
Generates a preconfigured installer for the updater for m$ windows and the supplies the XML file to allow a preconfigured installation of the oxtender for m$ outlook.
...
%dir /opt/open-xchange/files/
%dir /opt/open-xchange/bundles/
%dir /opt/open-xchange/etc/*/osgi/bundle.d/
/opt/open-xchange/templates/*
/opt/open-xchange/files/*
