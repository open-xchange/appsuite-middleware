...
/**
 * MailFilterConfigImpl
 *
 * @author <a href="mailto:sebastian.kauss@open-xchange.com">Sebastian Kauss</a>
 */
public class MailFilterConfigImpl implements MailFilterConfig {
	
	public MailFilterConfigImpl() {
		
	}

	public ConfigTestHolder[] getTests() {
		final String[] comparisons = { IsComparison.IS };

		final ConfigTestHolder configTest = new ConfigTestHolder(HeaderTest.HEADER, comparisons);
		return new ConfigTestHolder[] { configTest };
	}
	
	public String[] getActionCommands() {
		return new String[] { Stop.STOP };
	}
}
