...
public final class HeaderCacheStaticProperties extends AbstractProtocolProperties {
    ...
    private static final HeaderCacheStaticProperties instance = new HeaderCacheStaticProperties();
    ...
    /**
     * Initializes a new {@link HeaderCacheStaticProperties}.
     */
    private HeaderCacheStaticProperties() {
        super();
    }
    ...
    protected void loadProperties0() throws OXException {
        ...
        final ConfigurationService configuration = HeaderCacheServiceRegistry.getService(ConfigurationService.class);
        {
