...
public final class HeaderCacheMailProviderServiceTracker implements ServiceTrackerCustomizer {
    ...
    /**
     * Initializes a new {@link HeaderCacheMailProviderServiceTracker}
     */
    public HeaderCacheMailProviderServiceTracker(final BundleContext context) {
        super();
            ...
            try {
                if (HeaderCacheMailProviderRegistry.registerMailProvider(protocol.toString(), (MailProvider) addedService)) {
                    ...
                    LOG.warn(new StringBuilder(64).append("Mail provider for protocol '").append(protocol.toString()).append(
                        "' could not be added to header cache registry.").append(
