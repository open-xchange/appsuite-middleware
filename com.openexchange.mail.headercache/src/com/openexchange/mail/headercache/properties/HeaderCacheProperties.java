...
public interface HeaderCacheProperties {
    ...
    /**
     * The property name for refresh rate milliseconds.
     */
    public static final String PROP_REFRESH_RATE_MILLIS = "hdrcch.rr";

    /**
     * The property name for last-accessed time stamp that is the number of milliseconds since January 1, 1970, 00:00:00 GMT.
     */
    public static final String PROP_LAST_ACCESSED = "hdrcch.la";
