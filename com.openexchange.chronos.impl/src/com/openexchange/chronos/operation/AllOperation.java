 ...
 * @since v7.10.0
 */
public class AllOperation extends AbstractQueryOperation {

    /**
     * Prepares a new {@link AllOperation}.
     *
     * @param session The calendar session
     * @param storage The underlying calendar storage
     * @return The prepared operation
     */
    public static AllOperation prepare(CalendarSession session, CalendarStorage storage) throws OXException {
        return new AllOperation(session, storage);
    }

    /**
     * Initializes a new {@link AllOperation}.
     *
     * @param session The calendar session
     * @param storage The underlying calendar storage
     */
    private AllOperation(CalendarSession session, CalendarStorage storage) throws OXException {
