 ...
 * @since v7.10.0
 */
public class ResolveFilenamePerformer extends AbstractQueryPerformer {
     ...
     */
    public ResolveFilenamePerformer(CalendarSession session, CalendarStorage storage) throws OXException {
