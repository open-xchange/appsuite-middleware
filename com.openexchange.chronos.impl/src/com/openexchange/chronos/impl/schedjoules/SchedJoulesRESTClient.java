...
class SchedJoulesRESTClient {
    ...
    private static final String BASE_URL = "https://api.schedjoules.com/";
     ...
     */
    public SchedJoulesRESTClient(ServiceLookup services) throws OXException {
        super();

        LeanConfigurationService service = services.getService(LeanConfigurationService.class);
        apiKey = service.getProperty(SchedJoulesProperty.apiKey);
