...
public class CalculateFreeBusyTimeTest extends AbstractCombineTest {
    ...
    public void testSingles() throws OXException {
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 4, 1), PropsFactory.createDate(2017, 4, 2)));
    ...
    public void testEdges() throws OXException {
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 0, 5), PropsFactory.createDate(2017, 5, 1)));
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 5, 15), PropsFactory.createDate(2017, 5, 16)));
    ...
    public void testSingleOverlapAvailabilityWithPrecedingEvent() throws OXException {
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 2, 30), PropsFactory.createDate(2017, 3, 3)));
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 3, 10), PropsFactory.createDate(2017, 5, 30)));
    ...
    public void testSingleOverlapAvailabilityWithSucceedingEvent() throws OXException {
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 2, 27), PropsFactory.createDate(2017, 2, 29)));
    ...
    public void testSingleOverlapAvailabilityWithContainingEvent() throws OXException {
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 2, 20), PropsFactory.createDate(2017, 2, 25)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.BUSY_UNAVAILABLE, PropsFactory.createDate(2017, 2, 25), PropsFactory.createDate(2017, 2, 30)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 2, 30), PropsFactory.createDate(2017, 3, 5)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.BUSY, PropsFactory.createDate(2017, 3, 5), PropsFactory.createDate(2017, 3, 10)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 3, 10), PropsFactory.createDate(2017, 5, 30)));
    ...
    public void testSingleRangeQueryWithNoFreeSlotOverlaps() throws OXException {
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 1, 1), PropsFactory.createDate(2017, 2, 20)));
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 2, 25), PropsFactory.createDate(2017, 5, 1)));
    ...
    public void testSingleRangeQueryWithEdgeFreeSlotOverlaps() throws OXException {
        ...
        List<FreeBusyTime> expectedFreeBusyTimes = new ArrayList<>(7);
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 0, 1), PropsFactory.createDate(2017, 0, 3)));
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 5, 20), PropsFactory.createDate(2017, 5, 30)));
    ...
    public void testSingleRangeQueryWithStartingEndingEdgeFreeSlotOverlaps() throws OXException {
        ...
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 0, 29), PropsFactory.createDate(2017, 1, 1)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 1, 1), PropsFactory.createDate(2017, 2, 20)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.BUSY_UNAVAILABLE, PropsFactory.createDate(2017, 2, 20), PropsFactory.createDate(2017, 2, 25)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 2, 25), PropsFactory.createDate(2017, 5, 1)));
        expectedFreeBusyTimes.add(PropsFactory.createFreeBusyTime(FbType.FREE, PropsFactory.createDate(2017, 5, 1), PropsFactory.createDate(2017, 5, 10)));
