...
//    		assertEquals("<a xmlns='pubsub:test' href='3'/>", itemResults.get(3).getPayload().toXML().replace('\"', '\''));
	...
	{
		private final BlockingQueue<ItemEventCoordinator<T>> theQueue;
	...
	{
		private final BlockingQueue<NodeConfigCoordinator> theQueue;
		private final String id;
	...
	{
		private final BlockingQueue<ItemDeleteCoordinator> theQueue;
		private final String id;
