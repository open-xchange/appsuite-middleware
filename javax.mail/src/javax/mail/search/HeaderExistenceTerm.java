...
/**
 * This class implements existence check for Message headers.
 *
 * @author Thorben Betten
 */
public final class HeaderExistenceTerm extends SearchTerm {
    /**
    ...
    private static final long serialVersionUID = 574514650333389122L;
	...
	if (!(obj instanceof HeaderExistenceTerm))
	    return false;
	HeaderExistenceTerm ht = (HeaderExistenceTerm)obj;
