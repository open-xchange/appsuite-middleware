...
public class SNIPPET implements Item {

    static final char[] name = {'S','N','I','P','P','E','T'};
    ...
    /**
     * Gets the snippet's text; either
     * <ul>
     * <li>The snippet text,</li>
     * <li>An empty string if message's body is empty or</li>
     * <li><code>null</code> if snippet text is not available</li>
     * </ul>
     *
     * @return The text
     */
