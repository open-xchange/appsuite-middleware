...
/**
 * {@link OkFilterResult} - The OK filter result.
 *
 * @author Thorben Betten
 */
public class OkFilterResult extends FilterResult {

    /**
     * Initializes a new {@link OkFilterResult}.
     *
     * @param uid The optional UID or <code>-1</code>
     */
    public OkFilterResult(long uid) {
        super(uid);
    }
