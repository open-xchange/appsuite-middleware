...
/**
 * {@link RoundRobinSelector}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class RoundRobinSelector {

    private static final ConcurrentMap<String, RoundRobinSelector> SELECTORS = new ConcurrentHashMap<>(256, 0.9F, 1);

    static RoundRobinSelector getSharedSelectorFor(String host, InetAddress[] addresses) {
    ...
    private RoundRobinSelector(InetAddress[] addresses) {
        super();
