...
//
//    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(FileLocker.class);
//
...
//                    isw.write(content);
//                    Streams.close(isw);
//                    LOG.info("Writing to file " + fileName + "with content " + content);
//                } finally {
//                    unlockFile();
//                }
//            } else {
//                throw MobileNotifierExceptionCodes.ALREADY_LOCKED.create(fileName);
//            }
//        } finally {
//            lock.unlock();
//        }
