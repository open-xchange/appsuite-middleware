...
final class CSVFileCreationCallable implements Callable<Boolean> {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(CSVFileCreationCallable.class));
