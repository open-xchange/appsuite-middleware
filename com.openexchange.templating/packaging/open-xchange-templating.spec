...
if [ ${1:-0} -eq 2 ]; then
   ...
   ox_update_permissions "/opt/open-xchange/etc/groupware/templating.properties" root:open-xchange 640
fi
...
%config(noreplace) %attr(640,root,open-xchange) /opt/open-xchange/etc/groupware/templating.properties
