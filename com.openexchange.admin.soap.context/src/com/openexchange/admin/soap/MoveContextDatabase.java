...
public class MoveContextDatabase {
    ...
    @XmlElementRef(name = "dst_database_id", namespace = "http://soap.admin.openexchange.com", type = JAXBElement.class)
    protected JAXBElement<Database> dstDatabaseId;
     ...
     *     
     */
    public JAXBElement<Database> getDstDatabaseId() {
     ...
     *     
     */
    public void setDstDatabaseId(JAXBElement<Database> value) {
