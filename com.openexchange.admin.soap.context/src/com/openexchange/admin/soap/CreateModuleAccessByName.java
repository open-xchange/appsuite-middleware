...
public class CreateModuleAccessByName {
    ...
    @XmlElementRef(name = "admin_user", namespace = "http://soap.admin.openexchange.com", type = JAXBElement.class)
    protected JAXBElement<User> adminUser;
    @XmlElementRef(name = "access_combination_name", namespace = "http://soap.admin.openexchange.com", type = JAXBElement.class)
    protected JAXBElement<String> accessCombinationName;
     ...
     *     
     */
    public JAXBElement<User> getAdminUser() {
        return adminUser;
    }
     ...
     *     
     */
    public void setAdminUser(JAXBElement<User> value) {
     ...
     *     
     */
    public JAXBElement<String> getAccessCombinationName() {
     ...
     *     
     */
    public void setAccessCombinationName(JAXBElement<String> value) {
