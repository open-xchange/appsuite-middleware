...
package com.openexchange.admin.soap.osgi;
...
import com.openexchange.admin.soap.OXContextServicePortTypeImpl;
import com.openexchange.osgi.HousekeepingActivator;


/**
 * {@link SoapContextActivator}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class SoapContextActivator extends HousekeepingActivator {

    /**
     * Initializes a new {@link SoapContextActivator}.
     */
    public SoapContextActivator() {
        super();
    }
        ...
        final ServiceTrackerCustomizer<Remote, Remote> trackerCustomizer = new ServiceTrackerCustomizer<Remote, Remote>() {
            ...
            public Remote addingService(final ServiceReference<Remote> reference) {
                ...
                if (service instanceof OXContextInterface) {
                    OXContextServicePortTypeImpl.RMI_REFERENCE.set((OXContextInterface) service);
                    return service;
                }
            ...
            public void removedService(final ServiceReference<Remote> reference, final Remote service) {
                if (null != service) {
                    OXContextServicePortTypeImpl.RMI_REFERENCE.set(null);
                    context.ungetService(reference);
                }
            }
        };
