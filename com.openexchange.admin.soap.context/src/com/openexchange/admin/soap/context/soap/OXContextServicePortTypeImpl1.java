...
public class OXContextServicePortTypeImpl1 implements OXContextServicePortType {
    ...
    /* (non-Javadoc)
     * @see com.openexchange.admin.soap.context.soap.OXContextServicePortType#list(com.openexchange.admin.soap.context.dataobjects.Context, com.openexchange.admin.soap.context.dataobjects.Credentials)
     */
    @Override
    @WebResult(name = "return", targetNamespace = "http://soap.admin.openexchange.com")
    @Action(input = "urn:list", output = "urn:listResponse", fault = {
        @FaultAction(className = StorageException_Exception.class, value = "urn:listStorageException"),
        @FaultAction(className = InvalidCredentialsException_Exception.class, value = "urn:listInvalidCredentialsException"),
        @FaultAction(className = InvalidDataException_Exception.class, value = "urn:listInvalidDataException"),
    ...
    public List<Context> list(@WebParam(name = "ctx", targetNamespace = "http://soap.admin.openexchange.com") Context ctx, @WebParam(name = "auth", targetNamespace = "http://soap.admin.openexchange.com") Credentials auth) throws StorageException_Exception, InvalidCredentialsException_Exception, InvalidDataException_Exception, RemoteException_Exception {
