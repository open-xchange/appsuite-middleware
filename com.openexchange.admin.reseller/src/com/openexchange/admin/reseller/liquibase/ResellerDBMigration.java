...
package com.openexchange.admin.reseller.liquibase;
...
/**
 * {@link ResellerDBMigration}
 *
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 * @since v7.10.2
 */
public class ResellerDBMigration {
     ...
     * @param dbService The {@link DatabaseService} to use
     * @return The scheduled migration
     */
    public static DBMigrationState scheduleMigrations(DBMigrationExecutorService migrationService, Bundle bundle, DatabaseService dbService) throws OXException {
        ...
        DBMigrationConnectionProvider connectionProvider = new DBMigrationConnectionProvider() {
            ...
            public Connection get() throws OXException {
                return dbService.getForUpdateTask();
            }

            @Override
            public void back(Connection connection) {
                dbService.backForUpdateTask(connection);
            }

            @Override
            public void backAfterReading(Connection connection) {
                dbService.backForUpdateTaskAfterReading(connection);
            }
        };
        /*
         * register utility MBean and schedule migration
         */
        String schema = "configdb";
