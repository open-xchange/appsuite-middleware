...
public interface MobileNotifierServiceRegistry {
     ...
     * @throws OXException
     */
    MobilePushService getService(String provider, int uid, int cid) throws OXException;
     ...
     * @throws OXException
     */
    List<MobilePushService> getAllServices(int uid, int cid) throws OXException;
}
