...
/**
 * {@link MobilePushTemplatingActivator}
 *
 * @author <a href="mailto:lars.hoogestraat@open-xchange.com">Lars Hoogestraat</a>
 */
public class MobilePushTemplatingActivator extends HousekeepingActivator {

    private final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(MobilePushTemplatingActivator.class);
    private MobilePushServiceRegistryImpl registryImpl;
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            this.registryImpl = new MobilePushServiceRegistryImpl(context);
