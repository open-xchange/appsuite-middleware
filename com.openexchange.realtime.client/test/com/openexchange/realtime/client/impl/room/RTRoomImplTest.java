...
/**
 * Tests for class {@link AbstractRoomImpl}
 * 
...
public class RTRoomImplTest {
    ...
    public void testCreateRoom_Fine_Created() {
        AbstractRoomImpl room = new AbstractRoomImpl(mockedConnectionProperties);
    ...
    public void testCreateRoom_connectionMissing_ThrowException() {
        new AbstractRoomImpl(null);
    }

    /**
     * Test method for {@link com.openexchange.realtime.client.impl.room.AbstractRoomImpl#join()}.
     * 
     * @throws RTException
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Test method for {@link com.openexchange.realtime.client.impl.room.AbstractRoomImpl#setupTimer()}.
     * 
     * @throws RTException
     */
    @Test(expected = IllegalArgumentException.class)
