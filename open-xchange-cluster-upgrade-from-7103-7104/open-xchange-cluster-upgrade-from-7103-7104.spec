...
Name:           open-xchange-cluster-upgrade-from-7103-7104
BuildArch:      noarch
BuildRequires: ant
...
Summary:        Server module to invalidate cluster nodes running v7.10.3/v7.10.4 of the Open-Xchange server (Hazelcast v3.12.x) during upgrade
Autoreqprov:    no
Requires:       open-xchange-core >= @OXVERSION@

%description
Server module to invalidate cluster nodes running v7.10.3/v7.10.4 of the Open-Xchange server (Hazelcast v3.12.x) during upgrade
...
%changelog
* Tue May 11 2021 Thorben Betten <thorben.betten@open-xchange.com>
...
* Tue Jul 07 2020 Thorben Betten <thorben.betten@open-xchange.com>
Initial release
