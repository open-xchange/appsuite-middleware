 ...
 * 2012-05-31T13:21:32.880+02:00
 * Generated source version: 2.6.0
 * 
 */
@WebService(targetNamespace = "http://soap.admin.openexchange.com", name = "OXResourceServicePortType")
@XmlSeeAlso({com.openexchange.admin.rmi.exceptions.xsd.ObjectFactory.class, java.io.xsd.ObjectFactory.class, ObjectFactory.class, com.openexchange.admin.soap.dataobjects.xsd.ObjectFactory.class, java.rmi.xsd.ObjectFactory.class, com.openexchange.admin.rmi.dataobjects.xsd.ObjectFactory.class})
public interface OXResourceServicePortType {
    ...
    @RequestWrapper(localName = "listAll", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.ListAll")
    @WebMethod(action = "urn:listAll")
    @ResponseWrapper(localName = "listAllResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.ListAllResponse")
    ...
    @RequestWrapper(localName = "getMultipleData", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.GetMultipleData")
    @WebMethod(action = "urn:getMultipleData")
    @ResponseWrapper(localName = "getMultipleDataResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.GetMultipleDataResponse")
    ...
    @RequestWrapper(localName = "create", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.Create")
    @WebMethod(action = "urn:create")
    @ResponseWrapper(localName = "createResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.CreateResponse")
    ...
    @RequestWrapper(localName = "list", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.List")
    @WebMethod(action = "urn:list")
    @ResponseWrapper(localName = "listResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.ListResponse")
    ...
    @RequestWrapper(localName = "getData", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.GetData")
    @WebMethod(action = "urn:getData")
    @ResponseWrapper(localName = "getDataResponse", targetNamespace = "http://soap.admin.openexchange.com", className = "com.openexchange.admin.soap.resource.GetDataResponse")
