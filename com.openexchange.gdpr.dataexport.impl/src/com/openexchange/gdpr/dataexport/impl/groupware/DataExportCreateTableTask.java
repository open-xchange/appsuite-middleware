...
/**
 * {@link DataExportCreateTableTask}
 *
 * @author <a href="mailto:martin.herfurth@open-xchange.com">Martin Herfurth</a>
 * @since v7.10.3
 */
public class DataExportCreateTableTask extends UpdateTaskAdapter {
    ...
    public void perform(PerformParameters params) throws OXException {
        ...
        try {
            ...
            rollback = 1;
            for (Map.Entry<String, String> entry : DataExportCreateTableService.getTablesByName().entrySet()) {
    ...
    private static void createTable(Connection connection, String tableName, String createStatement) throws SQLException {
        if (tableExists(connection, tableName)) {
            LoggerFactory.getLogger(DataExportCreateTableTask.class).debug("Table {} already exists, skipping.", tableName);
            return;
        }
