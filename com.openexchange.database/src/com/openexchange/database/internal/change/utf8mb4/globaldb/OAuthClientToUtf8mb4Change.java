 ...
 * @since v7.10.0
 */
public class OAuthClientToUtf8mb4Change extends AbstractSingleTableChange {

    @Override
    protected List<String> tablesToConvert() {
        // prevent 'normal' change. Instead the table will be changed based on OAuthClientToUtf8mb4Change#after(Connection, String) implementation
