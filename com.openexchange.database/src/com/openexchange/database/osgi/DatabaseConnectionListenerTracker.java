 ...
 * @since v7.10.1
 */
public class DatabaseConnectionListenerTracker extends RankingAwareNearRegistryServiceTracker<DatabaseConnectionListener> {

    /**
     * Initializes a new {@link DatabaseConnectionListenerTracker}.
     */
    public DatabaseConnectionListenerTracker(BundleContext context) {
        super(context, DatabaseConnectionListener.class);
    }
