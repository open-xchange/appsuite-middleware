...
public class CalendarLabels {
    ...
    public String getNoteAsHTML() {
        ...
        return services.getService(HtmlService.class).htmlFormat(note);
    }
    
    public String getAcceptedLabel() {
        return getString(Strings.ACCEPTED);
    }

    public String getTentativeLabel() {
        return getString(Strings.TENTATIVE);
    }
    
    public String getDeclinedLabel() {
        return getString(Strings.DECLINED);
    }
    
    public String getUndecidedLabel() {
        return getString(Strings.UNDECIDED);
    }
    
    public String getResourcesLabel() {
        return getString(Strings.RESOURCES);
    }
    
    public String getParticipantsLabel() {
        return getString(Strings.PARTICIPANTS);
    }
