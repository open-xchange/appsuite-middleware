 ...
 * @since v7.10.0
 */
public abstract class ICalDateTimeMapping<T extends ICalComponent, U> extends AbstractICalMapping<T, U> {

    private final Class<? extends biweekly.property.DateTimeProperty> clazz;
     ...
     */
    protected ICalDateTimeMapping(Class<? extends biweekly.property.DateTimeProperty> clazz) {
        super();
        this.clazz = clazz;
    }
    ...
    protected abstract biweekly.property.DateTimeProperty createProperty();
    ...
    public void export(U object, T component, ICalParameters parameters, List<OXException> warnings) {
        ...
        if (null == value) {
            ...
            biweekly.property.DateTimeProperty property = component.getProperty(clazz);
            if (null == property) {
