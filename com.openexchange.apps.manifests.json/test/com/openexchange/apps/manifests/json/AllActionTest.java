...
public class AllActionTest {
    ...
    @Mock
    private final NearRegistryServiceTracker<ManifestContributor> manifestServiceTracker = null;
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(this.capabilityService.getCapabilities(Matchers.anyInt(), Matchers.anyInt(), Matchers.anyBoolean(), Matchers.anyBoolean())).thenReturn(
            new CapabilitySet(0));
        Mockito.when(this.manifestServiceTracker.getServiceList()).thenReturn(Collections.<ManifestContributor> emptyList());
    ...
    public void testGetManifests_IsAnonymousSessionAndManifestEmpty_ReturnEmptyArray() throws OXException {
        ...
        JSONArray array = AllAction.getManifests(this.serverSession, manifests, manifestServiceTracker);
    ...
    public void testGetManifests_IsAnonymousSessionAndManifestNotEmptyButNoNamespace_ReturnEmptyArray() throws OXException, JSONException {
        ...
        JSONArray array = AllAction.getManifests(serverSession, manifests, manifestServiceTracker);
