...
import com.openexchange.ssl.internal.SSLSocketFactoryInitializer;
...
public class SSLActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            SocketFactory initializedSocketFactory = SSLSocketFactoryInitializer.init(getService(ConfigurationService.class));
//            registerService(SocketFactoryInUseProvider.class, new SocketFactoryInUseProviderImpl(initializedSocketFactory));
        } catch (Exception e) {
