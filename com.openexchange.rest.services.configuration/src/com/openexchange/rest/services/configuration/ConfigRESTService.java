...
/**
 * The {@link ConfigRESTService} allows clients to retrieve configuration values.
 *
...
public class ConfigRESTService extends OXRESTService<Void>{
    ...
    public Object getProperty(String property) throws OXException {
     ...
     */
    @GET("/property/:property/:context/:user")
    public Object getProperty(String property, int context, int user) throws OXException {
        ...
        return map().put(property, p.get()).build();
    }
     ...
     */
    @GET("/withPrefix/:prefix")
    public Map<String, Object> getWithPrefix(String prefix) throws OXException {
