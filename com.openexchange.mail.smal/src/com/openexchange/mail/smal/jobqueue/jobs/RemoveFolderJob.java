...
public final class RemoveFolderJob extends AbstractMailSyncJob {
    ...
    private static final org.apache.commons.logging.Log LOG =
        com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(RemoveFolderJob.class));
     ...
     */
    public RemoveFolderJob(final String fullName, final int accountId, final int userId, final int contextId) {
     ...
     */
    public RemoveFolderJob setRanking(final int ranking) {
    ...
    public void replaceWith(final Job anotherJob) {
        ...
        final RemoveFolderJob anotherFolderJob = (RemoveFolderJob) anotherJob;
        ...
        try {
            ...
            try {
                ...
                if (DEBUG) {
                    ...
                    LOG.debug(SIMPLE_NAME + " \"" + identifier + "\" took " + dur + "msec for folder " + fullName + " in account " + accountId);
                }
            }
        } catch (final Exception e) {
            error = true;
            cancel();
            LOG.error(SIMPLE_NAME + " \"" + identifier + "\" failed.", e);
        }
    }
