...
package com.openexchange.ajp13.servlet.http.osgi;
...
public final class HttpServiceImpl implements HttpService {
    ...
    public void registerResources(final String alias, final String name, final HttpContext context) throws NamespaceException {
        final org.apache.commons.logging.Log log = com.openexchange.log.Log.loggerFor(HttpServiceImpl.class);
    ...
    @Override
    public void registerServlet(final String alias, final Servlet servlet, final Dictionary initparams, final HttpContext context) throws ServletException {
        try {
