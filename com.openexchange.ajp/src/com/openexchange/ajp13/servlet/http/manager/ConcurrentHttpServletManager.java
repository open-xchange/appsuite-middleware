        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (null == implier) {
                        final ServletQueue errServletQueue = new SingletonServletQueue(new HttpErrorServlet("No servlet bound to path/alias: " + AJPv13Utility.urlEncode(path, null)), path);
