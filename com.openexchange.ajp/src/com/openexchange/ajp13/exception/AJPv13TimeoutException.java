...
public final class AJPv13TimeoutException extends RuntimeException {
    ...
    private static final long serialVersionUID = 3945288582777990378L;

    /**
     * Initializes a new {@link AJPv13TimeoutException}.
     */
    public AJPv13TimeoutException() {
        super();
    }
     ...
     * @param cause The init cause
     */
    public AJPv13TimeoutException(final String message, final Throwable cause) {
        super(message, cause);
    }
