...
public class ServletRequestWrapper implements ServletRequest {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.exception.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(ServletRequestWrapper.class));
    ...
    private XAJPv13ServletInputStream servletInputStream;
    ...
    private final void handleContentType(final String value) throws AJPv13Exception {
        if (value != null && value.length() > 0) {
            ...
            try {
                ...
                throw new AJPv13Exception(AJPv13Exception.AJPCode.INVALID_CONTENT_TYPE, true, e, value);
            }
            if (ct.getCharsetParameter() == null) {
                ...
                try {
                    ...
                    throw new AJPv13Exception(
                        AJPv13Exception.AJPCode.UNSUPPORTED_ENCODING,
                        true,
                        e,
                ...
                try {
                    ...
                    throw new AJPv13Exception(AJPv13Exception.AJPCode.UNSUPPORTED_ENCODING, true, e, ct.getCharsetParameter());
                }
            }
        } else {
            /*
