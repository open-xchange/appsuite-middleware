...
public final class XAJPv13CPingRequest extends XAJPv13Request {
    ...
    private static final org.apache.commons.logging.Log LOG = com.openexchange.exception.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(XAJPv13CPingRequest.class));
    ...
    public void response(final INonBlockingConnection connection) throws AJPv13Exception, ServletException, IOException {
        writeResponse(AJPv13Response.getCPongBytes(), connection, true);
    }
