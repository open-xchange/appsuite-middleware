...
public final class Constants {
    ...
    public static final String[] attributeNameArray = {
        "context", "servlet_path", "remote_user", "auth_type", "query_string", "jvm_route", "ssl_cert", "ssl_cipher", "ssl_session",
        "req_attribute", "ssl_key_size", "secret_attribute", "stored_method" };
    ...
    public static final String[] headerTransArray = {
        "accept", "accept-charset", "accept-encoding", "accept-language", "authorization", "connection", "content-type", "content-length",
    ...
    static {
        try {
            ...
            for (i = 0; i < SC_RESP_AJP13_MAX; i++) {
                responseTransHash.put(responseTransArray[i], new Integer(0xA001 + i));
            }
    ...
    public static final int getResponseAjpIndex(final String header) {
        final Integer i = responseTransHash.get(header);
        if (i == null) {
            return 0;
        } else {
            return i.intValue();
     ...
     */
    public static final Set<String> SINGLE_VALUE_HEADERS = Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(CONTENT_TYPE, CONTENT_LENGTH)));
