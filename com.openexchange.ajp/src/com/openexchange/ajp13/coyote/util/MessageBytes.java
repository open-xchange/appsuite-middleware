...
public final class MessageBytes {
     ...
     */
    public void setCaseSenitive(final boolean b) {
        caseSensitive = b;
    }
    ...
    /**
     * Set the encoding. If the object was constructed from bytes[]. any previous conversion is reset. If no encoding is set, we'll use
     * 8859-1.
     */
    ...
    public void toBytes() {
        ...
        toString();
        type = T_BYTES;
        final byte bb[] = strValue.getBytes();
    ...
    public int indexOfIgnoreCase(final String s, final int starting) {
        toString();
        final String upper = strValue.toUpperCase();
    ...
    /**
     * @deprecated The buffer are general purpose, caching for headers should be done in headers. The second parameter allows us to pass a
     *             date format instance to avoid synchronization problems.
     */
    @Deprecated
    public void setTime(final long t, final DateFormat df) {
    ...
    public long getTime() {
        ...
        final long l = DateTool.parseDate(this);
        if (dateValue == null) {
