...
Summary:        The Open-Xchange AJP bundle
Requires:       open-xchange-common >= @OXVERSION@ open-xchange-global >= @OXVERSION@ open-xchange-configread >= @OXVERSION@ open-xchange-server >= @OXVERSION@ open-xchange-management >= @OXVERSION@ open-xchange-monitoring >= @OXVERSION@ open-xchange-threadpool >= @OXVERSION@
#

%description
The Open-Xchange AJP bundle
