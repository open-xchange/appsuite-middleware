...
/**
 * {@link UploadLimitations} - Upload limitations for the maximum allowed size of a single uploaded file and the maximum allowed size of a
 * complete request.
 *
...
public class UploadLimitations {
    ...
    /**
     * Initializes a new {@link UploadLimitations}.
     *
     ...
     */
    public UploadLimitations(long maxUploadFileSize, long maxUploadSize) {
        super();
