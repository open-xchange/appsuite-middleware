...
public interface Resource extends Serializable {
    ...
    /**
     * Get the priority level of the resource, that is a value between -128 and +127. If no priority is provided, the priority is
    ...
    /**
     * Gets the presence state associated with the resource.
     *
    ...
    /**
     * Gets the presence status message.
     *
     * @return The message, or <code>null</code> if not set
     */
    String getMessage();
