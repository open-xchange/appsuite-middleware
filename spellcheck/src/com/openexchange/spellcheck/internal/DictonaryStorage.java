...
public final class DictonaryStorage {
	...
	public static void loadDictionaries() throws SpellCheckException {
		...
		{
			final ConfigurationService c = SpellCheckServiceRegistry.getServiceRegistry().getService(
			...
			if (null != c) {
				...
				throw new SpellCheckException(new ServiceException(ServiceErrorCode.SERVICE_UNAVAILABLE,
