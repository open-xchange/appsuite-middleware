...
public final class InternalUtility {
    ...
    public static int parseColorLabel(final String cl, final int defaultValue) {
        try {
            ...
            final org.apache.commons.logging.Log log = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(Utility.class)));
