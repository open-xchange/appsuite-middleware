 ...
 * @since 7.8.0
 */
public class ContextConnectionHelper extends AbstractConnectionHelper {

    private int contextId = -1;

    /**
     * Initializes a new {@link ContextConnectionHelper}.
     *
    ...
    public void acquireConnection() throws OXException {
        ...
        this.connection = writableConnection ? dbService.getWritable(contextId) : dbService.getReadOnly(contextId);
    }
}
