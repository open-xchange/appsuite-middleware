...
/**
 * {@link AppsuiteClientExceptions}
 *
 * @author <a href="mailto:daniel.becker@open-xchange.com">Daniel Becker</a>
 * @since v7.10.5
 */
public enum AppsuiteClientExceptions implements DisplayableOXExceptionCode {
    ...
    /**
     * Initializes a new {@link AppsuiteClientExceptions}.
     * 
     * @param message The message
     * @param category The category
     * @param detailNumber The exception number
     */
    private AppsuiteClientExceptions(final String message, final Category category, final int detailNumber) {
     ...
     */
    private AppsuiteClientExceptions(final String message, final Category category, final int detailNumber, final String displayMessage) {
