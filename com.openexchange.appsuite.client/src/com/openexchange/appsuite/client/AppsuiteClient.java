...
/**
 * {@link AppsuiteClient} - A client for communicating to another Open Xchange server.
 * 
 * @author <a href="mailto:daniel.becker@open-xchange.com">Daniel Becker</a>
 * @since v7.10.5
 */
public interface AppsuiteClient {
     ...
     *
     * @throws OXException in case of error, specifically a {@link AppsuiteClientExceptions#NO_ACCESS} if the login fails
     */
     ...
     */
    <T> T execute(AppsuiteApiCall<T> request) throws OXException;
