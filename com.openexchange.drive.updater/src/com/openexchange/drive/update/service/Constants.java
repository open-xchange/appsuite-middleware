...
public class Constants {
    ...
    public static final String TMPL_UPDATER_CONFIG = "drive_updater.tmpl";

    public static final String TMPL_UPDATER_DEFAULT = "oxdrive_update.tmpl";

    public static final String DOWNLOAD_SERVLET = "updater/ox/drive/download";

    public static final String UPDATE_SERVLET = "updater/v1/ox/drive";

    public static final String AUTO_EXTRACTER = "7zS.sfx";

    //branding
    public static final String BRANDING_FILE = "com.openexchange.drive.update.branding";
    ...
    public static final String BRANDING_CODE = "upgrade";
    public static final String BRANDING_RELEASE = "release";
    public static final String BRANDING_IMPORTANCE = "importance";
