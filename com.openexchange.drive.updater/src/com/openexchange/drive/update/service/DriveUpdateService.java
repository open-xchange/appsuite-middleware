...
public interface DriveUpdateService {
    ...
    /**
     * Returns the name of the product behind this service implementation.
     * This name is used to distinguish the different service implementations.
     * Therefore it has to be unique!
     *
    ...
    /**
     * This function serves the template data for the product to update.
     *
     * @return The product specific {@link OXTemplate}.
    ...
    /**
     * Gets the necessary permission that is needed to receive updates for this product.
    ...
    /**
     * Returns an {@link InputStream} to a file identified by the given file name.
     *
    ...
    /**
     * Returns the size of a file identified by the given file name.
     *
     * @param fileName The file name.
