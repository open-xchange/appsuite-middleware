...
package com.openexchange.drive.update.files;
...
import com.openexchange.drive.update.service.UpdaterExceptionCodes;
import com.openexchange.drive.update.service.Utils;
import com.openexchange.drive.update.servlet.BrandingException;
import com.openexchange.exception.OXException;


/**
 * {@link UpdateFilesProviderImpl}
 *
...
public class UpdateFilesProviderImpl implements UpdateFilesProvider {
     ...
     * @throws OXException
     */
    public UpdateFilesProviderImpl(String path) throws OXException {
        super();
    ...
    @Override
    public InputStream getFile(Category category, String branding, String name) throws OXException {
        try {
    ...
    @Override
    public boolean contains(Category category, String branding, String name) throws OXException {
        return loaders.get(branding).getAvailableFiles().contains(name);
    }

    @Override
    public long getSize(Category category, String branding, String name) throws OXException {
        try {
    ...
    @Override
    public String getFileName(Category category, String branding, Pattern regex) throws OXException {
    ...
    @Override
    public String getMD5(Category category, String branding, String name) throws IOException, OXException {
