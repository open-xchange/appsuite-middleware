...
public class DBMigrationServiceTracker implements ServiceTrackerCustomizer<DBMigrationExecutorService, DBMigrationExecutorService> {
    ...
    /**
     * Initializes a new {@link DBMigrationServiceTracker}.
     */
    public DBMigrationServiceTracker(ServiceLookup services, BundleContext context) {
        super();
    ...
    public DBMigrationExecutorService addingService(ServiceReference<DBMigrationExecutorService> reference) {
        ...
        Logger logger = org.slf4j.LoggerFactory.getLogger(DBMigrationServiceTracker.class);
        String changeSetLocaltion = "/liquibase/updateTaskAwareConfigdbChangeLog.xml";
        try {
            ...
            logger.error("Failed to apply changeset: {}", changeSetLocaltion, e);
        }
