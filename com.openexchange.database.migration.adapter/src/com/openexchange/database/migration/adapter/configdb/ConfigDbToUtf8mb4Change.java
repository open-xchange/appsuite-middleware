 ...
 * @since v7.10.0
 */
public class ConfigDbToUtf8mb4Change extends AbstractConvertUtf8ToUtf8mb4TaskLiquibaseAdapter {
    ...
    protected List<String> tablesToConvert() {
        return ImmutableList.of("advertisement_config", "advertisement_mapping", "configdb_sequence", "context", "context_server2db_pool", 
            "context2push_registration", "contexts_per_dbpool", "contexts_per_dbschema", "contexts_per_filestore", "ctx_per_schema_sem", 
            "db_cluster", "db_pool", "dbpool_lock", "dbschema_lock", "filestore2user", "reason_text", "replicationMonitor", 
            "sequence_context");
    }
