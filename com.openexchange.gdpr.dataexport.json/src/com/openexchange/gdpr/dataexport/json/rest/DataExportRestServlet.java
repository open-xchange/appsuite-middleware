...
/**
 * {@link DataExportRestServlet} - The REST servlet for GDPR data export module.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class DataExportRestServlet extends AbstractRestServlet {
    ...
    /**
     * Initializes a new {@link DataExportRestServlet}.
     * @param prefix The dispatcher servlet prefix
     */
    public DataExportRestServlet(String prefix) {
        super(prefix);
