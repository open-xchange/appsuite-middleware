...
/**
 * {@link ScheduleDataExportAction}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.3
 */
public class ScheduleDataExportAction extends AbstractDataExportAction {

    /**
     * Initializes a new {@link ScheduleDataExportAction}.
     *
     * @param services The service look-up
     */
    public ScheduleDataExportAction(ServiceLookup services) {
        super(services);
    }
    ...
    protected AJAXRequestResult doPerform(AJAXRequestData requestData, ServerSession session) throws OXException, JSONException {
        ...
        dataExportService.planSchedule();
