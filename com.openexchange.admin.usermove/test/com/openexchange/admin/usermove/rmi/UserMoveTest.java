...
public class UserMoveTest extends AbstractTest {
    ...
    public final void testMoveUser() throws Throwable {
        final OXUserMoveInterface oxu = getUserMoveClient();
        ...
        oxu.moveUser(user, src, dest, auth);
    }
    ...
    public final void testMoveUserNoUser() throws Throwable {
        ...
        final Credentials auth = new Credentials(OXADMINMASTER, PASSWORD);
        try {
            oxu.moveUser(null, src, dest, auth);
    ...
    private OXUserMoveInterface getUserMoveClient() throws MalformedURLException, RemoteException, NotBoundException {
        return (OXUserMoveInterface) Naming.lookup(getRMIHostUrl()+ OXUserMoveInterface.RMI_NAME);
    }
}
