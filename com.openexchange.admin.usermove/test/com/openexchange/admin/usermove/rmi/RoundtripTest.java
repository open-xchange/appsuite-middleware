...
public class RoundtripTest extends AbstractRMITest {
    ...
    private final OXUserMoveInterface oxu;
    ...
    public void setUp() throws Exception {
        ...
        test.setImapLogin("jan.bauerdick424242669");
        ...
        final SetRequest setLanguage = new SetRequest(Tree.Language, "de_DE");
        userClient.execute(setLanguage);
        final SetRequest setTimezone = new SetRequest(Tree.TimeZone, "Europe/Berlin");
        ...
        final ExternalUserParticipant external = new ExternalUserParticipant("test@example.org");
        newTask.addParticipant(external);
        final com.openexchange.ajax.task.actions.InsertRequest newTaskRequest = new com.openexchange.ajax.task.actions.InsertRequest(
            newTask,
            TimeZone.getTimeZone("Europe/Berlin"));
        final com.openexchange.ajax.task.actions.InsertResponse newTaskResponse = userClient.execute(newTaskRequest);
        newTaskResponse.fillTask(newTask);

        final FolderObject taskFolder = new FolderObject("Task folder", 90, FolderObject.TASK, FolderObject.PRIVATE, userClient.getValues().getUserId());
        taskFolder.setParentFolderID(userClient.getValues().getPrivateTaskFolder());
        final OCLPermission taskPerm = new OCLPermission();
        ...
        final InsertRequest insertTaskFolderRequest = new InsertRequest(EnumAPI.OX_OLD, taskFolder);
        final InsertResponse insertTaskFolderResponse = userClient.execute(insertTaskFolderRequest);
        insertTaskFolderResponse.fillObject(taskFolder);

        final Task newFolderTask = new Task();
        ...
        final ExternalUserParticipant external2 = new ExternalUserParticipant("bla@blubber.de");
        newTask.addParticipant(external2);
        final com.openexchange.ajax.task.actions.InsertRequest newFolderTaskRequest = new com.openexchange.ajax.task.actions.InsertRequest(
            newFolderTask,
            TimeZone.getTimeZone("Europe/Berlin"));
        final com.openexchange.ajax.task.actions.InsertResponse newFolderTaskResponse = userClient.execute(newFolderTaskRequest);
        ...
        final com.openexchange.ajax.appointment.action.InsertRequest newAppointmentRequest = new com.openexchange.ajax.appointment.action.InsertRequest(
            newAppointment,
            TimeZone.getTimeZone("Europe/Berlin"));
        final AppointmentInsertResponse appointmentResponse = userClient.execute(newAppointmentRequest);
        appointmentResponse.fillObject(newAppointment);

        final FolderObject appointmentFolder = new FolderObject("Appointment folder", 91, FolderObject.CALENDAR, FolderObject.PRIVATE, userClient.getValues().getUserId());
        appointmentFolder.setParentFolderID(userClient.getValues().getPrivateAppointmentFolder());
        final OCLPermission appointmentPerm = new OCLPermission();
        ...
        final InsertRequest insertAppointmentFolderRequest = new InsertRequest(EnumAPI.OX_OLD, appointmentFolder);
        final InsertResponse insertAppointmentFolderResponse = userClient.execute(insertAppointmentFolderRequest);
        insertAppointmentFolderResponse.fillObject(appointmentFolder);

        final Appointment newFolderAppointment = new Appointment();
        ...
        final com.openexchange.ajax.appointment.action.InsertRequest newFolderAppointmentRequest = new com.openexchange.ajax.appointment.action.InsertRequest(
            newFolderAppointment,
            TimeZone.getTimeZone("Europe/Berlin"), true);
        final AppointmentInsertResponse folderAppointmentResponse = userClient.execute(newFolderAppointmentRequest);
        folderAppointmentResponse.fillObject(newFolderAppointment);

        final FileInputStream is = new FileInputStream("ext/attach.png");
        final AttachRequest attach = new AttachRequest(newAppointment, "attach.png", is, "image/png");
        ...
        final com.openexchange.ajax.contact.action.InsertRequest contactRequest1 = new com.openexchange.ajax.contact.action.InsertRequest(c1);
        final com.openexchange.ajax.contact.action.InsertResponse response1 = userClient.execute(contactRequest1);
        ...
        final com.openexchange.ajax.contact.action.InsertRequest contactRequest2 = new com.openexchange.ajax.contact.action.InsertRequest(c2);
        final com.openexchange.ajax.contact.action.InsertResponse response2 = userClient.execute(contactRequest2);
        response2.fillObject(c2);

        final FolderObject contactFolder = new FolderObject("Contact folder", 92, FolderObject.CONTACT, FolderObject.PRIVATE, userClient.getValues().getUserId());
        contactFolder.setParentFolderID(userClient.getValues().getPrivateContactFolder());
        final OCLPermission contactPerm = new OCLPermission();
        ...
        final InsertRequest insertContactFolderRequest = new InsertRequest(EnumAPI.OX_OLD, contactFolder);
        final InsertResponse insertContactFolderResponse = userClient.execute(insertContactFolderRequest);
        insertContactFolderResponse.fillObject(contactFolder);

        final Contact c3 = new Contact();
        c3.setEmail1("c3@example.org");
        c3.setSurName("Contact3");
        c3.setCityHome("Olpe");
        c3.setParentFolderID(contactFolder.getObjectID());
        final com.openexchange.ajax.contact.action.InsertRequest contactRequest3 = new com.openexchange.ajax.contact.action.InsertRequest(c3);
        final com.openexchange.ajax.contact.action.InsertResponse response3 = userClient.execute(contactRequest3);
        response3.fillObject(c3);

        final MailAccountDescription mail = new MailAccountDescription();
        ...
        final MailAccountInsertRequest mailRequest = new MailAccountInsertRequest(mail);
        final MailAccountInsertResponse mailResponse = userClient.execute(mailRequest);
        mailResponse.fillObject(mail);

        final File infostore = new File("ext/infostore.doc");
        final DocumentMetadata meta = new DocumentMetadataImpl();
        meta.setFileName(infostore.getName());
        meta.setFolderId(userClient.getValues().getPrivateInfostoreFolder());
        final NewInfostoreRequest request = new NewInfostoreRequest(meta, infostore);
        ...
        final NewSubscriptionRequest subscriptionRequest = new NewSubscriptionRequest(sub, form);
        userClient.execute(subscriptionRequest);

        final LogoutRequest logout = new LogoutRequest();
        userClient.execute(logout);
    }

    @Test
    public final void testMoveUser() throws Throwable {
        moved = oxu.moveUser(srcUser, srcCtx, dstCtx, superAdminCredentials);
    ...
    private void compareUsers(final User orig, final User copied) throws Exception {
        ...
        final Iterator<Object[]> origInfostoreIterator = origInfostoreResponse.iterator();
        ...
        final Iterator<Object[]> copiedInfostoreIterator = copiedInfostoreResponse.iterator();
        ...
        while (origInfostoreIterator.hasNext()) {
            final Object[] origNext = origInfostoreIterator.next();
            final Object[] copiedNext = copiedInfostoreIterator.next();
        ...
        final MailAccountAllRequest origMailAccountRequest = new MailAccountAllRequest(new int[] {1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021,1022,1023,1024,1025,1026,1027,1028,1029,1030,1031,1032,1033,1034,1035,1036,1037,1038});
        final MailAccountAllRequest copiedMailAccountRequest = new MailAccountAllRequest(new int[] {1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,1020,1021,1022,1023,1024,1025,1026,1027,1028,1029,1030,1031,1032,1033,1034,1035,1036,1037,1038});
        final MailAccountAllResponse origMailAccountResponse = origClient.execute(origMailAccountRequest);
        final MailAccountAllResponse copiedMailAccountAllResponse = copiedClient.execute(copiedMailAccountRequest);
        final List<MailAccountDescription> origMailAccounts = origMailAccountResponse.getDescriptions();
        final List<MailAccountDescription> copiedMailAccounts = copiedMailAccountAllResponse.getDescriptions();
        ...
        final AllSubscriptionsRequest origSubscriptionsRequest = new AllSubscriptionsRequest();
        final AllSubscriptionsRequest copiedSubscriptionsRequest = new AllSubscriptionsRequest();
        final AllSubscriptionsResponse origSubscriptionsResponse = origClient.execute(origSubscriptionsRequest);
        final AllSubscriptionsResponse copiedSubscriptionsResponse = copiedClient.execute(copiedSubscriptionsRequest);
        final JSONArray origSubscriptions = origSubscriptionsResponse.getAll();
        final JSONArray copiedSubcriptions = copiedSubscriptionsResponse.getAll();
    ...
    private void compareAttachments(final List<AttachmentMetadata> orig, final List<AttachmentMetadata> copied) {
        for (int i = 0; i < orig.size(); i++) {
            final AttachmentMetadata a1 = orig.get(i);
            final AttachmentMetadata a2 = orig.get(i);
    ...
    private void compareMailAccounts(final List<MailAccountDescription> orig, final List<MailAccountDescription> copied) {
        for (int i = 0; i < orig.size(); i++) {
            final MailAccountDescription m1 = orig.get(i);
            final MailAccountDescription m2 = copied.get(i);
    ...
    private void compareSubscriptions(final JSONArray orig, final JSONArray copied) throws Exception {
        for (int i = 0; i < orig.length(); i++) {
            final JSONArray origSub = orig.getJSONArray(i);
            final JSONArray copiedSub = copied.getJSONArray(i);
