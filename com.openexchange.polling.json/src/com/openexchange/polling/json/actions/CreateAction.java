 ...
 */
// This action implements the "new" call
// Note that we extend the AbstractPollingAction, which is responsible for constructing a nice PollingRequest
public class CreateAction extends AbstractPollingAction {

    protected CreateAction(PollingActionFactory factory) {
        super(factory);
    }
    ...
    protected AJAXRequestResult perform(PollingRequest req) throws OXException {
        ...
        polls.createPoll(poll, req.getContextId());
