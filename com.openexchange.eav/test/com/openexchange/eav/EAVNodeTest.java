...
public class EAVNodeTest extends TestCase {
    ...
    public void testVisitUpwards() {
        ...
        assertEquals(0, (int)visitor.level.get(0));
        assertEquals(-1, (int)visitor.level.get(1));
    ...
    public void testVisitDownwards() {
        ...
        assertEquals(0, (int)visitor.level.get(0));
        assertEquals(1, (int)visitor.level.get(1));
        assertEquals(2, (int)visitor.level.get(2));
        assertEquals(1, (int)visitor.level.get(3));
    }
