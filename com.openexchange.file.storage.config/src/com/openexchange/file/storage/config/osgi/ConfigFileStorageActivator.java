...
public final class ConfigFileStorageActivator extends HousekeepingActivator {
    ...
    protected void handleUnavailability(final Class<?> clazz) {
        final org.apache.commons.logging.Log logger = com.openexchange.log.Log.loggerFor(ConfigFileStorageActivator.class);
    ...
    protected void startBundle() throws Exception {
        final org.apache.commons.logging.Log log = com.openexchange.log.Log.loggerFor(ConfigFileStorageActivator.class);
        try {
