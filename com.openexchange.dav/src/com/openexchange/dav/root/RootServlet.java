 ...
 * @since v7.8.1
 */
public class RootServlet extends OXServlet {

    private static final long serialVersionUID = -5376312239416361160L;

    private final RootPerformer performer;

    /**
     * Initializes a new {@link RootServlet}.
     *
     * @param performer The underlying performer
     */
    public RootServlet(RootPerformer performer) {
        super();
    ...
    private void doIt(HttpServletRequest req, HttpServletResponse resp, WebdavMethod method) throws ServletException, IOException {
        ...
        } catch (com.openexchange.exception.OXException exc) {
            resp.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            return;
        }
        if (false == checkPermission(req, session)) {
