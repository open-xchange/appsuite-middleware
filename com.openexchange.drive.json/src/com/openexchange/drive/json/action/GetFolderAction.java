...
/**
 * {@link GetFolderAction}
 *
 * @author <a href="mailto:tobias.friedrich@open-xchange.com">Tobias Friedrich</a>
 */
public class GetFolderAction extends AbstractDriveAction {
    ...
    public AJAXRequestResult doPerform(AJAXRequestData requestData, DefaultDriveSession session) throws OXException {
        ...
        /*
         * get directory metadata & return appropriate JSON result
         */
        JSONObject metadata = getDriveService().getUtility().getDirectoryMetadata(session, new JsonDirectoryVersion(checksum, path));
