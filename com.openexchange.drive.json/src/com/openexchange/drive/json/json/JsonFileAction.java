 ...
 */
public class JsonFileAction extends JsonDriveAction<FileVersion> {

    public JsonFileAction(Action action, FileVersion version, FileVersion newVersion, Map<String, Object> parameters) {
    ...
    public static DriveAction<FileVersion> deserialize(JSONObject jsonObject) throws JSONException {
        if (null == jsonObject) {
            return null;
        }
        Action action = null;
        FileVersion version = null;
        FileVersion newVersion = null;
        ...
        for (Map.Entry<String, Object> entry : jsonObject.entrySet()) {
            if ("action".equals(entry.getKey())) {
                ...
                newVersion = JsonFileVersion.deserialize((JSONObject)entry.getValue());
            } else {
                parameters.put(entry.getKey(), entry.getValue());
            }
        }
        return new JsonFileAction(action, version, newVersion, parameters);
    }

    public static List<DriveAction<FileVersion>> deserialize(JSONArray jsonArray) throws JSONException {
        if (null == jsonArray) {
            return null;
        }
        List<DriveAction<FileVersion>> versions = new ArrayList<DriveAction<FileVersion>>();
