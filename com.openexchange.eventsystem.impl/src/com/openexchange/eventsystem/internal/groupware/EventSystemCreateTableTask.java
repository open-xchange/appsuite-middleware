...
/**
 * {@link EventSystemCreateTableTask}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class EventSystemCreateTableTask extends UpdateTaskAdapter {

    private final ServiceLookup services;

    /**
     * Initializes a new {@link EventSystemCreateTableTask}.
     *
     * @param services The service look-up
     */
    public EventSystemCreateTableTask(final ServiceLookup services) {
        super();
    ...
    public void perform(final PerformParameters params) throws OXException {
        ...
        try {
            ...
            rollback = true;
            final String[] tableNames = EventSystemCreateTableService.getTablesToCreate();
            final String[] createStmts = EventSystemCreateTableService.getCreateStmts();
