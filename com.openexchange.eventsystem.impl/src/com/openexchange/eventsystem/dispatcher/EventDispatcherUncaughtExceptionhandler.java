...
/**
 * {@link EventDispatcherUncaughtExceptionhandler} - The uncaught exception handler for event dispatcher.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since 7.6.0
 */
final class EventDispatcherUncaughtExceptionhandler implements UncaughtExceptionHandler {

    private static final EventDispatcherUncaughtExceptionhandler INSTANCE = new EventDispatcherUncaughtExceptionhandler();
     ...
     * @return The instance
     */
    static EventDispatcherUncaughtExceptionhandler getInstance() {
        return INSTANCE;
    }
    ...
    /**
     * Initializes a new {@link EventDispatcherUncaughtExceptionhandler}.
     */
    private EventDispatcherUncaughtExceptionhandler() {
        super();
    }

    @Override
    public void uncaughtException(final Thread t, final Throwable e) {
        final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(EventDispatcherUncaughtExceptionhandler.class);
