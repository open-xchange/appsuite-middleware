...
public final class WhitelistServiceTracker implements ServiceTrackerCustomizer {
    ...
    public Object addingService(final ServiceReference reference) {
        ...
        if (service instanceof ConfigurationService) {
            ...
            if (null == property) {
                final org.apache.commons.logging.Log log = com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(WhitelistServiceTracker.class)))));
