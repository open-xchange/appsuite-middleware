...
public class ContactTypeFacet extends ContactSearchFacet {
    ...
    private static final String ID = "contact_type";

    public ContactTypeFacet() {
        super(ContactsFacetType.TYPE, getFacetValues());
    }
    ...
    public SearchTerm<?> getSearchTerm(ServerSession session, String query) throws OXException {
        ...
        throw FindExceptionCode.UNSUPPORTED_FILTER_QUERY.create(query, ContactsFacetType.TYPE.getId());
    }
