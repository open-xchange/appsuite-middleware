 ...
 */
public class AddressFacet extends CommonContactSearchFacet {
    ...
    private static final String ID = "address";

    public AddressFacet() {
        super(ContactsFacetType.ADDRESS, Collections.singletonList(
