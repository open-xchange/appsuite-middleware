...
import com.openexchange.find.basic.drive.BasicInfostoreDriver;
...
public class FindBasicActivator extends HousekeepingActivator {
    ...
    protected void startBundle() throws Exception {
        ...
        String virtualAllMessagesFolder = configService.getProperty("com.openexchange.find.mail.allMessagesFolder");
        ...
        registerService(ModuleSearchDriver.class, new BasicInfostoreDriver(), properties);
    }
