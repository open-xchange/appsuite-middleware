...
/**
 * {@link AppsuiteClientBlacklist}
 *
 * @author <a href="mailto:daniel.becker@open-xchange.com">Daniel Becker</a>
 * @since v7.10.5
 */
public class AppsuiteClientBlacklist {

    private static final Logger LOGGER = LoggerFactory.getLogger(AppsuiteClientBlacklist.class);

    private final static Property BLACKLIST = DefaultProperty.valueOf("com.openexchange.appsuite.client.blacklistedHosts", "127.0.0.1-127.255.255.255,localhost");

    private final static Property ALLOWED_PORTS = DefaultProperty.valueOf("com.openexchange.appsuite.client.allowedPorts", "");
