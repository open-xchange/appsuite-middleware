...
package com.openexchange.appsuite.client.impl.share;
...
import com.openexchange.appsuite.client.common.calls.login.AccessShareCall;
import com.openexchange.appsuite.client.common.calls.login.AnonymousLoginCall;
import com.openexchange.appsuite.client.common.calls.login.GuestLoginCall;
import com.openexchange.appsuite.client.common.calls.login.RedeemTokenCall;
import com.openexchange.appsuite.client.common.calls.login.ShareLoginInformation;
import com.openexchange.appsuite.client.impl.AbstractAppsuiteClient;
import com.openexchange.exception.OXException;
import com.openexchange.java.Strings;
import com.openexchange.server.ServiceLookup;

/**
 * {@link AppsuiteShareClient}
 *
 * @author <a href="mailto:daniel.becker@open-xchange.com">Daniel Becker</a>
 * @since v7.10.5
 */
public class AppsuiteShareClient extends AbstractAppsuiteClient implements AutoLoginClient {

    private LoginInformation information;
    private final Optional<Credentials> credentials;

    /**
     * Initializes a new {@link AppsuiteShareClient}.
     *
     ...
     */
    public AppsuiteShareClient(ServiceLookup services, int contextId, int userId, URL loginTarget, Optional<Credentials> credentials) {
