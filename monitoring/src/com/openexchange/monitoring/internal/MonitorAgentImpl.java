 ...
 * 
 */
public class MonitorAgentImpl extends AbstractAgent implements MonitorAgent {

	/*
	 * Static fields
	 */
	private static final Log LOG = LogFactory.getLog(MonitorAgentImpl.class);

	private static final MonitorAgentImpl instance = new MonitorAgentImpl();
	...
	public static MonitorAgentImpl getInstance() {
		return instance;
	}

	private MonitorAgentImpl() {
		super();
	}

	public static void main(final String argv[]) {
		final MonitorAgentImpl agent = new MonitorAgentImpl();
		agent.run();
		waitForEnterPressed();
		agent.stop();
	}
	...
	private final void initializeMBeanServer() {
		...
		try {
			...
			final ObjectInstance objectInstance = mbs.registerMBean(generalMonitorBean, new ObjectName(
