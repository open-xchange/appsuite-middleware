...
public final class MonitorUtility {
	...
	/**
	 * Creates an array of <code>java.lang.String</code> with a length set to
	 * <code>2</code> which contains the domain and name of given class name
	 * <p>
	 * Example:<br>
	 * If class name is <code>my.path.to.class.ClassName</code>, then its
	 * domain is <code>my.path.to.class</code> and its name is
	 * <code>ClassName</code>.
	 * 
	 * 
	 * @param className
	 *            The class name
	 * @param defaultDomain
	 *            Whether to use default domain or not
	 ...
	 * @param defaultDomain
	 *            <code>true</code> to use the default domain
	 *            {@link MonitorMBean#DEFAULT_DOMAIN}; otherwise the canonical
	 *            class path extracted from <code>className</code> argument
	 * @return An appropriate instance of {@link ObjectName}
	 * @throws MalformedObjectNameException
	 *             If instantiation of {@link ObjectName} fails
	 * @throws NullPointerException
	 *             If instantiation of {@link ObjectName} fails due to a
	 *             <code>null</code> constructor argument
	 * @see #getDomainAndName(String, boolean)
	 */
	public static final ObjectName getObjectName(final String className, final boolean defaultDomain)
			throws MalformedObjectNameException, NullPointerException {
		final int pos = className.lastIndexOf('.');
		if (pos == -1 || defaultDomain) {
			return new ObjectName(MonitorMBean.DEFAULT_DOMAIN, "name", pos == -1 ? className : className
					.substring(pos + 1));
		}
