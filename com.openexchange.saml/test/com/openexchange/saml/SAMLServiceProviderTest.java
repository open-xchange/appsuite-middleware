...
public class SAMLServiceProviderTest {
    ...
    private SAMLServiceProvider authenticator;
    ...
    public void testMetadata() throws Exception {
        String metadataXML = authenticator.getMetadataXML();
    ...
    public void testWSO2IDP() throws Exception {
        ...
        authenticator.respondWithAuthnRequest(httpRequest, httpResponse);
    ...
    public void setUp() throws Exception {
        ...
        authenticator = new SAMLServiceProvider(config, openSAML);
        authenticator.init();
    }
    ...
    public void testResponseValidation() throws Exception {
        ...
        KeyStore keystore = authenticator.getKeystore();
    ...
    public void testRedirectRequest() throws Exception {
        ...
        DOMMetadataProvider metadataProvider = new DOMMetadataProvider(openSAML.getParserPool().parse(new StringReader(authenticator.getMetadataXML())).getDocumentElement());
        metadataProvider.initialize();
