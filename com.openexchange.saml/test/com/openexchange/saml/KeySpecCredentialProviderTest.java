...
public class KeySpecCredentialProviderTest {
    ...
    public void testSigningWithRawDERKeys() throws Exception {
        ...
        KeySpecCredentialProvider credentialProvider = KeySpecCredentialProvider.newInstance(idpPublicKeySpec, Algorithm.DSA, idpPrivateKeySpec, Algorithm.DSA, null, null);
