...
/**
 * {@link MobileNotifierSubscriptionsCreateTableService}
 *
 * @author <a href="mailto:lars.hoogestraat@open-xchange.com">Lars Hoogestraat</a>
 */
public class MobileNotifierSubscriptionsCreateTableService  extends AbstractCreateTableImpl {
    /**
     * Initializes a new {@link DriveEventSubscriptionsCreateTableService}.
     */
    public MobileNotifierSubscriptionsCreateTableService() {
        super();
    }
    ...
    public static String[] getTablesToCreate() {
        return new String[] { Statements.TABLE_NAME };
    }
    ...
    public static String[] getCreateStmts() {
        return new String[] { Statements.CREATE_TABLE };
    }
