...
package com.openexchange.metrics.exceptions;
...
/**
 * {@link MetricExceptionCode}
 *
 * @author <a href="mailto:ioannis.chouklis@open-xchange.com">Ioannis Chouklis</a>
 */
public enum MetricExceptionCode implements DisplayableOXExceptionCode {

    /**
     * <li>An error occurred inside the server which prevented it from fulfilling the request.</li>
     * <li>An error occurred while timing an event.</li>
     */
    ERROR_WHILE_TIMING("An error occurred while timing an event.", Category.CATEGORY_ERROR, 1);
    ...
    /**
     * Initialises a new {@link MetricExceptionCode}.
     */
    private MetricExceptionCode(String message, Category category, int detailNumber) {
     ...
     * Initialises a new {@link MetricExceptionCode}.
     */
    private MetricExceptionCode(String message, String displayMessage, Category category, int detailNumber) {
