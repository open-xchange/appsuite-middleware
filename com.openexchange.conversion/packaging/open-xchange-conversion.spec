...
BuildRequires:  ant open-xchange-global >= @OXVERSION@ open-xchange-common >= @OXVERSION@
...
Requires:       open-xchange-global >= @OXVERSION@ open-xchange-common >= @OXVERSION@
#

%description
The Open-Xchange Conversion Bundle
