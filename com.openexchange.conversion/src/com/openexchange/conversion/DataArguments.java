...
public final class DataArguments {
	...
	/**
	 * Returns <code>true</code> if these data arguments contain a mapping for
	 * the specified key.
	 * 
	 * @param key
	 *            The key whose presence in these data arguments is to be
	 *            tested.
	 * @return <code>true</code> if this data arguments contain a mapping for
	 ...
	 * data arguments contain no mapping for this key. A return value of
	 * <code>null</code> does not necessarily indicate that the data arguments
	 * contain no mapping for the key; it's also possible that the data
	 * arguments explicitly map the key to <code>null</code>. The
	 ...
	 *         data arguments contain no mapping for this key.
	 */
	 ...
	 * arguments previously contained a mapping for this key, the old value is
	 ...
	 *         arguments previously associated <code>null</code> with the
	 *         specified key.
	 */
	...
	/**
	 * Removes the mapping for this key from these data arguments if it is
	 * present.
	 * 
	 * @param key
