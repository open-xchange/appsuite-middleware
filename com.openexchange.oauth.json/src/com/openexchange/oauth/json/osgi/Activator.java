...
public class Activator extends DeferredActivator {
    ...
    public void stopBundle() throws Exception {
        try {
            ...
            com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(com.openexchange.log.Log.valueOf(org.apache.commons.logging.LogFactory.getLog(Activator.class)))).error(e.getMessage(), e);
            throw e;
        }
    }
