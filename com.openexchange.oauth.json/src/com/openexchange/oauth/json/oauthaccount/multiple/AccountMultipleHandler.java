...
package com.openexchange.oauth.json.oauthaccount.multiple;
...
public final class AccountMultipleHandler implements MultipleHandler {
    ...
    public Object performRequest(final String action, final JSONObject jsonObject, final ServerSession session, final boolean secure) throws AbstractOXException, JSONException {
        final AJAXActionService actionService = AccountActionFactory.getInstance().createActionService(action);
