...
public final class QuotaExceptionMessages implements LocalizableStrings {
    ...
    public static final String QUOTA_EXCEEDED_SIGNATURES_MSG = "The storage limit for signatures is %1$s MB. Delete old signatures to be able to store a new one.";
