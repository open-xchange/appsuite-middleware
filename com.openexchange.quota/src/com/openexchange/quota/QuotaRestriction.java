...
public interface QuotaRestriction {
     ...
     * @return The quota
     * @throws OXException If quota cannot be returned
     */
    Quota getQuota(Resource resource, ResourceDescription desc, Session session, ServiceProvider serviceProvider) throws OXException;
