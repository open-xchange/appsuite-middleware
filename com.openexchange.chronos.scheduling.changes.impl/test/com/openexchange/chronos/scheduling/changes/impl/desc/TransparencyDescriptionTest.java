...
public class TransparencyDescriptionTest extends AbstractDescriptionTest {
    ...
    private TransparencyDescriber describer;
    ...
    public void testTransp_SetOPAQUE_DescriptionAvailable() {
        ...
        checkMessage(description, "Reserved");
    }
    ...
    @Test
    public void testTransp_NoValues_DescriptionUnavailable() {
        PowerMockito.when(B(fields.contains(EventField.TRANSP))).thenReturn(Boolean.FALSE);
