...
public abstract class AbstractMobilePushAction implements AJAXActionService {
    ...
    /**
     * Initializes a new {@link AbstractMobilePushAction}.
     */
    protected AbstractMobilePushAction(final ServiceLookup services) {
        super();
     ...
     */
    protected abstract AJAXRequestResult perform(MobilePushRequest req) throws OXException, JSONException;
}
