...
/**
 * {@link MobilePushRequest} - A mobile notifier request.
 * 
...
public class MobilePushRequest {
    ...
    /**
     * Initializes a new {@link MobilePushRequest}.
     * 
     * @param request The request
     * @param session The session
     */
    public MobilePushRequest(final AJAXRequestData request, final ServerSession session) {
        super();
    ...
    /**
     * Gets values seperated by comma
     * 
     * @param name The parameter name
     * @return The values mapped to given parameter name as String array
     * @throws NullPointerException If name is <code>null</code>
     * @throws OXException If no such parameter exists
     */
