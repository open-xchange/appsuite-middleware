...
package com.openexchange.mail.filter.ajax.parser.test;

import org.json.JSONArray;
import org.json.JSONException;
import org.json.JSONObject;

import com.openexchange.mail.filter.ajax.parser.comparison.ComparisonParser;
import com.openexchange.mail.filter.ajax.parser.comparison.ComparisonParserFactory;
import com.openexchange.mail.filter.ajax.writer.comparison.ComparisonWriter;
...
public class HeaderParserImpl implements TestParser {
	...
	public AbstractTest parseTest(String name, JSONObject jsonObject) throws JSONException {
		...
		final JSONObject jsonCompObj = jsonObject.getJSONObject("comparison");
		final String comparisonName = jsonCompObj.getString("name");
		
		final ComparisonParser compParser = ComparisonParserFactory.getParser(comparisonName);
		final AbstractComparison abstractComp = compParser.parseComparison(comparisonName, jsonCompObj);
