...
public class GrizzlyWebSocketService implements WebSocketService {
     ...
     */
    public GrizzlyWebSocketService(GrizzlyWebSocketApplication app) {
        super();
        this.app = app;
    }

    @Override
    public WebSocket getWebSocketFor(int userId, int contextId) throws OXException {
        // 1. Check local application
        // 2. Check on remote nodes
        return null;
    }
