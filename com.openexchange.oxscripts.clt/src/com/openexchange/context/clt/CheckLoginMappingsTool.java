 ...
 */
public final class CheckLoginMappingsTool {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    final ContextMBean contextMBean = contextMBean(mbsc);
                    ...
                    if (null == contextOptionVal) {
                        ...
                        contextMBean.checkLogin2ContextMapping();
                        ...
                        contextMBean.checkLogin2ContextMapping(contextId);
    ...
    private static void printHelp() {
        ...
        helpFormatter.printHelp("checkloginmappings", sOptions);
    }

    private static ContextMBean contextMBean(MBeanServerConnection mbsc) throws MalformedObjectNameException {
        return MBeanServerInvocationHandler.newProxyInstance(mbsc, getObjectName(ContextMBean.class.getName(), ContextMBean.DOMAIN), ContextMBean.class, false);
    }
