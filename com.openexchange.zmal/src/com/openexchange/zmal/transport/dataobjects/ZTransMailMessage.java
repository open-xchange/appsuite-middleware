...
package com.openexchange.zmal.transport.dataobjects;
...
/**
 * {@link ZTransMailMessage} - Extends the {@link ComposedMailMessage} class to
 * compose Zimbra transport messages.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 *
 */
public final class ZTransMailMessage extends ComposedMailMessage {
	...
	/**
	 * Initializes a new {@link ZTransMailMessage}.
	 * <p>
	 ...
	 *            The context
	 */
	public ZTransMailMessage(final String htmlMailBody, final Session session, final Context ctx) {
		super(session, ctx);
		mailPart = new ZTransBodyPart(htmlMailBody);
	 ...
	 *            The context
	 */
	public ZTransMailMessage(final Session session, final Context ctx) {
		super(session, ctx);
		enclosedParts = new ArrayList<MailPart>();
	}
