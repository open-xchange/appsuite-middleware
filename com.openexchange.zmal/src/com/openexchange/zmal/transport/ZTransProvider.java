...
import com.openexchange.zmal.transport.dataobjects.ZTransBodyPart;
import com.openexchange.zmal.transport.dataobjects.ZTransDataPart;
import com.openexchange.zmal.transport.dataobjects.ZTransDocumentPart;
import com.openexchange.zmal.transport.dataobjects.ZTransFilePart;
import com.openexchange.zmal.transport.dataobjects.ZTransMailMessage;
import com.openexchange.zmal.transport.dataobjects.ZTransReferencedPart;
 ...
 */
public final class ZTransProvider extends TransportProvider {

    /**
     * Zimbra transport protocol
     */
    public static final Protocol PROTOCOL_ZTRAN = new Protocol("ztran", "ztrans");

    private static final ZTransProvider instance = new ZTransProvider();
     ...
     */
    public static ZTransProvider getInstance() {
        return instance;
    }

    /**
     * Initializes a new {@link ZTransProvider}
     */
    private ZTransProvider() {
        super();
    }
    ...
    public DataMailPart getNewDataPart(final Object data, final Map<String, String> dataProperties, final Session session) throws OXException {
        return new ZTransDataPart(data, dataProperties, session);
    }
