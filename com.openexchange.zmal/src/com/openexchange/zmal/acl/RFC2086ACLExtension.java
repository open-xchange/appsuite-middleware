 ...
 */
public class RFC2086ACLExtension extends AbstractACLExtension {

    private static final RFC2086ACLExtension instance = new RFC2086ACLExtension();
     ...
     * @return The instance
     */
    public static RFC2086ACLExtension getInstance() {
        return instance;
    }
     ...
     */
    private RFC2086ACLExtension() {
        super();
        fullRights = new Rights("acdilprsw");
    }
