...
/**
 * {@link JSONToStackTraceElementConverterTest}
 *
 * @author <a href='mailto:marc.arens@open-xchange.com'>Marc Arens</a>
 */
public class JSONToStackTraceElementConverterTest {
    
    private final static String stackTraceElementString = "org.eclipse.osgi.baseadaptor.bundlefile.ZipBundleFile.basicOpen(ZipBundleFile.java:87)";
    private final static String stackTraceElementMissingFileNameString = "org.eclipse.osgi.baseadaptor.bundlefile.ZipBundleFile.basicOpen(Unknown Source)";

    private JSONObject stackTraceElementJSON=null;
    private JSONObject stackTraceElementMissingFileNameJSON=null;
    private JSONToStackTraceElementConverter converter = new JSONToStackTraceElementConverter();
    ...
    public void testConvert() throws OXException, JSONException {
        ...
        StackTraceElement element = StackTraceElement.class.cast(converted);
