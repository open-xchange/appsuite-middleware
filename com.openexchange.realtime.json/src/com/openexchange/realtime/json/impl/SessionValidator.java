...
public class SessionValidator {
    ...
    private final JSONConfig atmosphereConfig;

    private final JSONServiceRegistry atmosphereServiceRegistry;
    ...
    public SessionValidator(AtmosphereResource resource, String postData) {
        ...
        this.atmosphereServiceRegistry = JSONServiceRegistry.getInstance();
        this.atmosphereConfig = JSONConfig.getInstance();
    }
    ...
    private String getSessionFromPostData(String postData) throws OXException {
        ...
        if (postData != null) {
            ...
            try {
                ...
                throw JSONExceptionCode.POST_DATA_MALFORMED.create();
            }
        }
        return sessionId;
    }
