...
package com.openexchange.unitedinternet.mail.attachment.osgi;
...
import com.openexchange.unitedinternet.mail.attachment.URLMailAttachmentDataSource;
...
public final class URLMailAttachmentActivator implements BundleActivator {
    ...
    public void start(final BundleContext context) throws Exception {
        LOG.info("starting bundle: com.openexchange.unitedinternet.mail.attachment");
        try {
            /*
    ...
    public void stop(final BundleContext context) throws Exception {
        LOG.info("stopping bundle: com.openexchange.unitedinternet.mail.attachment");
        try {
            ...
            LOG.error("stopping bundle failed: com.openexchange.unitedinternet.mail.attachment", e);
            throw e;
        }
    }
