...
/**
 * {@link MakeNotNullUpdateTask} - Checks if <i>"cap"</i> column is nullable for tables <i>"capability_context"</i> and
 * <i>"capability_user"</i>, sets it to <code>NOT NULL</code> if so.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.8.1
 */
public class MakeNotNullUpdateTask extends UpdateTaskAdapter {

    /**
     * Initializes a new {@link MakeNotNullUpdateTask}.
     */
    public MakeNotNullUpdateTask() {
        super();
    }
    ...
    public void perform(PerformParameters params) throws OXException {
        ...
        try {
            ...
            if (Tools.isNullable(con, "capability_context", "cap")) {
                Tools.modifyColumns(con, "capability_context", column);
            }

            if (Tools.isNullable(con, "capability_user", "cap")) {
                Tools.modifyColumns(con, "capability_user", column);
            }
    ...
    public String[] getDependencies() {
        return new String[] { CapabilityCreateTableTask.class.getName() };
    }
