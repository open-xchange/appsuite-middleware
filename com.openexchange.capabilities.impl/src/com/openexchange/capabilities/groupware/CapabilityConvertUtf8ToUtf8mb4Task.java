 ...
 * @since v7.10.0
 */
public class CapabilityConvertUtf8ToUtf8mb4Task extends SimpleConvertUtf8ToUtf8mb4UpdateTask {

    /**
     * Initializes a new {@link CapabilityConvertUtf8ToUtf8mb4Task}.
     */
    public CapabilityConvertUtf8ToUtf8mb4Task() {
        super(ImmutableList.of("capability_context", "capability_user"), MakeNotNullUpdateTask.class.getName());
    }
}
