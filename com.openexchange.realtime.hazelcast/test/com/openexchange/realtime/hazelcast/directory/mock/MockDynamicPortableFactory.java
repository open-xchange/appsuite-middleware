 ...
 *
 * @author <a href="mailto:marc.arens@open-xchange.com">Tobias Friedrich</a>
 * @since 7.6.0
 */
public class MockDynamicPortableFactory implements DynamicPortableFactory {

    /** Named logger instance */
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(MockDynamicPortableFactory.class);

    private final ConcurrentMap<Integer, CustomPortableFactory> factories;

    /**
     * Initializes a new {@link MockDynamicPortableFactory}.
     */
    public MockDynamicPortableFactory() {
        super();
        this.factories = new ConcurrentHashMap<Integer, CustomPortableFactory>();
    }
    
    public MockDynamicPortableFactory(CustomPortableFactory... factories) {
        this();
        for (CustomPortableFactory portableFactory : factories) {
