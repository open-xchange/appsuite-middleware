...
package com.openexchange.document.converter.osgi;
...
public class DocumentConverterActivator extends HousekeepingActivator {
    ...
    /**
     * Initializes a new {@link DocumentConverterActivator}.
     */
    public DocumentConverterActivator() {
        super();
    }
...
//            System.getProperties().put("java.library.path", "/usr/lib/openoffice/program/"); // TODO: Where ever this is located
    ...
    protected void stopBundle() throws Exception {
        ...
        try {
            ...
            logger.error("Stopping bundle failed: com.openexchange.document.converter", e);
            throw e;
        }
    }
