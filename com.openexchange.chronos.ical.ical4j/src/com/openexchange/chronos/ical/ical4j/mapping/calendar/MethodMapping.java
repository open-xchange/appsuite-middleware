 ...
 * @since v7.10.0
 */
public class MethodMapping extends ICalTextMapping<VCalendar, Calendar> {

    /**
     * Initializes a new {@link MethodMapping}.
     */
	...
	protected Property createProperty() {
        return new WrCalName(PropertyFactoryImpl.getInstance());
	}
