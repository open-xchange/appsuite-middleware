 ...
 * @since v7.10.0
 */
public class AcknowledgedMapping extends ICalUtcMapping<VAlarm, Alarm> {
	...
	@Override
	protected Date getValue(Alarm object) {
		return object.getAcknowledged();
	}

	@Override
	protected void setValue(Alarm object, Date value) {
