...
/**
 * {@link ICal2EventsDataHandler}
 *
 * @author <a href="mailto:tobias.friedrich@open-xchange.com">Tobias Friedrich</a>
 * @since v7.10.0
 */
public class ICal2EventsDataHandler extends ICal2ObjectDataHandler<Event[]> {

    private final ICalMapper mapper;

    /**
     * Initializes a new {@link ICal2EventsDataHandler}.
     *
     * @param mapper The iCal mapper to use
     */
    public ICal2EventsDataHandler(ICalMapper mapper) {
        super();
        this.mapper = mapper;
    }
