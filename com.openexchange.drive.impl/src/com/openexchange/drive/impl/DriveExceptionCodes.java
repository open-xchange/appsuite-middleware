...
import static com.openexchange.drive.impl.DriveExceptionMessages.CLIENT_OUTDATED_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.CLIENT_VERSION_UPDATE_AVAILABLE_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.CONFLICTING_FILENAME_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.CONFLICTING_PATH_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.DIRECTORYVERSION_NOT_FOUND_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.FILEVERSION_NOT_FOUND_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.FILE_NOT_FOUND_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.IGNORED_FILENAME_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.IGNORED_PATH_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.INVALID_DIRECTORYVERSION_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.INVALID_FILENAME_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.INVALID_FILEVERSION_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.INVALID_FILE_OFFSET_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.INVALID_PATH_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.INVALID_PATTERN_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.LEVEL_CONFLICTING_FILENAME_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.LEVEL_CONFLICTING_PATH_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.LONG_POLLING_NOT_AVAILABLE_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.NO_CREATE_DIRECTORY_PERMISSION_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.NO_CREATE_FILE_PERMISSION_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.NO_DELETE_DIRECTORY_PERMISSION_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.NO_DELETE_FILE_PERMISSION_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.NO_MODIFY_FILE_PERMISSION_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.PATH_NOT_FOUND_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.QUOTA_REACHED_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.REPEATED_SYNC_PROBLEMS_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.SERVER_BUSY_MSG;
import static com.openexchange.drive.impl.DriveExceptionMessages.UPLOADED_FILE_CHECKSUM_ERROR_MSG;
