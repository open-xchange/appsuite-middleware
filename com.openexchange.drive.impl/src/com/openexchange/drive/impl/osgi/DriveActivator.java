...
import com.openexchange.drive.impl.checksum.rdb.DriveCreateTableService;
import com.openexchange.drive.impl.checksum.rdb.DriveDeleteListener;
import com.openexchange.drive.impl.checksum.rdb.SQL;
...
public class DriveActivator extends HousekeepingActivator {
    ...
    protected Class<?>[] getNeededServices() {
        return new Class<?>[] { IDBasedFileAccessFactory.class, ManagedFileManagement.class, DatabaseService.class, CapabilityService.class,
            ...
            UserService.class, GroupService.class, ModuleSupport.class, ShareService.class };
    }
