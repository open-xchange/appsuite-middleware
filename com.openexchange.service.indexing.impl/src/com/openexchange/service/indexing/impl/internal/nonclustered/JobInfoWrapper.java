...
public class JobInfoWrapper implements Serializable {
    ...
    private static final long serialVersionUID = 2915583098949913223L;
    ...
    /**
     * Convenience constructor with lastUpdate = now. Initializes a new {@link JobInfoWrapper}.
     */
    public JobInfoWrapper(JobInfo jobInfo, long jobTimeout, long interval, int progressionRate) {
        this(jobInfo, System.currentTimeMillis(), jobTimeout, interval, progressionRate);
    }
