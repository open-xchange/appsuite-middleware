...
/**
 * {@link MobilePushSubscriptionsCreateTableTask}
 *
 * @author <a href="mailto:lars.hoogestraat@open-xchange.com">Lars Hoogestraat</a>
 */
public class MobilePushSubscriptionsCreateTableTask extends UpdateTaskAdapter {
    ...
    public void perform(final PerformParameters params) throws OXException {
        ...
        try {
            ...
            rollback = true;
            final String[] tableNames = MobilePushSubscriptionsCreateTableService.getTablesToCreate();
            final String[] createStmts = MobilePushSubscriptionsCreateTableService.getCreateStmts();
            ...
            throw MobilePushExceptionCodes.UNEXPECTED_ERROR.create(e, e.getMessage());
        } finally {
            if (rollback) {
