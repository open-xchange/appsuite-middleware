...
public class Subscription {
    ...
    private MobilePushProviders mobileNotifierProviders;
    ...
    public Subscription(int contextId, int userId, String token, String serviceId, MobilePushProviders mobileNotifierProviders, long timestamp) {
    ...
    public void setMobileNotifierProviders(MobilePushProviders mobileNotifierProviders) {
        this.mobileNotifierProviders = mobileNotifierProviders;
    }
