...
public class CrawlerWebConnection extends HttpWebConnection {
    ...
    private final HttpWebConnection connection;
     ...
     */
    public CrawlerWebConnection(WebClient webClient) throws IllegalArgumentException {
        super(webClient);
        if (webClient == null) {
            throw new IllegalArgumentException("WebClient can't be null");
        }
        connection = (HttpWebConnection) webClient.getWebConnection(); 
    ...
    public WebResponse getResponse(final WebRequestSettings settings) throws IOException {
        return connection.getResponse(settings);
    }
