...
import com.openexchange.osgi.DeferredActivatorMBean;
import com.openexchange.osgi.DeferredActivatorMBeanImpl;
...
class ManagementRegisterer implements ServiceTrackerCustomizer<ManagementService, ManagementService> {
    ...
    public void removedService(final ServiceReference<ManagementService> reference, final ManagementService service) {
        ...
        unregisterOsgiMBean(management);
