...
/**
 * {@link AdministrativeCalendarUtilImpl}
 *
 * @author <a href="mailto:kevin.ruthmann@open-xchange.com">Kevin Ruthmann</a>
 * @since v7.10.1
 */
public class AdministrativeCalendarUtilImpl implements AdministrativeCalendarUtil {

    private static final Logger LOG = LoggerFactory.getLogger(AdministrativeCalendarUtilImpl.class);
    private final CalendarStorageFactory factory;
    private final CalendarUtilities utils;

    /**
     * Initializes a new {@link AdministrativeCalendarUtilImpl}.
     */
    public AdministrativeCalendarUtilImpl(CalendarStorageFactory factory, CalendarUtilities utilities) {
        super();
    ...
    @Override
    public Event getEventByAlarm(Context context, CalendarAccount account, int userId, String eventId) throws OXException {
        ...
        return storage.getUtilities().loadAdditionalEventData(userId, result, null);
    }
    ...
    @Override
    public void touchEvent(Context context, CalendarAccount account, int userId, String eventId) throws OXException {
