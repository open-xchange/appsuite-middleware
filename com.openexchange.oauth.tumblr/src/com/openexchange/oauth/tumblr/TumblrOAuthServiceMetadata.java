...
/**
 * {@link TumblrOAuthServiceMetadata}
 *
...
public class TumblrOAuthServiceMetadata extends AbstractOAuthServiceMetaData {
    ...
    @Override
    public String getId() {
        return "com.openexchange.oauth.tumblr";
    }

    @Override
    public String getAPIKey() {
        final ConfigurationService configurationService = services.getService(ConfigurationService.class);
        return configurationService.getProperty("com.openexchange.oauth.tumblr.apiKey", "");
    }

    @Override
    public String getAPISecret() {
        final ConfigurationService configurationService = services.getService(ConfigurationService.class);
        return configurationService.getProperty("com.openexchange.oauth.tumblr.apiSecret", "");
    }
