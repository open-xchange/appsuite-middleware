...
public class AppointmentWriter extends CalendarWriter {
    ...
    public void writeAppointment(final Appointment appointmentObject, final JSONObject jsonObj) throws JSONException {
        ...
        if (isFullTime) {
            ...
            if (appointmentObject.getRecurrenceType() == CalendarObject.NO_RECURRENCE) {
                ...
                writeParameter(CalendarFields.START_DATE, appointmentObject.getStartDate(), appointmentObject.getStartDate(), timeZone, jsonObj);
                writeParameter(CalendarFields.END_DATE, appointmentObject.getEndDate(), appointmentObject.getEndDate(), timeZone, jsonObj);
            }
        }
        ...
        if (appointmentObject.containsRecurrenceDatePosition()) {
            writeParameter(CalendarFields.RECURRENCE_DATE_POSITION, appointmentObject.getRecurrenceDatePosition(), jsonObj);
        }
    ...
    static {
        ...
        m.put(CalendarObject.RECURRENCE_POSITION, new AppointmentFieldWriter() {
            ...
            @Override
            public void write(final Appointment appointmentObject, final JSONArray jsonArray) {
                writeValue(appointmentObject.getRecurrencePosition(), jsonArray, appointmentObject.containsRecurrencePosition());
            }
        });
        ...
        m.put(CalendarObject.PARTICIPANTS, new AppointmentFieldWriter() {
            ...
            @Override
            public void write(final Appointment appointmentObject, final JSONArray jsonArray) throws JSONException {
