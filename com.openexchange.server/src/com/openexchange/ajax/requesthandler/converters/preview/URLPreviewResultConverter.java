...
/**
 * {@link URLPreviewResultConverter}
 *
 * @author <a href="mailto:steffen.templin@open-xchange.com">Steffen Templin</a>
 */
public class URLPreviewResultConverter extends AbstractPreviewResultConverter {
    
    public URLPreviewResultConverter() {
        super();
    }
    ...
    public void convert(AJAXRequestData request, AJAXRequestResult result, ServerSession session, Converter converter) throws OXException {
         ...
         * Set result object
         */
        result.setResultObject(managedFile.constructHTMLURL(session), getOutputFormat());
    }
