 ...
 * blobs are limited to 65KB, what's likely to small for some preview
 * images. Therefore the column is enlarged by changing the type to longblob,
 * which allows data up to 4GB.
 *
 * @author <a href="mailto:steffen.templin@open-xchange.com">Steffen Templin</a>
 * @since v7.6.0
 */
public class ChangeDataToLongblob extends UpdateTaskAdapter {
