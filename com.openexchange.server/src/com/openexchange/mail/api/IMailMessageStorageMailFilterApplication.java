...
public interface IMailMessageStorageMailFilterApplication extends IMailMessageStorage {
    ...
    /**
     * Applies the given mail filter to the messages contained in folder specified by full name.
     *
     * @param fullName the folder full name
     * @param mailFilter The mail filter to apply
     * @param searchTerm The search term to filter messages; may be <code>null</code> to apply to all messages
     * @return The filter results
     * @throws OXException If an error occurs
     */
    List<MailFilterResult> applyMailFilter(String fullName, String mailFilter, SearchTerm<?> searchTerm) throws OXException;
