    ...
    public RawJSONMessageHandler(final int accountId, final MailPath mailPath, final MailMessage mail) throws OXException {
        ...
        try {
            if (null != mail) {
                ...
                jsonObject.put(MailJSONField.AUTHENTICITY.getKey(), null == mailAuthenticityResult ? JSONObject.NULL : JsonMessageHandler.authenticationMechanismResultsToJson(mailAuthenticityResult));
