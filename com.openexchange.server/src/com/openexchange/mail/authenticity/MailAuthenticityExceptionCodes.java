...
/**
 * {@link MailAuthenticityExceptionCodes} - The error codes for mail authenticity.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.0
 */
public enum MailAuthenticityExceptionCodes implements DisplayableOXExceptionCode {
    ...
    public static final String PREFIX = "MAL-AUTH";
    ...
    private MailAuthenticityExceptionCodes(String message, String displayMessage, Category category, int detailNumber) {
