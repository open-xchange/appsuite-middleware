...
public enum MailField {
     ...
     */
    public static final MailField[] FIELDS_LOW_COST = { ID, FOLDER_ID, ATTACHMENT, MIME_TYPE, FROM, TO, CC, BCC, SUBJECT, SIZE, SENT_DATE, RECEIVED_DATE, FLAGS, THREAD_LEVEL, DISPOSITION_NOTIFICATION_TO, PRIORITY, COLOR_LABEL };
     ...
     */
    public static final MailField[] FIELDS_WO_BODY = { ID, FOLDER_ID, ATTACHMENT, MIME_TYPE, FROM, TO, CC, BCC, SUBJECT, SIZE, SENT_DATE, RECEIVED_DATE, FLAGS, THREAD_LEVEL, DISPOSITION_NOTIFICATION_TO, PRIORITY, COLOR_LABEL, HEADERS };
