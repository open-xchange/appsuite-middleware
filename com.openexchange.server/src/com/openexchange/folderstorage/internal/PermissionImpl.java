...
public class PermissionImpl implements Permission {
    ...
    private static final long serialVersionUID = -4329764120917375181L;
    ...
    /**
     * Initializes an empty {@link PermissionImpl} for a given entity.
     *
     * @param entity
     */
    public PermissionImpl(int entity) {
        super();
        this.entity = entity;
    }

    /**
     * Initializes a new {@link PermissionImpl} based on the given permission.
     *
     * @param permission
     */
    public PermissionImpl(Permission permission) {
        ...
        setAllPermissions(permission.getFolderPermission(), permission.getReadPermission(), permission.getWritePermission(), permission.getDeletePermission());
    }
