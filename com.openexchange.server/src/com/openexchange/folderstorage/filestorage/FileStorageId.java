...
public final class FileStorageId implements SortableId {
     ...
     * @param name The name
     */
    public FileStorageId(final String folderId, final int ordinal, final String name) {
        super();
    ...
    public int compareTo(final SortableId o) {
        if (o instanceof FileStorageId) {
            final int thisVal = ordinal;
            final int anotherVal = ((FileStorageId) o).ordinal;
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof FileStorageId)) {
            return false;
        }
        final FileStorageId other = (FileStorageId) obj;
