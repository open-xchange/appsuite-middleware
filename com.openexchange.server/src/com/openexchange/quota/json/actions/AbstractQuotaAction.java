...
public abstract class AbstractQuotaAction implements AJAXActionService {
    ...
    /**
     * Initializes a new {@link AbstractQuotaAction}.
     */
    protected AbstractQuotaAction(final ServiceLookup services) {
        super();
     ...
     */
    protected abstract AJAXRequestResult perform(QuotaAJAXRequest req) throws OXException, JSONException;
