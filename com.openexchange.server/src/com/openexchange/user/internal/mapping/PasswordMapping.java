...
/**
 *
 * {@link PasswordMapping}
 *
 * @author <a href="mailto:martin.schneider@open-xchange.com">Martin Schneider</a>
 * @since 7.8.0
 */
public final class PasswordMapping extends VarCharMapping<User> {
    ...
    public void set(User user, String value) {
        ...
        if (user instanceof UserImpl) {
            ((UserImpl) user).setUserPassword(value);
        } else {
            throw new UnsupportedOperationException("com.openexchange.groupware.ldap.User.setUserPassword(String)");
        }
    }
