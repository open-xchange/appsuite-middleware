...
/**
 * {@link IMAPServerMapping}
 *
 * @author <a href="mailto:marcus.klein@open-xchange.com">Marcus Klein</a>
 */
public final class IMAPServerMapping extends VarCharMapping<User> {

    public IMAPServerMapping() {
        super("imapServer", "IMAP server");
    }

    @Override
    public boolean isSet(User user) {
        return null != user.getImapServer();
    }
