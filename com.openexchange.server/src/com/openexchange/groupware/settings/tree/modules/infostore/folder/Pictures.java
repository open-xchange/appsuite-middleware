...
public class Pictures implements PreferencesItemService {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(Pictures.class);
            ...
            public void getValue(Session session, Context ctx, User user, UserConfiguration userConfig, Setting setting) throws OXException {
                ...
                try {
                    ...
                    if (null != defaultAccountManager) {
                        ...
                        try {
                            FileStorageFolder picturesFolder = accountAccess.getFolderAccess().getPicturesFolder();
