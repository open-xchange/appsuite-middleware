 ...
 */
public class UploadQuotaTotal implements PreferencesItemService {

    /**
     * Default constructor.
     */
    public UploadQuotaTotal() {
        super();
    }
    ...
    public String[] getPath() {
        return new String[] { "modules", "mail", "uploadquota_total" };
    }
        ...
        return new ReadOnlyValue() {
            ...
            public void getValue(Session session, Context ctx, User user, UserConfiguration userConfig, Setting setting) throws OXException {
                ...
                if (null != settings) {
                    ...
                    setting.setSingleValue(Long.valueOf(quotaChecker.getQuotaMax()));
                }
            }
        };
    }
