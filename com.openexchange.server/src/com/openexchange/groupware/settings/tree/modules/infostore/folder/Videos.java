 ...
 * @since v7.8
 */
public class Videos implements PreferencesItemService {

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(Videos.class);
    private static final String DEFAULT_ID = FileStorageAccount.DEFAULT_ID;

    /**
     * Initializes a new {@link Videos}.
     */
    public Videos() {
        super();
    }
    ...
    public IValueHandler getSharedValue() {
        return new ReadOnlyValue() {
            ...
            public void getValue(Session session, Context ctx, User user, UserConfiguration userConfig, Setting setting) throws OXException {
                ...
                /*
                 * Use infostore default videos folder if available
                 */
                ...
                /*
                 * Get videos folder from primary account
                 */
                ...
                try {
                    ...
                    if (null != defaultAccountManager) {
                        ...
                        try {
                            FileStorageFolder videosFolder = accountAccess.getFolderAccess().getVideosFolder();
                            setting.setSingleValue(new FolderID(
                                fileStorageService.getId(), defaultAccount.getId(), videosFolder.getId()).toUniqueID());
                            return;
                        } finally {
                            accountAccess.close();
                        }
                    ...
                    LOG.error("Infostore videos folder could not be applied to user configuration.", e);
                }
            }
        };
    }
