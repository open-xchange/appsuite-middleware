 ...
 */
public class DisplayReceiptNotification implements PreferencesItemService {

    /**
     * Default constructor.
     */
    public DisplayReceiptNotification() {
        super();
    }
    ...
    public String[] getPath() {
        return new String[] { "modules", "mail", "displayReceiptNotification" };
    }
    ...
    public IValueHandler getSharedValue() {
        return new IValueHandler() {
            ...
            public void getValue(final Session session, final Context ctx, final User user, final UserConfiguration userConfig, final Setting setting) throws OXException {
                ...
                if (null != settings) {
                    setting.setSingleValue(Boolean.valueOf(settings.isDisplayReceiptNotification()));
                }
            }
            ...
            public void writeValue(final Session session, final Context ctx, final User user, final Setting setting) throws OXException {
                ...
                if (null != usm) {
                    ...
                    if (!com.openexchange.java.Strings.isEmpty(s)) {
                        try {
                            boolean displayReceiptNotification = Boolean.parseBoolean(s.trim());
                            if (displayReceiptNotification != usm.isDisplayReceiptNotification()) {
