...
/**
 * {@link MaxVersionCount}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.1
 */
public class MaxVersionCount implements PreferencesItemService, ConfigTreeEquivalent {

    /**
     * Initializes a new {@link MaxVersionCount}.
     */
    public MaxVersionCount() {
        super();
    }

    @Override
    public String[] getPath() {
        return new String[] { "modules", "infostore", "features", "autodelete", "maxVersions" };
    }

    @Override
    public String getConfigTreePath() {
        return "modules/infostore/features/autodelete/maxVersions";
    }

    @Override
    public String getJslobPath() {
        return "io.ox/files//features/autodelete/maxVersions";
    }
    ...
    public IValueHandler getSharedValue() {
        return new IValueHandlerExtended() {
            ...
            public void writeValue(Session session, Context ctx, User user, Setting setting) throws OXException {
                int maxVersions = ((Integer) setting.getSingleValue()).intValue();
                InfostoreAutodeleteSettings.setMaxNumberOfFileVersions(maxVersions, session);
            }
            ...
            public void getValue(Session session, Context ctx, User user, UserConfiguration userConfig, Setting setting) throws OXException {
                ...
                setting.setSingleValue(Integer.valueOf(maxVersions));
            }
