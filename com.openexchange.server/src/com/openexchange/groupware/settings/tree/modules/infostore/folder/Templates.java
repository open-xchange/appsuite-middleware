 ...
 * @since v7.8
 */
public class Templates implements PreferencesItemService {

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(Templates.class);
    private static final String DEFAULT_ID = FileStorageAccount.DEFAULT_ID;

    /**
     * Initializes a new {@link Templates}.
     */
    public Templates() {
        super();
    }
    ...
    public String[] getPath() {
        return new String[] { "modules", "infostore", "folder", "templates" };
    }
    ...
    public IValueHandler getSharedValue() {
        return new ReadOnlyValue() {
            ...
            public void getValue(Session session, Context ctx, User user, UserConfiguration userConfig, Setting setting) throws OXException {
                ...
                /*
                 * Use infostore default templates folder if available
                 */
                ...
                /*
                 * Get templates folder from primary account
                 */
                ...
                try {
                    ...
                    if (null != defaultAccountManager) {
                        ...
                        try {
                            ...
                            if (fa instanceof MediaFolderAwareFolderAccess) {
                                FileStorageFolder templatesFolder = ((MediaFolderAwareFolderAccess) fa).getTemplatesFolder();
                                setting.setSingleValue(new FolderID(
                                    fileStorageService.getId(), defaultAccount.getId(), templatesFolder.getId()).toUniqueID());
                            }
                        } finally {
                            accountAccess.close();
                        }
                    ...
                    LOG.error("Infostore templates folder could not be applied to user configuration.", e);
                }
            }
        };
    }
