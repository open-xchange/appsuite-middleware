...
public class MailObject {
    ...
    public final void send() throws OXException {
        try {
            ...
            */
            ...
            saveChangesSafe(msg, keepMessageId);
            /*
    ...
    private void saveChangesSafe(final MimeMessage mimeMessage, boolean keepMessageId) throws OXException {
        ...
        MimeMessageUtility.saveChanges(mimeMessage, hostName, keepMessageId);
    }
