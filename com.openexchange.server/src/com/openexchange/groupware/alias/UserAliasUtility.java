...
public final class UserAliasUtility {
     ...
     * @param users The {@link User} to check
     * @return The {@link User} matching the alias or <code>null</code>
     * @see <a href="https://tools.ietf.org/html/rfc5321#section-2.4">RFC 5321</a>
     */
    public static User getUser(String possibleAlias, Collection<User> users) {
        for (User user : users) {
            if (isAlias(possibleAlias, user)) {
                return user;
            }
        }
        return null;
