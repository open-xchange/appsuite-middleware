...
public enum TaskExceptionCode implements OXExceptionCode {
    ...
    NO_CONNECTION(TaskExceptionMessage.NO_CONNECTION_MSG, Category.CATEGORY_SERVICE_DOWN, 3),
    ...
    COSTS_OFF_LIMIT(TaskExceptionMessage.COSTS_OFF_LIMIT_MSG, Category.CATEGORY_USER_INPUT, 50),
    /** In order to accomplish the search, %1$d or more characters are required. */
    PATTERN_TOO_SHORT(TaskExceptionMessage.PATTERN_TOO_SHORT_MSG, Category.CATEGORY_USER_INPUT, 51),
    ...
    private TaskExceptionCode(final String message, final Category category, final int number) {
