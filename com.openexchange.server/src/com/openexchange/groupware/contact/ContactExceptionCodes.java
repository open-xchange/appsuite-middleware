...
public enum ContactExceptionCodes implements OXExceptionCode {
    ...
    /** Unable to import this contact picture. Either the type is not part of the supported type (JPG, GIF, BMP or PNG) or the size exceed %3$d. Your file type is %1$s and your image size is %2$d. */
    ...
    /** You do not have CATEGORY_PERMISSION_DENIED to access objects in this folder %1$d in context %2$d with user %3$d */
    ...
    /** You do not have CATEGORY_PERMISSION_DENIED to create objects in this folder %1$d in context %2$d with user %3$d */
    ...
    TRIGGERING_EVENT_FAILED(TRIGGERING_EVENT_FAILED_MSG, Category.CATEGORY_ERROR, 146),
    /** Unable to pick up a connection from the DBPool */
    INIT_CONNECTION_FROM_DBPOOL(INIT_CONNECTION_FROM_DBPOOL_MSG, Category.CATEGORY_SERVICE_DOWN, 151),
    ...
    FIRST_NAME_MANDATORY(FIRST_NAME_MANDATORY_MSG, Category.CATEGORY_USER_INPUT, 164),
    ...
    /** You do not have CATEGORY_PERMISSION_DENIED to delete objects from folder %1$d in context %2$d with user %3$d */
    NO_DELETE_PERMISSION(NO_DELETE_PERMISSION_MSG, Category.CATEGORY_PERMISSION_DENIED, 169),
    /** Mime type is not defined. */
    MIME_TYPE_NOT_DEFINED(MIME_TYPE_NOT_DEFINED_MSG, Category.CATEGORY_USER_INPUT, 170),
    /** A contact with private flag cannot be stored in a public folder. Folder: %1$d context %2$d user %3$d */
    PFLAG_IN_PUBLIC_FOLDER(PFLAG_IN_PUBLIC_FOLDER_MSG, Category.CATEGORY_USER_INPUT, 171),
    ...
    NO_PRIMARY_EMAIL_EDIT(NO_PRIMARY_EMAIL_EDIT_MSG, Category.CATEGORY_PERMISSION_DENIED, 173),
    ...
    DATE_CONVERSION_FAILED(DATE_CONVERSION_FAILED_MSG, Category.CATEGORY_ERROR, 600),
    /** Could not convert given object %1$s to a date when setting %2$s. */
    CONV_OBJ_2_DATE_FAILED(CONV_OBJ_2_DATE_FAILED_MSG, Category.CATEGORY_ERROR, 700),
    /** Need at least a ContactObject to get the value of %s */
    CONTACT_OBJECT_MISSING(CONTACT_OBJECT_MISSING_MSG, Category.CATEGORY_ERROR, 800),
    /** In order to accomplish the search, %1$d or more characters are required. */
    TOO_FEW_SEARCH_CHARS(TOO_FEW_SEARCH_CHARS_MSG, Category.CATEGORY_USER_INPUT, 1000),
    /** An unexpected error occurred: %1$s */
    UNEXPECTED_ERROR(ContactExceptionMessages.UNEXPECTED_ERROR_MSG, Category.CATEGORY_USER_INPUT, 1001),
    ...
    private ContactExceptionCodes(final String message, final Category category, final int number) {
