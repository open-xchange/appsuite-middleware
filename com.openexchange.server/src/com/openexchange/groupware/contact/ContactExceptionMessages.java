...
public class ContactExceptionMessages implements LocalizableStrings {
    ...
    public static final String DATA_TRUNCATION_MSG = "Some data entered exceeded the field limit. Please shorten the value for \"%1$s\" (current: %2$s, limit: %3$s) and try again.";
