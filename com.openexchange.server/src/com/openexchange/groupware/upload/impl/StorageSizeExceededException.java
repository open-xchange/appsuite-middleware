 ...
 */
public final class StorageSizeExceededException extends UploadException {

    /**
     * No instance.
     */
    private StorageSizeExceededException(final int code, final String displayMessage, final Throwable cause, final Object[] displayArgs) {
    ...
    public static UploadException create(final long size, final long maxSize, final boolean humanReadable) {
        return UploadException.UploadCode.MAX_STORAGE_SIZE_EXCEEDED.create(
