...
/**
 * {@link AddMetaForInfostoreDocumentTable} - Extends infostore document tables by "meta" JSON BLOB.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public class AddMetaForInfostoreDocumentTable extends UpdateTaskAdapter {

    /**
     * Initializes a new {@link AddMetaForInfostoreDocumentTable}.
     */
    public AddMetaForInfostoreDocumentTable() {
        super();
    }
    ...
    public void perform(PerformParameters params) throws OXException {
        ...
        try {
            ...
            if (!Tools.columnExists(con, "del_infostore_document", "meta")) {
