...
/**
 *
 * UpdateTask for adding vCardId column to del_contacts
 *
 * @author <a href="mailto:martin.schneider@open-xchange.com">Martin Schneider</a>
 * @since 7.8.0
 */
public final class ContactAddVCardIdToDelTask extends UpdateTaskAdapter {

    /**
     * Initializes a new {@link ContactAddVCardIdToDelTask}.
     */
    public ContactAddVCardIdToDelTask() {
        super();
    }
    ...
    public void perform(final PerformParameters params) throws OXException {
        ...
        try {
            ...
            Tools.checkAndAddColumns(con, TableNameConstants.DEL_CONTACTS, getColumns());
            con.commit();
