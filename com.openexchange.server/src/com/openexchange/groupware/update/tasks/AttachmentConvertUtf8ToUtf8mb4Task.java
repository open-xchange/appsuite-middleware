...
/**
 * {@link AttachmentConvertUtf8ToUtf8mb4Task} - Converts attachment tables to utf8mb4.
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.0
 */
public class AttachmentConvertUtf8ToUtf8mb4Task extends AbstractConvertUtf8ToUtf8mb4Task {
    ...
    public String[] getDependencies() {
        return new String[] { AttachmentCountUpdateTask.class.getName() };
    }

    @Override
    protected List<String> tablesToConvert() {
        return ImmutableList.of("prg_attachment", "del_attachment");
    }
