...
/**
 * {@link ContactAddFilenameColumnTask}
 * 
 * @author <a href="mailto:tobias.friedrich@open-xchange.com">Tobias Friedrich</a>
 */
public class ContactAddFilenameColumnTask extends UpdateTaskAdapter {
    ...
    public void perform(PerformParameters params) throws OXException {
        ...
        try {
            ...
            Tools.checkAndAddColumns(connnection, "prg_contacts", filenameColumn);
            Tools.checkAndAddColumns(connnection, "del_contacts", filenameColumn);
            connnection.commit();
