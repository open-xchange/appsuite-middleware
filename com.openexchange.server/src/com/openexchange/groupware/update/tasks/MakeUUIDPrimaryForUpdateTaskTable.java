...
public class MakeUUIDPrimaryForUpdateTaskTable extends UpdateTaskAdapter {
    ...
    public void perform(PerformParameters params) throws OXException {
        ...
        try {
            ...
            if (!Tools.columnExists(connection, TABLE, COLUMN)) {
                throw UpdateExceptionCodes.COLUMN_NOT_FOUND.create(COLUMN);
            }

            AddUUIDForUpdateTaskTable.fillUUIDs(connection, TABLE, progress);
    ...
    public String[] getDependencies() {
        return new String[] { "com.openexchange.groupware.update.tasks.AddUUIDForUpdateTaskTable" };
    }
