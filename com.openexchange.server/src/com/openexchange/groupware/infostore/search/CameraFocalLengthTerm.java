...
/**
 * {@link CameraFocalLengthTerm}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since 7.10.2
 */
public class CameraFocalLengthTerm extends AbstractNumberSearchTerm {

    /**
     * Initializes a new {@link CameraFocalLengthTerm}.
     * @param pattern
     */
    public CameraFocalLengthTerm(ComparablePattern<Number> pattern) {
        super(pattern);
    }
    ...
    public void addField(Collection<Metadata> col) {
        if (null != col) {
            col.add(Metadata.CAMERA_FOCAL_LENGTH_LITERAL);
        }
    }
