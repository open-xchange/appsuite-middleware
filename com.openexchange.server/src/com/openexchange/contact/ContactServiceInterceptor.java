...
/**
 * {@link ContactServiceInterceptor}
 *
...
public interface ContactServiceInterceptor {
	 ...
	 */
	static final int DEFAULT_RANKING = 100;
	...
	/**
	 * Invoked after a contact has been read from the storage, but before passing the result to the caller.
	 *
	 * @param contact A reference to the read contact.
	 * @param session The session used to access the contact
	 */
