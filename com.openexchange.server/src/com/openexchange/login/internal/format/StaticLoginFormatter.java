...
/**
 * {@link StaticLoginFormatter} - The static formatter just appending pre-set string.
 *
...
public final class StaticLoginFormatter implements LoginFormatter {
    ...
    /**
     * Initializes a new {@link StaticLoginFormatter}.
     */
    public StaticLoginFormatter(final String str) {
        super();
        this.str = str;
    }
