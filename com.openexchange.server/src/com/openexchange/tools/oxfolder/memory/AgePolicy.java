...
public final class AgePolicy implements EvictionPolicy {
    ...
    /**
     * Initializes a new {@link AgePolicy}.
     *
     * @param ageThresholdMillis The age threshold
     */
    public AgePolicy(final long ageThresholdMillis) {
        super();
    ...
    public Entry<?, ?> recordAccess(final Entry<?, ?> head, final Entry<?, ?> accessedEntry) {
        final long ageThresholdMillis = this.ageThresholdMillis;
