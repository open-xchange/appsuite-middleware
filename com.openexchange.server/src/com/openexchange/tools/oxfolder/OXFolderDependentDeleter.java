            ...
            if (null != subfolderIDs && 0 < subfolderIDs.size()) {
                ...
                subfolderIDs.forEach(new TIntProcedure() {
                    ...
                    public boolean execute(int subfolderID) {
                        targets.add(new GroupwareTarget(module, Integer.toString(subfolderID)));
                        return true;
                    }
                });
                ...
                shareService.deleteTarget(session, new GroupwareTarget(module, Integer.toString(folderID)), guestIDs);
            }
        } finally {
