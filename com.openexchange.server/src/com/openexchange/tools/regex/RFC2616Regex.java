...
public final class RFC2616Regex {
    ...
    private static final String tokenCharRegex = "[\\p{L}&&[^\\p{Cntrl}()<>@,;:\\\"/\\[\\]?={}\\p{Blank}]]";
    ...
    private static final String qdtextRegex = "[\\p{L}\\p{Blank}&&[^\\p{Cntrl}\"]]*";
    ...
    private static final String quotedPairRegex = "(?:\\\\\\p{L})*";
    ...
    private static final String quotedStringRegex = "(?:\"(?:[\\p{L}\\p{Blank}&&[^\\p{Cntrl}\"]]|(?:\\\\\\p{L}))*\")";
