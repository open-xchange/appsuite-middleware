...
public final class RFC2616Regex {
    ...
    private static final String tokenCharRegex = "[^\\p{Cntrl}()<>@,;:\\\"/\\[\\]?={}\\p{Blank}]";
    ...
    private static final String qdtextRegex = "[^\\p{Cntrl}\";=]*";
    ...
    private static final String quotedPairRegex = "(?:\\\\[^;=])*";
    ...
    private static final String quotedStringRegex = "(?:\"(?:[^\\p{Cntrl}\";=]|(?:\\\\[^;=]))*\")";
