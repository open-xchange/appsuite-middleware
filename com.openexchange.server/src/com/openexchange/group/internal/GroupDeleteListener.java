...
/**
 * {@link GroupDeleteListener}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since v7.10.0
 */
public class GroupDeleteListener implements DeleteListener {

    /**
     * Initializes a new {@link GroupDeleteListener}.
     */
    ...
    private void handleContextDeletion(Connection writeCon, Context ctx) throws OXException {
        ...
        try {
            ...
            stmt.addBatch("DELETE FROM groups_member WHERE cid=" + ctx.getContextId());
