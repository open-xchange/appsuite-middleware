...
/**
 * {@link DefaultBasicPasswordChangeServiceTest}
 *
...
public class DefaultBasicPasswordChangeServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        factory = new PasswordMechFactoryImpl();
        factory.register(PasswordMech.BCRYPT, PasswordMech.CRYPT, PasswordMech.SHA);
    ...
    public void testPrepareUserUpdate_userHasPasswordMechSHA_returnUpdatedUserWithSHA() throws OXException {
        ...
        origUser.setUserPassword(factory.get(IPasswordMech.SHA).encode(password));
        UserImpl updatedUser = new UserImpl();

        service.prepareUserUpdate(event, origUser, updatedUser);

        Assert.assertEquals(IPasswordMech.SHA, updatedUser.getPasswordMech());
    ...
    public void testPrepareUserUpdate_passwordMechEmpty_useBcryptAsDefault() throws OXException {
        ...
        Assert.assertEquals(IPasswordMech.BCRYPT, updatedUser.getPasswordMech());
        Assert.assertNotNull("Password should not be empty", updatedUser.getUserPassword());
    }
    ...
    public void testPrepareUserUpdate_newPasswordEmpty_setEmptyPassword() throws OXException {
        ...
        Assert.assertNull(updatedUser.getUserPassword());
    }
}
