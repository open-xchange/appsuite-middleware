...
public class AdministrativeCalendarUtilImpl implements AdministrativeCalendarUtil {
     ...
     */
    public AdministrativeCalendarUtilImpl(ServiceLookup services) {
        super();
    ...
    public String getProivderId() {
        return BirthdaysCalendarProvider.PROVIDER_ID;
    }
    ...
    public Event getEventByAlarm(Context context, CalendarAccount account, int userId, String eventId) throws OXException {
        ...
        EventConverter eventConverter = new EventConverter(services, session.getUser().getLocale(), userId);
