...
public class BirthdayCalendarEvent implements CalendarEvent {
    ...
    /**
     * Initializes a new {@link BirthdayCalendarEvent}.
     *
     ...
     */
    public BirthdayCalendarEvent(int contextId, int accountId, int calendarUserId, Map<Integer, List<String>> affectedFoldersPerUser, List<CreateResult> creations, List<UpdateResult> updates, List<DeleteResult> deletions, Session session) {
        super();
