 ...
 */
public final class PasscryptServiceRegistry {

    private static final ServiceRegistry SERVICE_REGISTRY = new ServiceRegistry(8);

    /**
     * Gets the service registry of <i>com.openexchange.passcrypt</i> bundle.
     *
    ...
    /**
     * Initializes a new {@link PasscryptServiceRegistry}.
     */
    private PasscryptServiceRegistry() {
        super();
    }
