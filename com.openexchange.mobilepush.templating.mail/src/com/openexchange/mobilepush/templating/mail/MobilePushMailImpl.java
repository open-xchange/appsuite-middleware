...
package com.openexchange.mobilepush.templating.mail;
...
import com.openexchange.mobilepush.templating.AbstractMobilePushService;
import com.openexchange.mobilepush.templating.NotifyItem;
import com.openexchange.mobilepush.templating.NotifyTemplate;
import com.openexchange.mobilepush.templating.utility.LocaleAndTimeZone;
import com.openexchange.mobilepush.templating.utility.LocalizationUtility;
import com.openexchange.mobilepush.templating.utility.MobileNotifierFileUtility;
import com.openexchange.server.ExceptionOnAbsenceServiceLookup;
import com.openexchange.server.ServiceLookup;
import com.openexchange.session.Session;

/**
 * {@link MobilePushMailImpl}
 *
 * @author <a href="mailto:lars.hoogestraat@open-xchange.com">Lars Hoogestraat</a>
 */
public class MobilePushMailImpl extends AbstractMobilePushService {

    private final ServiceLookup services;

    /**
     * Initializes a new {@link MobilePushMailImpl}.
     *
     * @param services The service look-up
     */
    public MobilePushMailImpl(final ServiceLookup services) {
        super();
    ...
    public String getProviderName() {
        return MobilePushProviders.MAIL.getProviderName();
    }

    @Override
    public String getFrontendName() {
        return MobilePushProviders.MAIL.getFrontendName();
    }
    ...
    public NotifyTemplate getTemplate() throws OXException {
        final String template = MobileNotifierFileUtility.getTemplateFileContent(MobilePushProviders.MAIL.getTemplateFileName());
        final String title = MobilePushProviders.MAIL.getTitle();
        return new NotifyTemplate(title, template, true, MobilePushProviders.MAIL.getIndex());
    }

    @Override
    public void putTemplate(String changedTemplate) throws OXException {
        MobileNotifierFileUtility.writeTemplateFileContent(MobilePushProviders.MAIL.getTemplateFileName(), changedTemplate);
    }
