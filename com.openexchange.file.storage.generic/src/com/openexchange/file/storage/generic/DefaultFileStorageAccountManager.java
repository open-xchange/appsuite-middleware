...
/**
 * {@link DefaultFileStorageAccountManager} - The default file storage account manager.
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since Open-Xchange v6.18.2
 */
public class DefaultFileStorageAccountManager implements FileStorageAccountManager {
    ...
    /**
     * Initializes a new {@link DefaultFileStorageAccountManager}.
     * 
     * @param service The file storage service
     */
    public DefaultFileStorageAccountManager(final FileStorageService service) {
        super();
