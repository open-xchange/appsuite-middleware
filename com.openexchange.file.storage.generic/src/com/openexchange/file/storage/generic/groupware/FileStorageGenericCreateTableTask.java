...
package com.openexchange.file.storage.generic.groupware;
...
import com.openexchange.file.storage.generic.services.FileStorageGenericServiceRegistry;
...
/**
 * {@link FileStorageGenericCreateTableTask}
 *
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 */
public final class FileStorageGenericCreateTableTask extends AbstractCreateTableImpl implements UpdateTaskV2 {

    /**
     * Initializes a new {@link FileStorageGenericCreateTableTask}.
     */
    public FileStorageGenericCreateTableTask() {
        super();
    }
    ...
    public void perform(final PerformParameters params) throws AbstractOXException {
        ...
        final org.apache.commons.logging.Log logger = org.apache.commons.logging.LogFactory.getLog(FileStorageGenericCreateTableTask.class);
        if (logger.isInfoEnabled()) {
            logger.info("UpdateTask '" + FileStorageGenericCreateTableTask.class.getSimpleName() + "' successfully performed!");
        }
    }
    ...
    private <S> S getService(final Class<? extends S> clazz) throws UpdateException {
        try {
            return FileStorageGenericServiceRegistry.getServiceRegistry().getService(clazz, true);
