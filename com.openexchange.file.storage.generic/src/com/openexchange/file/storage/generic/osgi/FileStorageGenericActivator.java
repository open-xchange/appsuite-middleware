...
package com.openexchange.file.storage.generic.osgi;

import static com.openexchange.file.storage.generic.services.FileStorageGenericServiceRegistry.getServiceRegistry;
...
import com.openexchange.file.storage.generic.groupware.FileStorageGenericCreateTableTask;
import com.openexchange.file.storage.generic.groupware.FileStorageGenericDeleteListener;
import com.openexchange.file.storage.generic.internal.CachingFileStorageAccountStorage;
import com.openexchange.file.storage.generic.internal.DefaultFileStorageAccountManagerProvider;
import com.openexchange.file.storage.generic.secret.FileStorageSecretHandling;
...
/**
 * {@link FileStorageGenericActivator}
 * 
 * @author <a href="mailto:thorben.betten@open-xchange.com">Thorben Betten</a>
 * @since Open-Xchange v6.18.2
 */
public class FileStorageGenericActivator extends DeferredActivator {
    ...
    public FileStorageGenericActivator() {
        super();
    }
    ...
    protected void handleAvailability(final Class<?> clazz) {
        final org.apache.commons.logging.Log logger = org.apache.commons.logging.LogFactory.getLog(FileStorageGenericActivator.class);
    ...
    protected void startBundle() throws Exception {
        try {
            ...
            registrations.add(context.registerService(FileStorageAccountManagerProvider.class.getName(), new DefaultFileStorageAccountManagerProvider(), null));
            final FileStorageGenericCreateTableTask createTableTask = new FileStorageGenericCreateTableTask();
            ...
            registrations.add(context.registerService(DeleteListener.class.getName(), new FileStorageGenericDeleteListener(), null));
            /*
             * Secret Handling
             */
            {
            ...
            org.apache.commons.logging.LogFactory.getLog(FileStorageGenericActivator.class).error(e.getMessage(), e);
            throw e;
        }
    }
