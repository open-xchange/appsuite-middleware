...
BuildArch:	noarch
BuildRequires:  ant open-xchange-common open-xchange-global open-xchange-configread open-xchange-monitoring open-xchange-caching open-xchange-server
...
Requires:       open-xchange-common open-xchange-global open-xchange-configread open-xchange-monitoring open-xchange-caching open-xchange-server
#
