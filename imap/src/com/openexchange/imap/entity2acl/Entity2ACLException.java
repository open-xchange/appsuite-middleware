...
public final class Entity2ACLException extends AbstractOXException {
    ...
    public static enum Code {
         ...
         */
        CREATING_SOCKET_FAILED("An I/O error occurred while creating the socket connection to IMAP server (%1$s): %2$s", Category.SUBSYSTEM_OR_SERVICE_DOWN, 2),
        /**
         ...
         */
        UNKNOWN_USER("User %1$s from context %2$s is not known on IMAP server \"%3$s\".", Category.CODE_ERROR, 9);
