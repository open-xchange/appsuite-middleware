...
public final class IMAPException extends MIMEMailException {
	...
	public static enum Code {
		 ...
		 */
		NO_MAIL_MODULE_ACCESS("User %1$s has no mail module access due to user configuration",
		...
		FOLDER_CREATION_FAILED(
				"Mail folder \"%1$s\" could not be created (maybe due to insufficient permission on parent folder %2$s or due to an invalid folder name)",
		...
		NO_ADMINISTER_ACCESS_ON_INITIAL(
				"The composed rights could not be applied to new folder %1$s due to missing administer right in its initial rights specified by IMAP server. However, the folder has been created.",
		 ...
		 */
		IMAP_SEARCH_FAILED("IMAP search failed due to following reason: %1$s. Switching to application-based search",
				Category.SUBSYSTEM_OR_SERVICE_DOWN, 2029),
		/**
		 * IMAP sort failed due to following reason: %1$s Switching to
		 * application-based sorting
		 */
		IMAP_SORT_FAILED("IMAP sort failed due to following reason: %1$s Switching to application-based sorting",
		 ...
		 * equal: %2$s
		 */
		NO_EQUAL_MOVE("Message move aborted for user %1$s. Source and destination folder are equal: %2$s",
		 ...
		 * error: %3$s
		 */
		UID_EXPUNGE_FAILED("Message(s) %1$s in folder %2$s could not be deleted due to following error: %3$s",
		 ...
		 * read
		 */
		MESSAGE_CONTENT_ERROR("The raw content's input stream of message %1$s in folder %2$s cannot be read",
		 ...
		 */
		PROTOCOL_ERROR("A protocol exception occurred during execution of an IMAP request: %1$s",
